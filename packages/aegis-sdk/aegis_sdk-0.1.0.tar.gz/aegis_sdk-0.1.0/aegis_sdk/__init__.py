...
class Aegis:
    ...
    Example:
        ...
        # With license and policy groups (departments)
    ...
    def __init__(
        ...
        Args:
            license_key: Optional license key for cloud features
        ...
        # Determine policy configuration
        effective_policy = policy_config

        if license_key and auto_fetch_policy and not policy_config:
            # Fetch policy from cloud
            try:
