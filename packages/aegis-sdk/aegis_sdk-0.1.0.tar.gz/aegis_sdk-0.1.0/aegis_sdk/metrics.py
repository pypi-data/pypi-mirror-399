...
DEFAULT_API_ENDPOINT = "https://api.aegis.io/v1"
...
class MetricsReporter:
    ...
    def record_from_result(self, result, destination: str = "AI_TOOL", duration_ms: float = 0.0):
        ...
        """
        self.record(
            decision=result.decision if hasattr(result, 'decision') else str(result.decision),
    ...
    def _send_metrics(self, metrics: AggregatedMetrics):
        ...
        try:
            ...
            url = f"{self.api_endpoint}/metrics/batch"
            headers = {
                "Authorization": f"Bearer {self.license_key}",
                "Content-Type": "application/json",
                "User-Agent": "aegis-sdk/0.1.0",
            }
