...
def calculate_brokerage(buy_price, sell_price, quantity, broker="zerodha", market_type="options", order_type="MARKET", lot_size=100, position_type="LONG", holding_type="intraday", no_of_orders=2, market="IN", exchange="NSE"):
    ...
    try:
        ...
        # print(f"broker_fees         : {broker_fees}")
        # print(f"stt                 : {stt_charge}")
        # print(f"exchange_charges    : {transaction_charge}")
        # print(f"gst                 : {gst}")
        # print(f"sebi_charges        : {sebi_charge}")
        # print(f"stamp_duty          : {stamp_charge}")
        # print(f"total_charges       : {total_charges}")
