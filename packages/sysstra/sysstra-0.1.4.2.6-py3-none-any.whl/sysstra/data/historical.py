...
def fetch_option_candles(underlying, start_date, end_date, option_type, strike_price, expiry="near", granularity=1,
...
def fetch_option_candle_by_timestamp(underlying, strike_price, option_type, timestamp, granularity=1, expiry="near", exchange="XNSE"):
