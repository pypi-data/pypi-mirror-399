...
def main():
    parser = argparse.ArgumentParser(
        prog="make-memzip.py", usage="%(prog)s [options] [command]", description="Generates a C source memzip file."
    )
    parser.add_argument(
        "-z", "--zip-file", dest="zip_filename", help="Specifies the name of the created zip file.", default="memzip_files.zip"
    )
    parser.add_argument(
        "-c", "--c-file", dest="c_filename", help="Specifies the name of the created C source file.", default="memzip_files.c"
    )
