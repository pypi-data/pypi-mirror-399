...
latex_documents = [
    (master_doc, "MicroPython.tex", "MicroPython Documentation", "Damien P. George, Paul Sokolovsky, and contributors", "manual"),
]
...
man_pages = [
    ("index", "micropython", "MicroPython Documentation", ["Damien P. George, Paul Sokolovsky, and contributors"], 1),
]
