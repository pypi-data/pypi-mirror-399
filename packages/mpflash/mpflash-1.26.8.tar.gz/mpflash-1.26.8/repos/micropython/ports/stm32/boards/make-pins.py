...
class Pins(object):
    ...
    def print_adc(self, adc_num):
        ...
        for named_pin in self.cpu_pins:
            pin = named_pin.pin()
            if pin.is_board_pin() and not named_pin.is_hidden() and (pin.adc_num & (1 << (adc_num - 1))):
                ...
                for af in named_pin.pin().alt_fn:
                    ...
                    if cmp_strings:
                        ...
                        cmp_str = (
                            ...
                            ' & strcmp( #pin_obj , "((&pin_%s_obj))")) == 0) ? (%d) : \\' % (pin_name, pin_name, af.idx)
                        )
                    else:
