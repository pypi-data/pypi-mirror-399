...
class Pin(object):
    ...
    def print(self):
        ...
        print("const machine_pin_obj_t pin_{:s}_obj = PIN({:s}, {:d}, {:s});".format(self._name, self._name, self._pin_idx, pin_ad_name))
        print("")
...
def main():
    ...
    parser.add_argument("-b", "--board", dest="board_filename", help="Specifies the board file", default="pins.csv")
    parser.add_argument(
        "-p",
        "--prefix",
