...
import generated.configmaps.models
from generated.configmaps import rest
from generated.configmaps.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(generated.configmaps.models, klass)
