...
import generated.secrets.models
from generated.secrets import rest
from generated.secrets.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(generated.secrets.models, klass)
