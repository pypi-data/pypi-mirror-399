...
class AppServiceSetupAutoScalingPolicyBody(BaseModel):
    ...
    """
    auto_scaling_policy: V1AutoscalingPolicy = Field(alias="autoScalingPolicy")
    __properties: ClassVar[List[str]] = ["autoScalingPolicy"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AppServiceSetupAutoScalingPolicyBody from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of AppServiceSetupAutoScalingPolicyBody from a dict"""
        if obj is None:
            return None
