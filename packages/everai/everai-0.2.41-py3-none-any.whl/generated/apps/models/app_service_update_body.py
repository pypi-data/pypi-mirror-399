...
class AppServiceUpdateBody(BaseModel):
    """
    AppServiceUpdateBody
    """
    app: Optional[V1App] = None
    update_mask: Optional[StrictStr] = Field(default=None, alias="updateMask")
    __properties: ClassVar[List[str]] = ["app", "updateMask"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AppServiceUpdateBody from a JSON string"""
    ...
    def from_dict(cls, obj: dict) -> Self:
        """Create an instance of AppServiceUpdateBody from a dict"""
        if obj is None:
            return None
