...
from generated.apps.models.v1_list_workers_response import V1ListWorkersResponse  # noqa: E501
    ...
    def make_instance(self, include_optional) -> V1ListWorkersResponse:
        ...
        if include_optional:
            return V1ListWorkersResponse(
                ...
                queue_size = 56,
                queue_name = '',
                last_scale_up_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                last_scale_down_delete_time = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                max_workers = 56
            )
        else:
            return V1ListWorkersResponse(
