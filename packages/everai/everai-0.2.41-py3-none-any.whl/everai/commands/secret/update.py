...
class UpdateCommand(ClientCommand):
    ...
    def setup(parser: _SubParsersAction):
        update_parser = parser.add_parser('update',
                                          ...
                                          help='Update Secret from file or literal string')
        ...
        file_group.add_argument(
            ...
            '--from-file',
            type=str,
            help='Update secret from file, for example: --from-file filename'
        )
        ...
        literal_group.add_argument(
            ...
            action='append',
            type=str,
            help='Update secret from literal, for example: --from-literal name=user'
        )
    ...
    def run(self):
        ...
        if self.args.from_literal is not None and len(self.args.from_literal) > 0:
            ...
            secret = SecretManager().update_from_file(file=self.args.from_file)
        else:
