...
# Maximum concurrent stream sends per producer worker
# Higher = more throughput but more memory/connections
# Phase 3: Fire-and-forget stream sending to eliminate blocking
...
class ProducerWorker:
    ...
    def _run(self) -> None:
        ...
        self.logger.info(f"Started producer worker {self.worker_id} (max_concurrent_sends={MAX_CONCURRENT_SENDS})")
    ...
    async def _send_message_safely(self, task_data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            # Overlay storage - already fire-and-forget via frame_cache.put_overlay()
