...
class AsyncConsumerManager:
    ...
    # ================================================================
    # HIGH-PERFORMANCE CONFIGURATION (RESTORED - previous values caused starvation)
    # ================================================================
    BATCH_SIZE = 5000       # Messages to read per XREAD (RESTORED from 500)
    BLOCK_MS = 5            # XREAD block time in ms (low for responsiveness)
    QUEUE_MAX = 10_000      # RESTORED from 2,000 (was causing starvation)
    BACKPRESSURE_THRESHOLD = 0.8  # RESTORED from 0.5 (was triggering too early)
