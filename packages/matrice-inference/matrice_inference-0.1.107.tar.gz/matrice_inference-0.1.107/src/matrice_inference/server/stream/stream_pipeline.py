...
class StreamingPipeline:
    ...
    DEFAULT_QUEUE_SIZE = 1000  # Reduced from 5000 for earlier backpressure detection
    ...
    def _setup_executors(self) -> None:
        ...
        # Calculate dynamic worker count: 50% of CPU count, min 4, max 16
        # Phase 2 optimization: Increased from 25% to 50% for higher parallelism
        dynamic_worker_count = max(4, min(16, int(cpu_count * 0.5)))
