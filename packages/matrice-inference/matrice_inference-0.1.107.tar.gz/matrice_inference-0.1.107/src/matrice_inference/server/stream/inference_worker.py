...
ASYNC_BUFFER_SIZE = 500      # asyncio.Queue size (reduced for lower latency)
...
# Reduced from 16 to 8 for lower tail latency and better backpressure handling
MAX_INFLIGHT_BATCHES = 8     # Max concurrent batch inference operations per worker
