...
class AsyncConsumerManager:
    ...
    # ================================================================
    # HIGH-PERFORMANCE CONFIGURATION (optimized for backpressure control)
    # ================================================================
    BATCH_SIZE = 500        # Messages to read per XREAD (reduced for lower latency)
    BLOCK_MS = 5            # XREAD block time in ms (low for responsiveness)
    QUEUE_MAX = 2_000       # Reduced from 10k for earlier backpressure detection
    BACKPRESSURE_THRESHOLD = 0.5  # Trigger backpressure at 50% queue capacity
