...
from wafer_core.rollouts._retry import async_retry
from wafer_core.rollouts.dtypes import Actor, ChatCompletion, StreamEvent, ToolCallError
    ...
    if trajectory.completions:
        ...
        for i, msg in enumerate(trajectory.messages):
            ...
            if i == 0:
                ...
                from wafer_core.rollouts.inference.backends import tokenize_message_with_delimiter
