...
from wafer_core.rollouts.agents import Actor, AgentState, RunConfig, handle_stop_max_turns, run_agent
...
if TYPE_CHECKING:
    from wafer_core.rollouts.dtypes import Environment
...
async def agent_rollout_to_sample(
    ...
    Example (string prompt):
        >>> from wafer_core.rollouts.environments.calculator import CalculatorEnvironment
...
def _branching_trajectory_to_samples(
    ...
    """
    from wafer_core.rollouts.inference.backends import tokenize_chat
    from wafer_core.rollouts.training.types import Sample, Status
...
def _extract_tokens_from_trajectory(
    ...
    """
    from wafer_core.rollouts.inference.backends import (
