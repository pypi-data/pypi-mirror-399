...
if TYPE_CHECKING:
    from wafer_core.rollouts.dtypes import Score, Trajectory
...
class Sample:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        from wafer_core.rollouts.dtypes import Trajectory
    ...
    def from_dict(data: dict[str, Any]) -> "Sample":
        ...
        """
        from wafer_core.rollouts.dtypes import Metric, Score, Trajectory
