...
def debug_swa() -> None:
    ...
    from wafer_core.rollouts.inference.attention.mask import create_sliding_window_causal_mask
    ...
    from wafer_core.rollouts.inference.attention.mask import create_attention_mask
