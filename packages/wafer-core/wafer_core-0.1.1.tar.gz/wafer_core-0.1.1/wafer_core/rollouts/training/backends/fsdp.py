...
from wafer_core.rollouts.training.distributed_utils import (
    barrier,
    get_rank,
    get_world_size,
    is_main_process,
)
from wafer_core.rollouts.training.types import TrainFuture
...
class FSDPTrainingBackend:
    ...
    def forward_backward(self, batch: dict[str, Any]) -> TrainFuture[dict[str, float]]:
        ...
        """
        from wafer_core.rollouts.training.types import ImmediateTrainFuture
