...
multiplier = 10
""",
        initial_data={"base_value": 5}
    )

    Template.register_template("calc", """
result = base_value * multiplier
greeting = greet("World")
print(f"{greeting} Result: {result}")
""")

    Template.run("calc", profile="math_profile")
    Template.save("calc", profile_id="math_profile")