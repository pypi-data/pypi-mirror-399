...
def _process_r_tree(
    ...
    if node.type == "binary_operator":
        ...
        if is_assignment and left_node and right_node:
            ...
            _process_r_tree(right_node, source, rel_path, symbols, edges, function_registry, symbol_id)
    ...
    # Function calls
        ...
        if func_name_node:
            ...
            if func_name in ("library", "require"):
                ...
                # Regular function call - create edge
    ...
    for child in node.children:
        _process_r_tree(child, source, rel_path, symbols, edges, function_registry, current_function)
