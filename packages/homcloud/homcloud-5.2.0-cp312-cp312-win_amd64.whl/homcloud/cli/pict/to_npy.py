...
def argument_parser():
    ...
    p.add_argument("-O", "--output-type", default="float", help="output data type (float, int, bool)")
    p.add_argument("-t", "--threshold", type=float, help="threshold for boolean output")
