...
from ...models.get_v1_maintenance_status import GetV1MaintenanceStatus
...
def _get_kwargs(
    *,
    status: Union[Unset, GetV1MaintenanceStatus] = UNSET,
...
def sync_detailed(
    *,
    ...
    Args:
        status (Union[Unset, GetV1MaintenanceStatus]):
