...
T = TypeVar("T", bound="RepoMaintenanceEntry")



@_attrs_define
class RepoMaintenanceEntry:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repo_maintenance_entry.additional_properties = d
        return repo_maintenance_entry
