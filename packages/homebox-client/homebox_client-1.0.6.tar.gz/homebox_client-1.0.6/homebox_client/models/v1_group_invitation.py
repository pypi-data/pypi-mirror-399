...
T = TypeVar("T", bound="V1GroupInvitation")



@_attrs_define
class V1GroupInvitation:
    """ 
        Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        v1_group_invitation.additional_properties = d
        return v1_group_invitation
