...
if TYPE_CHECKING:
  from ..models.ent_label_edges import EntLabelEdges





T = TypeVar("T", bound="EntLabel")
...
class EntLabel:
    """ 
        Attributes:
            color (Union[Unset, str]): Color holds the value of the "color" field.
            ...
            edges (Union[Unset, EntLabelEdges]):
    ...
    edges: Union[Unset, 'EntLabelEdges'] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_edges,  Unset):
            ...
            edges = EntLabelEdges.from_dict(_edges)
        ...
        ent_label.additional_properties = d
        return ent_label
