...
T = TypeVar("T", bound="RepoItemTemplateCreate")



@_attrs_define
class RepoItemTemplateCreate:
    """ 
        Attributes:
            name (str):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        repo_item_template_create.additional_properties = d
        return repo_item_template_create
