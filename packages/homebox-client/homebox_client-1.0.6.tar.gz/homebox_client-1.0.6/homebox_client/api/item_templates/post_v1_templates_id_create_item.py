...
from ...models.v1_item_template_create_item_request import V1ItemTemplateCreateItemRequest
...
def _get_kwargs(
    id: str,
    *,
    body: V1ItemTemplateCreateItemRequest,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/v1/templates/{id}/create-item".format(id=id,),
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[RepoItemOut]:
    if response.status_code == 201:
        response_201 = RepoItemOut.from_dict(response.json())
