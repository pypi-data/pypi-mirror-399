...
MaxTrmP = 24
epsilon = 1e-15
coik = [[0] * (MaxTrmP + 1) for _ in range(MaxFlds + 1)]
doik = [[0] * (MaxTrmP + 1) for _ in range(MaxFlds + 1)]
dijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
Drold = 0
Trold = 0
Told = 0
Trold2 = 0
xold = [0] * (MaxFlds + 1)
mNumb = [[0] * (MaxFlds + 1) for _ in range(MaxFlds + 1)]
kpol = [0] * (MaxFlds + 1)
kexp = [0] * (MaxFlds + 1)
kpolij = [0] * (MaxMdl + 1)
kexpij = [0] * (MaxMdl + 1)
...
Vc3 = [0] * (MaxFlds + 1)
Tc2 = [0] * (MaxFlds + 1)
noik = [[0] * (MaxTrmP + 1) for _ in range(MaxFlds + 1)]
toik = [[0] * (MaxTrmP + 1) for _ in range(MaxFlds + 1)]
cijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
eijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
gijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
nijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
tijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
btij = [[0] * (MaxFlds + 1) for _ in range(MaxFlds + 1)]
bvij = [[0] * (MaxFlds + 1) for _ in range(MaxFlds + 1)]
gtij = [[0] * (MaxFlds + 1) for _ in range(MaxFlds + 1)]
gvij = [[0] * (MaxFlds + 1) for _ in range(MaxFlds + 1)]
fij = [[0] * (MaxFlds + 1) for _ in range(MaxFlds + 1)]
th0i = [[0] * (7 + 1) for _ in range(MaxFlds + 1)]
n0i = [[0] * (7 + 1) for _ in range(MaxFlds + 1)]
taup = [[0] * (MaxTrmP + 1) for _ in range(MaxFlds + 1)]
taupijk = [[0] * (MaxTrmM + 1) for _ in range(MaxFlds + 1)]
...
bijk = [[0] * (MaxTrmM + 1) for _ in range(MaxMdl + 1)]
T0 = 0
d0 = 0
