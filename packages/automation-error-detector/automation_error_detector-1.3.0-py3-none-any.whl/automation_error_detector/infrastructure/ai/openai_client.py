...
- short_description (string, MUST be written in Vietnamese)
- keywords (array of strings, lowercase, can be English or Vietnamese)
...
- keywords MUST be concise and relevant to detection.
...
- keywords (array of strings, lowercase, English or Vietnamese)
