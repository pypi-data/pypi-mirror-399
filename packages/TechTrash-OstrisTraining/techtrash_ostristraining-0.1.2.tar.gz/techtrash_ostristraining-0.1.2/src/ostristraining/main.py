...
class OstrisTraining:
    ...
    def _train_model(self) -> str:
        ...
        # The AI-Toolkit training can be very verbose and is usually printed to stdout/stderr.
        # We capture *all* of it into a deterministic log file so a serverless wrapper
        # (ex: RunPod handler) can tail it and stream to Supabase in real-time.
        ...
        # Ensure output folders exist. Some toolkits fail if they don't.
