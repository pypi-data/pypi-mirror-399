"""Tests for Docker environment detection plugin."""
...
import pytest
from systemeval.plugins.docker import (
...
class TestIsDockerEnvironment:
    ...
    def test_dockerenv_takes_priority(self):
        ...
        with patch("systemeval.plugins.docker.Path") as MockPath:
...
class TestGetEnvironmentType:
    ...
    def test_returns_docker_when_in_docker(self):
        ...
        with patch(
            "systemeval.plugins.docker.is_docker_environment", return_value=True
        ):
    ...
    def test_returns_local_when_not_in_docker(self):
        ...
        with patch(
            "systemeval.plugins.docker.is_docker_environment", return_value=False
        ):
