...
class ConstantBootstraps:
    @staticmethod
    def arrayVarHandle(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type['VarHandle'], class2: typing.Type[typing.Any]) -> 'VarHandle': ...
    _enumConstant__E = typing.TypeVar('_enumConstant__E', bound=java.lang.Enum)  # <E>
    @staticmethod
    def enumConstant(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[_enumConstant__E]) -> _enumConstant__E: ...
    @staticmethod
    def explicitCast(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], object: typing.Any) -> typing.Any: ...
    @staticmethod
    def fieldVarHandle(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type['VarHandle'], class2: typing.Type[typing.Any], class3: typing.Type[typing.Any]) -> 'VarHandle': ...
    @typing.overload
    @staticmethod
    def getStaticFinal(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any]) -> typing.Any: ...
    @typing.overload
    @staticmethod
    def getStaticFinal(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], class2: typing.Type[typing.Any]) -> typing.Any: ...
    @staticmethod
    def invoke(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], methodHandle: 'MethodHandle', *object: typing.Any) -> typing.Any: ...
    @staticmethod
    def nullConstant(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any]) -> typing.Any: ...
    @staticmethod
    def primitiveClass(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any]) -> typing.Type[typing.Any]: ...
    @staticmethod
    def staticFieldVarHandle(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type['VarHandle'], class2: typing.Type[typing.Any], class3: typing.Type[typing.Any]) -> 'VarHandle': ...
...
class LambdaConversionException(java.lang.Exception):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], throwable: java.lang.Throwable, boolean: bool, boolean2: bool): ...
    @typing.overload
...
class LambdaMetafactory:
    ...
    @staticmethod
    def altMetafactory(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], methodType: 'MethodType', *object: typing.Any) -> CallSite: ...
    @staticmethod
    def metafactory(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], methodType: 'MethodType', methodType2: 'MethodType', methodHandle: 'MethodHandle', methodType3: 'MethodType') -> CallSite: ...
...
class MethodHandleInfo:
    ...
    @staticmethod
    def toString(int: int, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], methodType: 'MethodType') -> java.lang.String: ...
...
class MethodHandles:
    ...
    @staticmethod
    def classData(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[_classData__T]) -> _classData__T: ...
    _classDataAt__T = typing.TypeVar('_classDataAt__T')  # <T>
    @staticmethod
    def classDataAt(lookup: 'MethodHandles.Lookup', string: typing.Union[java.lang.String, str], class_: typing.Type[_classDataAt__T], int: int) -> _classDataAt__T: ...
    @staticmethod
    ...
    class Lookup:
        ...
        def bind(self, object: typing.Any, string: typing.Union[java.lang.String, str], methodType: 'MethodType') -> MethodHandle: ...
        ...
        def findClass(self, string: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
        def findConstructor(self, class_: typing.Type[typing.Any], methodType: 'MethodType') -> MethodHandle: ...
        def findGetter(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any]) -> MethodHandle: ...
        def findSetter(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any]) -> MethodHandle: ...
        def findSpecial(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], methodType: 'MethodType', class2: typing.Type[typing.Any]) -> MethodHandle: ...
        def findStatic(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], methodType: 'MethodType') -> MethodHandle: ...
        def findStaticGetter(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any]) -> MethodHandle: ...
        def findStaticSetter(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any]) -> MethodHandle: ...
        def findStaticVarHandle(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any]) -> 'VarHandle': ...
        def findVarHandle(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any]) -> 'VarHandle': ...
        def findVirtual(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], methodType: 'MethodType') -> MethodHandle: ...
...
class StringConcatFactory:
    @staticmethod
    def makeConcat(lookup: MethodHandles.Lookup, string: typing.Union[java.lang.String, str], methodType: 'MethodType') -> CallSite: ...
    @staticmethod
    def makeConcatWithConstants(lookup: MethodHandles.Lookup, string: typing.Union[java.lang.String, str], methodType: 'MethodType', string2: typing.Union[java.lang.String, str], *object: typing.Any) -> CallSite: ...
...
class VarHandle(java.lang.constant.Constable):
    ...
    class AccessMode(java.lang.Enum['VarHandle.AccessMode']):
        ...
        @staticmethod
        def valueFromMethodName(string: typing.Union[java.lang.String, str]) -> 'VarHandle.AccessMode': ...
        _valueOf_0__T = typing.TypeVar('_valueOf_0__T', bound=java.lang.Enum)  # <T>
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_0__T], string: typing.Union[java.lang.String, str]) -> _valueOf_0__T: ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'VarHandle.AccessMode': ...
        @staticmethod
    ...
    class VarHandleDesc(java.lang.constant.DynamicConstantDesc['VarHandle']):
        ...
        @staticmethod
        def ofField(classDesc: java.lang.constant.ClassDesc, string: typing.Union[java.lang.String, str], classDesc2: java.lang.constant.ClassDesc) -> 'VarHandle.VarHandleDesc': ...
        @staticmethod
        def ofStaticField(classDesc: java.lang.constant.ClassDesc, string: typing.Union[java.lang.String, str], classDesc2: java.lang.constant.ClassDesc) -> 'VarHandle.VarHandleDesc': ...
...
class MethodType(java.lang.constant.Constable, java.lang.invoke.TypeDescriptor.OfMethod[typing.Type[typing.Any], 'MethodType'], java.io.Serializable):
    ...
    @staticmethod
    def fromMethodDescriptorString(string: typing.Union[java.lang.String, str], classLoader: java.lang.ClassLoader) -> 'MethodType': ...
