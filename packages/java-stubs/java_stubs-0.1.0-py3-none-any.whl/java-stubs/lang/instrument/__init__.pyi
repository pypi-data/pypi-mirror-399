...
class ClassFileTransformer:
    @typing.overload
    def transform(self, classLoader: java.lang.ClassLoader, string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any], protectionDomain: java.security.ProtectionDomain, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> typing.MutableSequence[int]: ...
    @typing.overload
    def transform(self, module: java.lang.Module, classLoader: java.lang.ClassLoader, string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any], protectionDomain: java.security.ProtectionDomain, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> typing.MutableSequence[int]: ...
...
class Instrumentation:
    ...
    def setNativeMethodPrefix(self, classFileTransformer: ClassFileTransformer, string: typing.Union[java.lang.String, str]) -> None: ...
