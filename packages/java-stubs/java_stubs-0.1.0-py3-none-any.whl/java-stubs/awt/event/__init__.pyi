...
class ActionEvent(java.awt.AWTEvent):
    ...
    @typing.overload
    def __init__(self, object: typing.Any, int: int, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, object: typing.Any, int: int, string: typing.Union[java.lang.String, str], int2: int): ...
    @typing.overload
    def __init__(self, object: typing.Any, int: int, string: typing.Union[java.lang.String, str], long: int, int2: int): ...
...
class FocusEvent(ComponentEvent):
    ...
    class Cause(java.lang.Enum['FocusEvent.Cause']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'FocusEvent.Cause': ...
        @typing.overload
        @staticmethod
