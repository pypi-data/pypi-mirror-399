...
class QuitStrategy(java.lang.Enum['QuitStrategy']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'QuitStrategy': ...
    @typing.overload
    @staticmethod
    def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
    @staticmethod
...
class UserSessionEvent(AppEvent):
    ...
    class Reason(java.lang.Enum['UserSessionEvent.Reason']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'UserSessionEvent.Reason': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[java.lang.String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class OpenFilesEvent(FilesEvent):
    def __init__(self, list: java.util.List[typing.Union[java.io.File, jpype.protocol.SupportsPath]], string: typing.Union[java.lang.String, str]): ...
