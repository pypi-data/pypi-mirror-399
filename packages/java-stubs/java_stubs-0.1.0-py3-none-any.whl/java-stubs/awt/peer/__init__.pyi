...
class TaskbarPeer:
    ...
    def setIconBadge(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class TrayIconPeer:
    def displayMessage(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> None: ...
    def dispose(self) -> None: ...
    def setToolTip(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class ChoicePeer(ComponentPeer):
    def add(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
...
class TextAreaPeer(TextComponentPeer):
    ...
    def insert(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    def replaceRange(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> None: ...
...
class FileDialogPeer(DialogPeer):
    def setDirectory(self, string: typing.Union[java.lang.String, str]) -> None: ...
