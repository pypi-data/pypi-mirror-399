...
class Channels:
    ...
    @typing.overload
    @staticmethod
    def newReader(readableByteChannel: 'ReadableByteChannel', string: typing.Union[java.lang.String, str]) -> java.io.Reader: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def newWriter(writableByteChannel: 'WritableByteChannel', string: typing.Union[java.lang.String, str]) -> java.io.Writer: ...
    @typing.overload
    @staticmethod
