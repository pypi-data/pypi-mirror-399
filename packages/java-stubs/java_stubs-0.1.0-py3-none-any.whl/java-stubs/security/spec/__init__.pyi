...
class PSSParameterSpec(AlgorithmParameterSpec):
    ...
    def __init__(self, int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], algorithmParameterSpec: AlgorithmParameterSpec, int: int, int2: int): ...
    def getDigestAlgorithm(self) -> java.lang.String: ...
...
class PKCS8EncodedKeySpec(EncodedKeySpec, java.security.DEREncodable):
    ...
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]): ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], string: typing.Union[java.lang.String, str]): ...
    def getEncoded(self) -> typing.MutableSequence[int]: ...
    def getFormat(self) -> java.lang.String: ...
