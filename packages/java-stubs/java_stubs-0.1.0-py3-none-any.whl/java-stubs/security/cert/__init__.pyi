...
class CRLReason(java.lang.Enum['CRLReason']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'CRLReason': ...
    @staticmethod
...
class CertPathBuilder:
    ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str]) -> 'CertPathBuilder': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'CertPathBuilder': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], provider: java.security.Provider) -> 'CertPathBuilder': ...
...
class CertPathValidator:
    ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str]) -> 'CertPathValidator': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'CertPathValidator': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], provider: java.security.Provider) -> 'CertPathValidator': ...
    def getProvider(self) -> java.security.Provider: ...
    def getRevocationChecker(self) -> CertPathChecker: ...
...
class CertStore:
    ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], certStoreParameters: typing.Union['CertStoreParameters', typing.Callable]) -> 'CertStore': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], certStoreParameters: typing.Union['CertStoreParameters', typing.Callable], string2: typing.Union[java.lang.String, str]) -> 'CertStore': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], certStoreParameters: typing.Union['CertStoreParameters', typing.Callable], provider: java.security.Provider) -> 'CertStore': ...
    def getProvider(self) -> java.security.Provider: ...
    def getType(self) -> java.lang.String: ...
...
class Certificate(java.io.Serializable):
    ...
    @typing.overload
    def verify(self, publicKey: java.security.PublicKey, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
...
class CertificateFactory:
    ...
    @typing.overload
    def generateCertPath(self, inputStream: java.io.InputStream, string: typing.Union[java.lang.String, str]) -> CertPath: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str]) -> 'CertificateFactory': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'CertificateFactory': ...
    @typing.overload
    @staticmethod
    def getInstance(string: typing.Union[java.lang.String, str], provider: java.security.Provider) -> 'CertificateFactory': ...
    def getProvider(self) -> java.security.Provider: ...
    def getType(self) -> java.lang.String: ...
...
class CertificateFactorySpi:
    ...
    @typing.overload
    def engineGenerateCertPath(self, inputStream: java.io.InputStream, string: typing.Union[java.lang.String, str]) -> CertPath: ...
    @typing.overload
...
class TrustAnchor:
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], publicKey: java.security.PublicKey, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]): ...
    @typing.overload
...
class X509Extension:
    ...
    def getExtensionValue(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[int]: ...
...
class CertificateRevokedException(CertificateException):
    def __init__(self, date: java.util.Date, cRLReason: CRLReason, x500Principal: javax.security.auth.x500.X500Principal, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], Extension], typing.Mapping[typing.Union[java.lang.String, str], Extension]]): ...
...
class PKIXCertPathChecker(CertPathChecker, java.lang.Cloneable):
    @typing.overload
    def check(self, certificate: Certificate, collection: typing.Union[java.util.Collection[typing.Union[java.lang.String, str]], typing.Sequence[typing.Union[java.lang.String, str]], typing.Set[typing.Union[java.lang.String, str]]]) -> None: ...
    @typing.overload
    def check(self, certificate: Certificate) -> None: ...
    def clone(self) -> typing.Any: ...
...
class PKIXParameters(CertPathParameters):
    ...
    def setInitialPolicies(self, set: java.util.Set[typing.Union[java.lang.String, str]]) -> None: ...
    ...
    def setSigProvider(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class X509CRLSelector(CRLSelector):
    ...
    @typing.overload
    def addIssuerName(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def clone(self) -> typing.Any: ...
...
class X509CertSelector(CertSelector):
    ...
    @typing.overload
    def addPathToName(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def addSubjectAlternativeName(self, int: int, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def addSubjectAlternativeName(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    def clone(self) -> typing.Any: ...
    ...
    def setExtendedKeyUsage(self, set: java.util.Set[typing.Union[java.lang.String, str]]) -> None: ...
    @typing.overload
    def setIssuer(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def setIssuer(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    def setPolicy(self, set: java.util.Set[typing.Union[java.lang.String, str]]) -> None: ...
    ...
    def setSubjectPublicKeyAlgID(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class PKIXRevocationChecker(PKIXCertPathChecker):
    ...
    class Option(java.lang.Enum['PKIXRevocationChecker.Option']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'PKIXRevocationChecker.Option': ...
        @staticmethod
...
class CertPathValidatorException(java.security.GeneralSecurityException):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], throwable: java.lang.Throwable, certPath: CertPath, int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], throwable: java.lang.Throwable, certPath: CertPath, int: int, reason: 'CertPathValidatorException.Reason'): ...
    @typing.overload
    def __init__(self, throwable: java.lang.Throwable): ...
    def getCertPath(self) -> CertPath: ...
    ...
    class BasicReason(java.lang.Enum['CertPathValidatorException.BasicReason'], java.security.cert.CertPathValidatorException.Reason):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'CertPathValidatorException.BasicReason': ...
        @staticmethod
...
class PKIXReason(java.lang.Enum['PKIXReason'], CertPathValidatorException.Reason):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'PKIXReason': ...
    @staticmethod
