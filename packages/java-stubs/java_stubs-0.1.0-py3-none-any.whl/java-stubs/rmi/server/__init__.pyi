...
class LoaderHandler:
    ...
    @typing.overload
    def loadClass(self, string: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
    @typing.overload
    def loadClass(self, uRL: java.net.URL, string: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
...
class LogStream(java.io.PrintStream):
    ...
    @staticmethod
    def log(string: typing.Union[java.lang.String, str]) -> 'LogStream': ...
    @staticmethod
    def parseLevel(string: typing.Union[java.lang.String, str]) -> int: ...
    @staticmethod
...
class RMIClassLoader:
    @staticmethod
    def getClassAnnotation(class_: typing.Type[typing.Any]) -> java.lang.String: ...
    @staticmethod
    def getClassLoader(string: typing.Union[java.lang.String, str]) -> java.lang.ClassLoader: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def loadClass(string: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
    @typing.overload
    @staticmethod
    def loadClass(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
    @typing.overload
    @staticmethod
    def loadClass(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], classLoader: java.lang.ClassLoader) -> typing.Type[typing.Any]: ...
    @typing.overload
    @staticmethod
    def loadClass(uRL: java.net.URL, string: typing.Union[java.lang.String, str]) -> typing.Type[typing.Any]: ...
    @staticmethod
    def loadProxyClass(string: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray], classLoader: java.lang.ClassLoader) -> typing.Type[typing.Any]: ...

class RMIClassLoaderSpi:
    def __init__(self): ...
    def getClassAnnotation(self, class_: typing.Type[typing.Any]) -> java.lang.String: ...
    def getClassLoader(self, string: typing.Union[java.lang.String, str]) -> java.lang.ClassLoader: ...
    def loadClass(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], classLoader: java.lang.ClassLoader) -> typing.Type[typing.Any]: ...
    def loadProxyClass(self, string: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray], classLoader: java.lang.ClassLoader) -> typing.Type[typing.Any]: ...

class RMIClientSocketFactory:
    def createSocket(self, string: typing.Union[java.lang.String, str], int: int) -> java.net.Socket: ...
