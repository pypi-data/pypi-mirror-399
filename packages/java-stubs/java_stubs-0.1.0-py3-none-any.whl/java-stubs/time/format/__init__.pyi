...
class DateTimeFormatter:
    ...
    @staticmethod
    def ofLocalizedPattern(string: typing.Union[java.lang.String, str]) -> 'DateTimeFormatter': ...
    @staticmethod
    def ofLocalizedTime(formatStyle: 'FormatStyle') -> 'DateTimeFormatter': ...
    @typing.overload
    @staticmethod
    def ofPattern(string: typing.Union[java.lang.String, str]) -> 'DateTimeFormatter': ...
    @typing.overload
    @staticmethod
    def ofPattern(string: typing.Union[java.lang.String, str], locale: java.util.Locale) -> 'DateTimeFormatter': ...
...
class DateTimeFormatterBuilder:
    ...
    @typing.overload
    def appendLiteral(self, string: typing.Union[java.lang.String, str]) -> 'DateTimeFormatterBuilder': ...
    @typing.overload
    def appendLocalized(self, string: typing.Union[java.lang.String, str]) -> 'DateTimeFormatterBuilder': ...
    @typing.overload
    ...
    def appendOffset(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'DateTimeFormatterBuilder': ...
    ...
    def appendPattern(self, string: typing.Union[java.lang.String, str]) -> 'DateTimeFormatterBuilder': ...
    @typing.overload
    ...
    @typing.overload
    def appendText(self, temporalField: java.time.temporal.TemporalField, map: typing.Union[java.util.Map[int, typing.Union[java.lang.String, str]], typing.Mapping[int, typing.Union[java.lang.String, str]]]) -> 'DateTimeFormatterBuilder': ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def getLocalizedDateTimePattern(string: typing.Union[java.lang.String, str], chronology: java.time.chrono.Chronology, locale: java.util.Locale) -> java.lang.String: ...
    @typing.overload
    @staticmethod
    def getLocalizedDateTimePattern(formatStyle: 'FormatStyle', formatStyle2: 'FormatStyle', chronology: java.time.chrono.Chronology, locale: java.util.Locale) -> java.lang.String: ...
...
class DateTimeParseException(java.time.DateTimeException):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], charSequence: typing.Union[java.lang.CharSequence, str], int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], charSequence: typing.Union[java.lang.CharSequence, str], int: int, throwable: java.lang.Throwable): ...
...
class FormatStyle(java.lang.Enum['FormatStyle']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'FormatStyle': ...
    @staticmethod
...
class ResolverStyle(java.lang.Enum['ResolverStyle']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'ResolverStyle': ...
    @staticmethod
...
class SignStyle(java.lang.Enum['SignStyle']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'SignStyle': ...
    @staticmethod
...
class TextStyle(java.lang.Enum['TextStyle']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'TextStyle': ...
    @staticmethod
