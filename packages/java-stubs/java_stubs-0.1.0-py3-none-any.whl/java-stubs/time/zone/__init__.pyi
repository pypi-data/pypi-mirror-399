...
class ZoneOffsetTransitionRule(java.io.Serializable):
    ...
    class TimeDefinition(java.lang.Enum['ZoneOffsetTransitionRule.TimeDefinition']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ZoneOffsetTransitionRule.TimeDefinition': ...
        @staticmethod
...
class ZoneRulesProvider:
    ...
    @staticmethod
    def getRules(string: typing.Union[java.lang.String, str], boolean: bool) -> ZoneRules: ...
    @staticmethod
    def getVersions(string: typing.Union[java.lang.String, str]) -> java.util.NavigableMap[java.lang.String, ZoneRules]: ...
    @staticmethod
    def refresh() -> bool: ...
    @staticmethod
