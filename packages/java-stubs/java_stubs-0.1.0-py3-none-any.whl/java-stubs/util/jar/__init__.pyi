...
class Attributes(java.util.Map[typing.Any, typing.Any], java.lang.Cloneable):
    ...
    def putValue(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
...
class JarFile(java.util.zip.ZipFile):
    ...
    def getEntry(self, string: typing.Union[java.lang.String, str]) -> java.util.zip.ZipEntry: ...
    def getInputStream(self, zipEntry: java.util.zip.ZipEntry) -> java.io.InputStream: ...
    def getJarEntry(self, string: typing.Union[java.lang.String, str]) -> JarEntry: ...
...
class Manifest(java.lang.Cloneable):
    ...
    def clone(self) -> typing.Any: ...
    def equals(self, object: typing.Any) -> bool: ...
    def getAttributes(self, string: typing.Union[java.lang.String, str]) -> Attributes: ...
