...
class RandomGeneratorFactory(typing.Generic[_RandomGeneratorFactory__T]):
    ...
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'RandomGeneratorFactory'[_of__T]: ...
...
class RandomGenerator:
    ...
    def equiDoubles(self, double: float, double2: float, boolean: bool, boolean2: bool) -> java.util.stream.DoubleStream: ...
    @staticmethod
    ...
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'RandomGenerator': ...
    class ArbitrarilyJumpableGenerator(java.util.random.RandomGenerator.LeapableGenerator):
        ...
        def leap(self) -> None: ...
        @staticmethod
        def of(string: typing.Union[java.lang.String, str]) -> 'RandomGenerator.ArbitrarilyJumpableGenerator': ...
    class JumpableGenerator(java.util.random.RandomGenerator.StreamableGenerator):
        ...
        def jumps(self, long: int) -> java.util.stream.Stream['RandomGenerator']: ...
        @staticmethod
        def of(string: typing.Union[java.lang.String, str]) -> 'RandomGenerator.JumpableGenerator': ...
        @typing.overload
    ...
    class LeapableGenerator(java.util.random.RandomGenerator.JumpableGenerator):
        ...
        @staticmethod
        def of(string: typing.Union[java.lang.String, str]) -> 'RandomGenerator.LeapableGenerator': ...
    class SplittableGenerator(java.util.random.RandomGenerator.StreamableGenerator):
        @staticmethod
        def of(string: typing.Union[java.lang.String, str]) -> 'RandomGenerator.SplittableGenerator': ...
        @typing.overload
        def rngs(self) -> java.util.stream.Stream['RandomGenerator']: ...
        @typing.overload
        def rngs(self, long: int) -> java.util.stream.Stream['RandomGenerator']: ...
    ...
    class StreamableGenerator(java.util.random.RandomGenerator):
        @staticmethod
        def of(string: typing.Union[java.lang.String, str]) -> 'RandomGenerator.StreamableGenerator': ...
        @typing.overload
        def rngs(self) -> java.util.stream.Stream['RandomGenerator']: ...
        @typing.overload
        def rngs(self, long: int) -> java.util.stream.Stream['RandomGenerator']: ...
