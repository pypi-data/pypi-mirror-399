...
class Collector(typing.Generic[_Collector__T, _Collector__A, _Collector__R]):
    ...
    class Characteristics(java.lang.Enum['Collector.Characteristics']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Collector.Characteristics': ...
        @staticmethod
...
class Collectors:
    ...
    @typing.overload
    @staticmethod
    def joining() -> Collector[java.lang.CharSequence, typing.Any, java.lang.String]: ...
    @typing.overload
    @staticmethod
    def joining(charSequence: typing.Union[java.lang.CharSequence, str]) -> Collector[java.lang.CharSequence, typing.Any, java.lang.String]: ...
    @typing.overload
    @staticmethod
    def joining(charSequence: typing.Union[java.lang.CharSequence, str], charSequence2: typing.Union[java.lang.CharSequence, str], charSequence3: typing.Union[java.lang.CharSequence, str]) -> Collector[java.lang.CharSequence, typing.Any, java.lang.String]: ...
...
class Gatherers:
    ...
    @staticmethod
    def fold(supplier: typing.Union[java.util.function.Supplier[_fold__R], typing.Callable[[], _fold__R]], biFunction: typing.Union[java.util.function.BiFunction[_fold__R, _fold__T, _fold__R], typing.Callable[[_fold__R, _fold__T], _fold__R]]) -> 'Gatherer'[_fold__T, typing.Any, _fold__R]: ...
    _mapConcurrent__T = typing.TypeVar('_mapConcurrent__T')  # <T>
    _mapConcurrent__R = typing.TypeVar('_mapConcurrent__R')  # <R>
    @staticmethod
    def mapConcurrent(int: int, function: typing.Union[java.util.function.Function[_mapConcurrent__T, _mapConcurrent__R], typing.Callable[[_mapConcurrent__T], _mapConcurrent__R]]) -> 'Gatherer'[_mapConcurrent__T, typing.Any, _mapConcurrent__R]: ...
    _scan__T = typing.TypeVar('_scan__T')  # <T>
    _scan__R = typing.TypeVar('_scan__R')  # <R>
    @staticmethod
    def scan(supplier: typing.Union[java.util.function.Supplier[_scan__R], typing.Callable[[], _scan__R]], biFunction: typing.Union[java.util.function.BiFunction[_scan__R, _scan__T, _scan__R], typing.Callable[[_scan__R, _scan__T], _scan__R]]) -> 'Gatherer'[_scan__T, typing.Any, _scan__R]: ...
    _windowFixed__TR = typing.TypeVar('_windowFixed__TR')  # <TR>
    @staticmethod
    def windowFixed(int: int) -> 'Gatherer'[_windowFixed__TR, typing.Any, java.util.List[_windowFixed__TR]]: ...
    _windowSliding__TR = typing.TypeVar('_windowSliding__TR')  # <TR>
    @staticmethod
    def windowSliding(int: int) -> 'Gatherer'[_windowSliding__TR, typing.Any, java.util.List[_windowSliding__TR]]: ...
...
class Stream(BaseStream[_Stream__T, 'Stream'[_Stream__T]], typing.Generic[_Stream__T]):
    ...
    def gather(self, gatherer: typing.Union['Gatherer'[_Stream__T, typing.Any, _gather__R], typing.Callable[[], 'Gatherer.Integrator'[typing.Any, typing.Any, typing.Any]]]) -> 'Stream'[_gather__R]: ...
...
_Gatherer__Integrator__Greedy__A = typing.TypeVar('_Gatherer__Integrator__Greedy__A')  # <A>
_Gatherer__Integrator__Greedy__T = typing.TypeVar('_Gatherer__Integrator__Greedy__T')  # <T>
_Gatherer__Integrator__Greedy__R = typing.TypeVar('_Gatherer__Integrator__Greedy__R')  # <R>
...
class Gatherer(typing.Generic[_Gatherer__T, _Gatherer__A, _Gatherer__R]):
    ...
    def andThen(self, gatherer: typing.Union['Gatherer'[_Gatherer__R, typing.Any, _andThen__RR], typing.Callable[[], 'Gatherer.Integrator'[typing.Any, typing.Any, typing.Any]]]) -> 'Gatherer'[_Gatherer__T, typing.Any, _andThen__RR]: ...
    ...
    @staticmethod
    def defaultFinisher() -> java.util.function.BiConsumer[_defaultFinisher__A, 'Gatherer.Downstream'[_defaultFinisher__R]]: ...
    ...
    def finisher(self) -> java.util.function.BiConsumer[_Gatherer__A, 'Gatherer.Downstream'[_Gatherer__R]]: ...
    def initializer(self) -> java.util.function.Supplier[_Gatherer__A]: ...
    def integrator(self) -> 'Gatherer.Integrator'[_Gatherer__A, _Gatherer__T, _Gatherer__R]: ...
    _of_0__T = typing.TypeVar('_of_0__T')  # <T>
    _of_0__A = typing.TypeVar('_of_0__A')  # <A>
    _of_0__R = typing.TypeVar('_of_0__R')  # <R>
    _of_1__T = typing.TypeVar('_of_1__T')  # <T>
    ...
    @typing.overload
    @staticmethod
    def of(supplier: typing.Union[java.util.function.Supplier[_of_0__A], typing.Callable[[], _of_0__A]], integrator: typing.Union['Gatherer.Integrator'[_of_0__A, _of_0__T, _of_0__R], typing.Callable[[_of_0__A, _of_0__T, 'Gatherer.Downstream'[typing.Any]], bool]], binaryOperator: typing.Union[java.util.function.BinaryOperator[_of_0__A], typing.Callable], biConsumer: typing.Union[java.util.function.BiConsumer[_of_0__A, typing.Union['Gatherer.Downstream'[_of_0__R], typing.Callable[[_of_0__R], bool]]], typing.Callable[[_of_0__A, typing.Union['Gatherer.Downstream'[_of_0__R], typing.Callable[[_of_0__R], bool]]], None]]) -> 'Gatherer'[_of_0__T, _of_0__A, _of_0__R]: ...
    @typing.overload
    @staticmethod
    def of(integrator: typing.Union['Gatherer.Integrator'[None, _of_1__T, _of_1__R], typing.Callable[[None, _of_1__T, 'Gatherer.Downstream'[typing.Any]], bool]]) -> 'Gatherer'[_of_1__T, None, _of_1__R]: ...
    @typing.overload
    @staticmethod
    def of(integrator: typing.Union['Gatherer.Integrator'[None, _of_2__T, _of_2__R], typing.Callable[[None, _of_2__T, 'Gatherer.Downstream'[typing.Any]], bool]], biConsumer: typing.Union[java.util.function.BiConsumer[None, typing.Union['Gatherer.Downstream'[_of_2__R], typing.Callable[[_of_2__R], bool]]], typing.Callable[[None, typing.Union['Gatherer.Downstream'[_of_2__R], typing.Callable[[_of_2__R], bool]]], None]]) -> 'Gatherer'[_of_2__T, None, _of_2__R]: ...
    ...
    @typing.overload
    @staticmethod
    def ofSequential(supplier: typing.Union[java.util.function.Supplier[_ofSequential_0__A], typing.Callable[[], _ofSequential_0__A]], integrator: typing.Union['Gatherer.Integrator'[_ofSequential_0__A, _ofSequential_0__T, _ofSequential_0__R], typing.Callable[[_ofSequential_0__A, _ofSequential_0__T, 'Gatherer.Downstream'[typing.Any]], bool]]) -> 'Gatherer'[_ofSequential_0__T, _ofSequential_0__A, _ofSequential_0__R]: ...
    @typing.overload
    @staticmethod
    def ofSequential(supplier: typing.Union[java.util.function.Supplier[_ofSequential_1__A], typing.Callable[[], _ofSequential_1__A]], integrator: typing.Union['Gatherer.Integrator'[_ofSequential_1__A, _ofSequential_1__T, _ofSequential_1__R], typing.Callable[[_ofSequential_1__A, _ofSequential_1__T, 'Gatherer.Downstream'[typing.Any]], bool]], biConsumer: typing.Union[java.util.function.BiConsumer[_ofSequential_1__A, typing.Union['Gatherer.Downstream'[_ofSequential_1__R], typing.Callable[[_ofSequential_1__R], bool]]], typing.Callable[[_ofSequential_1__A, typing.Union['Gatherer.Downstream'[_ofSequential_1__R], typing.Callable[[_ofSequential_1__R], bool]]], None]]) -> 'Gatherer'[_ofSequential_1__T, _ofSequential_1__A, _ofSequential_1__R]: ...
    @typing.overload
    @staticmethod
    def ofSequential(integrator: typing.Union['Gatherer.Integrator'[None, _ofSequential_2__T, _ofSequential_2__R], typing.Callable[[None, _ofSequential_2__T, 'Gatherer.Downstream'[typing.Any]], bool]]) -> 'Gatherer'[_ofSequential_2__T, None, _ofSequential_2__R]: ...
    @typing.overload
    @staticmethod
    def ofSequential(integrator: typing.Union['Gatherer.Integrator'[None, _ofSequential_3__T, _ofSequential_3__R], typing.Callable[[None, _ofSequential_3__T, 'Gatherer.Downstream'[typing.Any]], bool]], biConsumer: typing.Union[java.util.function.BiConsumer[None, typing.Union['Gatherer.Downstream'[_ofSequential_3__R], typing.Callable[[_ofSequential_3__R], bool]]], typing.Callable[[None, typing.Union['Gatherer.Downstream'[_ofSequential_3__R], typing.Callable[[_ofSequential_3__R], bool]]], None]]) -> 'Gatherer'[_ofSequential_3__T, None, _ofSequential_3__R]: ...
    ...
    class Integrator(typing.Generic[_Gatherer__Integrator__A, _Gatherer__Integrator__T, _Gatherer__Integrator__R]):
        def integrate(self, a: _Gatherer__Integrator__A, t: _Gatherer__Integrator__T, downstream: typing.Union['Gatherer.Downstream'[_Gatherer__Integrator__R], typing.Callable[[_Gatherer__Integrator__R], bool]]) -> bool: ...
        _of__A = typing.TypeVar('_of__A')  # <A>
        _of__T = typing.TypeVar('_of__T')  # <T>
        _of__R = typing.TypeVar('_of__R')  # <R>
        @staticmethod
        def of(integrator: typing.Union['Gatherer.Integrator'[_of__A, _of__T, _of__R], typing.Callable[[_of__A, _of__T, 'Gatherer.Downstream'[typing.Any]], bool]]) -> 'Gatherer.Integrator'[_of__A, _of__T, _of__R]: ...
        ...
        @staticmethod
        def ofGreedy(greedy: typing.Union['Gatherer.Integrator.Greedy'[_ofGreedy__A, _ofGreedy__T, _ofGreedy__R], typing.Callable]) -> 'Gatherer.Integrator.Greedy'[_ofGreedy__A, _ofGreedy__T, _ofGreedy__R]: ...
        class Greedy(java.util.stream.Gatherer.Integrator[_Gatherer__Integrator__Greedy__A, _Gatherer__Integrator__Greedy__T, _Gatherer__Integrator__Greedy__R], typing.Generic[_Gatherer__Integrator__Greedy__A, _Gatherer__Integrator__Greedy__T, _Gatherer__Integrator__Greedy__R]): ...
...
class __module_protocol__(Protocol):
    ...
    Gatherer: typing.Type[Gatherer]
    Gatherers: typing.Type[Gatherers]
