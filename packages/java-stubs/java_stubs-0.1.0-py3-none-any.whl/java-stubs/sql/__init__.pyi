...
class Array:
    ...
    @typing.overload
    def getArray(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> typing.Any: ...
    @typing.overload
    def getArray(self, long: int, int: int) -> typing.Any: ...
    @typing.overload
    def getArray(self, long: int, int: int, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> typing.Any: ...
    def getBaseType(self) -> int: ...
    def getBaseTypeName(self) -> java.lang.String: ...
    @typing.overload
    def getResultSet(self) -> 'ResultSet': ...
    @typing.overload
    def getResultSet(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> 'ResultSet': ...
    @typing.overload
    def getResultSet(self, long: int, int: int) -> 'ResultSet': ...
    @typing.overload
    def getResultSet(self, long: int, int: int, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> 'ResultSet': ...
...
class ClientInfoStatus(java.lang.Enum['ClientInfoStatus']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'ClientInfoStatus': ...
    @staticmethod
...
class Clob:
    ...
    def length(self) -> int: ...
    @typing.overload
    def position(self, string: typing.Union[java.lang.String, str], long: int) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def setString(self, long: int, string: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    def setString(self, long: int, string: typing.Union[java.lang.String, str], int: int, int2: int) -> int: ...
    def truncate(self, long: int) -> None: ...

class ConnectionBuilder:
    def build(self) -> 'Connection': ...
    def password(self, string: typing.Union[java.lang.String, str]) -> 'ConnectionBuilder': ...
    ...
    def user(self, string: typing.Union[java.lang.String, str]) -> 'ConnectionBuilder': ...
...
class Date(java.util.Date, _JSQLDate):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'Date': ...
    @typing.overload
    @staticmethod
    def valueOf(localDate: java.time.LocalDate) -> 'Date': ...

class Driver:
    def acceptsURL(self, string: typing.Union[java.lang.String, str]) -> bool: ...
    def connect(self, string: typing.Union[java.lang.String, str], properties: java.util.Properties) -> 'Connection': ...
    def getMajorVersion(self) -> int: ...
    def getMinorVersion(self) -> int: ...
    def getParentLogger(self) -> java.util.logging.Logger: ...
    def getPropertyInfo(self, string: typing.Union[java.lang.String, str], properties: java.util.Properties) -> typing.MutableSequence['DriverPropertyInfo']: ...
...
class DriverManager:
    ...
    @typing.overload
    @staticmethod
    def getConnection(string: typing.Union[java.lang.String, str]) -> 'Connection': ...
    @typing.overload
    @staticmethod
    def getConnection(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'Connection': ...
    @typing.overload
    @staticmethod
    def getConnection(string: typing.Union[java.lang.String, str], properties: java.util.Properties) -> 'Connection': ...
    @staticmethod
    def getDriver(string: typing.Union[java.lang.String, str]) -> Driver: ...
    @staticmethod
    ...
    @staticmethod
    def println(string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    @staticmethod
...
class PseudoColumnUsage(java.lang.Enum['PseudoColumnUsage']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'PseudoColumnUsage': ...
    @staticmethod
...
class Ref:
    ...
    @typing.overload
    def getObject(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> typing.Any: ...
...
class RowIdLifetime(java.lang.Enum['RowIdLifetime']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'RowIdLifetime': ...
    @staticmethod
    def values() -> typing.MutableSequence['RowIdLifetime']: ...

class SQLData:
    def getSQLTypeName(self) -> java.lang.String: ...
    def readSQL(self, sQLInput: 'SQLInput', string: typing.Union[java.lang.String, str]) -> None: ...
...
class SQLException(java.lang.Exception, java.lang.Iterable[java.lang.Throwable]):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], int: int, throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], throwable: java.lang.Throwable): ...
    @typing.overload
...
class SQLOutput:
    ...
    def writeNString(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    def writeString(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class Struct:
    ...
    @typing.overload
    def getAttributes(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> typing.MutableSequence[typing.Any]: ...
    def getSQLTypeName(self) -> java.lang.String: ...
...
class Time(java.util.Date, _JSQLTime):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'Time': ...
    @typing.overload
    @staticmethod
...
class BatchUpdateException(SQLException):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], int: int, intArray: typing.Union[typing.List[int], jpype.JArray]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], int: int, intArray: typing.Union[typing.List[int], jpype.JArray], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], int: int, longArray: typing.Union[typing.List[int], jpype.JArray], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, throwable: java.lang.Throwable): ...
...
class Connection(Wrapper, java.lang.AutoCloseable):
    ...
    def createArrayOf(self, string: typing.Union[java.lang.String, str], objectArray: typing.Union[typing.List[typing.Any], jpype.JArray]) -> Array: ...
    ...
    def createStruct(self, string: typing.Union[java.lang.String, str], objectArray: typing.Union[typing.List[typing.Any], jpype.JArray]) -> Struct: ...
    def endRequest(self) -> None: ...
    def getAutoCommit(self) -> bool: ...
    def getCatalog(self) -> java.lang.String: ...
    @typing.overload
    def getClientInfo(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    ...
    def getTypeMap(self) -> java.util.Map[java.lang.String, typing.Type[typing.Any]]: ...
    def getWarnings(self) -> 'SQLWarning': ...
    def isClosed(self) -> bool: ...
    def isReadOnly(self) -> bool: ...
    def isValid(self, int: int) -> bool: ...
    def nativeSQL(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    def prepareCall(self, string: typing.Union[java.lang.String, str]) -> 'CallableStatement': ...
    @typing.overload
    def prepareCall(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> 'CallableStatement': ...
    @typing.overload
    def prepareCall(self, string: typing.Union[java.lang.String, str], int: int, int2: int, int3: int) -> 'CallableStatement': ...
    @typing.overload
    def prepareStatement(self, string: typing.Union[java.lang.String, str]) -> 'PreparedStatement': ...
    @typing.overload
    def prepareStatement(self, string: typing.Union[java.lang.String, str], int: int) -> 'PreparedStatement': ...
    @typing.overload
    def prepareStatement(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> 'PreparedStatement': ...
    @typing.overload
    def prepareStatement(self, string: typing.Union[java.lang.String, str], int: int, int2: int, int3: int) -> 'PreparedStatement': ...
    @typing.overload
    def prepareStatement(self, string: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]) -> 'PreparedStatement': ...
    @typing.overload
    def prepareStatement(self, string: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> 'PreparedStatement': ...
    ...
    def setCatalog(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setClientInfo(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def setSavepoint(self, string: typing.Union[java.lang.String, str]) -> Savepoint: ...
    def setSchema(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    def setTypeMap(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> None: ...
...
class DatabaseMetaData(Wrapper):
    ...
    def getAttributes(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getBestRowIdentifier(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], int: int, boolean: bool) -> 'ResultSet': ...
    ...
    def getColumnPrivileges(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getColumns(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getConnection(self) -> Connection: ...
    def getCrossReference(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str], string5: typing.Union[java.lang.String, str], string6: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    ...
    def getExportedKeys(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getExtraNameCharacters(self) -> java.lang.String: ...
    def getFunctionColumns(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getFunctions(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getIdentifierQuoteString(self) -> java.lang.String: ...
    def getImportedKeys(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getIndexInfo(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], boolean: bool, boolean2: bool) -> 'ResultSet': ...
    ...
    def getPrimaryKeys(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getProcedureColumns(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getProcedureTerm(self) -> java.lang.String: ...
    def getProcedures(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getPseudoColumns(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    ...
    @typing.overload
    def getSchemas(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getSearchStringEscape(self) -> java.lang.String: ...
    def getStringFunctions(self) -> java.lang.String: ...
    def getSuperTables(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getSuperTypes(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getSystemFunctions(self) -> java.lang.String: ...
    def getTablePrivileges(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
    def getTableTypes(self) -> 'ResultSet': ...
    def getTables(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> 'ResultSet': ...
    def getTimeDateFunctions(self) -> java.lang.String: ...
    def getTypeInfo(self) -> 'ResultSet': ...
    def getUDTs(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]) -> 'ResultSet': ...
    def getURL(self) -> java.lang.String: ...
    def getUserName(self) -> java.lang.String: ...
    def getVersionColumns(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> 'ResultSet': ...
...
class JDBCType(java.lang.Enum['JDBCType'], SQLType):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'JDBCType': ...
    @staticmethod
...
class ResultSet(Wrapper, java.lang.AutoCloseable):
    ...
    def findColumn(self, string: typing.Union[java.lang.String, str]) -> int: ...
    def first(self) -> bool: ...
    @typing.overload
    def getArray(self, int: int) -> Array: ...
    @typing.overload
    def getArray(self, string: typing.Union[java.lang.String, str]) -> Array: ...
    @typing.overload
    def getAsciiStream(self, int: int) -> java.io.InputStream: ...
    @typing.overload
    def getAsciiStream(self, string: typing.Union[java.lang.String, str]) -> java.io.InputStream: ...
    @typing.overload
    def getBigDecimal(self, int: int) -> java.math.BigDecimal: ...
    @typing.overload
    def getBigDecimal(self, int: int, int2: int) -> java.math.BigDecimal: ...
    @typing.overload
    def getBigDecimal(self, string: typing.Union[java.lang.String, str]) -> java.math.BigDecimal: ...
    @typing.overload
    def getBigDecimal(self, string: typing.Union[java.lang.String, str], int: int) -> java.math.BigDecimal: ...
    @typing.overload
    def getBinaryStream(self, int: int) -> java.io.InputStream: ...
    @typing.overload
    def getBinaryStream(self, string: typing.Union[java.lang.String, str]) -> java.io.InputStream: ...
    @typing.overload
    def getBlob(self, int: int) -> Blob: ...
    @typing.overload
    def getBlob(self, string: typing.Union[java.lang.String, str]) -> Blob: ...
    @typing.overload
    ...
    @typing.overload
    def getByte(self, string: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    def getBytes(self, int: int) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getBytes(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getCharacterStream(self, int: int) -> java.io.Reader: ...
    @typing.overload
    def getCharacterStream(self, string: typing.Union[java.lang.String, str]) -> java.io.Reader: ...
    @typing.overload
    def getClob(self, int: int) -> Clob: ...
    @typing.overload
    def getClob(self, string: typing.Union[java.lang.String, str]) -> Clob: ...
    ...
    @typing.overload
    def getDate(self, string: typing.Union[java.lang.String, str]) -> Date: ...
    @typing.overload
    def getDate(self, string: typing.Union[java.lang.String, str], calendar: java.util.Calendar) -> Date: ...
    @typing.overload
    ...
    @typing.overload
    def getInt(self, string: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    ...
    @typing.overload
    def getNCharacterStream(self, string: typing.Union[java.lang.String, str]) -> java.io.Reader: ...
    @typing.overload
    def getNClob(self, int: int) -> NClob: ...
    @typing.overload
    def getNClob(self, string: typing.Union[java.lang.String, str]) -> NClob: ...
    @typing.overload
    def getNString(self, int: int) -> java.lang.String: ...
    @typing.overload
    def getNString(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    ...
    @typing.overload
    def getObject(self, int: int, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> typing.Any: ...
    @typing.overload
    def getObject(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    @typing.overload
    def getObject(self, string: typing.Union[java.lang.String, str], class_: typing.Type[_getObject_4__T]) -> _getObject_4__T: ...
    @typing.overload
    def getObject(self, string: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Type[typing.Any]], typing.Mapping[typing.Union[java.lang.String, str], typing.Type[typing.Any]]]) -> typing.Any: ...
    @typing.overload
    def getRef(self, int: int) -> Ref: ...
    @typing.overload
    def getRef(self, string: typing.Union[java.lang.String, str]) -> Ref: ...
    def getRow(self) -> int: ...
    @typing.overload
    def getRowId(self, int: int) -> RowId: ...
    @typing.overload
    def getRowId(self, string: typing.Union[java.lang.String, str]) -> RowId: ...
    @typing.overload
    def getSQLXML(self, int: int) -> SQLXML: ...
    @typing.overload
    def getSQLXML(self, string: typing.Union[java.lang.String, str]) -> SQLXML: ...
    @typing.overload
    def getShort(self, int: int) -> int: ...
    @typing.overload
    def getShort(self, string: typing.Union[java.lang.String, str]) -> int: ...
    def getStatement(self) -> 'Statement': ...
    @typing.overload
    def getString(self, int: int) -> java.lang.String: ...
    @typing.overload
    def getString(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    def getTime(self, int: int) -> Time: ...
    @typing.overload
    def getTime(self, int: int, calendar: java.util.Calendar) -> Time: ...
    @typing.overload
    def getTime(self, string: typing.Union[java.lang.String, str]) -> Time: ...
    @typing.overload
    def getTime(self, string: typing.Union[java.lang.String, str], calendar: java.util.Calendar) -> Time: ...
    @typing.overload
    def getTimestamp(self, int: int) -> Timestamp: ...
    @typing.overload
    def getTimestamp(self, int: int, calendar: java.util.Calendar) -> Timestamp: ...
    @typing.overload
    def getTimestamp(self, string: typing.Union[java.lang.String, str]) -> Timestamp: ...
    @typing.overload
    def getTimestamp(self, string: typing.Union[java.lang.String, str], calendar: java.util.Calendar) -> Timestamp: ...
    def getType(self) -> int: ...
    @typing.overload
    def getURL(self, int: int) -> java.net.URL: ...
    @typing.overload
    def getURL(self, string: typing.Union[java.lang.String, str]) -> java.net.URL: ...
    @typing.overload
    def getUnicodeStream(self, int: int) -> java.io.InputStream: ...
    @typing.overload
    def getUnicodeStream(self, string: typing.Union[java.lang.String, str]) -> java.io.InputStream: ...
    def getWarnings(self) -> 'SQLWarning': ...
    ...
    @typing.overload
    def updateArray(self, string: typing.Union[java.lang.String, str], array: Array) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateAsciiStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def updateAsciiStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, int: int) -> None: ...
    @typing.overload
    def updateAsciiStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def updateBigDecimal(self, int: int, bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal]) -> None: ...
    @typing.overload
    def updateBigDecimal(self, string: typing.Union[java.lang.String, str], bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateBinaryStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def updateBinaryStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, int: int) -> None: ...
    @typing.overload
    def updateBinaryStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateBlob(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def updateBlob(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def updateBlob(self, string: typing.Union[java.lang.String, str], blob: Blob) -> None: ...
    @typing.overload
    def updateBoolean(self, int: int, boolean: bool) -> None: ...
    @typing.overload
    def updateBoolean(self, string: typing.Union[java.lang.String, str], boolean: bool) -> None: ...
    @typing.overload
    def updateByte(self, int: int, byte: int) -> None: ...
    @typing.overload
    def updateByte(self, string: typing.Union[java.lang.String, str], byte: int) -> None: ...
    @typing.overload
    def updateBytes(self, int: int, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def updateBytes(self, string: typing.Union[java.lang.String, str], byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def updateCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, int: int) -> None: ...
    @typing.overload
    def updateCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def updateClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def updateClob(self, string: typing.Union[java.lang.String, str], clob: Clob) -> None: ...
    @typing.overload
    def updateDate(self, int: int, date: typing.Union[Date, datetime.date]) -> None: ...
    @typing.overload
    def updateDate(self, string: typing.Union[java.lang.String, str], date: typing.Union[Date, datetime.date]) -> None: ...
    @typing.overload
    def updateDouble(self, int: int, double: float) -> None: ...
    @typing.overload
    def updateDouble(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
    @typing.overload
    def updateFloat(self, int: int, float: float) -> None: ...
    @typing.overload
    def updateFloat(self, string: typing.Union[java.lang.String, str], float: float) -> None: ...
    @typing.overload
    def updateInt(self, int: int, int2: int) -> None: ...
    @typing.overload
    def updateInt(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    @typing.overload
    def updateLong(self, int: int, long: int) -> None: ...
    @typing.overload
    def updateLong(self, string: typing.Union[java.lang.String, str], long: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateNCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def updateNCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateNClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def updateNClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def updateNClob(self, string: typing.Union[java.lang.String, str], nClob: NClob) -> None: ...
    @typing.overload
    def updateNString(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def updateNString(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def updateNull(self, int: int) -> None: ...
    @typing.overload
    def updateNull(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def updateObject(self, int: int, object: typing.Any) -> None: ...
    @typing.overload
    def updateObject(self, int: int, object: typing.Any, int2: int) -> None: ...
    @typing.overload
    def updateObject(self, string: typing.Union[java.lang.String, str], object: typing.Any) -> None: ...
    @typing.overload
    def updateObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, int: int) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def updateObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, sQLType: SQLType) -> None: ...
    @typing.overload
    def updateObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, sQLType: SQLType, int: int) -> None: ...
    @typing.overload
    def updateRef(self, int: int, ref: Ref) -> None: ...
    @typing.overload
    def updateRef(self, string: typing.Union[java.lang.String, str], ref: Ref) -> None: ...
    def updateRow(self) -> None: ...
    @typing.overload
    def updateRowId(self, int: int, rowId: typing.Union[RowId, typing.Callable]) -> None: ...
    @typing.overload
    def updateRowId(self, string: typing.Union[java.lang.String, str], rowId: typing.Union[RowId, typing.Callable]) -> None: ...
    @typing.overload
    def updateSQLXML(self, int: int, sQLXML: SQLXML) -> None: ...
    @typing.overload
    def updateSQLXML(self, string: typing.Union[java.lang.String, str], sQLXML: SQLXML) -> None: ...
    @typing.overload
    def updateShort(self, int: int, short: int) -> None: ...
    @typing.overload
    def updateShort(self, string: typing.Union[java.lang.String, str], short: int) -> None: ...
    @typing.overload
    def updateString(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def updateString(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def updateTime(self, int: int, time: typing.Union[Time, datetime.time]) -> None: ...
    @typing.overload
    def updateTime(self, string: typing.Union[java.lang.String, str], time: typing.Union[Time, datetime.time]) -> None: ...
    @typing.overload
    def updateTimestamp(self, int: int, timestamp: typing.Union[Timestamp, datetime.datetime]) -> None: ...
    @typing.overload
    def updateTimestamp(self, string: typing.Union[java.lang.String, str], timestamp: typing.Union[Timestamp, datetime.datetime]) -> None: ...
    def wasNull(self) -> bool: ...
...
class SQLClientInfoException(SQLException):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], int: int, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], int: int, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]], throwable: java.lang.Throwable): ...
    @typing.overload
    def __init__(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]]): ...
    @typing.overload
    def __init__(self, map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], ClientInfoStatus], typing.Mapping[typing.Union[java.lang.String, str], ClientInfoStatus]], throwable: java.lang.Throwable): ...
...
class Statement(Wrapper, java.lang.AutoCloseable):
    ...
    def addBatch(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def cancel(self) -> None: ...
    def clearBatch(self) -> None: ...
    def clearWarnings(self) -> None: ...
    def close(self) -> None: ...
    def closeOnCompletion(self) -> None: ...
    def enquoteIdentifier(self, string: typing.Union[java.lang.String, str], boolean: bool) -> java.lang.String: ...
    def enquoteLiteral(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    def enquoteNCharLiteral(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    def execute(self, string: typing.Union[java.lang.String, str]) -> bool: ...
    @typing.overload
    def execute(self, string: typing.Union[java.lang.String, str], int: int) -> bool: ...
    @typing.overload
    def execute(self, string: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]) -> bool: ...
    @typing.overload
    def execute(self, string: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> bool: ...
    def executeBatch(self) -> typing.MutableSequence[int]: ...
    def executeLargeBatch(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def executeLargeUpdate(self, string: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    def executeLargeUpdate(self, string: typing.Union[java.lang.String, str], int: int) -> int: ...
    @typing.overload
    def executeLargeUpdate(self, string: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]) -> int: ...
    @typing.overload
    def executeLargeUpdate(self, string: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> int: ...
    def executeQuery(self, string: typing.Union[java.lang.String, str]) -> ResultSet: ...
    @typing.overload
    def executeUpdate(self, string: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    def executeUpdate(self, string: typing.Union[java.lang.String, str], int: int) -> int: ...
    @typing.overload
    def executeUpdate(self, string: typing.Union[java.lang.String, str], intArray: typing.Union[typing.List[int], jpype.JArray]) -> int: ...
    @typing.overload
    def executeUpdate(self, string: typing.Union[java.lang.String, str], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> int: ...
    def getConnection(self) -> Connection: ...
    def getFetchDirection(self) -> int: ...
    def getFetchSize(self) -> int: ...
    ...
    def isSimpleIdentifier(self, string: typing.Union[java.lang.String, str]) -> bool: ...
    def setCursorName(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class PreparedStatement(Statement):
    ...
    def setNString(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setNull(self, int: int, int2: int) -> None: ...
    @typing.overload
    def setNull(self, int: int, int2: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    def setString(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
...
class CallableStatement(PreparedStatement):
    ...
    @typing.overload
    def registerOutParameter(self, int: int, int2: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def registerOutParameter(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    @typing.overload
    def registerOutParameter(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> None: ...
    @typing.overload
    def registerOutParameter(self, string: typing.Union[java.lang.String, str], int: int, string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    ...
    @typing.overload
    def registerOutParameter(self, int: int, sQLType: SQLType, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def registerOutParameter(self, string: typing.Union[java.lang.String, str], sQLType: SQLType) -> None: ...
    @typing.overload
    def registerOutParameter(self, string: typing.Union[java.lang.String, str], sQLType: SQLType, int: int) -> None: ...
    @typing.overload
    def registerOutParameter(self, string: typing.Union[java.lang.String, str], sQLType: SQLType, string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setAsciiStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def setAsciiStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, int: int) -> None: ...
    @typing.overload
    def setAsciiStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def setAsciiStream(self, int: int, inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def setAsciiStream(self, int: int, inputStream: java.io.InputStream, int2: int) -> None: ...
    ...
    def setAsciiStream(self, int: int, inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def setBigDecimal(self, string: typing.Union[java.lang.String, str], bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal]) -> None: ...
    @typing.overload
    def setBigDecimal(self, int: int, bigDecimal: typing.Union[java.math.BigDecimal, decimal.Decimal]) -> None: ...
    @typing.overload
    def setBinaryStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def setBinaryStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, int: int) -> None: ...
    @typing.overload
    def setBinaryStream(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def setBinaryStream(self, int: int, inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def setBinaryStream(self, int: int, inputStream: java.io.InputStream, int2: int) -> None: ...
    ...
    def setBinaryStream(self, int: int, inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def setBlob(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def setBlob(self, string: typing.Union[java.lang.String, str], inputStream: java.io.InputStream, long: int) -> None: ...
    @typing.overload
    def setBlob(self, string: typing.Union[java.lang.String, str], blob: Blob) -> None: ...
    @typing.overload
    def setBlob(self, int: int, inputStream: java.io.InputStream) -> None: ...
    @typing.overload
    def setBlob(self, int: int, inputStream: java.io.InputStream, long: int) -> None: ...
    ...
    def setBoolean(self, int: int, boolean: bool) -> None: ...
    @typing.overload
    def setByte(self, string: typing.Union[java.lang.String, str], byte: int) -> None: ...
    @typing.overload
    def setByte(self, int: int, byte: int) -> None: ...
    @typing.overload
    def setBytes(self, string: typing.Union[java.lang.String, str], byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def setBytes(self, int: int, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> None: ...
    @typing.overload
    def setCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def setCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, int: int) -> None: ...
    @typing.overload
    def setCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def setCharacterStream(self, int: int, reader: java.io.Reader) -> None: ...
    @typing.overload
    def setCharacterStream(self, int: int, reader: java.io.Reader, int2: int) -> None: ...
    ...
    def setCharacterStream(self, int: int, reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def setClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def setClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def setClob(self, string: typing.Union[java.lang.String, str], clob: Clob) -> None: ...
    @typing.overload
    def setClob(self, int: int, reader: java.io.Reader) -> None: ...
    @typing.overload
    def setClob(self, int: int, reader: java.io.Reader, long: int) -> None: ...
    ...
    def setClob(self, int: int, clob: Clob) -> None: ...
    @typing.overload
    def setDate(self, string: typing.Union[java.lang.String, str], date: typing.Union[Date, datetime.date]) -> None: ...
    @typing.overload
    def setDate(self, string: typing.Union[java.lang.String, str], date: typing.Union[Date, datetime.date], calendar: java.util.Calendar) -> None: ...
    @typing.overload
    def setDate(self, int: int, date: typing.Union[Date, datetime.date]) -> None: ...
    @typing.overload
    def setDate(self, int: int, date: typing.Union[Date, datetime.date], calendar: java.util.Calendar) -> None: ...
    ...
    def setFloat(self, int: int, float: float) -> None: ...
    @typing.overload
    def setInt(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    @typing.overload
    def setInt(self, int: int, int2: int) -> None: ...
    @typing.overload
    ...
    def setLong(self, int: int, long: int) -> None: ...
    @typing.overload
    def setNCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def setNCharacterStream(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def setNCharacterStream(self, int: int, reader: java.io.Reader) -> None: ...
    @typing.overload
    def setNCharacterStream(self, int: int, reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def setNClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader) -> None: ...
    @typing.overload
    def setNClob(self, string: typing.Union[java.lang.String, str], reader: java.io.Reader, long: int) -> None: ...
    @typing.overload
    def setNClob(self, string: typing.Union[java.lang.String, str], nClob: NClob) -> None: ...
    @typing.overload
    def setNClob(self, int: int, reader: java.io.Reader) -> None: ...
    @typing.overload
    def setNClob(self, int: int, reader: java.io.Reader, long: int) -> None: ...
    ...
    def setNClob(self, int: int, nClob: NClob) -> None: ...
    @typing.overload
    def setNString(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setNString(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setNull(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
    @typing.overload
    def setNull(self, string: typing.Union[java.lang.String, str], int: int, string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setNull(self, int: int, int2: int) -> None: ...
    @typing.overload
    def setNull(self, int: int, int2: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setObject(self, string: typing.Union[java.lang.String, str], object: typing.Any) -> None: ...
    @typing.overload
    def setObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, int: int) -> None: ...
    @typing.overload
    def setObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, int: int, int2: int) -> None: ...
    @typing.overload
    def setObject(self, int: int, object: typing.Any) -> None: ...
    @typing.overload
    def setObject(self, int: int, object: typing.Any, int2: int) -> None: ...
    ...
    def setObject(self, int: int, object: typing.Any, int2: int, int3: int) -> None: ...
    @typing.overload
    def setObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, sQLType: SQLType) -> None: ...
    @typing.overload
    def setObject(self, string: typing.Union[java.lang.String, str], object: typing.Any, sQLType: SQLType, int: int) -> None: ...
    @typing.overload
    def setObject(self, int: int, object: typing.Any, sQLType: SQLType) -> None: ...
    @typing.overload
    def setObject(self, int: int, object: typing.Any, sQLType: SQLType, int2: int) -> None: ...
    @typing.overload
    def setRowId(self, string: typing.Union[java.lang.String, str], rowId: typing.Union[RowId, typing.Callable]) -> None: ...
    @typing.overload
    def setRowId(self, int: int, rowId: typing.Union[RowId, typing.Callable]) -> None: ...
    @typing.overload
    def setSQLXML(self, string: typing.Union[java.lang.String, str], sQLXML: SQLXML) -> None: ...
    @typing.overload
    def setSQLXML(self, int: int, sQLXML: SQLXML) -> None: ...
    @typing.overload
    def setShort(self, string: typing.Union[java.lang.String, str], short: int) -> None: ...
    @typing.overload
    def setShort(self, int: int, short: int) -> None: ...
    @typing.overload
    def setString(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setString(self, int: int, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def setTime(self, string: typing.Union[java.lang.String, str], time: typing.Union[Time, datetime.time]) -> None: ...
    @typing.overload
    def setTime(self, string: typing.Union[java.lang.String, str], time: typing.Union[Time, datetime.time], calendar: java.util.Calendar) -> None: ...
    @typing.overload
    def setTime(self, int: int, time: typing.Union[Time, datetime.time]) -> None: ...
    @typing.overload
    def setTime(self, int: int, time: typing.Union[Time, datetime.time], calendar: java.util.Calendar) -> None: ...
    @typing.overload
    def setTimestamp(self, string: typing.Union[java.lang.String, str], timestamp: typing.Union[Timestamp, datetime.datetime]) -> None: ...
    @typing.overload
    def setTimestamp(self, string: typing.Union[java.lang.String, str], timestamp: typing.Union[Timestamp, datetime.datetime], calendar: java.util.Calendar) -> None: ...
    @typing.overload
    def setTimestamp(self, int: int, timestamp: typing.Union[Timestamp, datetime.datetime]) -> None: ...
    @typing.overload
    def setTimestamp(self, int: int, timestamp: typing.Union[Timestamp, datetime.datetime], calendar: java.util.Calendar) -> None: ...
    @typing.overload
    def setURL(self, string: typing.Union[java.lang.String, str], uRL: java.net.URL) -> None: ...
    @typing.overload
    def setURL(self, int: int, uRL: java.net.URL) -> None: ...
    def wasNull(self) -> bool: ...
