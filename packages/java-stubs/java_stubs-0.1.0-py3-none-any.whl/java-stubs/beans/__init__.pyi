...
class Beans:
    ...
    @typing.overload
    @staticmethod
    def instantiate(classLoader: java.lang.ClassLoader, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    @typing.overload
    @staticmethod
    def instantiate(classLoader: java.lang.ClassLoader, string: typing.Union[java.lang.String, str], beanContext: java.beans.beancontext.BeanContext) -> typing.Any: ...
    @typing.overload
    @staticmethod
    def instantiate(classLoader: java.lang.ClassLoader, string: typing.Union[java.lang.String, str], beanContext: java.beans.beancontext.BeanContext, appletInitializer: AppletInitializer) -> typing.Any: ...
    @staticmethod
...
class EventHandler(java.lang.reflect.InvocationHandler):
    ...
    @typing.overload
    @staticmethod
    def create(class_: typing.Type[_create_0__T], object: typing.Any, string: typing.Union[java.lang.String, str]) -> _create_0__T: ...
    @typing.overload
    @staticmethod
    def create(class_: typing.Type[_create_1__T], object: typing.Any, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> _create_1__T: ...
    @typing.overload
    @staticmethod
    def create(class_: typing.Type[_create_2__T], object: typing.Any, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]) -> _create_2__T: ...
...
class FeatureDescriptor:
    ...
    def getValue(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    ...
    def setValue(self, string: typing.Union[java.lang.String, str], object: typing.Any) -> None: ...
    def toString(self) -> java.lang.String: ...
...
class Introspector:
    ...
    @staticmethod
    def decapitalize(string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @staticmethod
    ...
    @staticmethod
    def setBeanInfoSearchPath(stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
...
class PropertyChangeEvent(java.util.EventObject):
    def __init__(self, object: typing.Any, string: typing.Union[java.lang.String, str], object2: typing.Any, object3: typing.Any): ...
...
class PropertyChangeSupport(java.io.Serializable):
    ...
    def addPropertyChangeListener(self, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def addPropertyChangeListener(self, string: typing.Union[java.lang.String, str], propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def fireIndexedPropertyChange(self, string: typing.Union[java.lang.String, str], int: int, boolean: bool, boolean2: bool) -> None: ...
    @typing.overload
    def fireIndexedPropertyChange(self, string: typing.Union[java.lang.String, str], int: int, int2: int, int3: int) -> None: ...
    @typing.overload
    def fireIndexedPropertyChange(self, string: typing.Union[java.lang.String, str], int: int, object: typing.Any, object2: typing.Any) -> None: ...
    @typing.overload
    def firePropertyChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], boolean: bool, boolean2: bool) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> None: ...
    @typing.overload
    def firePropertyChange(self, string: typing.Union[java.lang.String, str], object: typing.Any, object2: typing.Any) -> None: ...
    @typing.overload
    def getPropertyChangeListeners(self) -> typing.MutableSequence[PropertyChangeListener]: ...
    @typing.overload
    def getPropertyChangeListeners(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[PropertyChangeListener]: ...
    def hasListeners(self, string: typing.Union[java.lang.String, str]) -> bool: ...
    @typing.overload
    def removePropertyChangeListener(self, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def removePropertyChangeListener(self, string: typing.Union[java.lang.String, str], propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
...
class PropertyEditor:
    ...
    def removePropertyChangeListener(self, propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]) -> None: ...
    def setAsText(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class PropertyEditorManager:
    ...
    @staticmethod
    def setEditorSearchPath(stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...

class PropertyVetoException(java.lang.Exception):
    def __init__(self, string: typing.Union[java.lang.String, str], propertyChangeEvent: PropertyChangeEvent): ...
    def getPropertyChangeEvent(self) -> PropertyChangeEvent: ...

class Statement:
    def __init__(self, object: typing.Any, string: typing.Union[java.lang.String, str], objectArray: typing.Union[typing.List[typing.Any], jpype.JArray]): ...
...
class VetoableChangeSupport(java.io.Serializable):
    ...
    @typing.overload
    def addVetoableChangeListener(self, string: typing.Union[java.lang.String, str], vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def fireVetoableChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
    @typing.overload
    def fireVetoableChange(self, string: typing.Union[java.lang.String, str], boolean: bool, boolean2: bool) -> None: ...
    @typing.overload
    def fireVetoableChange(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> None: ...
    @typing.overload
    def fireVetoableChange(self, string: typing.Union[java.lang.String, str], object: typing.Any, object2: typing.Any) -> None: ...
    @typing.overload
    def getVetoableChangeListeners(self) -> typing.MutableSequence[VetoableChangeListener]: ...
    @typing.overload
    def getVetoableChangeListeners(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[VetoableChangeListener]: ...
    def hasListeners(self, string: typing.Union[java.lang.String, str]) -> bool: ...
    @typing.overload
    def removeVetoableChangeListener(self, vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
    @typing.overload
    def removeVetoableChangeListener(self, string: typing.Union[java.lang.String, str], vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]) -> None: ...
...
class DefaultPersistenceDelegate(PersistenceDelegate):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]): ...

class EventSetDescriptor(FeatureDescriptor):
    @typing.overload
    def __init__(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any], string2: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, class_: typing.Type[typing.Any], string: typing.Union[java.lang.String, str], class2: typing.Type[typing.Any], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str], string5: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], methodDescriptorArray: typing.Union[typing.List['MethodDescriptor'], jpype.JArray], method2: java.lang.reflect.Method, method3: java.lang.reflect.Method): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], methodArray: typing.Union[typing.List[java.lang.reflect.Method], jpype.JArray], method2: java.lang.reflect.Method, method3: java.lang.reflect.Method): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], methodArray: typing.Union[typing.List[java.lang.reflect.Method], jpype.JArray], method2: java.lang.reflect.Method, method3: java.lang.reflect.Method, method4: java.lang.reflect.Method): ...
...
class Expression(Statement):
    @typing.overload
    def __init__(self, object: typing.Any, object2: typing.Any, string: typing.Union[java.lang.String, str], objectArray: typing.Union[typing.List[typing.Any], jpype.JArray]): ...
    @typing.overload
    def __init__(self, object: typing.Any, string: typing.Union[java.lang.String, str], objectArray: typing.Union[typing.List[typing.Any], jpype.JArray]): ...
    def execute(self) -> None: ...
    def getValue(self) -> typing.Any: ...
...
class IndexedPropertyChangeEvent(PropertyChangeEvent):
    def __init__(self, object: typing.Any, string: typing.Union[java.lang.String, str], object2: typing.Any, object3: typing.Any, int: int): ...
...
class PropertyChangeListenerProxy(java.util.EventListenerProxy[PropertyChangeListener], PropertyChangeListener):
    def __init__(self, string: typing.Union[java.lang.String, str], propertyChangeListener: typing.Union[PropertyChangeListener, typing.Callable]): ...
    def getPropertyName(self) -> java.lang.String: ...
    def propertyChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
...
class PropertyDescriptor(FeatureDescriptor):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], method: java.lang.reflect.Method, method2: java.lang.reflect.Method): ...
...
class SimpleBeanInfo(BeanInfo):
    ...
    def getMethodDescriptors(self) -> typing.MutableSequence[MethodDescriptor]: ...
    def getPropertyDescriptors(self) -> typing.MutableSequence[PropertyDescriptor]: ...
    def loadImage(self, string: typing.Union[java.lang.String, str]) -> java.awt.Image: ...

class VetoableChangeListenerProxy(java.util.EventListenerProxy[VetoableChangeListener], VetoableChangeListener):
    def __init__(self, string: typing.Union[java.lang.String, str], vetoableChangeListener: typing.Union[VetoableChangeListener, typing.Callable]): ...
    def getPropertyName(self) -> java.lang.String: ...
    def vetoableChange(self, propertyChangeEvent: PropertyChangeEvent) -> None: ...
...
class XMLEncoder(Encoder, java.lang.AutoCloseable):
    ...
    @typing.overload
    def __init__(self, outputStream: java.io.OutputStream, string: typing.Union[java.lang.String, str], boolean: bool, int: int): ...
    def close(self) -> None: ...
    def flush(self) -> None: ...
    def getOwner(self) -> typing.Any: ...
    def setOwner(self, object: typing.Any) -> None: ...
...
class IndexedPropertyDescriptor(PropertyDescriptor):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], string2: typing.Union[java.lang.String, str], string3: typing.Union[java.lang.String, str], string4: typing.Union[java.lang.String, str], string5: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], method: java.lang.reflect.Method, method2: java.lang.reflect.Method, method3: java.lang.reflect.Method, method4: java.lang.reflect.Method): ...
    def equals(self, object: typing.Any) -> bool: ...
