...
class BeanContextChild:
    def addPropertyChangeListener(self, string: typing.Union[java.lang.String, str], propertyChangeListener: typing.Union[java.beans.PropertyChangeListener, typing.Callable]) -> None: ...
    def addVetoableChangeListener(self, string: typing.Union[java.lang.String, str], vetoableChangeListener: typing.Union[java.beans.VetoableChangeListener, typing.Callable]) -> None: ...
    def getBeanContext(self) -> 'BeanContext': ...
    def removePropertyChangeListener(self, string: typing.Union[java.lang.String, str], propertyChangeListener: typing.Union[java.beans.PropertyChangeListener, typing.Callable]) -> None: ...
    def removeVetoableChangeListener(self, string: typing.Union[java.lang.String, str], vetoableChangeListener: typing.Union[java.beans.VetoableChangeListener, typing.Callable]) -> None: ...
...
class BeanContext(BeanContextChild, java.util.Collection, java.beans.DesignMode, java.beans.Visibility):
    ...
    def getResource(self, string: typing.Union[java.lang.String, str], beanContextChild: BeanContextChild) -> java.net.URL: ...
    def getResourceAsStream(self, string: typing.Union[java.lang.String, str], beanContextChild: BeanContextChild) -> java.io.InputStream: ...
    def hashCode(self) -> int: ...
    def instantiateChild(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
