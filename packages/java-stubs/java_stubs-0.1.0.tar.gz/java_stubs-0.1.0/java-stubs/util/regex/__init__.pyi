...
class Pattern(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def compile(string: typing.Union[java.lang.String, str]) -> 'Pattern': ...
    @typing.overload
    @staticmethod
    def compile(string: typing.Union[java.lang.String, str], int: int) -> 'Pattern': ...
    def flags(self) -> int: ...
    def matcher(self, charSequence: typing.Union[java.lang.CharSequence, str]) -> 'Matcher': ...
    @staticmethod
    def matches(string: typing.Union[java.lang.String, str], charSequence: typing.Union[java.lang.CharSequence, str]) -> bool: ...
    def namedGroups(self) -> java.util.Map[java.lang.String, int]: ...
    def pattern(self) -> java.lang.String: ...
    @staticmethod
    def quote(string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    def split(self, charSequence: typing.Union[java.lang.CharSequence, str]) -> typing.MutableSequence[java.lang.String]: ...
    @typing.overload
    def split(self, charSequence: typing.Union[java.lang.CharSequence, str], int: int) -> typing.MutableSequence[java.lang.String]: ...
    def splitAsStream(self, charSequence: typing.Union[java.lang.CharSequence, str]) -> java.util.stream.Stream[java.lang.String]: ...
    def splitWithDelimiters(self, charSequence: typing.Union[java.lang.CharSequence, str], int: int) -> typing.MutableSequence[java.lang.String]: ...
...
class Matcher(MatchResult):
    @typing.overload
    def appendReplacement(self, stringBuffer: java.lang.StringBuffer, string2: typing.Union[java.lang.String, str]) -> 'Matcher': ...
    @typing.overload
    def appendReplacement(self, stringBuilder: java.lang.StringBuilder, string2: typing.Union[java.lang.String, str]) -> 'Matcher': ...
    @typing.overload
    ...
    @staticmethod
    def quoteReplacement(string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    def region(self, int: int, int2: int) -> 'Matcher': ...
    def regionEnd(self) -> int: ...
    def regionStart(self) -> int: ...
    @typing.overload
    def replaceAll(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    def replaceAll(self, function: typing.Union[java.util.function.Function[MatchResult, typing.Union[java.lang.String, str]], typing.Callable[[MatchResult], typing.Union[java.lang.String, str]]]) -> java.lang.String: ...
    @typing.overload
    def replaceFirst(self, string: typing.Union[java.lang.String, str]) -> java.lang.String: ...
    @typing.overload
    def replaceFirst(self, function: typing.Union[java.util.function.Function[MatchResult, typing.Union[java.lang.String, str]], typing.Callable[[MatchResult], typing.Union[java.lang.String, str]]]) -> java.lang.String: ...
