...
class DayOfWeek(java.lang.Enum['DayOfWeek'], java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'DayOfWeek': ...
    @staticmethod
...
class Instant(java.time.temporal.Temporal, java.time.temporal.TemporalAdjuster, java.lang.Comparable['Instant'], java.io.Serializable):
    ...
    @typing.overload
    def until(self, instant: typing.Union['Instant', datetime.datetime]) -> Duration: ...
    @typing.overload
...
class Month(java.lang.Enum['Month'], java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'Month': ...
    @staticmethod
...
class ZoneId(java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'ZoneId': ...
    @typing.overload
    @staticmethod
    def of(string: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], typing.Union[java.lang.String, str]], typing.Mapping[typing.Union[java.lang.String, str], typing.Union[java.lang.String, str]]]) -> 'ZoneId': ...
    @staticmethod
    def ofOffset(string: typing.Union[java.lang.String, str], zoneOffset: 'ZoneOffset') -> 'ZoneId': ...
    @staticmethod
...
class ZoneOffset(ZoneId, java.time.temporal.TemporalAccessor, java.time.temporal.TemporalAdjuster, java.lang.Comparable['ZoneOffset'], java.io.Serializable):
    ...
    @typing.overload
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'ZoneOffset': ...
    @staticmethod
