...
class NumericShaper(java.io.Serializable):
    ...
    class Range(java.lang.Enum['NumericShaper.Range']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'NumericShaper.Range': ...
        @typing.overload
        @staticmethod
...
class OpenType:
    ...
    @typing.overload
    def getFontTable(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getFontTable(self, string: typing.Union[java.lang.String, str], int: int, int2: int) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getFontTableSize(self, int: int) -> int: ...
    @typing.overload
    def getFontTableSize(self, string: typing.Union[java.lang.String, str]) -> int: ...
...
class TextLayout(java.lang.Cloneable):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], font: java.awt.Font, fontRenderContext: FontRenderContext): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map[java.text.AttributedCharacterIterator.Attribute, typing.Any], typing.Mapping[java.text.AttributedCharacterIterator.Attribute, typing.Any]], fontRenderContext: FontRenderContext): ...
    @typing.overload
    def __init__(self, attributedCharacterIterator: java.text.AttributedCharacterIterator, fontRenderContext: FontRenderContext): ...
    def draw(self, graphics2D: java.awt.Graphics2D, float: float, float2: float) -> None: ...
    @typing.overload
