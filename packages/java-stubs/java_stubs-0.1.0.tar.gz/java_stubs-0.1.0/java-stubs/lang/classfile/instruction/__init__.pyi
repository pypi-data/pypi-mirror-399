...
class LocalVariable(java.lang.classfile.PseudoInstruction):
    ...
    @typing.overload
    @staticmethod
    def of(int: int, string: typing.Union[java.lang.String, str], classDesc: java.lang.constant.ClassDesc, label: java.lang.classfile.Label, label2: java.lang.classfile.Label) -> 'LocalVariable': ...
    @typing.overload
    @staticmethod
...
class LocalVariableType(java.lang.classfile.PseudoInstruction):
    ...
    @typing.overload
    @staticmethod
    def of(int: int, string: typing.Union[java.lang.String, str], signature: java.lang.classfile.Signature, label: java.lang.classfile.Label, label2: java.lang.classfile.Label) -> 'LocalVariableType': ...
    @typing.overload
    @staticmethod
