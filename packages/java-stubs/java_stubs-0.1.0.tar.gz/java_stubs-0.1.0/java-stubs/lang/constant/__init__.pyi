...
class ConstantDescs:
    ...
    @staticmethod
    def ofCallsiteBootstrap(classDesc: 'ClassDesc', string: typing.Union[java.lang.String, str], classDesc2: 'ClassDesc', *classDesc3: 'ClassDesc') -> 'DirectMethodHandleDesc': ...
    @staticmethod
    def ofConstantBootstrap(classDesc: 'ClassDesc', string: typing.Union[java.lang.String, str], classDesc2: 'ClassDesc', *classDesc3: 'ClassDesc') -> 'DirectMethodHandleDesc': ...
...
class DynamicCallSiteDesc:
    ...
    @typing.overload
    @staticmethod
    def of(directMethodHandleDesc: 'DirectMethodHandleDesc', string: typing.Union[java.lang.String, str], methodTypeDesc: 'MethodTypeDesc') -> 'DynamicCallSiteDesc': ...
    @typing.overload
    @staticmethod
    def of(directMethodHandleDesc: 'DirectMethodHandleDesc', string: typing.Union[java.lang.String, str], methodTypeDesc: 'MethodTypeDesc', *constantDesc: ConstantDesc) -> 'DynamicCallSiteDesc': ...
    @typing.overload
    @staticmethod
    ...
    def withNameAndType(self, string: typing.Union[java.lang.String, str], methodTypeDesc: 'MethodTypeDesc') -> 'DynamicCallSiteDesc': ...

class ModuleDesc:
    def equals(self, object: typing.Any) -> bool: ...
    def name(self) -> java.lang.String: ...
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'ModuleDesc': ...
...
class PackageDesc:
    ...
    def name(self) -> java.lang.String: ...
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'PackageDesc': ...
    @staticmethod
    def ofInternalName(string: typing.Union[java.lang.String, str]) -> 'PackageDesc': ...
...
class ClassDesc(ConstantDesc, java.lang.invoke.TypeDescriptor.OfField['ClassDesc']):
    ...
    @typing.overload
    def nested(self, string: typing.Union[java.lang.String, str]) -> 'ClassDesc': ...
    @typing.overload
    def nested(self, string: typing.Union[java.lang.String, str], *string2: typing.Union[java.lang.String, str]) -> 'ClassDesc': ...
    @typing.overload
    @staticmethod
    def of(string: typing.Union[java.lang.String, str]) -> 'ClassDesc': ...
    @typing.overload
    @staticmethod
    def of(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'ClassDesc': ...
    @staticmethod
    def ofDescriptor(string: typing.Union[java.lang.String, str]) -> 'ClassDesc': ...
    @staticmethod
    def ofInternalName(string: typing.Union[java.lang.String, str]) -> 'ClassDesc': ...
...
class DynamicConstantDesc(ConstantDesc, typing.Generic[_DynamicConstantDesc__T]):
    ...
    @staticmethod
    def ofCanonical(directMethodHandleDesc: 'DirectMethodHandleDesc', string: typing.Union[java.lang.String, str], classDesc: ClassDesc, constantDescArray: typing.Union[typing.List[ConstantDesc], jpype.JArray]) -> ConstantDesc: ...
    _ofNamed__T = typing.TypeVar('_ofNamed__T')  # <T>
    @staticmethod
    def ofNamed(directMethodHandleDesc: 'DirectMethodHandleDesc', string: typing.Union[java.lang.String, str], classDesc: ClassDesc, *constantDesc: ConstantDesc) -> 'DynamicConstantDesc'[_ofNamed__T]: ...
...
class MethodHandleDesc(ConstantDesc):
    ...
    def invocationType(self) -> 'MethodTypeDesc': ...
    @staticmethod
    def of(kind: 'DirectMethodHandleDesc.Kind', classDesc: ClassDesc, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'DirectMethodHandleDesc': ...
    @staticmethod
    def ofConstructor(classDesc: ClassDesc, *classDesc2: ClassDesc) -> 'DirectMethodHandleDesc': ...
    @staticmethod
    def ofField(kind: 'DirectMethodHandleDesc.Kind', classDesc: ClassDesc, string: typing.Union[java.lang.String, str], classDesc2: ClassDesc) -> 'DirectMethodHandleDesc': ...
    @staticmethod
    def ofMethod(kind: 'DirectMethodHandleDesc.Kind', classDesc: ClassDesc, string: typing.Union[java.lang.String, str], methodTypeDesc: 'MethodTypeDesc') -> 'DirectMethodHandleDesc': ...
...
class MethodTypeDesc(ConstantDesc, java.lang.invoke.TypeDescriptor.OfMethod[ClassDesc, 'MethodTypeDesc']):
    ...
    @staticmethod
    def ofDescriptor(string: typing.Union[java.lang.String, str]) -> 'MethodTypeDesc': ...
...
class DirectMethodHandleDesc(MethodHandleDesc):
    ...
    class Kind(java.lang.Enum['DirectMethodHandleDesc.Kind']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'DirectMethodHandleDesc.Kind': ...
        @staticmethod
