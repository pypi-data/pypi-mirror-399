...
class Class(java.io.Serializable, java.lang.reflect.GenericDeclaration, java.lang.reflect.Type, java.lang.reflect.AnnotatedElement, java.lang.invoke.TypeDescriptor.OfField[typing.Type[typing.Any]], java.lang.constant.Constable, typing.Generic[_Class__T]):
    ...
    @typing.overload
    @staticmethod
    def forName(module: 'Module', string: typing.Union['String', str]) -> typing.Type[typing.Any]: ...
    @typing.overload
    @staticmethod
    def forName(string: typing.Union['String', str]) -> typing.Type[typing.Any]: ...
    @typing.overload
    @staticmethod
    def forName(string: typing.Union['String', str], boolean: bool, classLoader: 'ClassLoader') -> typing.Type[typing.Any]: ...
    @staticmethod
    def forPrimitiveName(string: typing.Union['String', str]) -> typing.Type[typing.Any]: ...
    ...
    def getDeclaredField(self, string: typing.Union['String', str]) -> java.lang.reflect.Field: ...
    def getDeclaredFields(self) -> typing.MutableSequence[java.lang.reflect.Field]: ...
    def getDeclaredMethod(self, string: typing.Union['String', str], *class_: typing.Type[typing.Any]) -> java.lang.reflect.Method: ...
    ...
    def getField(self, string: typing.Union['String', str]) -> java.lang.reflect.Field: ...
    ...
    def getMethod(self, string: typing.Union['String', str], *class_: typing.Type[typing.Any]) -> java.lang.reflect.Method: ...
    ...
    def getResource(self, string: typing.Union['String', str]) -> java.net.URL: ...
    def getResourceAsStream(self, string: typing.Union['String', str]) -> java.io.InputStream: ...
...
class ClassLoader:
    ...
    def getDefinedPackage(self, string: typing.Union['String', str]) -> 'Package': ...
    ...
    def getResource(self, string: typing.Union['String', str]) -> java.net.URL: ...
    def getResourceAsStream(self, string: typing.Union['String', str]) -> java.io.InputStream: ...
    def getResources(self, string: typing.Union['String', str]) -> java.util.Enumeration[java.net.URL]: ...
    @staticmethod
    def getSystemClassLoader() -> 'ClassLoader': ...
    @staticmethod
    def getSystemResource(string: typing.Union['String', str]) -> java.net.URL: ...
    @staticmethod
    def getSystemResourceAsStream(string: typing.Union['String', str]) -> java.io.InputStream: ...
    @staticmethod
    def getSystemResources(string: typing.Union['String', str]) -> java.util.Enumeration[java.net.URL]: ...
    def getUnnamedModule(self) -> 'Module': ...
    def isRegisteredAsParallelCapable(self) -> bool: ...
    def loadClass(self, string: typing.Union['String', str]) -> typing.Type[typing.Any]: ...
    def resources(self, string: typing.Union['String', str]) -> java.util.stream.Stream[java.net.URL]: ...
    def setClassAssertionStatus(self, string: typing.Union['String', str], boolean: bool) -> None: ...
    def setDefaultAssertionStatus(self, boolean: bool) -> None: ...
    def setPackageAssertionStatus(self, string: typing.Union['String', str], boolean: bool) -> None: ...
...
class IO:
    ...
    @typing.overload
    @staticmethod
    def readln(string: typing.Union['String', str]) -> 'String': ...
...
class Module(java.lang.reflect.AnnotatedElement):
    def addExports(self, string: typing.Union['String', str], module: 'Module') -> 'Module': ...
    def addOpens(self, string: typing.Union['String', str], module: 'Module') -> 'Module': ...
    ...
    def getResourceAsStream(self, string: typing.Union['String', str]) -> java.io.InputStream: ...
    @typing.overload
    def isExported(self, string: typing.Union['String', str]) -> bool: ...
    @typing.overload
    def isExported(self, string: typing.Union['String', str], module: 'Module') -> bool: ...
    def isNamed(self) -> bool: ...
    def isNativeAccessEnabled(self) -> bool: ...
    @typing.overload
    def isOpen(self, string: typing.Union['String', str]) -> bool: ...
    @typing.overload
    def isOpen(self, string: typing.Union['String', str], module: 'Module') -> bool: ...
    def toString(self) -> 'String': ...
...
class ModuleLayer:
    ...
    @typing.overload
    def defineModules(self, configuration: java.lang.module.Configuration, function: typing.Union[java.util.function.Function[typing.Union['String', str], ClassLoader], typing.Callable[[typing.Union['String', str]], ClassLoader]]) -> 'ModuleLayer': ...
    @typing.overload
    @staticmethod
    def defineModules(configuration: java.lang.module.Configuration, list: java.util.List['ModuleLayer'], function: typing.Union[java.util.function.Function[typing.Union['String', str], ClassLoader], typing.Callable[[typing.Union['String', str]], ClassLoader]]) -> 'ModuleLayer.Controller': ...
    @typing.overload
    ...
    def findLoader(self, string: typing.Union['String', str]) -> ClassLoader: ...
    def findModule(self, string: typing.Union['String', str]) -> java.util.Optional[Module]: ...
    def modules(self) -> java.util.Set[Module]: ...
    def parents(self) -> java.util.List['ModuleLayer']: ...
    def toString(self) -> 'String': ...
    class Controller:
        def addExports(self, module: Module, string: typing.Union['String', str], module2: Module) -> 'ModuleLayer.Controller': ...
        def addOpens(self, module: Module, string: typing.Union['String', str], module2: Module) -> 'ModuleLayer.Controller': ...
...
class RuntimePermission(java.security.BasicPermission):
    @typing.overload
    def __init__(self, string: typing.Union['String', str]): ...
    @typing.overload
    def __init__(self, string: typing.Union['String', str], string2: typing.Union['String', str]): ...
...
_ScopedValue__CallableOp__X = typing.TypeVar('_ScopedValue__CallableOp__X', bound='Throwable')  # <X>
...
class ScopedValue(typing.Generic[_ScopedValue__T]):
    ...
    class CallableOp(typing.Generic[_ScopedValue__CallableOp__T, _ScopedValue__CallableOp__X]):
    ...
    class Carrier:
        ...
        def call(self, callableOp: typing.Union['ScopedValue.CallableOp'[_call__R, _call__X], typing.Callable[[], _call__R]]) -> _call__R: ...
...
class SecurityManager:
    def __init__(self): ...
    def checkAccept(self, string: typing.Union['String', str], int: int) -> None: ...
    @typing.overload
    def checkAccess(self, thread: 'Thread') -> None: ...
    @typing.overload
    def checkAccess(self, threadGroup: 'ThreadGroup') -> None: ...
    @typing.overload
    def checkConnect(self, string: typing.Union['String', str], int: int) -> None: ...
    @typing.overload
    def checkConnect(self, string: typing.Union['String', str], int: int, object: typing.Any) -> None: ...
    def checkCreateClassLoader(self) -> None: ...
    def checkDelete(self, string: typing.Union['String', str]) -> None: ...
    def checkExec(self, string: typing.Union['String', str]) -> None: ...
    def checkExit(self, int: int) -> None: ...
    def checkLink(self, string: typing.Union['String', str]) -> None: ...
    ...
    def checkPackageAccess(self, string: typing.Union['String', str]) -> None: ...
    def checkPackageDefinition(self, string: typing.Union['String', str]) -> None: ...
    @typing.overload
    ...
    def checkPropertyAccess(self, string: typing.Union['String', str]) -> None: ...
    @typing.overload
    def checkRead(self, fileDescriptor: java.io.FileDescriptor) -> None: ...
    @typing.overload
    def checkRead(self, string: typing.Union['String', str]) -> None: ...
    @typing.overload
    def checkRead(self, string: typing.Union['String', str], object: typing.Any) -> None: ...
    def checkSecurityAccess(self, string: typing.Union['String', str]) -> None: ...
    def checkSetFactory(self) -> None: ...
    @typing.overload
    def checkWrite(self, fileDescriptor: java.io.FileDescriptor) -> None: ...
    @typing.overload
    def checkWrite(self, string: typing.Union['String', str]) -> None: ...
...
class StableValue(typing.Generic[_StableValue__T]):
    ...
    @staticmethod
    def function(set: java.util.Set[_function__T], function: typing.Union[java.util.function.Function[_function__T, _function__R], typing.Callable[[_function__T], _function__R]]) -> java.util.function.Function[_function__T, _function__R]: ...
    def hashCode(self) -> int: ...
    _intFunction__R = typing.TypeVar('_intFunction__R')  # <R>
    @staticmethod
    def intFunction(int: int, intFunction: typing.Union[java.util.function.IntFunction[_intFunction__R], typing.Callable[[int], _intFunction__R]]) -> java.util.function.IntFunction[_intFunction__R]: ...
    def isSet(self) -> bool: ...
    _list__E = typing.TypeVar('_list__E')  # <E>
    @staticmethod
    def list(int: int, intFunction: typing.Union[java.util.function.IntFunction[_list__E], typing.Callable[[int], _list__E]]) -> java.util.List[_list__E]: ...
    _map__K = typing.TypeVar('_map__K')  # <K>
    _map__V = typing.TypeVar('_map__V')  # <V>
    @staticmethod
    def map(set: java.util.Set[_map__K], function: typing.Union[java.util.function.Function[_map__K, _map__V], typing.Callable[[_map__K], _map__V]]) -> java.util.Map[_map__K, _map__V]: ...
    ...
    def orElseSet(self, supplier: typing.Union[java.util.function.Supplier[_StableValue__T], typing.Callable[[], _StableValue__T]]) -> _StableValue__T: ...
    def orElseThrow(self) -> _StableValue__T: ...
    def setOrThrow(self, t: _StableValue__T) -> None: ...
    _supplier__T = typing.TypeVar('_supplier__T')  # <T>
    @staticmethod
    def supplier(supplier: typing.Union[java.util.function.Supplier[_supplier__T], typing.Callable[[], _supplier__T]]) -> java.util.function.Supplier[_supplier__T]: ...
    def trySet(self, t: _StableValue__T) -> bool: ...

class StackTraceElement(java.io.Serializable):
    @typing.overload
    def __init__(self, string: typing.Union['String', str], string2: typing.Union['String', str], string3: typing.Union['String', str], int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union['String', str], string2: typing.Union['String', str], string3: typing.Union['String', str], string4: typing.Union['String', str], string5: typing.Union['String', str], string6: typing.Union['String', str], int: int): ...
    def equals(self, object: typing.Any) -> bool: ...
...
class Throwable(java.io.Serializable, JException):
    ...
    def __init__(self, string: typing.Union['String', str]): ...
    @typing.overload
    def __init__(self, string: typing.Union['String', str], throwable: 'Throwable'): ...
    @typing.overload
...
class Boolean(java.io.Serializable, Comparable[bool], java.lang.constant.Constable):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    @staticmethod
    def getBoolean(string: typing.Union['String', str]) -> bool: ...
    @typing.overload
    def hashCode(self) -> int: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def parseBoolean(string: typing.Union['String', str]) -> bool: ...
    @typing.overload
    def toString(self) -> 'String': ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union['String', str]) -> bool: ...
...
class Byte(Number, Comparable[int], java.lang.constant.Constable):
    ...
    @staticmethod
    def decode(string: typing.Union['String', str]) -> int: ...
    ...
    @typing.overload
    @staticmethod
    def parseByte(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def parseByte(string: typing.Union['String', str], int: int) -> int: ...
    def shortValue(self) -> int: ...
    @typing.overload
    def toString(self) -> 'String': ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union['String', str], int: int) -> int: ...
...
class Double(Number, Comparable[float], java.lang.constant.Constable, java.lang.constant.ConstantDesc):
    ...
    def min(double: float, double2: float) -> float: ...
    @staticmethod
    def parseDouble(string: typing.Union['String', str]) -> float: ...
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union['String', str]) -> float: ...
...
class Enum(java.lang.constant.Constable, Comparable[_Enum__E], java.io.Serializable, typing.Generic[_Enum__E]):
    ...
    @staticmethod
    def valueOf(class_: typing.Type[_valueOf__T], string: typing.Union['String', str]) -> _valueOf__T: ...
    class EnumDesc(java.lang.constant.DynamicConstantDesc[_Enum__EnumDesc__E], typing.Generic[_Enum__EnumDesc__E]):
        ...
        @typing.overload
        @staticmethod
        def of(classDesc: java.lang.constant.ClassDesc, string: typing.Union['String', str]) -> 'Enum.EnumDesc'[_of_0__E]: ...
        @typing.overload
        @staticmethod
...
class Float(Number, Comparable[float], java.lang.constant.Constable, java.lang.constant.ConstantDesc):
    ...
    def min(float: float, float2: float) -> float: ...
    @staticmethod
    def parseFloat(string: typing.Union['String', str]) -> float: ...
    def resolveConstantDesc(self, lookup: java.lang.invoke.MethodHandles.Lookup) -> float: ...
    def shortValue(self) -> int: ...
    @staticmethod
...
class Integer(Number, Comparable[int], java.lang.constant.Constable, java.lang.constant.ConstantDesc):
    ...
    @typing.overload
    @staticmethod
    def getInteger(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def getInteger(string: typing.Union['String', str], int: int) -> int: ...
    @typing.overload
    @staticmethod
    def getInteger(string: typing.Union['String', str], integer: int) -> int: ...
    @typing.overload
    def hashCode(self) -> int: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def parseInt(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def parseInt(string: typing.Union['String', str], int: int) -> int: ...
    @typing.overload
    @staticmethod
    def parseUnsignedInt(charSequence: typing.Union[CharSequence, str], int: int, int2: int, int3: int) -> int: ...
    @typing.overload
    @staticmethod
    def parseUnsignedInt(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def parseUnsignedInt(string: typing.Union['String', str], int: int) -> int: ...
    @staticmethod
...
class Long(Number, Comparable[int], java.lang.constant.Constable, java.lang.constant.ConstantDesc):
    ...
    @typing.overload
    @staticmethod
    def getLong(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def getLong(string: typing.Union['String', str], long: int) -> int: ...
    @typing.overload
    @staticmethod
    def getLong(string: typing.Union['String', str], long: int) -> int: ...
    @typing.overload
    ...
    @typing.overload
    @staticmethod
    def parseLong(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def parseLong(string: typing.Union['String', str], int: int) -> int: ...
    @typing.overload
    @staticmethod
    def parseUnsignedLong(charSequence: typing.Union[CharSequence, str], int: int, int2: int, int3: int) -> int: ...
    @typing.overload
    @staticmethod
    def parseUnsignedLong(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def parseUnsignedLong(string: typing.Union['String', str], int: int) -> int: ...
    @staticmethod
...
class Runtime(_JRuntime):
    ...
    @typing.overload
    def exec_(self, string: typing.Union['String', str]) -> Process: ...
    @typing.overload
    def exec_(self, string: typing.Union['String', str], stringArray: typing.Union[typing.List['String'], jpype.JArray]) -> Process: ...
    @typing.overload
    def exec_(self, string: typing.Union['String', str], stringArray: typing.Union[typing.List['String'], jpype.JArray], file: typing.Union[java.io.File, jpype.protocol.SupportsPath]) -> Process: ...
    @typing.overload
    def exec_(self, stringArray: typing.Union[typing.List['String'], jpype.JArray]) -> Process: ...
    @typing.overload
    def exec_(self, stringArray: typing.Union[typing.List['String'], jpype.JArray], stringArray2: typing.Union[typing.List['String'], jpype.JArray]) -> Process: ...
    @typing.overload
    def exec_(self, stringArray: typing.Union[typing.List['String'], jpype.JArray], stringArray2: typing.Union[typing.List['String'], jpype.JArray], file: typing.Union[java.io.File, jpype.protocol.SupportsPath]) -> Process: ...
    ...
    def load(self, string: typing.Union['String', str]) -> None: ...
    def loadLibrary(self, string: typing.Union['String', str]) -> None: ...
    ...
    class Version(Comparable['Runtime.Version']):
        ...
        @staticmethod
        def parse(string: typing.Union['String', str]) -> 'Runtime.Version': ...
        def patch(self) -> int: ...
...
class Short(Number, Comparable[int], java.lang.constant.Constable):
    ...
    @typing.overload
    @staticmethod
    def parseShort(string: typing.Union['String', str]) -> int: ...
    @typing.overload
    @staticmethod
    def parseShort(string: typing.Union['String', str], int: int) -> int: ...
    @staticmethod
...
class String(java.io.Serializable, Comparable['String'], CharSequence, java.lang.constant.Constable, java.lang.constant.ConstantDesc, _JStringProto):
    ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], int: int, int2: int, string: typing.Union['String', str]): ...
    @typing.overload
    ...
    @typing.overload
    def __init__(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes], string: typing.Union['String', str]): ...
    @typing.overload
    ...
    def codePoints(self) -> java.util.stream.IntStream: ...
    def compareTo(self, string: typing.Union['String', str]) -> int: ...
    def compareToIgnoreCase(self, string: typing.Union['String', str]) -> int: ...
    def concat(self, string: typing.Union['String', str]) -> 'String': ...
    ...
    @typing.overload
    @staticmethod
    def copyValueOf(charArray: typing.Union[typing.List[str], jpype.JArray]) -> 'String': ...
    @typing.overload
    @staticmethod
    def copyValueOf(charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int) -> 'String': ...
    def describeConstable(self) -> java.util.Optional['String']: ...
    def endsWith(self, string: typing.Union['String', str]) -> bool: ...
    def equals(self, object: typing.Any) -> bool: ...
    def equalsIgnoreCase(self, string: typing.Union['String', str]) -> bool: ...
    @typing.overload
    @staticmethod
    def format(string: typing.Union['String', str], *object: typing.Any) -> 'String': ...
    @typing.overload
    @staticmethod
    def format(locale: java.util.Locale, string: typing.Union['String', str], *object: typing.Any) -> 'String': ...
    def formatted(self, *object: typing.Any) -> 'String': ...
    @typing.overload
    def getBytes(self) -> typing.MutableSequence[int]: ...
    @typing.overload
    def getBytes(self, string: typing.Union['String', str]) -> typing.MutableSequence[int]: ...
    @typing.overload
    ...
    @typing.overload
    def indexOf(self, string: typing.Union['String', str]) -> int: ...
    @typing.overload
    def indexOf(self, string: typing.Union['String', str], int: int) -> int: ...
    @typing.overload
    def indexOf(self, string: typing.Union['String', str], int: int, int2: int) -> int: ...
    def intern(self) -> 'String': ...
    def isBlank(self) -> bool: ...
    def isEmpty(self) -> bool: ...
    @typing.overload
    @staticmethod
    def join(charSequence: typing.Union[CharSequence, str], *charSequence2: typing.Union[CharSequence, str]) -> 'String': ...
    @typing.overload
    @staticmethod
    def join(charSequence: typing.Union[CharSequence, str], iterable: typing.Union[Iterable[CharSequence], typing.Sequence[CharSequence], typing.Set[CharSequence], typing.Callable[[], java.util.Iterator[typing.Any]]]) -> 'String': ...
    @typing.overload
    def lastIndexOf(self, int: int) -> int: ...
    @typing.overload
    def lastIndexOf(self, int: int, int2: int) -> int: ...
    @typing.overload
    def lastIndexOf(self, string: typing.Union['String', str]) -> int: ...
    @typing.overload
    def lastIndexOf(self, string: typing.Union['String', str], int: int) -> int: ...
    def length(self) -> int: ...
    def lines(self) -> java.util.stream.Stream['String']: ...
    def matches(self, string: typing.Union['String', str]) -> bool: ...
    def offsetByCodePoints(self, int: int, int2: int) -> int: ...
    @typing.overload
    def regionMatches(self, boolean: bool, int: int, string: typing.Union['String', str], int2: int, int3: int) -> bool: ...
    @typing.overload
    def regionMatches(self, int: int, string: typing.Union['String', str], int2: int, int3: int) -> bool: ...
    def repeat(self, int: int) -> 'String': ...
    @typing.overload
    def replace(self, char: str, char2: str) -> 'String': ...
    @typing.overload
    def replace(self, charSequence: typing.Union[CharSequence, str], charSequence2: typing.Union[CharSequence, str]) -> 'String': ...
    def replaceAll(self, string: typing.Union['String', str], string2: typing.Union['String', str]) -> 'String': ...
    def replaceFirst(self, string: typing.Union['String', str], string2: typing.Union['String', str]) -> 'String': ...
    def resolveConstantDesc(self, lookup: java.lang.invoke.MethodHandles.Lookup) -> 'String': ...
    @typing.overload
    def split(self, string: typing.Union['String', str]) -> typing.MutableSequence['String']: ...
    @typing.overload
    def split(self, string: typing.Union['String', str], int: int) -> typing.MutableSequence['String']: ...
    def splitWithDelimiters(self, string: typing.Union['String', str], int: int) -> typing.MutableSequence['String']: ...
    @typing.overload
    def startsWith(self, string: typing.Union['String', str]) -> bool: ...
    @typing.overload
    def startsWith(self, string: typing.Union['String', str], int: int) -> bool: ...
    ...
    def transform(self, function: typing.Union[java.util.function.Function['String', _transform__R], typing.Callable[['String'], _transform__R]]) -> _transform__R: ...
    ...
    @typing.overload
    @staticmethod
    def valueOf(charArray: typing.Union[typing.List[str], jpype.JArray]) -> 'String': ...
    @typing.overload
    @staticmethod
    def valueOf(charArray: typing.Union[typing.List[str], jpype.JArray], int: int, int2: int) -> 'String': ...
    @typing.overload
    @staticmethod
...
class ProcessBuilder:
    ...
    def __init__(self, *string: typing.Union[String, str]): ...
    @typing.overload
    def __init__(self, list: java.util.List[typing.Union[String, str]]): ...
    @typing.overload
    def command(self, *string: typing.Union[String, str]) -> 'ProcessBuilder': ...
    @typing.overload
    def command(self, list: java.util.List[typing.Union[String, str]]) -> 'ProcessBuilder': ...
    @typing.overload
    ...
    class Redirect:
        ...
        class Type(Enum['ProcessBuilder.Redirect.Type']):
            ...
            @typing.overload
            @staticmethod
            def valueOf(class_: typing.Type[_valueOf_0__T], string: typing.Union[String, str]) -> _valueOf_0__T: ...
            @typing.overload
            @staticmethod
            def valueOf(string: typing.Union[String, str]) -> 'ProcessBuilder.Redirect.Type': ...
            @staticmethod
...
class StackWalker:
    ...
    class Option(Enum['StackWalker.Option']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[String, str]) -> 'StackWalker.Option': ...
        @staticmethod
...
class System:
    ...
    @staticmethod
    def clearProperty(string: typing.Union[String, str]) -> String: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def getLogger(string: typing.Union[String, str]) -> 'System.Logger': ...
    @typing.overload
    @staticmethod
    def getLogger(string: typing.Union[String, str], resourceBundle: java.util.ResourceBundle) -> 'System.Logger': ...
    @staticmethod
    def getProperties() -> java.util.Properties: ...
    @typing.overload
    @staticmethod
    def getProperty(string: typing.Union[String, str]) -> String: ...
    @typing.overload
    @staticmethod
    def getProperty(string: typing.Union[String, str], string2: typing.Union[String, str]) -> String: ...
    @staticmethod
    def getSecurityManager() -> SecurityManager: ...
    @typing.overload
    @staticmethod
    def getenv(string: typing.Union[String, str]) -> String: ...
    @typing.overload
    @staticmethod
    ...
    @staticmethod
    def load(string: typing.Union[String, str]) -> None: ...
    @staticmethod
    def loadLibrary(string: typing.Union[String, str]) -> None: ...
    @staticmethod
    def mapLibraryName(string: typing.Union[String, str]) -> String: ...
    @staticmethod
    def nanoTime() -> int: ...
    @staticmethod
    ...
    @staticmethod
    def setProperty(string: typing.Union[String, str], string2: typing.Union[String, str]) -> String: ...
    @staticmethod
    ...
    class Logger:
        ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', resourceBundle: java.util.ResourceBundle, string: typing.Union[String, str], *object: typing.Any) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', resourceBundle: java.util.ResourceBundle, string: typing.Union[String, str], throwable: Throwable) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', object: typing.Any) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', string: typing.Union[String, str]) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', string: typing.Union[String, str], *object: typing.Any) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', string: typing.Union[String, str], throwable: Throwable) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', supplier: typing.Union[java.util.function.Supplier[typing.Union[String, str]], typing.Callable[[], typing.Union[String, str]]]) -> None: ...
        @typing.overload
        def log(self, level: 'System.Logger.Level', supplier: typing.Union[java.util.function.Supplier[typing.Union[String, str]], typing.Callable[[], typing.Union[String, str]]], throwable: Throwable) -> None: ...
        class Level(Enum['System.Logger.Level']):
            ...
            @typing.overload
            @staticmethod
            def valueOf(string: typing.Union[String, str]) -> 'System.Logger.Level': ...
            @staticmethod
            def values() -> typing.MutableSequence['System.Logger.Level']: ...
    class LoggerFinder:
        def getLocalizedLogger(self, string: typing.Union[String, str], resourceBundle: java.util.ResourceBundle, module: Module) -> 'System.Logger': ...
        def getLogger(self, string: typing.Union[String, str], module: Module) -> 'System.Logger': ...
        @staticmethod
...
class EnumConstantNotPresentException(RuntimeException):
    def __init__(self, class_: typing.Type[Enum], string: typing.Union[String, str]): ...
...
class Character(java.io.Serializable, Comparable[str], java.lang.constant.Constable):
    ...
    @staticmethod
    def codePointOf(string: typing.Union[String, str]) -> int: ...
    @staticmethod
    ...
    class UnicodeBlock(java.lang.Character.Subset):
        ...
        CJK_UNIFIED_IDEOGRAPHS_EXTENSION_I: typing.ClassVar['Character.UnicodeBlock'] = ...
        ...
        SYMBOLS_FOR_LEGACY_COMPUTING_SUPPLEMENT: typing.ClassVar['Character.UnicodeBlock'] = ...
        OL_ONAL: typing.ClassVar['Character.UnicodeBlock'] = ...
        @staticmethod
        def forName(string: typing.Union[String, str]) -> 'Character.UnicodeBlock': ...
        @typing.overload
        @staticmethod
    ...
    class UnicodeScript(Enum['Character.UnicodeScript']):
        ...
        @staticmethod
        def forName(string: typing.Union[String, str]) -> 'Character.UnicodeScript': ...
        @staticmethod
        def of(int: int) -> 'Character.UnicodeScript': ...
        _valueOf_1__T = typing.TypeVar('_valueOf_1__T', bound=Enum)  # <T>
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[String, str]) -> 'Character.UnicodeScript': ...
        @typing.overload
        @staticmethod
        def valueOf(class_: typing.Type[_valueOf_1__T], string: typing.Union[String, str]) -> _valueOf_1__T: ...
        @staticmethod
...
class Package(java.lang.NamedPackage, java.lang.reflect.AnnotatedElement):
    ...
    def getName(self) -> String: ...
    @staticmethod
    def getPackage(string: typing.Union[String, str]) -> 'Package': ...
    @staticmethod
    ...
    def hashCode(self) -> int: ...
    def isAnnotationPresent(self, class_: typing.Type[java.lang.annotation.Annotation]) -> bool: ...
    def isCompatibleWith(self, string: typing.Union[String, str]) -> bool: ...
    @typing.overload
    def isSealed(self) -> bool: ...
    @typing.overload
...
class StringBuffer(java.lang.AbstractStringBuilder, Appendable, java.io.Serializable, Comparable['StringBuffer'], CharSequence):
    ...
    @typing.overload
    def append(self, string: typing.Union[String, str]) -> 'StringBuffer': ...
    @typing.overload
    ...
    @typing.overload
    def insert(self, int: int, string: typing.Union[String, str]) -> 'StringBuffer': ...
    @typing.overload
    def lastIndexOf(self, string: typing.Union[String, str]) -> int: ...
    @typing.overload
    def lastIndexOf(self, string: typing.Union[String, str], int: int) -> int: ...
    ...
    def replace(self, int: int, int2: int, string: typing.Union[String, str]) -> 'StringBuffer': ...
...
class StringBuilder(java.lang.AbstractStringBuilder, Appendable, java.io.Serializable, Comparable['StringBuilder'], CharSequence):
    ...
    @typing.overload
    def append(self, string: typing.Union[String, str]) -> 'StringBuilder': ...
    @typing.overload
    ...
    @typing.overload
    def insert(self, int: int, string: typing.Union[String, str]) -> 'StringBuilder': ...
    @typing.overload
    ...
    def replace(self, int: int, int2: int, string: typing.Union[String, str]) -> 'StringBuilder': ...
...
class Thread(Runnable, _JThread):
    ...
    @typing.overload
    def __init__(self, runnable: typing.Union[Runnable, typing.Callable], string: typing.Union[String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[String, str]): ...
    @typing.overload
    def __init__(self, threadGroup: 'ThreadGroup', runnable: typing.Union[Runnable, typing.Callable]): ...
    @typing.overload
    def __init__(self, threadGroup: 'ThreadGroup', runnable: typing.Union[Runnable, typing.Callable], string: typing.Union[String, str]): ...
    @typing.overload
    def __init__(self, threadGroup: 'ThreadGroup', runnable: typing.Union[Runnable, typing.Callable], string: typing.Union[String, str], long: int): ...
    @typing.overload
    def __init__(self, threadGroup: 'ThreadGroup', runnable: typing.Union[Runnable, typing.Callable], string: typing.Union[String, str], long: int, boolean: bool): ...
    @typing.overload
    def __init__(self, threadGroup: 'ThreadGroup', string: typing.Union[String, str]): ...
    @staticmethod
    def activeCount() -> int: ...
    ...
    def setName(self, string: typing.Union[String, str]) -> None: ...
    ...
    class Builder:
        ...
        @typing.overload
        def name(self, string: typing.Union[String, str]) -> 'Thread.Builder': ...
        @typing.overload
        def name(self, string: typing.Union[String, str], long: int) -> 'Thread.Builder': ...
        ...
        class OfPlatform(java.lang.Thread.Builder):
            ...
            @typing.overload
            def name(self, string: typing.Union[String, str]) -> 'Thread.Builder.OfPlatform': ...
            @typing.overload
            def name(self, string: typing.Union[String, str], long: int) -> 'Thread.Builder.OfPlatform': ...
        ...
        class OfVirtual(java.lang.Thread.Builder):
            ...
            @typing.overload
            def name(self, string: typing.Union[String, str]) -> 'Thread.Builder.OfVirtual': ...
            @typing.overload
            def name(self, string: typing.Union[String, str], long: int) -> 'Thread.Builder.OfVirtual': ...
    ...
    class State(Enum['Thread.State']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[String, str]) -> 'Thread.State': ...
        @staticmethod
...
class __module_protocol__(Protocol):
    ...
    StableValue: typing.Type[StableValue]
