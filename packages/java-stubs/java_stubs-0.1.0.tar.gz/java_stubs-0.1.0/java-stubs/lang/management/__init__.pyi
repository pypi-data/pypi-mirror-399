...
class ManagementFactory:
    ...
    @staticmethod
    def newPlatformMXBeanProxy(mBeanServerConnection: javax.management.MBeanServerConnection, string: typing.Union[java.lang.String, str], class_: typing.Type[_newPlatformMXBeanProxy__T]) -> _newPlatformMXBeanProxy__T: ...
...
class MemoryNotificationInfo:
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], memoryUsage: 'MemoryUsage', long: int): ...
    @staticmethod
...
class MemoryType(java.lang.Enum['MemoryType']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'MemoryType': ...
    @staticmethod
...
class MonitorInfo(LockInfo):
    def __init__(self, string: typing.Union[java.lang.String, str], int: int, int2: int, stackTraceElement: java.lang.StackTraceElement): ...
    @typing.overload
    @staticmethod
    def from_(compositeData: javax.management.openmbean.CompositeData) -> LockInfo: ...
    @typing.overload
