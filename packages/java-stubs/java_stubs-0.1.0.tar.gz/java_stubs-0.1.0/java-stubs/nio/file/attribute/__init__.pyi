...
class AclEntryFlag(java.lang.Enum['AclEntryFlag']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'AclEntryFlag': ...
    @staticmethod
...
class AclEntryPermission(java.lang.Enum['AclEntryPermission']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'AclEntryPermission': ...
    @staticmethod
...
class AclEntryType(java.lang.Enum['AclEntryType']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'AclEntryType': ...
    @staticmethod
...
class PosixFilePermission(java.lang.Enum['PosixFilePermission']):
    ...
    @typing.overload
    @staticmethod
    def valueOf(string: typing.Union[java.lang.String, str]) -> 'PosixFilePermission': ...
    @staticmethod
...
class PosixFilePermissions:
    ...
    @staticmethod
    def fromString(string: typing.Union[java.lang.String, str]) -> java.util.Set[PosixFilePermission]: ...
    @typing.overload
    def toString(self) -> java.lang.String: ...
    @typing.overload
    @staticmethod
...
class UserPrincipalLookupService:
    def lookupPrincipalByGroupName(self, string: typing.Union[java.lang.String, str]) -> 'GroupPrincipal': ...
    def lookupPrincipalByName(self, string: typing.Union[java.lang.String, str]) -> UserPrincipal: ...
...
class UserDefinedFileAttributeView(FileAttributeView):
    def delete(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def list(self) -> java.util.List[java.lang.String]: ...
    def name(self) -> java.lang.String: ...
    def read(self, string: typing.Union[java.lang.String, str], byteBuffer: java.nio.ByteBuffer) -> int: ...
    def size(self, string: typing.Union[java.lang.String, str]) -> int: ...
    def write(self, string: typing.Union[java.lang.String, str], byteBuffer: java.nio.ByteBuffer) -> int: ...
