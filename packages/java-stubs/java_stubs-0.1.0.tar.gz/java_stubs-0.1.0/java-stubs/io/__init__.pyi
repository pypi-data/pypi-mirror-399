...
class FilenameFilter:
    def accept(self, file: typing.Union['File', jpype.protocol.SupportsPath], string: typing.Union[java.lang.String, str]) -> bool: ...
...
class ObjectInputFilter:
    ...
    class Config:
        @staticmethod
        def createFilter(string: typing.Union[java.lang.String, str]) -> 'ObjectInputFilter': ...
        @staticmethod
    ...
    class Status(java.lang.Enum['ObjectInputFilter.Status']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ObjectInputFilter.Status': ...
        @typing.overload
        @staticmethod
...
class ObjectStreamField(java.lang.Comparable[typing.Any]):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], class_: typing.Type[typing.Any], boolean: bool): ...
...
class UncheckedIOException(java.lang.RuntimeException):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], iOException: IOException): ...
...
class Console(Flushable):
    ...
    def flush(self) -> None: ...
    @typing.overload
    def format(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'Console': ...
    @typing.overload
    def format(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'Console': ...
    def isTerminal(self) -> bool: ...
    @typing.overload
    def printf(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'Console': ...
    @typing.overload
    def printf(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'Console': ...
    @typing.overload
    def readLine(self) -> java.lang.String: ...
    @typing.overload
    def readLine(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> java.lang.String: ...
    @typing.overload
    def readLine(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> java.lang.String: ...
    @typing.overload
    def readPassword(self) -> typing.MutableSequence[str]: ...
    @typing.overload
    def readPassword(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> typing.MutableSequence[str]: ...
    @typing.overload
    def readPassword(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> typing.MutableSequence[str]: ...
...
class File(Serializable, java.lang.Comparable['File']):
    ...
    @typing.overload
    def __init__(self, file: typing.Union['File', jpype.protocol.SupportsPath], string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]): ...
    ...
    @typing.overload
    @staticmethod
    def createTempFile(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'File': ...
    @typing.overload
    @staticmethod
    def createTempFile(string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str], file: typing.Union['File', jpype.protocol.SupportsPath]) -> 'File': ...
    ...
    @typing.overload
    def list(self, filenameFilter: typing.Union[FilenameFilter, typing.Callable]) -> typing.MutableSequence[java.lang.String]: ...
    @typing.overload
...
class ObjectStreamClass(Serializable):
    ...
    def getField(self, string: typing.Union[java.lang.String, str]) -> ObjectStreamField: ...
...
class Reader(java.lang.Readable, Closeable):
    ...
    @staticmethod
    def of(charSequence: typing.Union[java.lang.CharSequence, str]) -> 'Reader': ...
    @typing.overload
...
class InputStreamReader(Reader):
    ...
    def __init__(self, inputStream: InputStream): ...
    @typing.overload
    def __init__(self, inputStream: InputStream, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
...
class ObjectInputStream(InputStream, ObjectInput, ObjectStreamConstants):
    ...
    class GetField:
        def __init__(self): ...
        def defaulted(self, string: typing.Union[java.lang.String, str]) -> bool: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], boolean: bool) -> bool: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], byte: int) -> int: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], char: str) -> str: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], double: float) -> float: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], float: float) -> float: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], int: int) -> int: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], object: typing.Any) -> typing.Any: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], long: int) -> int: ...
        @typing.overload
        def get(self, string: typing.Union[java.lang.String, str], short: int) -> int: ...
...
class ObjectOutputStream(OutputStream, ObjectOutput, ObjectStreamConstants):
    ...
    class PutField:
        def __init__(self): ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], boolean: bool) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], byte: int) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], char: str) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], double: float) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], float: float) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], int: int) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], object: typing.Any) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], long: int) -> None: ...
        @typing.overload
        def put(self, string: typing.Union[java.lang.String, str], short: int) -> None: ...
...
class OutputStreamWriter(Writer):
    ...
    def __init__(self, outputStream: OutputStream): ...
    @typing.overload
    def __init__(self, outputStream: OutputStream, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
...
class PrintWriter(Writer):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], charset: java.nio.charset.Charset): ...
    @typing.overload
    ...
    def flush(self) -> None: ...
    @typing.overload
    def format(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintWriter': ...
    @typing.overload
    def format(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintWriter': ...
    @typing.overload
    ...
    @typing.overload
    def print_(self, string: typing.Union[java.lang.String, str]) -> None: ...
    @typing.overload
    def print_(self, long: int) -> None: ...
    @typing.overload
    def printf(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintWriter': ...
    @typing.overload
    def printf(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintWriter': ...
    @typing.overload
...
class FileWriter(OutputStreamWriter):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], charset: java.nio.charset.Charset): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], charset: java.nio.charset.Charset, boolean: bool): ...
...
class PrintStream(FilterOutputStream, java.lang.Appendable, Closeable):
    ...
    def __init__(self, outputStream: OutputStream, boolean: bool): ...
    @typing.overload
    def __init__(self, outputStream: OutputStream, boolean: bool, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, outputStream: OutputStream, boolean: bool, charset: java.nio.charset.Charset): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    ...
    def flush(self) -> None: ...
    @typing.overload
    def format(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintStream': ...
    @typing.overload
    def format(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintStream': ...
    @typing.overload
    def print_(self, boolean: bool) -> None: ...
    @typing.overload
    def print_(self, char: str) -> None: ...
    ...
    def print_(self, long: int) -> None: ...
    @typing.overload
    def printf(self, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintStream': ...
    @typing.overload
    def printf(self, locale: java.util.Locale, string: typing.Union[java.lang.String, str], *object: typing.Any) -> 'PrintStream': ...
    @typing.overload
    def println(self) -> None: ...
    @typing.overload
    def println(self, boolean: bool) -> None: ...
