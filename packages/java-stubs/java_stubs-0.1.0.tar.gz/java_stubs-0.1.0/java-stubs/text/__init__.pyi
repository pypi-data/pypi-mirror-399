...
class AttributedString:
    ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], map: typing.Union[java.util.Map['AttributedCharacterIterator.Attribute', typing.Any], typing.Mapping['AttributedCharacterIterator.Attribute', typing.Any]]): ...
    @typing.overload
...
class Collator(java.util.Comparator[typing.Any], java.lang.Cloneable):
    ...
    def clone(self) -> typing.Any: ...
    @typing.overload
    def compare(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> int: ...
    @typing.overload
    def compare(self, object: typing.Any, object2: typing.Any) -> int: ...
    @typing.overload
    def equals(self, object: typing.Any) -> bool: ...
    @typing.overload
    def equals(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> bool: ...
    @staticmethod
    def getAvailableLocales() -> typing.MutableSequence[java.util.Locale]: ...
    def getCollationKey(self, string: typing.Union[java.lang.String, str]) -> CollationKey: ...
...
class DateFormatSymbols(java.io.Serializable, java.lang.Cloneable):
    ...
    def getZoneStrings(self) -> typing.MutableSequence[typing.MutableSequence[java.lang.String]]: ...
    def hashCode(self) -> int: ...
    def setAmPmStrings(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setEras(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setLocalPatternChars(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setMonths(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setShortMonths(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setShortWeekdays(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setWeekdays(self, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setZoneStrings(self, stringArray: typing.Union[typing.List[typing.MutableSequence[java.lang.String]], jpype.JArray]) -> None: ...
...
class DecimalFormatSymbols(java.lang.Cloneable, java.io.Serializable):
    ...
    def setCurrencySymbol(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setDecimalSeparator(self, char: str) -> None: ...
    def setDigit(self, char: str) -> None: ...
    def setExponentSeparator(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setGroupingSeparator(self, char: str) -> None: ...
    def setInfinity(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setInternationalCurrencySymbol(self, string: typing.Union[java.lang.String, str]) -> None: ...
    ...
    def setNaN(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class Normalizer:
    ...
    @staticmethod
    def normalize(charSequence: typing.Union[java.lang.CharSequence, str], form: 'Normalizer.Form') -> java.lang.String: ...
    class Form(java.lang.Enum['Normalizer.Form']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'Normalizer.Form': ...
        @staticmethod
...
class RuleBasedCollator(Collator):
    ...
    def equals(self, object: typing.Any) -> bool: ...
    @typing.overload
    def getCollationElementIterator(self, string: typing.Union[java.lang.String, str]) -> CollationElementIterator: ...
    @typing.overload
...
class StringCharacterIterator(CharacterIterator):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str], int: int): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], int: int, int2: int, int3: int): ...
    def clone(self) -> typing.Any: ...
    def current(self) -> str: ...
    def equals(self, object: typing.Any) -> bool: ...
    def first(self) -> str: ...
...
class Format(java.io.Serializable, java.lang.Cloneable):
    ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> typing.Any: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
...
class DateFormat(Format):
    ...
    @typing.overload
    def parse(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> java.util.Date: ...
    @typing.overload
    def parse(self, string: typing.Union[java.lang.String, str]) -> java.util.Date: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> typing.Any: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
...
class ListFormat(Format):
    ...
    def format(self, object: typing.Any) -> java.lang.String: ...
    @typing.overload
    def format(self, list: java.util.List[typing.Union[java.lang.String, str]]) -> java.lang.String: ...
    @typing.overload
    def format(self, object: typing.Any, stringBuffer: java.lang.StringBuffer, fieldPosition: FieldPosition) -> java.lang.StringBuffer: ...
    def formatToCharacterIterator(self, object: typing.Any) -> AttributedCharacterIterator: ...
    @staticmethod
    ...
    @typing.overload
    @staticmethod
    def getInstance(stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> 'ListFormat': ...
    @typing.overload
    @staticmethod
    def getInstance(locale: java.util.Locale, type: 'ListFormat.Type', style: 'ListFormat.Style') -> 'ListFormat': ...
    def getLocale(self) -> java.util.Locale: ...
    def getPatterns(self) -> typing.MutableSequence[java.lang.String]: ...
    def hashCode(self) -> int: ...
    def parse(self, string: typing.Union[java.lang.String, str]) -> java.util.List[java.lang.String]: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> typing.Any: ...
    ...
    class Style(java.lang.Enum['ListFormat.Style']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ListFormat.Style': ...
        @staticmethod
    ...
    class Type(java.lang.Enum['ListFormat.Type']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'ListFormat.Type': ...
        @staticmethod
...
class MessageFormat(Format):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], locale: java.util.Locale): ...
    def applyPattern(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def clone(self) -> typing.Any: ...
    def equals(self, object: typing.Any) -> bool: ...
    @typing.overload
    def format(self, object: typing.Any) -> java.lang.String: ...
    ...
    @typing.overload
    @staticmethod
    def format(string: typing.Union[java.lang.String, str], *object: typing.Any) -> java.lang.String: ...
    def formatToCharacterIterator(self, object: typing.Any) -> AttributedCharacterIterator: ...
    ...
    def hashCode(self) -> int: ...
    @typing.overload
    def parse(self, string: typing.Union[java.lang.String, str]) -> typing.MutableSequence[typing.Any]: ...
    @typing.overload
    def parse(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> typing.MutableSequence[typing.Any]: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> typing.Any: ...
...
class NumberFormat(Format):
    ...
    @typing.overload
    def parse(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> java.lang.Number: ...
    @typing.overload
    def parse(self, string: typing.Union[java.lang.String, str]) -> java.lang.Number: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str], parsePosition: ParsePosition) -> typing.Any: ...
    @typing.overload
    def parseObject(self, string: typing.Union[java.lang.String, str]) -> typing.Any: ...
    ...
    class Style(java.lang.Enum['NumberFormat.Style']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'NumberFormat.Style': ...
        @staticmethod
        def values() -> typing.MutableSequence['NumberFormat.Style']: ...

class ChoiceFormat(NumberFormat):
    @typing.overload
    def __init__(self, doubleArray: typing.Union[typing.List[float], jpype.JArray], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    def applyPattern(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def clone(self) -> typing.Any: ...
    ...
    def setChoices(self, doubleArray: typing.Union[typing.List[float], jpype.JArray], stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]) -> None: ...
    def setStrict(self, boolean: bool) -> None: ...
    def toPattern(self) -> java.lang.String: ...
    def toString(self) -> java.lang.String: ...
...
class CompactNumberFormat(NumberFormat):
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], decimalFormatSymbols: DecimalFormatSymbols, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], decimalFormatSymbols: DecimalFormatSymbols, stringArray: typing.Union[typing.List[java.lang.String], jpype.JArray], string3: typing.Union[java.lang.String, str]): ...
...
class DecimalFormat(NumberFormat):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], decimalFormatSymbols: DecimalFormatSymbols): ...
    def applyLocalizedPattern(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def applyPattern(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def clone(self) -> typing.Any: ...
    def equals(self, object: typing.Any) -> bool: ...
    @typing.overload
    ...
    def setNegativePrefix(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setNegativeSuffix(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setParseBigDecimal(self, boolean: bool) -> None: ...
    def setPositivePrefix(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setPositiveSuffix(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def setRoundingMode(self, roundingMode: java.math.RoundingMode) -> None: ...
    def setStrict(self, boolean: bool) -> None: ...
...
class SimpleDateFormat(DateFormat):
    ...
    def __init__(self, string: typing.Union[java.lang.String, str]): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], dateFormatSymbols: DateFormatSymbols): ...
    @typing.overload
    def __init__(self, string: typing.Union[java.lang.String, str], locale: java.util.Locale): ...
    def applyLocalizedPattern(self, string: typing.Union[java.lang.String, str]) -> None: ...
    def applyPattern(self, string: typing.Union[java.lang.String, str]) -> None: ...
...
class __module_protocol__(Protocol):
    ...
    ListFormat: typing.Type[ListFormat]
