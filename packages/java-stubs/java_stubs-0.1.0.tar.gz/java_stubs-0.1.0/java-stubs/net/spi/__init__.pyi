...
class InetAddressResolver:
    def lookupByAddress(self, byteArray: typing.Union[typing.List[int], jpype.JArray, bytes]) -> java.lang.String: ...
    def lookupByName(self, string: typing.Union[java.lang.String, str], lookupPolicy: 'InetAddressResolver.LookupPolicy') -> java.util.stream.Stream[java.net.InetAddress]: ...
    class LookupPolicy:
