...
class HttpClient(java.lang.AutoCloseable):
    ...
    class Redirect(java.lang.Enum['HttpClient.Redirect']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'HttpClient.Redirect': ...
        @staticmethod
    ...
    class Version(java.lang.Enum['HttpClient.Version']):
        ...
        @typing.overload
        @staticmethod
        def valueOf(string: typing.Union[java.lang.String, str]) -> 'HttpClient.Version': ...
        @staticmethod
        def values() -> typing.MutableSequence['HttpClient.Version']: ...

class HttpHeaders:
    def allValues(self, string: typing.Union[java.lang.String, str]) -> java.util.List[java.lang.String]: ...
    def equals(self, object: typing.Any) -> bool: ...
    def firstValue(self, string: typing.Union[java.lang.String, str]) -> java.util.Optional[java.lang.String]: ...
    def firstValueAsLong(self, string: typing.Union[java.lang.String, str]) -> java.util.OptionalLong: ...
    def hashCode(self) -> int: ...
    def map(self) -> java.util.Map[java.lang.String, java.util.List[java.lang.String]]: ...
    @staticmethod
    def of(map: typing.Union[java.util.Map[typing.Union[java.lang.String, str], java.util.List[typing.Union[java.lang.String, str]]], typing.Mapping[typing.Union[java.lang.String, str], java.util.List[typing.Union[java.lang.String, str]]]], biPredicate: typing.Union[java.util.function.BiPredicate[typing.Union[java.lang.String, str], typing.Union[java.lang.String, str]], typing.Callable[[typing.Union[java.lang.String, str], typing.Union[java.lang.String, str]], bool]]) -> 'HttpHeaders': ...
...
class HttpRequest:
    ...
    @typing.overload
    @staticmethod
    def newBuilder(httpRequest: 'HttpRequest', biPredicate: typing.Union[java.util.function.BiPredicate[typing.Union[java.lang.String, str], typing.Union[java.lang.String, str]], typing.Callable[[typing.Union[java.lang.String, str], typing.Union[java.lang.String, str]], bool]]) -> 'HttpRequest.Builder': ...
    ...
    class BodyPublishers:
        ...
        @typing.overload
        @staticmethod
        def ofString(string: typing.Union[java.lang.String, str]) -> 'HttpRequest.BodyPublisher': ...
        @typing.overload
        @staticmethod
        def ofString(string: typing.Union[java.lang.String, str], charset: java.nio.charset.Charset) -> 'HttpRequest.BodyPublisher': ...
    class Builder:
        ...
        def header(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'HttpRequest.Builder': ...
        def headers(self, *string: typing.Union[java.lang.String, str]) -> 'HttpRequest.Builder': ...
        def method(self, string: typing.Union[java.lang.String, str], bodyPublisher: 'HttpRequest.BodyPublisher') -> 'HttpRequest.Builder': ...
        def setHeader(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'HttpRequest.Builder': ...
...
class HttpResponse(typing.Generic[_HttpResponse__T]):
    ...
    class BodyHandlers:
        ...
        @staticmethod
        def limiting(bodyHandler: typing.Union['HttpResponse.BodyHandler'[_limiting__T], typing.Callable[['HttpResponse.ResponseInfo'], 'HttpResponse.BodySubscriber'[typing.Any]]], long: int) -> 'HttpResponse.BodyHandler'[_limiting__T]: ...
        @staticmethod
        ...
        @staticmethod
        def ofLines() -> 'HttpResponse.BodyHandler'[java.util.stream.Stream[java.lang.String]]: ...
        @staticmethod
        ...
        @typing.overload
        @staticmethod
        def ofString(charset: java.nio.charset.Charset) -> 'HttpResponse.BodyHandler'[java.lang.String]: ...
    ...
    class BodySubscribers:
        ...
        @typing.overload
        @staticmethod
        def fromLineSubscriber(subscriber: java.util.concurrent.Flow.Subscriber[java.lang.String]) -> 'HttpResponse.BodySubscriber'[None]: ...
        @typing.overload
        @staticmethod
        def fromLineSubscriber(s: _fromLineSubscriber_1__S, function: typing.Union[java.util.function.Function[_fromLineSubscriber_1__S, _fromLineSubscriber_1__T], typing.Callable[[_fromLineSubscriber_1__S], _fromLineSubscriber_1__T]], charset: java.nio.charset.Charset, string: typing.Union[java.lang.String, str]) -> 'HttpResponse.BodySubscriber'[_fromLineSubscriber_1__T]: ...
        _fromSubscriber_1__S = typing.TypeVar('_fromSubscriber_1__S', bound=java.util.concurrent.Flow.Subscriber)  # <S>
        _fromSubscriber_1__T = typing.TypeVar('_fromSubscriber_1__T')  # <T>
        @typing.overload
        @staticmethod
        ...
        _limiting__T = typing.TypeVar('_limiting__T')  # <T>
        @staticmethod
        def limiting(bodySubscriber: 'HttpResponse.BodySubscriber'[_limiting__T], long: int) -> 'HttpResponse.BodySubscriber'[_limiting__T]: ...
        ...
        @staticmethod
        def ofLines(charset: java.nio.charset.Charset) -> 'HttpResponse.BodySubscriber'[java.util.stream.Stream[java.lang.String]]: ...
        @staticmethod
        def ofPublisher() -> 'HttpResponse.BodySubscriber'[java.util.concurrent.Flow.Publisher[java.util.List[java.nio.ByteBuffer]]]: ...
        @staticmethod
        def ofString(charset: java.nio.charset.Charset) -> 'HttpResponse.BodySubscriber'[java.lang.String]: ...
        _replacing__U = typing.TypeVar('_replacing__U')  # <U>
        @staticmethod
...
class WebSocket:
    ...
    def sendClose(self, int: int, string: typing.Union[java.lang.String, str]) -> java.util.concurrent.CompletableFuture['WebSocket']: ...
    ...
    class Builder:
        ...
        def header(self, string: typing.Union[java.lang.String, str], string2: typing.Union[java.lang.String, str]) -> 'WebSocket.Builder': ...
        def subprotocols(self, string: typing.Union[java.lang.String, str], *string2: typing.Union[java.lang.String, str]) -> 'WebSocket.Builder': ...
    class Listener:
        ...
        def onClose(self, webSocket: 'WebSocket', int: int, string: typing.Union[java.lang.String, str]) -> java.util.concurrent.CompletionStage[typing.Any]: ...
