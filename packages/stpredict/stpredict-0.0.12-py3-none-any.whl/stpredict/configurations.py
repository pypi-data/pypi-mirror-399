...
PERFORMANCE_MEASURES = ['MAE', 'MAPE', 'MASE', 'MSE', 'R2_score', 'AIC', 'BIC', 'likelihood', 'AUC', 'AUPR',
                        'RMSE', 'RRMSE', 'WMAPE', 'APB', 'WI', 'skill_score', 'LM', 'KGE', 'pearson_r', 'EVS']

LOWER_IS_BETTER = ['MAE', 'MAPE', 'MASE', 'MSE', 'AIC', 'BIC', 'likelihood', 'RMSE', 'RRMSE', 'WMAPE', 'APB']

REGRESSION_PERFORMANCE_MEASURES = ['MAE', 'MAPE', 'MASE', 'MSE', 'R2_score', 'RMSE', 'RRMSE', 'WMAPE', 'APB', 
                                   'WI', 'skill_score', 'LM', 'KGE', 'pearson_r', 'EVS']
