...
def sanitize_metadata(metadata: dict[str, Any] | None, logger: logging.Logger) -> dict[str, Any]:
    ...
    '''
def build_chroma_get_kwargs(filters: QueryFilter | None, include: list[str] | None = None, limit: int | None = None, **additional_kwargs: Any) -> dict[str, Any]:
    ...
    Examples:
        1. Build kwargs with metadata and content filters:
            ...
            out = build_chroma_get_kwargs(filters, include=["documents"], limit=10)
            # out ->
            # {
            #   "where": {"status": "active"},
        ...
        2. Build kwargs using id filters:
            ...
            out = build_chroma_get_kwargs(filters)
            # out -> {"ids": ["123", "a", "b"]}
            ```
    ...
    '''
def build_chroma_delete_kwargs(filters: QueryFilter | None, **additional_kwargs: Any) -> dict[str, Any]:
    ...
    Examples:
        1. Delete by ids or where:
            ...
            out = build_chroma_delete_kwargs(filters)
            # out ->
            # {
            #   "ids": ["x1", "x2"],
