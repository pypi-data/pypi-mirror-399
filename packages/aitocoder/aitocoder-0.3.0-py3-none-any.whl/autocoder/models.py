...
MODELS_JSON = str(GLOBAL_CONFIG_DIR / "keys" / "models.json")
...
def load_models() -> List[Dict]:
    """
    Load models from ~/.ac_config/keys/models.json and merge with default_models_list.
...
def save_models(models: List[Dict]) -> None:
    """
    Save models to ~/.ac_config/keys/models.json
    """
    lm = _get_llm_manager()
