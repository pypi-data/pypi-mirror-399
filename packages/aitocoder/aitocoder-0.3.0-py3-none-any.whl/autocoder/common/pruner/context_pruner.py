            ...
            try:                
                ...
                if tokens > self.max_tokens:
                    ...
                    if merged_snippets:
                        ...
                        if self.verbose:
                            self.printer.print_str_in_terminal(f"\u00BB 文件 {file_source.module_name} 滑动窗口处理后无相关代码片段，跳过处理")
                        continue
                ...
                if extracted:
                    ...
                    if snippets:
                        ...
                        # 没有相关代码片段，跳过这个文件
                        if self.verbose:
                            self.printer.print_str_in_terminal(f"\u00BB 文件 {file_source.module_name} 无相关代码片段，跳过处理")
                else:
                    if self.verbose:
