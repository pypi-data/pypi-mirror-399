...
class LinterConfigLoader:
    ...
    4. Global user config file (~/.ac_config/.autocoderlinters/)
    ...
    def _load_from_global_config(self, config_key: str = 'linter') -> Optional[Dict[str, Any]]:
        ...
        try:
            # Use GLOBAL_CONFIG_DIR for cross-platform support
            global_config_dir = GLOBAL_CONFIG_DIR / '.autocoderlinters'
