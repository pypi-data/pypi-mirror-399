...
AUTO_CODER_MESSAGES = {
    ...
    "model_info_not_found": {
        "en": "Model information not found for '{{model_name}}' in {{product_mode}} mode. Please check your model configuration in ~/.ac_config/keys/models.json or verify the model name is correct.",
        "zh": "在 {{product_mode}} 模式下未找到模型 '{{model_name}}' 的信息。请检查 ~/.ac_config/keys/models.json 中的模型配置或验证模型名称是否正确。",
        "ja": "{{product_mode}} モードでモデル '{{model_name}}' の情報が見つかりません。~/.ac_config/keys/models.json のモデル設定を確認するか、モデル名が正しいことを確認してください。",
        "ar": "لم يتم العثور على معلومات النموذج '{{model_name}}' في وضع {{product_mode}}. يرجى التحقق من تكوين النموذج في ~/.ac_config/keys/models.json أو التحقق من صحة اسم النموذج.",
        "ru": "Информация о модели '{{model_name}}' не найдена в режиме {{product_mode}}. Пожалуйста, проверьте конфигурацию модели в ~/.ac_config/keys/models.json или убедитесь, что имя модели правильное."
    },
