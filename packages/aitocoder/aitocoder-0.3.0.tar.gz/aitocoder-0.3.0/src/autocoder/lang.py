lang_desc = {
    "en": {
        ...
        "base_dir": "Alternative path for /~/.ac_config to store or retrieve text embeddings. Using /~/.ac_config/ if not specified",
    ...
    "zh": {
        ...
        "base_dir": "用于替代byzerllm中/~/.ac_config的路径存放或读取向量化后的文本。不指定则使用默认路径",
