...
class PluginManager:
    ...
    def load_global_plugin_dirs(self) -> None:
        """Read global plugin dirs from ~/.ac_config/plugins/global_plugin_dirs"""
        global_plugin_dirs_path = str(GLOBAL_CONFIG_DIR / "plugins" / "global_plugin_dirs")
    ...
    def save_global_plugin_dirs(self) -> None:
        """Save global plugin dirs to ~/.ac_config/plugins/global_plugin_dirs"""
        global_plugin_dirs_path = str(GLOBAL_CONFIG_DIR / "plugins" / "global_plugin_dirs")
        # 确保目录存在
