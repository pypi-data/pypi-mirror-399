"""
Middlewares for TinyDB.

Contains the base class for all Middlewares and implementations.

Middlewares hook into the read/write process of TinyDB allowing you to
extend the behaviour by adding caching, logging, etc.
"""

from typing import Any, Dict, Optional, Type

__all__ = ['Middleware', 'CachingMiddleware']
...
class Middleware:
    ...
    def __init__(self, storage_cls: Type) -> None:
