from gllm_misc.router.router import DEPRECATION_MESSAGE as DEPRECATION_MESSAGE
from gllm_misc.utils.data_utils import encode_bytes as encode_bytes
...
class BytesCompatRoute(Route):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        """Initialize the BytesCompatRoute.
