...
from gllm_misc.chat_history_manager.schema import ConversationModel as ConversationModel, MessageModel as MessageModel, MessagePair as MessagePair, OperationType as OperationType, SchemaKey as SchemaKey
...
class ChatHistoryManager(Component):
    ...
    def __init__(self, data_store: BaseSQLDataStore, order_by: str = ..., processor: BaseChatHistoryProcessor | None = None, fallback_to_original_history: bool = True) -> None:
        ...
        '''
    async def retrieve(self, conversation_id: str, user_message: str | None = None, pair_limit: int = ..., last_message_id: str | None = None) -> list[Message]:
