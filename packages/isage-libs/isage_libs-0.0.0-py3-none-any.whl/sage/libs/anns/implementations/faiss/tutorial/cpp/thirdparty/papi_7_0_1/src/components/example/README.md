...
To enable reading of EXAMPLE counters the user needs to link against a PAPI library that was
configured with the EXAMPLE component enabled. As an example the following command:
`./configure --with-components="example"` is sufficient to enable the component.
