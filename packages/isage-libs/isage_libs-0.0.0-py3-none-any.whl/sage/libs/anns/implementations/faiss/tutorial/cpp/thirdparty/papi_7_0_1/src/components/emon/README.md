...
To enable reading of EMON counters the user needs to link against a PAPI library that was configured
with the EMON component enabled. There are no specific component configure scripts. In order to
