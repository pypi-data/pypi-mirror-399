...
void setup_PAPI(int *event_set){
    ...
    if((ret=PAPI_add_named_event(*event_set, "sde:::CPP_Lib_With_Recorder::simple_recording:CNT")) != PAPI_OK){
        test_fail( __FILE__, __LINE__, "PAPI_add_named_event", ret );
    }

    if((ret=PAPI_add_named_event(*event_set, "sde:::CPP_Lib_With_Recorder::simple_recording")) != PAPI_OK){
        test_fail( __FILE__, __LINE__, "PAPI_add_named_event", ret );
    }
