...
To enable reading of LUSTRE counters the user needs to link against a PAPI library that was
configured with the LUSTRE component enabled. As an example the following command:
`./configure --with-components="lustre"` is sufficient to enable the component.
