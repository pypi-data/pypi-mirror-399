...
def get_cci_means( obj, cci_idx_lst = None, 
    ...
    if isinstance(obj, anndata.AnnData):
        if adata_t.uns['analysis_parameters']['REF_NORMAL_CONDITIONS'] is not None:
            ref_normal_cond = adata_t.uns['analysis_parameters']['REF_NORMAL_CONDITIONS']
