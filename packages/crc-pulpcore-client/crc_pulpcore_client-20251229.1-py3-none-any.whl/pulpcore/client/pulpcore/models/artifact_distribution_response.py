...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["no_content_change_since", "pulp_href", "base_url", "pulp_last_updated", "name", "content_guard", "prn", "hidden", "pulp_created", "base_path", "pulp_labels"]
