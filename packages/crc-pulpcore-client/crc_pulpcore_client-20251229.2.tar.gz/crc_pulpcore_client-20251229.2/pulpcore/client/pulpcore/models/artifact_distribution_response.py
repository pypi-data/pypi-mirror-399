...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["base_path", "pulp_last_updated", "content_guard", "base_url", "name", "prn", "pulp_created", "pulp_href", "hidden", "no_content_change_since", "pulp_labels"]
