...
def test_pivot_zip_backend_extracts_pivots_and_caches_and_links_connection(tmp_path: Path) -> None:
...
"""
    ...
    g = WorkbookGraph()
    ctx = AnalysisContext(path=xlsx, options=AnalysisOptions(include_pivots=True, include_connections=True))
