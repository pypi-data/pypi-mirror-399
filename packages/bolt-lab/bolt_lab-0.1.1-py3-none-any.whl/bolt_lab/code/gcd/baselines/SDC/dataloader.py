...
class Data:
    ...
    def __init__(self, args):
        ...
        self.all_label_list = self.known_label_list + [
            i for i in self.all_label_list if i not in self.known_label_list
        ]
    ...
    def get_semi(self, labeled_examples, unlabeled_examples, args):
        ...
        unlabeled_features = convert_examples_to_features_semi(
            unlabeled_examples,
    ...
    def get_loader(self, examples, args, mode="train"):
        ...
        if mode == "train" or mode == "eval":
            ...
            features = convert_examples_to_features_semi(
                examples,
                self.known_label_list,
                self.all_label_list,
                args.max_seq_length,
...
def convert_examples_to_features_semi(
    examples, labeled_list, all_list, max_seq_length, tokenizer
):
    label_map = {}
