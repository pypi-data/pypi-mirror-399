...
class ModelManager:
    ...
    def __init__(self, args, data, pretrained_model=None):
        ...
        if pretrained_model is None:
            pretrained_model = BertForModel.from_pretrained(
                args.bert_model, cache_dir="", num_labels=data.n_known_cls
            )
        ...
        self.model = BertForModel.from_pretrained(
            args.bert_model, cache_dir="", num_labels=self.num_labels
        )
        ...
        num_train_examples = len(data.train_labeled_examples) + len(
    ...
    def predict_k(self, args, data):
        ...
        feats, _ = self.get_features_labels(
            data.train_semi_dataloader, self.pretrained_model, args
        )
