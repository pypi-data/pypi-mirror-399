...
class Data:
    ...
    def __init__(self, args):
        ...
        self.train_eval_dataloader = self.get_loader(
            self.train_eval_examples, args, "train_eval"
        )
    ...
    def get_semi(self, labeled_examples, unlabeled_examples, args):
        ...
        unlabeled_true_label_ids = torch.tensor(
    ...
    def get_loader(self, examples, args, mode="train"):
        ...
        if mode == "train":
            ...
            dataloader = DataLoader(
                data, sampler=sampler, batch_size=args.eval_batch_size, drop_last=False
            )
        else:
            raise NotImplementedError(f"Mode {mode} not found")
