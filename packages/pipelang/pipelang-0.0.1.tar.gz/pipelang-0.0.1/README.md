...
[![CI Status](https://github.com/smacke/pipelang/workflows/pipelang/badge.svg)](https://github.com/smacke/pipelang/actions)
...
[![Python Versions](https://img.shields.io/pypi/pyversions/pipelang.svg)](https://pypi.org/project/pipelang)
[![PyPI Version](https://img.shields.io/pypi/v/pipelang.svg)](https://pypi.org/project/pipelang)

pipelang is an IPython extension that brings a pipe operator `|>` and
...
for R, then you'll be right  at home with pipelang.


## Getting Started

Run the following in IPython or Jupyter to install pipelang and load
the extension:
...
The `%load_ext pipelang` invocation is what enables the new pipe syntax
...
lambda construction: for pipelang, we use `$` to stand in for function arguments
...
pipelang permits *named placeholders* by prefixing `$` to an identifier:
...
thing is that the same name was used -- otherwise pipelang would have
...
step of an pipelang pipeline, this *undetermined pipeline* will represent a function:
...
A natural question is: how does pipelang know what part of the code should
...
## More Examples
I developed pipelang while working on
...
pipelang is not a general purpose functional programming language on top of
...
and Jupyter specifically. In short, pipelang aims to provide simple but powerful
...
appear. pipelang aims to optimize for simplicity, readability / writability, and
...
pipelang draws inspiration largely from
