...
T = TypeVar("T", bound="SemanticSearchContextsResponse200Suggestions")


@_attrs_define
class SemanticSearchContextsResponse200Suggestions:
    """
    Attributes:
        related_tags (list[str] | Unset):
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        semantic_search_contexts_response_200_suggestions = cls(
            related_tags=related_tags,
            workspaces=workspaces,
            tips=tips,
        )

        semantic_search_contexts_response_200_suggestions.additional_properties = d
        return semantic_search_contexts_response_200_suggestions
