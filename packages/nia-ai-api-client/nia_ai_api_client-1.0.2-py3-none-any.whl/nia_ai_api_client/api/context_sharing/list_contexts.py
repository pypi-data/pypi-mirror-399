...
from ...models.list_contexts_response_200 import ListContextsResponse200
...
) -> Error | ListContextsResponse200 | None:
    if response.status_code == 200:
        response_200 = ListContextsResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[Error | ListContextsResponse200]:
    return Response(
