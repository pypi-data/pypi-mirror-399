...
def auto_detect_provider(preferred: Optional[ProviderType] = None) -> ProviderConfig:
    ...
    detection_order = ["openai", "azure", "anthropic", "google", "ollama", "docker"]
    ...
    raise ConfigurationError(
        ...
        "  5. Start Ollama (https://ollama.ai)\n"
        "  6. Enable Docker Model Runner (docker desktop enable model-runner --tcp 12434)"
    )
