...
from haniwers.v1.helpers.validator import validate_threshold_range
from haniwers.v1.helpers.exceptions import InvalidThresholdError
...
class SensorConfig(BaseModel):
    ...
    def validate_center(cls, v):
        ...
        Note (P1-8):
            Uses unified validate_threshold_range() helper from helpers/validator.py
            for consistent validation across config, CLI, and device layers.
        """
        if v is not None:
            try:
                validate_threshold_range(v)
