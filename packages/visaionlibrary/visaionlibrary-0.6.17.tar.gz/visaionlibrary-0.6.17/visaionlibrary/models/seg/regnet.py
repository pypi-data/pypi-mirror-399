...
from mmpretrain.models.backbones.resnext import Bottleneck
from mmcv.cnn import ConvModule


@MODELS.register_module()
class RegNetVisaion(ResNet):
    """RegNet backbone.
    ...
    def _make_stem_layer(self, in_channels, base_channels):
        if self.deep_stem:
            assert self.stem_layers >= 2
            bottleneck_layers = self.stem_layers - 2
            stem = [
                ConvModule(
                    in_channels,
                    base_channels // 2,
