...
public:
    ...
    {
        static_assert(( offsetof( WebsocketHeaderUpdate,m_WebsocketHeaderUpdate_mask) + 0 ) == 64 );
    ...
    {
        static_assert( offsetof( WebsocketHeaderUpdate,m_value ) == 32 );
        static_assert( alignof( std::string ) == 8 );
        static_assert( sizeof( std::string ) == 32 );
...
private:
    ...
    {
        static_assert( offsetof( WebsocketHeaderUpdate, m_WebsocketHeaderUpdate_mask ) == 64 );
    }
};
