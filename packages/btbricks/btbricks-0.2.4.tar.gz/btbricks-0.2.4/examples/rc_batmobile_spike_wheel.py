...
# This code is meant to run a steering wheel, with SPIKE2 firmware.
# and connects to the Batmobile 76112 set
...
# use these import if you have the mpy_robot_tools package installed
# from projects.mpy_robot_tools.ctrl_plus import SmartHub
# from projects.mpy_robot_tools.helpers import PBMotor

# use this import if you have the btbricks package installed
from btbricks import SmartHub
