...
class StreamingGateway:
    ...
    def __init__(
        ...
        # FFmpeg options
        use_ffmpeg: bool = False,          # Use FFmpeg subprocess-based encoding
        ...
        if use_gstreamer and use_ffmpeg:
            raise ValueError("Cannot enable both GStreamer and FFmpeg backends")
