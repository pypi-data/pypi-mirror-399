...
def equirectangular_ray(resolution, extrinsic):
  '''
  Construct input ray for equirectangular unwrapped panoramic camera model
  # Arguments
  ...
  * 18 * `height` * `width`
  ...
  The sample range of ray direction is linear approximated
  '''
