...
from expt_logger.env import get_api_key, get_base_url
...
class Run:
    ...
    def __init__(
        ...
        Args:
            ...
            base_url: Optional base URL (defaults to EXPT_LOGGER_BASE_URL env var or https://expt-platform.vercel.app)
        """
    ...
    def log_rollout(
        ...
        try:
            ...
            logger.warning(f"Command queue full, dropping rollout: {prompt[:50]}...")
