...
def test_readme_example():
    ...
    with patch("expt_logger.Run") as MockRun:
        run_instance = Mock()
        run_instance.experiment_url = "https://expt-platform.vercel.app/experiments/test-id"
        run_instance.base_url = "https://expt-platform.vercel.app"
        MockRun.return_value = run_instance
        ...
        assert url == "https://expt-platform.vercel.app/experiments/test-id"
        assert base == "https://expt-platform.vercel.app"
