...
def api_key(server_available: None) -> str:
    ...
    response = requests.post(
        ...
        json={"name": "Integration Test Key E2E"},
        timeout=5,
    )
...
@pytest.fixture
def cleanup_experiments(api_key: str, base_url: str):
...
@pytest.fixture
def env_with_api_key(api_key: str, monkeypatch):
    """Set API key in environment."""
    monkeypatch.setenv("EXPT_LOGGER_API_KEY", api_key)
...
@pytest.fixture
def fetch_experiment_data(api_key: str, base_url: str):
...
@pytest.fixture
def fetch_scalars(api_key: str, base_url: str):
...
@pytest.fixture
def fetch_rollouts(api_key: str, base_url: str):
...
class TestBasicWorkflow:
    ...
    def test_sequential_runs(
        ...
        # First run
        run1 = expt_logger.init(name="test-run-1", api_key=api_key, base_url=base_url)
        ...
        # Second run
        run2 = expt_logger.init(name="test-run-2", api_key=api_key, base_url=base_url)
...
class TestBufferingAndCommit:
    ...
    def test_buffering_without_commit(
        ...
        run = expt_logger.init(name="test-buffering", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_buffering_last_write_wins(
        ...
        run = expt_logger.init(name="test-last-write", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_commit_true_immediate_flush(
        ...
        run = expt_logger.init(name="test-immediate", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_mixed_commit_patterns(
        ...
        run = expt_logger.init(name="test-mixed", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_batch_scalars_and_rollouts_same_step(
        ...
        run = expt_logger.init(name="test-batch-both", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
...
class TestModeSystem:
    ...
    def test_mode_defaults_to_train(
        ...
        run = expt_logger.init(name="test-default-mode", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_explicit_mode_parameter(
        ...
        run = expt_logger.init(name="test-explicit-mode", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_slash_prefix_detection(
        ...
        run = expt_logger.init(name="test-slash-prefix", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
...
class TestRollouts:
    ...
    def test_log_rollout_basic(
        ...
        run = expt_logger.init(name="test-rollout-basic", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_log_rollout_multiple_rewards(
        ...
        run = expt_logger.init(name="test-rollout-multi-reward", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
...
class TestEnvironmentConfiguration:
    ...
    def test_base_url_from_env(
        ...
        run = expt_logger.init(name="test-env-base-url", api_key=api_key)
        cleanup_experiments.append(run._experiment_id)
...
class TestGracefulShutdown:
    ...
    def test_end_flushes_buffered_data(
        ...
        run = expt_logger.init(name="test-end-flush", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_end_is_idempotent(
        ...
        run = expt_logger.init(name="test-end-idempotent", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
...
class TestStressTesting:
    ...
    def test_rapid_logging_stress(
        ...
        run = expt_logger.init(name="test-stress-rapid", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_large_batch_scalars(
        ...
        run = expt_logger.init(name="test-stress-batch", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
    ...
    def test_large_rollout_messages(
        ...
        run = expt_logger.init(name="test-stress-rollout", api_key=api_key, base_url=base_url)
        cleanup_experiments.append(run._experiment_id)
