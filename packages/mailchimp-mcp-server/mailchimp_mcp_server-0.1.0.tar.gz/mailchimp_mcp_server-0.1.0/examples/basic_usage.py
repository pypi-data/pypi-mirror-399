"""
Basic usage example for Mailchimp MCP Server.
...
Prerequisites:
- Install the package: pip install mailchimp-mcp-server
- Set required environment variables (see .env.example or README.md)
"""

import asyncio
import os
from mailchimp_mcp.server import main


async def example_usage():
    """
    Example usage of Mailchimp MCP Server.

    Make sure to set the required environment variables before running:
    - See the README.md for complete environment variable requirements
    - Copy .env.example to .env and fill in your credentials
    """
    print("Starting Mailchimp MCP Server...")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Mailchimp MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install mailchimp-mcp-server")
