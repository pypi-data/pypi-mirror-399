...
from tpu_mlir.python.utils.mlir_shell import _os_system_log, getstatusoutput_v2
...
class DebugBase:
    ...
    def task_mlir2onnx(self, target_file: str):
        from tpu_mlir.python.utils.mlir_shell import mlir2onnx
...
class DebugMetric(DebugBase):
    ...
    def task_tdb(self, target_file: str, reference_file: str = None):
        ...
        recorder = CommandRecorder(target_file, read=True)
        target = RefFile(**recorder.dic)
        from tpu_mlir.python.tools.tdb import get_tdb
    ...
    def task_bmodel_checker(self, target_file: str):
        ...
        from tpu_mlir.python.tools.bmodel_checker import main
...
class DebugPerformance(DebugBase):
    ...
    def task_simulation(self, target_file: str):
        ...
        from tpu_mlir.python.tools.run_bmprofile import simulation
    ...
    def task_realprofile(self, target_file: str):
        ...
        from tpu_mlir.python.tools.run_bmprofile import bmprofile
    ...
    def task_parse_lglog2table(self, target_file: str):
        ...
        """
        from tpu_mlir.python.tools.logdebug_tool import op_lg_cost, cost_table
