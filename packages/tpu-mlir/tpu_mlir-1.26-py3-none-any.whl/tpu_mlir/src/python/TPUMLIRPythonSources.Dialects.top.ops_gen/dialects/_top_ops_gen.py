...
class A16MatMulOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, weight, scale, zp, bias, *, right_transpose=None, q_group_size=None, weight_bits=None, dq_type=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class ConcatOp(_ods_ir.OpView):
  ...
  def __init__(self, output, inputs, *, axis=None, do_relu=None, relu_limit=None, only_merge=None, round_mode=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class FAttentionOp(_ods_ir.OpView):
  ...
  def __init__(self, output, queries, keys, values, mask, buffer, scale, batch, q_head, kv_head, dim, mq, mk, *, keep_dims=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class GatherOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, indices, *, keepdims=None, axis=None, is_scalar=None, is_lora=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class MatMulOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input, right, bias, *, right_transpose=None, left_transpose=None, output_transpose=None, hdim_is_batch=None, keep_dims=None, do_relu=None, relu_limit=None, is_lora=None, weight_bits=None, in_int4_scale=None, in_int4_zp=None, out_int8_scale=None, out_int8_zp=None, dq_type=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
...
class WeightOp(_ods_ir.OpView):
  ...
  def __init__(self, output, *, scale=None, store_mode=None, allow_split=None, indices_idx=None, indices_slice=None, path=None, do_compress=None, bias0=None, bias1=None, is_signed=None, zero_guard=None, inline_bytes=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if path is not None: attributes["path"] = (path if (
  ...
  @builtins.property
  def path(self):
    if "path" not in self.operation.attributes:
      return None
  ...
  def path(self, value):
    ...
    elif "path" in self.operation.attributes:
      del self.operation.attributes["path"]
...
class RopeOp(_ods_ir.OpView):
  ...
  def __init__(self, output, input1, input2, input3, *, rope_mode=None, is_permute_optimize=None, mul1_round_mode=None, mul2_round_mode=None, add_round_mode=None, mul1_shift=None, mul2_shift=None, add_shift=None, mul1_saturation=None, mul2_saturation=None, add_saturation=None, force_f32=None, loc=None, ip=None):
    operands = []
    results = []
    attributes = {}
    regions = None
    ...
    if rope_mode is not None: attributes["rope_mode"] = (rope_mode if (
        ...
        not _ods_ir.AttrBuilder.contains('RopeModeAttr')) else
          _ods_ir.AttrBuilder.get('RopeModeAttr')(rope_mode, context=_ods_context))
