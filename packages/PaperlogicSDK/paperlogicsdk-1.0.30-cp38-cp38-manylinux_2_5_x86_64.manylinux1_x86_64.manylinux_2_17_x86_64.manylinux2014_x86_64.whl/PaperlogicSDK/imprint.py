...
def prepare_document_imprint(local_imprint_folder, local_tmp_folder, input_file, PDF_PWD, user_info, pki, position):
    ...
    try:
        ...
        sign_left = int(position.get('left', None))
        sign_bottom = int(position.get('bottom', None))
        ...
        width, _, total_pages = _get_page_dimensions(input_file, PDF_PWD, sign_page)
        ...
        return isVisualization, visualize_location, vis_page, local_visfile
