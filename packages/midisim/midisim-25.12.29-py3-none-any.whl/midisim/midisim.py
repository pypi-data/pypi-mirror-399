...
def download_model(repo_id='projectlosangeles/midisim',
                   filename='midisim_small_pre_trained_model_2_epochs_43117_steps_0.3148_loss_0.9229_acc.pth',
                   local_dir='./midisim-models/',
                   verbose=True
                  ):
