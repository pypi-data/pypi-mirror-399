...
@app.route("/")
def home():
    return Titled("Faststrap Custom Themes",
        Container(
                ...
                Section(
                    ...
                    Grid(
                        Div(
                            ...
                            P("The theme now overrides standard Bootstrap colors.", cls="mt-2 text-muted")
                        ),
                        Div(
                            H4("Components"),
                            Badge("Custom Badge", variant="primary", cls="me-1"),
                            Spinner(variant="primary"),
                            Progress(75, variant="primary", striped=True, animated=True, cls="mt-3")
                        )
                    ),
                    cls="p-4"
                )
