...
"""
from fasthtml.common import FastHTML, serve, Div, H1, H2, H5, H6, P, Button as FTButton
from faststrap import (
    add_bootstrap,
    Container, Row, Col, Card, create_theme,
    # New Components
    Table, THead, TBody, TRow, TCell,
    Accordion, AccordionItem,
    ListGroup, ListGroupItem, Collapse,
    Checkbox, Radio, Switch, Range,
    InputGroup, InputGroupText, FloatingLabel, Input,
    Badge, Button
)
...
add_bootstrap(app, theme="orange-sunset", mode="dark",)
            ...
            Col(
                Card(
                    ...
                    Table(
                        ...
                        TBody(
                            TRow(TCell("1"), TCell("Admin"), TCell("Super"), TCell("Active", variant="success")),
                            TRow(TCell("2"), TCell("User"), TCell("Editor"), TCell("Pending", variant="warning")),
                            TRow(TCell("3"), TCell("Guest"), TCell("Viewer"), TCell("Inactive", variant="secondary")),
                        ),
                        bordered=True,
                        responsive=True,
                        small=True
        ...
        Row(
            Col(
                Card(
                     ...
                     Accordion(
                         AccordionItem("This is the first item's body.", title="Accordion Item #1", expanded=True),
        ...
        Row(
            Col(
                Card(
                    ...
                    ListGroup(
                        ...
                        ListGroupItem("With badge", badge=Badge("14", variant="primary", rounded=True)),
                    ),
                    body_cls="p-4"
                ),
                width=12, md=6
            ...
            Col(
                Card(
                    ...
                    Button("Toggle Collapse", variant="primary", data_bs_toggle="collapse", data_bs_target="#demo-collapse", cls="mb-2"),
                    Collapse(
                        Card(body=Div("This content is hidden by default but shown via toggle.", cls="p-3")),
        ...
        Row(
            ...
            Col(
                Card(
                    ...
                    FloatingLabel("float_email", label="Email address", input_type="email", cls="mb-3"),
