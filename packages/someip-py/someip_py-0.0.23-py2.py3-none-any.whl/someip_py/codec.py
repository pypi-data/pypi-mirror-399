...
class Uint16:
    ...
    def deserialize(self, payload):
        ...
        Returns:
            self: The deserialized object.
        """
        (self.value,) = struct.unpack(">H", payload[:2])
        return self
...
class Uint32:
    ...
    def deserialize(self, payload):
        (self.value,) = struct.unpack(">L", payload[:4])
        return self
...
class Uint64:
    ...
    def deserialize(self, payload):
        (self.value,) = struct.unpack(">Q", payload[:8])
        return self
...
class Bool:
    ...
    def deserialize(self, payload):
        ...
        """
        (int_value,) = struct.unpack(">B", payload[:1])
        if int_value == 0:
            self.value = False
        elif int_value == 1:
            self.value = True
...
class Float32:
    ...
    def deserialize(self, payload):
        ...
        The deserialized object is then returned.
        """
        (self.value,) = struct.unpack(">f", payload[:4])
        return self
...
class Float64:
    ...
    def deserialize(self, payload):
        ...
        The deserialized object is then returned.
        """
        (self.value,) = struct.unpack(">d", payload[:8])
        return self
...
class SomeIpPayload:
    ...
    def deserialize(self, payload: bytes):
        ...
        for key, value in ordered_items:
            ...
            pos += len(self.__dict__[key].deserialize(payload[pos:]))
...
class SomeIpDynamicSizeArray(Generic[T]):
    ...
    def __len__(self) -> int:
        ...
        return self.length_field_length + self._total_length
    ...
    def serialize(self) -> bytes:
        ...
        if (
            ...
            length_data_in_bytes = len(self.data) * (self._single_element_length + 4)
        ...
        for element in self.data:
            if hasattr(element, "_include_struct_len") and element._include_struct_len:
                result += struct.pack(">L", len(element))
            result += element.serialize()
        return result
    ...
    def deserialize(self, payload: bytes):
        ...
        remaining = self._total_length = length
        element_length = 0
        # Dynamically parse each element
        while remaining > 0:
            element = self._class_reference()
            if hasattr(element, "_include_struct_len") and element._include_struct_len:
                element_length += 4
                self._total_length += 4

            element.deserialize(remaining_payload)
            element_length = len(element)
            remaining -= element_length
            self.data.append(element)
            remaining_payload = remaining_payload[element_length:]
    ...
    def deserialize(self, payload: bytes):
        ...
        if bom == codecs.BOM_UTF8:
            ...
            try:
                ...
                decoded_string = payload[start_idx:end_idx].hex()
            self.data = decoded_string.rstrip("\0")
        elif bom == codecs.BOM_UTF16_LE:
            self.encoding = "utf-16le"
