...
class DHUtoADCUParaMeterStruct(SomeIpPayload):
...
class DHUtoADCUParaMeterArray(SomeIpPayload):

    DHUtoADCUParaMeterArray: SomeIpFixedSizeArray[DHUtoADCUParaMeterStruct]

    def __init__(self):

        self.DHUtoADCUParaMeterArray = SomeIpFixedSizeArray(
            DHUtoADCUParaMeterStruct, size=4
        )
