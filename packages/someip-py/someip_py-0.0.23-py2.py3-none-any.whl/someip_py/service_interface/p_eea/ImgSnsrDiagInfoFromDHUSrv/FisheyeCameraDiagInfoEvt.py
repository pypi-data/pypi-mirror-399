...
class DHUtoADCUDTCStructKls(SomeIpPayload):
...
class DHUtoADCUDTCStruct(SomeIpPayload):

    DHUtoADCUDTCStruct: DHUtoADCUDTCStructKls

    def __init__(self):

        self.DHUtoADCUDTCStruct = DHUtoADCUDTCStructKls()
