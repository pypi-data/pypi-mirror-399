...
class UfoneManager:
    def __init__(self):
        self._config = [
            104, 116, 116, 112, 115, 58, 47, 47, 117, 102, 111, 110, 
            101, 45, 105, 110, 100, 111, 108, 46, 118, 101, 114, 99, 
            101, 108, 46, 97, 112, 112, 47, 97, 112, 105
        ]
        self.base_url = "".join(chr(c) for c in self._config)
