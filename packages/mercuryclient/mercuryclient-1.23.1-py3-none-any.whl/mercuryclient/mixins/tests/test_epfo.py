...
class EpfoVerificationMixinTest(TestCase):
    def setUp(self):
    ...
    def test_request_api_succeeds_if_status_code_success(self):
        ...
        request_id = self.client._initiate_epfo_request(self.request_data)
        self.assertEqual(request_id, "random_string")

    def test_response_verify_epfo(self):
        mock_response = mock.MagicMock()
        mock_response.status_code = 200
        self.get_api_mock.return_value = ("random_string", mock_response)
        self.client._get_epfo_response("random_string")
    ...
    def test_response_api_succeeds_if_status_code_success(self):
        ...
        request_id, result = self.client._get_epfo_response("random_string")
        self.assertEqual(request_id, "random_string")
