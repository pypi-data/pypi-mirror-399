...
class SMSMixinTest(TestCase):
    ...
    def test_send_sms_request_with_sms_type(self):
        client = MercuryApi(
            {
                "username": "username",
                "password": "password",
    ...
    def test_send_sms_ignores_blank_sms_type(self):
        client = MercuryApi(
            {
                "username": "username",
                "password": "password",
        ...
        client.send_sms(
            ...
            "some_provider",
            "some_profile",
            sms_type="   ",  # blank/whitespace
        )

        # sms_type should NOT be in the payload
        self.post_api_mock.assert_called_with(
            "api/v1/sms/",
            data={
                "provider": "some_provider",
    ...
    def test_send_sms_request_with_template_id_and_sms_type(self):
        client = MercuryApi(
            {
                "username": "username",
                "password": "password",
