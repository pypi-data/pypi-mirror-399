...
class UdyogVerificationMixinTest(TestCase):
    def setUp(self):
        ...
        self.request_data = {
            ...
            "provider": "zoop",
            "udyog_aadhaar": "random_number",
            "consent": True,
        }

    def test_request_udyog_verification(self):
        mock_response = mock.MagicMock()
        mock_response.status_code = 201
        self.post_api_mock.return_value = ("random_string", mock_response)
        self.client.initiate_udyog_verification(self.request_data)

        self.post_api_mock.assert_called_with(
            "api/v1/udyog_aadhaar/verify/",
            data={
                "profile": "some_profile",
                "provider": "zoop",
                "udyog_aadhaar": "random_number",
    ...
    def test_request_api_succeeds_if_status_code_success(self):
        ...
        request_id = self.client.initiate_udyog_verification(self.request_data)
    ...
    def test_response_verify_rc(self):
        ...
        self.client.get_udyog_details("random_string")
    ...
    def test_response_api_succeeds_if_status_code_success(self):
        ...
        request_id, result = self.client.get_udyog_details("random_string")
        self.assertEqual(request_id, "random_string")
