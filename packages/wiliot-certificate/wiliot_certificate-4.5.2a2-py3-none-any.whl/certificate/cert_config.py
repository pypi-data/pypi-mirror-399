...
def backward_compatible_handler(test, pkt_type, brg, **kwargs):
    ...
    if brg.api_version < ag.API_VERSION_V13:
...
def get_default_brg_pkt(test, pkt_type, group_id=ag.GROUP_ID_GW2BRG, seq_id=0, target=DUT, **kwargs):
    ...
    safe_kwargs = backward_compatible_handler(test, pkt_type, brg, **kwargs)
