...
class Evaluation:
    ...
    def _evaluate_data_theta_input(
        ...
        if theta is None:
            theta = self.model.latent_scores(data=data, theta_estimation=theta_estimation, device=ml_map_device, lbfgs_learning_rate=lbfgs_learning_rate)
    ...
    def _get_theta_scores_and_weights(
        ...
        if population_data is None:
            ...
            theta_scores = self.model.latent_scores(population_data, theta_estimation="NN", device=ml_map_device, lbfgs_learning_rate=lbfgs_learning_rate)
