...
class LinearRegression:
    ...
    def residuals_plot(self, cmap: str):
        ...
        ax2.axvline(mean_residual, color='orange', linestyle=':', linewidth=2.5, label=f'Mean Error ({mean_residual:.3f})')
    ...
    def predictions_vs_actuals_plot(self, cmap: str):
        """
        ...
        plt.title("Predicted vs Actual Values (Color = Error Magnitude)")
