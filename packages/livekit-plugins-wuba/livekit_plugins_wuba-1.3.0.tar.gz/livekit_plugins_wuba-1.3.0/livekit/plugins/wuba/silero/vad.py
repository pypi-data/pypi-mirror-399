                ...
                if p >= self._opts.activation_threshold:
                    ...
                    if not pub_speaking:
                        if speech_threshold_duration >= self._opts.min_speech_duration:
                            ...
                            self._vad.speech_start_at = time.time()
                            logger.info(
                                "speech start",
                                extra={"start timestamp": self._vad.speech_start_at},
                            )
                    ...
                    if (
                        ...
                        self._vad.speech_end_at = time.time()
                        logger.info(
                            "speech end",
                            extra={
                                "end timestamp": self._vad.speech_end_at,
                            },
                        )
                        _reset_write_cursor()
