...
**[Installation](#-installation) • [Quick Start](#-quick-start) • [Changelog](#-changelog) • [Commands](#-commands) • [Examples](#-examples)**
...
- **v0.2.1**: Added branding display and improved connection status messages
- **v0.2.0**: Custom startup banner with ASCII art and company branding
- **v0.1.9**: Fixed missing psutil dependency for system info display
- **v0.1.8**: Initial release with full CLI functionality
