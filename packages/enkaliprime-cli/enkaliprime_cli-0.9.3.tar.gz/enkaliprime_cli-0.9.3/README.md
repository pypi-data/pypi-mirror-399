...
**[Installation](#-installation) • [Quick Start](#-quick-start) • [Commands](#-commands) • [Examples](#-examples) • [Changelog](#-changelog)**
...
- **🎯 Project Planning**: AI creates detailed implementation plans with tasks, files, and dependencies
- **📁 File Operations**: Safe creation, editing, and reading of project files
- **📊 Progress Tracking**: Visual progress indicators and task completion tracking
- **🔒 Security**: All file operations are sandboxed within your project directory
- **🤖 AI Assistance**: Specialized coding AI with best practices and modern conventions
...
- **📋 Task Breakdown**: Logical separation of work into manageable tasks
- **📄 File Specifications**: Exact files needed for each task
...
- **🗂️ Sandboxed**: Operations limited to project directory
- **💾 Backup**: Existing files require confirmation before overwrite
...
- ❌ Removed all spinner animations and loading indicators
...
- 📋 Interactive menu for multi-code-block responses
- 🔧 Cross-platform clipboard support with pyperclip

#### v0.7.2 - Global Default Model
- 🎯 Single command to set default from ALL available models
- 🤖 Automatic provider selection (local/cloud/remote)
- ⚙️ No flags needed - just chat normally

#### v0.7.0 - Ollama Cloud Support
- ☁️ Access large AI models without local hardware
- 🔑 Secure API key management for ollama.com
- 🚀 Models like GPT-OSS 120B available instantly

#### v0.6.0 - AI Behavior Customization
- 🎭 Custom system prompts and AI personalities
- 🧠 Different behaviors for different providers
- 🔄 Reset to defaults anytime

#### v0.5.0 - Local Ollama Integration
- 🏠 Full local LLM support with Ollama
- 💰 Zero API costs for local inference
