...
from .commands.chat import provider_manager, SERVICE_NAME, create_client
...
class CodingAssistant:
    ...
    def _create_client(self):
        ...
        client = provider_manager.create_client(model=self.model)

        # Apply coding system prompt
    ...
    def start_session(self):
        ...
        console.clear()
        Header.draw(agent_name=f"{self.agent_name} - Coding Mode")

        console.print(cyber_panel(
            f"Welcome to [bold {COLOR_ACCENT}]Coding Assistant Mode[/]!\n\n"
            "🎯 [bold]Capabilities:[/]\n"
            ...
            "• 'create <file>' - Create/edit a file\n"
        ...
        console.print(f"\n[dim]Type 'help' for commands or start with 'plan <your project idea>'[/]")
    ...
    def show_help(self):
        ...
        help_panel = Panel(
            ...
            "📝 [cyan]create <file>[/] - Create or edit a file\n"
