...
class CodingAssistant:
    ...
    def generate_code_for_description(self, description: str):
        ...
        Create a modern, production-ready implementation with proper folder structure.
        Format your response with directory paths for organized file structure:
        ...
        ## ProjectName/data/products.json
        ```json
        // product data here
        ```

        Use appropriate subdirectories (css/, js/, images/, data/, etc.) for organization.
        Include ALL necessary files with proper paths and make it immediately runnable.
        Create a complete, well-organized project structure.
        """
