...
Example:
    ...
    >>>
    >>> # Or check if enabled
    >>> from tenro.debug import is_trace_enabled
    >>> if is_trace_enabled():
...
from tenro.debug.config import TraceConfig, get_trace_config, is_trace_enabled
from tenro.debug.renderer import TraceRenderer
