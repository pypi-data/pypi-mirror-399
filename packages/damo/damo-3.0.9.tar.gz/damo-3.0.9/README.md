...
![masim stairs heatmap in ascii](https://raw.githubusercontent.com/damonitor/damo/v3.0.9/images/masim_stairs_heatmap_ascii.png)
...
For more detailed usage, please refer to [USAGE.md](https://github.com/damonitor/damo/blob/v3.0.9/USAGE.md) file.
...
In short, features that documented on [USAGE.md](https://github.com/damonitor/damo/blob/v3.0.9/USAGE.md) and not explicitly
