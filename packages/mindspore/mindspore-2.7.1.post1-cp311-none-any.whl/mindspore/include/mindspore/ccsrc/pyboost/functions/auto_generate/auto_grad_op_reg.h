...
enum class OpType {
  ...
  kReluGrad = 317,
  kDivs = 318,
  kAdaptiveMaxPool1D = 319,
  kSwiglu = 320,
  kNanToNum = 321,
  kAllGatherMatmul = 322,
  kNLLLoss = 323,
  kReflectionPad2D = 324,
  kInplaceErfinv = 325,
  kToDtype = 326,
  kLinalgQr = 327,
  kMoeTokenPermute = 328,
  kDivMods = 329,
  kRandnLike = 330,
  kReshape = 331,
  kIndexFillScalar = 332,
  kFullLike = 333,
  kMla = 334,
  kInplaceTanh = 335,
  kRandIntLike = 336,
  kInplaceRemainderTensorScalar = 337,
  kFloorDivScalar = 338,
  kMaskedSelect = 339,
  kSpeedFusionAttention = 340,
  kInplaceMuls = 341,
  kInplaceReLU = 342,
  ...
  kDropoutGradExt = 345,
  kHSwishGrad = 346,
  kL1LossBackwardExt = 347,
  kBroadcastToView = 348,
  kOuter = 349,
  kCumsumExt = 350,
  kClampScalar = 351,
  kNormalFloatFloat = 352,
  kIndex = 353,
  kTopkExt = 354,
  kArgMinWithValue = 355,
  kXlogy = 356,
  kSquare = 357,
  kBinaryCrossEntropyWithLogitsBackward = 358,
  kXLogYScalarOther = 359,
  kBroadcastTo = 360,
  kDropoutDoMaskExt = 361,
  kHardtanhGrad = 362,
  kBernoulliExt = 363,
  kBatchNormElemtGrad = 364,
  kMaxPoolWithIndices = 365,
  kLessEqual = 366,
  kInplaceRemainderTensorTensor = 367,
  kReplicationPad3D = 368,
  kInplaceFillScalar = 369,
  kSoftplusExt = 370,
  kAddLayerNormGrad = 371,
  kFlattenExt = 372,
  kSplit = 372,
  kExpandAs = 373,
  kNewOnes = 373,
  kLeakyReLUGradExt = 374,
  kScatterValue = 375,
  kSortExt = 376,
  kAdaptiveAvgPool3DExt = 377,
  kConv3DExt = 378,
  kIncreFlashAttention = 379,
  kMaxUnpool2DExt = 380,
  kInplaceIndexPut = 381,
  kHSigmoidGrad = 382,
  kFlashAttentionScoreGrad = 383,
  kAcoshExt = 384,
  kMoeDistributeCombine = 385,
  kMeanExt = 386,
  kZeros = 387,
  kInplaceAddsExt = 388,
  kConvolutionStr = 389,
  ...
  kSubExt = 393,
  kRandInt = 394,
  kInplaceBernoulliTensor = 395,
  kBitwiseAndTensor = 396,
  kInplaceIndexAddExt = 397,
  kAdd = 398,
  kNLLLoss2d = 399,
  kInplaceScatterValueReduce = 400,
  kLogicalOr = 401,
  kTake = 402,
  kSub = 403,
  kAtanh = 404,
  ...
  kTraceExt = 406,
  kInplaceSiLU = 407,
  kPromptFlashAttention = 408,
  kCross = 409,
  kUnstackExtView = 410,
  kInplaceNormal = 411,
  kMm = 412,
  kIndexSelect = 413,
  kTriangularSolve = 414,
  kIsNegInf = 415,
  kCol2ImGrad = 416,
  kConvolutionStrGrad = 417,
  kFFNExt = 418,
  kAdaptiveAvgPool1D = 419,
  kCast = 420,
  kMishExt = 421,
  kDiagExt = 422,
  kInplaceScatterValue = 423,
  kRemainderTensorTensor = 424,
  kLerpScalar = 425,
  kCellBackwardHook = 426,
  kLogicalXor = 427,
  kMeshgrid = 428,
  kUpsampleNearest2D = 428,
  kConvTranspose2D = 429,
  kUniqueDim = 430,
  kInplaceStopGradient = 431,
  kReverseV2 = 432,
  kReduceAll = 433,
  ...
  kCos = 436,
  kTan = 437,
  kMoeDistributeDispatch = 438,
  kReplicationPad2D = 439,
  kBaddbmm = 440,
  kMSELossGradExt = 441,
  kUpsampleNearest1D = 442,
  kUpsampleLinear1D = 443,
  kLogSoftmax = 444,
  kUpsampleBilinear2DGrad = 445,
  kSoftmaxBackward = 446,
  kInplaceFillDiagonal = 447,
  kStackExt = 448,
  kMuls = 449,
  kUpsampleNearest3D = 450,
  kTile = 451,
  kAdaptiveMaxPool2D = 452,
  kUpsampleBicubic2D = 453,
  kBitwiseXorTensor = 454,
  kNarrowView = 455,
  kMax = 456,
  kInplaceIndexFillTensor = 457,
  kEmbedding = 458,
  kIndexAddExt = 459,
  kMul = 460,
  kSelect = 461,
  kBCEWithLogitsLoss = 462,
  kConv3DPadding = 463,
  kMultiScaleDeformableAttnGrad = 464,
  kGatherD = 465,
  kNansum = 466,
  kGreaterEqualScalar = 467,
  kIsClose = 468,
  kInplaceMaskedFillScalar = 469,
  kBatchNormGradExt = 470,
  kInplaceFillTensor = 471,
  kExp2 = 472,
  kInplaceGroupedMatmulAdd = 473,
  kUpsampleTrilinear3D = 474,
  kOneHotExt = 475,
  kMaxDim = 476,
  kDot = 477,
  kSmoothL1LossGrad = 478,
  kReflectionPad2DGrad = 479,
  kScatter = 480,
  kMaxPoolGradWithMask = 481,
  kGcd = 482,
  kView = 483,
  kSoftShrink = 484,
  kSplitTensor = 485,
  kAbs = 486,
  kUpsampleNearest1DGrad = 487,
  kFloorDiv = 488,
  kLogSoftmaxGrad = 489,
  kSumExt = 490,
  kArgMaxWithValue = 491,
  kAvgPool2D = 492,
  kContiguous = 493,
  kRepeatInterleaveGrad = 494,
  kTriu = 495,
  kRandpermExt = 496,
  kMoeTokenUnpermuteGrad = 497,
  kAddLayerNormV2 = 498,
  kQuantV2 = 499,
  kMoeInitRouting = 500,
  kGroupedMatmulV4 = 501,
  kMatmulAllReduceAddRmsNorm = 502,
  kKVCacheScatterUpdate = 503,
  kMoeInitRoutingV2 = 504,
  kMoeComputeExpertTokens = 505,
  kQuantMatmul = 506,
  kMoeInitRoutingQuantV2 = 507,
  kAddRmsNormQuantV2 = 508,
  kQuantBatchMatmul = 509,
  kMoeFinalizeRouting = 510,
  kFusedInferAttentionScore = 511,
  kMoeGatingTopKSoftmax = 512,
  kGroupedMatmul = 513,
  kWeightQuantBatchMatmul = 514,
  kGroupedMatmulV2 = 515,
  kDynamicQuantExt = 516,
  kDistCommScatterTensor = 517,
  kDistCommAllToAllVC = 518,
  kDistCommAllGatherIntoTensorUneven = 519,
  kDistCommBarrier = 520,
  kInnerCommAllToAllV = 521,
  kDistCommGather = 522,
  kDistCommBroadcast = 523,
  kDistCommAllToAllV = 524,
  kDistCommReduceScatterTensorUneven = 525,
  kDistCommGatherIntoTensor = 526,
  kDistCommIrecv = 527,
  kDistCommAllReduce = 528,
  kInnerCommReduceScatter = 529,
  kDistCommReduce = 530,
  kInnerCommIsend = 531,
  kDistCommIsend = 532,
  kDistCommScatter = 533,
  kDistCommReduceScatter = 534,
  kDistCommBatchIsendIrecv = 535,
  kInnerCommAllGather = 536,
  kInnerCommAllReduce = 537,
  kDistCommReduceScatterTensor = 538,
  kDistCommAllToAllVSingle = 539,
  kDistCommAllGatherIntoTensor = 540,
  kDistCommAllGather = 541,
  kInnerCommIrecv = 542,
  kAnyExt = 543,
  kGmmV2 = 544,
  kEinsumExt = 545,
  ...
  kAny = 551,
  kFuncMaxPool2D = 552,
  kGmmBackwardFusion = 553,
  kGmmV2BackwardFusion = 554,
  kMoeTokenUnpermute = 555,
