...
def test_text_log_entry_with_tokens():
    ...
    assert log_dict["cache_creation_input_tokens"] == 100
    assert log_dict["cache_read_input_tokens"] == 50
...
def test_text_log_entry_without_tokens():
    ...
    assert log_dict["cache_creation_input_tokens"] is None
    assert log_dict["cache_read_input_tokens"] is None
...
def test_audio_log_entry_with_tokens():
    ...
    assert log_dict["cache_creation_input_tokens"] == 80
    assert log_dict["cache_read_input_tokens"] == 20
...
def test_image_log_entry_with_tokens():
    ...
    assert log_dict["cache_creation_input_tokens"] == 40
    assert log_dict["cache_read_input_tokens"] == 10
...
def test_vector_log_entry_with_tokens():
    ...
    assert log_dict["cache_creation_input_tokens"] == 0
    assert log_dict["cache_read_input_tokens"] == 25
