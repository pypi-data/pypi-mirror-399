...
class DatabaseManager:
    ...
    def _get_text_log_schema(self):
        ...
        return [
            ...
            bigquery.SchemaField("cache_creation_input_tokens", "INT64", mode="NULLABLE", description="快取建立輸入 token 數量"),
            bigquery.SchemaField("cache_read_input_tokens", "INT64", mode="NULLABLE", description="快取讀取輸入 token 數量"),
