...
> **Note**: While this tool provides point-in-time compliance assessments, we strongly encourage customers to use [AWS Config](https://aws.amazon.com/config/) as their ongoing assessment service for continuous compliance monitoring, automated remediation, and real-time configuration tracking.
