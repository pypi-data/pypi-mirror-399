...
transcode(
    input_file="../dump/testv0.0.7/stay1.ts", output_file="../dump/testv0.0.7/stay1.mkv",
    ...
    mute=False, debug=False, overwrite=False, thread_count=3, thread_type="SLICE", loop=3
)