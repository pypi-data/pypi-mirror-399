export const __webpack_id__="1454";export const __webpack_ids__=["1454"];export const __webpack_modules__={55124:function(t,e,a){a.d(e,{d:()=>i});const i=t=>t.stopPropagation()},2173:function(t,e,a){a.a(t,(async function(t,i){try{a.r(e),a.d(e,{HaFormOptionalActions:()=>_});var o=a(62826),s=a(96196),c=a(77845),d=a(22786),n=a(55124),h=a(89473),p=(a(56565),a(60961),a(91120),t([h]));h=(p.then?(await p)():p)[0];const l="M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z",r=[];class _ extends s.WF{async focus(){await this.updateComplete,this.renderRoot.querySelector("ha-form")?.focus()}updated(t){if(super.updated(t),t.has("data")){const t=this._displayActions??r,e=this._hiddenActions(this.schema.schema,t);this._displayActions=[...t,...e.filter((t=>t in this.data))]}}render(){const t=this._displayActions??r,e=this._displaySchema(this.schema.schema,this._displayActions??[]),a=this._hiddenActions(this.schema.schema,t),i=new Map(this.computeLabel?this.schema.schema.map((t=>[t.name,t])):[]);return s.qy`
      ${e.length>0?s.qy`
            <ha-form
              .hass=${this.hass}
              .data=${this.data}
