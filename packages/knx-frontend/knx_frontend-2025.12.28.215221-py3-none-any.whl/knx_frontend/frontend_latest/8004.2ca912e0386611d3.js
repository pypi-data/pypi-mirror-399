export const __webpack_id__="8004";export const __webpack_ids__=["8004"];export const __webpack_modules__={42256:function(e,t,i){i.d(t,{I:()=>o});class s{addFromStorage(e){if(!this._storage[e]){const t=this.storage.getItem(e);t&&(this._storage[e]=JSON.parse(t))}}subscribeChanges(e,t){return this._listeners[e]?this._listeners[e].push(t):this._listeners[e]=[t],()=>{this.unsubscribeChanges(e,t)}}unsubscribeChanges(e,t){if(!(e in this._listeners))return;const i=this._listeners[e].indexOf(t);-1!==i&&this._listeners[e].splice(i,1)}hasKey(e){return e in this._storage}getValue(e){return this._storage[e]}setValue(e,t){const i=this._storage[e];this._storage[e]=t;try{void 0===t?this.storage.removeItem(e):this.storage.setItem(e,JSON.stringify(t))}catch(s){}finally{this._listeners[e]&&this._listeners[e].forEach((e=>e(i,t)))}}constructor(e=window.localStorage){this._storage={},this._listeners={},this.storage=e,this.storage===window.localStorage&&window.addEventListener("storage",(e=>{e.key&&this.hasKey(e.key)&&(this._storage[e.key]=e.newValue?JSON.parse(e.newValue):e.newValue,this._listeners[e.key]&&this._listeners[e.key].forEach((t=>t(e.oldValue?JSON.parse(e.oldValue):e.oldValue,this._storage[e.key]))))}))}}const a={};function o(e){return(t,i)=>{if("object"==typeof i)throw new Error("This decorator does not support this compilation type.");const o=e.storage||"localStorage";let n;o&&o in a?n=a[o]:(n=new s(window[o]),a[o]=n);const r=e.key||String(i);n.addFromStorage(r);const d=!1!==e.subscribe?e=>n.subscribeChanges(r,((t,s)=>{e.requestUpdate(i,t)})):void 0,l=()=>n.hasKey(r)?e.deserializer?e.deserializer(n.getValue(r)):n.getValue(r):void 0,h=(t,s)=>{let a;e.state&&(a=l()),n.setValue(r,e.serializer?e.serializer(s):s),e.state&&t.requestUpdate(i,a)},c=t.performUpdate;if(t.performUpdate=function(){this.__initialized=!0,c.call(this)},e.subscribe){const e=t.connectedCallback,i=t.disconnectedCallback;t.connectedCallback=function(){e.call(this);const t=this;t.__unbsubLocalStorage||(t.__unbsubLocalStorage=d?.(this))},t.disconnectedCallback=function(){i.call(this);this.__unbsubLocalStorage?.(),this.__unbsubLocalStorage=void 0}}const p=Object.getOwnPropertyDescriptor(t,i);let _;if(void 0===p)_={get(){return l()},set(e){(this.__initialized||void 0===l())&&h(this,e)},configurable:!0,enumerable:!0};else{const e=p.set;_={...p,get(){return l()},set(t){(this.__initialized||void 0===l())&&h(this,t),e?.call(this,t)}}}Object.defineProperty(t,i,_)}}},48206:function(e,t,i){var s=i(62826),a=i(96196),o=i(77845),n=i(94333),r=i(9477),d=i(45369),l=i(98320),h=i(10234);class c{get active(){return this._active}get sampleRate(){return this._context?.sampleRate}static get isSupported(){return window.isSecureContext&&(window.AudioContext||window.webkitAudioContext)}async start(){if(this._context&&this._stream&&this._source&&this._recorder)this._stream.getTracks()[0].enabled=!0,await this._context.resume(),this._active=!0;else try{await this._createContext()}catch(e){console.error(e),this._active=!1}}async stop(){this._active=!1,this._stream&&(this._stream.getTracks()[0].enabled=!1),await(this._context?.suspend())}close(){this._active=!1,this._stream?.getTracks()[0].stop(),this._recorder&&(this._recorder.port.onmessage=null),this._source?.disconnect(),this._context?.close(),this._stream=void 0,this._source=void 0,this._recorder=void 0,this._context=void 0}async _createContext(){const e=new(AudioContext||webkitAudioContext);this._stream=await navigator.mediaDevices.getUserMedia({audio:!0}),await e.audioWorklet.addModule(new URL(i(12889),i.b)),this._context=e,this._source=this._context.createMediaStreamSource(this._stream),this._recorder=new AudioWorkletNode(this._context,"recorder-worklet"),this._recorder.port.onmessage=e=>{this._active&&this._callback(e.data)},this._active=!0,this._source.connect(this._recorder)}constructor(e){this._active=!1,this._callback=e}}var p=i(62001);i(17963),i(28089),i(78740);class _ extends a.WF{willUpdate(e){this.hasUpdated&&!e.has("pipeline")||(this._conversation=[{who:"hass",text:this.hass.localize("ui.dialogs.voice_command.how_can_i_help")}])}firstUpdated(e){super.firstUpdated(e),this.startListening&&this.pipeline&&this.pipeline.stt_engine&&c.isSupported&&this._toggleListening(),setTimeout((()=>this._messageInput.focus()),0)}updated(e){super.updated(e),e.has("_conversation")&&this._scrollMessagesBottom()}disconnectedCallback(){super.disconnectedCallback(),this._audioRecorder?.close(),this._unloadAudio()}render(){const e=!!this.pipeline&&(this.pipeline.prefer_local_intents||!this.hass.states[this.pipeline.conversation_engine]||(0,r.$)(this.hass.states[this.pipeline.conversation_engine],l.ZE.CONTROL)),t=c.isSupported,i=this.pipeline?.stt_engine&&!this.disableSpeech;return a.qy`
      <div class="messages">
        ...
        ${this._conversation.map((e=>a.qy`
            <ha-markdown
              class="message ${(0,n.H)({error:!!e.error,[e.who]:!0})}"
              breaks
              cache
              .content=${e.text}
            >
        ...
        >
          <div slot="trailingIcon">
            ${this._showSendButton||!i?a.qy`
                ...
                `:a.qy`
                  ${this._audioRecorder?.active?a.qy`
                        <div class="bouncer">
  ...
  `,(0,s.__decorate)([(0,o.MZ)()],r.prototype,"corner",void 0),(0,s.__decorate)([(0,o.MZ)({attribute:"menu-corner"})],r.prototype,"menuCorner",void 0),(0,s.__decorate)([(0,o.MZ)({type:Number})],r.prototype,"x",void 0),(0,s.__decorate)([(0,o.MZ)({type:Number})],r.prototype,"y",void 0),(0,s.__decorate)([(0,o.MZ)({type:Boolean})],r.prototype,"multi",void 0),(0,s.__decorate)([(0,o.MZ)({type:Boolean})],r.prototype,"activatable",void 0),(0,s.__decorate)([(0,o.MZ)({type:Boolean})],r.prototype,"disabled",void 0),(0,s.__decorate)([(0,o.MZ)({type:Boolean})],r.prototype,"fixed",void 0),(0,s.__decorate)([(0,o.MZ)({type:Boolean,attribute:"no-anchor"})],r.prototype,"noAnchor",void 0),(0,s.__decorate)([(0,o.P)("ha-menu",!0)],r.prototype,"_menu",void 0),r=(0,s.__decorate)([(0,o.EM)("ha-button-menu")],r)},28959:function(e,t,i){i.a(e,(async function(e,s){try{i.r(t),i.d(t,{HaVoiceCommandDialog:()=>f});var a=i(62826),o=i(96196),n=i(77845),r=i(42256),d=i(92542),l=i(55124),h=(i(17963),i(48206),i(89473)),c=(i(16857),i(95637),i(86451),i(60733),i(56565),i(89600)),p=i(45369),_=i(39396),u=i(62001),g=e([h,c]);[h,c]=g.then?(await g)():g;const m="M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z",v="M19,6.41L17.59,5L12,10.59L6.41,5L5,6.41L10.59,12L5,17.59L6.41,19L12,13.41L17.59,19L19,17.59L13.41,12L19,6.41Z",b="M11,18H13V16H11V18M12,2A10,10 0 0,0 2,12A10,10 0 0,0 12,22A10,10 0 0,0 22,12A10,10 0 0,0 12,2M12,20C7.59,20 4,16.41 4,12C4,7.59 7.59,4 12,4C16.41,4 20,7.59 20,12C20,16.41 16.41,20 12,20M12,6A4,4 0 0,0 8,10H10A2,2 0 0,1 12,8A2,2 0 0,1 14,10C14,12 11,11.75 11,15H13C13,12.75 16,12.5 16,10A4,4 0 0,0 12,6Z",y="M12,17.27L18.18,21L16.54,13.97L22,9.24L14.81,8.62L12,2L9.19,8.62L2,9.24L7.45,13.97L5.82,21L12,17.27Z";class f extends o.WF{async showDialog(e){await this._loadPipelines();const t=this._pipelines?.map((e=>e.id))||[];"preferred"===e.pipeline_id||"last_used"===e.pipeline_id&&!this._pipelineId?this._pipelineId=this._preferredPipeline:["last_used","preferred"].includes(e.pipeline_id)||(this._pipelineId=e.pipeline_id),this._pipelineId&&!t.includes(this._pipelineId)&&(this._pipelineId=this._preferredPipeline),this._startListening=e.start_listening,this._opened=!0}async closeDialog(){this._opened=!1,this._pipelines=void 0,(0,d.r)(this,"dialog-closed",{dialog:this.localName})}render(){return this._opened?o.qy`
      <ha-dialog
        open
      ...
      >
        <ha-dialog-header slot="heading">
          ...
          <div slot="title">
            ...
            >
              ...
              ${this._pipelines?this._pipelines?.map((e=>o.qy`<ha-list-item
                      ...
                      >
                        ${e.name}${e.id===this._preferredPipeline?o.qy`
                              <ha-svg-icon
                                slot="meta"
                                .path=${y}
                              ></ha-svg-icon>
                            `:o.s6}
                      </ha-list-item>`)):o.qy`<div class="pipelines-loading">
                    <ha-spinner size="small"></ha-spinner>
                  </div>`}
              ${this.hass.user?.is_admin?o.qy`<li divider role="separator"></li>
        ...
        ${this._errorLoadAssist?o.qy`<ha-alert alert-type="error">
              ...
              `:o.qy`<div class="pipelines-loading">
                <ha-spinner size="large"></ha-spinner>
              </div>`}
      </ha-dialog>
    `:o.s6}willUpdate(e){(e.has("_pipelineId")||e.has("_opened")&&!0===this._opened&&this._pipelineId)&&this._getPipeline()}async _loadPipelines(){if(this._pipelines)return;const{pipelines:e,preferred_pipeline:t}=await(0,p.nx)(this.hass);this._pipelines=e,this._preferredPipeline=t||void 0}async _selectPipeline(e){this._pipelineId=e.currentTarget.pipeline,await this.updateComplete}async _getPipeline(){this._pipeline=void 0,this._errorLoadAssist=void 0;const e=this._pipelineId;try{const t=await(0,p.mp)(this.hass,e);e===this._pipelineId&&(this._pipeline=t)}catch(t){if(e!==this._pipelineId)return;"not_found"===t.code?this._errorLoadAssist="not_found":(this._errorLoadAssist="unknown",console.error(t))}}static get styles(){return[_.nA,o.AH`
        ha-dialog {
      ...
      `]}constructor(...e){super(...e),this._opened=!1,this._startListening=!1}}(0,a.__decorate)([(0,n.MZ)({attribute:!1})],f.prototype,"hass",void 0),(0,a.__decorate)([(0,n.wk)()],f.prototype,"_opened",void 0),(0,a.__decorate)([(0,n.wk)(),(0,r.I)({key:"AssistPipelineId",state:!0,subscribe:!1})],f.prototype,"_pipelineId",void 0),(0,a.__decorate)([(0,n.wk)()],f.prototype,"_pipeline",void 0),(0,a.__decorate)([(0,n.wk)()],f.prototype,"_pipelines",void 0),(0,a.__decorate)([(0,n.wk)()],f.prototype,"_preferredPipeline",void 0),(0,a.__decorate)([(0,n.wk)()],f.prototype,"_errorLoadAssist",void 0),f=(0,a.__decorate)([(0,n.EM)("ha-voice-command-dialog")],f),s()}catch(m){s(m)}}))},12889:function(e,t,i){e.exports=i.p+"12889.7851236d1a04fd18.js"}};
//# sourceMappingURL=8004.2ca912e0386611d3.js.map