export const __webpack_id__="3488";export const __webpack_ids__=["3488"];export const __webpack_modules__={31747:function(e,t,a){a.a(e,(async function(e,o){try{a.d(t,{T:()=>n});var i=a(22),s=a(22786),r=e([i]);i=(r.then?(await r)():r)[0];const n=(e,t)=>{try{return l(t)?.of(e)??e}catch{return e}},l=(0,s.A)((e=>new Intl.DisplayNames(e.language,{type:"language",fallback:"code"})));o()}catch(n){o(n)}}))},51362:function(e,t,a){a.a(e,(async function(e,o){try{a.d(t,{t:()=>v});var i=a(22),s=a(62826),r=a(96196),n=a(77845),l=a(22786),c=a(92542),d=a(31747),p=a(25749),h=a(13673),u=a(89473),g=a(96943),_=e([i,u,g,d]);[i,u,g,d]=_.then?(await _)():_;const y="M7,10L12,15L17,10H7Z",v=(e,t,a,o)=>{let i=[];if(t){const t=h.P.translations;i=e.map((e=>{let a=t[e]?.nativeName;if(!a)try{a=new Intl.DisplayNames(e,{type:"language",fallback:"code"}).of(e)}catch(o){a=e}return{id:e,primary:a,search_labels:[a]}}))}else o&&(i=e.map((e=>({id:e,primary:(0,d.T)(e,o),search_labels:[(0,d.T)(e,o)]}))));return!a&&o&&i.sort(((e,t)=>(0,p.SH)(e.primary,t.primary,o.language))),i};class b extends r.WF{firstUpdated(e){super.firstUpdated(e),this._computeDefaultLanguageOptions()}_computeDefaultLanguageOptions(){this._defaultLanguages=Object.keys(h.P.translations)}render(){const e=this.value??(this.required&&!this.disabled?this._getItems()[0].id:this.value);return r.qy`
      <ha-generic-picker
        .hass=${this.hass}
      ...
      >
        ${this.buttonStyle?r.qy`<ha-button
            ...
            >
              ...
              <ha-svg-icon slot="end" .path=${y}></ha-svg-icon>
            </ha-button>`:r.s6}
      </ha-generic-picker>
    `}_openPicker(e){e.stopPropagation(),this.genericPicker.open()}_changed(e){e.stopPropagation(),this.value=e.detail.value,(0,c.r)(this,"value-changed",{value:this.value})}constructor(...e){super(...e),this.disabled=!1,this.required=!1,this.nativeName=!1,this.buttonStyle=!1,this.noSort=!1,this.inlineArrow=!1,this._defaultLanguages=[],this._getLanguagesOptions=(0,l.A)(v),this._getItems=()=>this._getLanguagesOptions(this.languages??this._defaultLanguages,this.nativeName,this.noSort,this.hass?.locale),this._getLanguageName=e=>this._getItems().find((t=>t.id===e))?.primary,this._valueRenderer=e=>r.qy`<span slot="headline"
