...
class TestBaseFactorModel:
    ...
    def test_base_factor_model_interface(self):
        ...
        assert hasattr(dfm, 'result')
        assert hasattr(ddfm, 'result')
        assert hasattr(kdfm, 'result')
    ...
    def test_validate_ndarray_with_valid_1d_array(self):
        """Test _validate_ndarray accepts valid 1D numpy array."""
        dfm = DFM()
        arr = np.array([1.0, 2.0, 3.0])
        # Should not raise
        dfm._validate_ndarray(arr, "test_array", 1)
    
    def test_validate_ndarray_with_valid_2d_array(self):
        """Test _validate_ndarray accepts valid 2D numpy array."""
        dfm = DFM()
        arr = np.array([[1.0, 2.0], [3.0, 4.0]])
        # Should not raise
        dfm._validate_ndarray(arr, "test_array", 2)
    
    def test_validate_ndarray_with_non_numpy_array(self):
        """Test _validate_ndarray raises DataValidationError for non-numpy array."""
        dfm = DFM()
    ...
    def test_validate_ndarray_with_wrong_ndim(self):
        """Test _validate_ndarray raises DataValidationError for wrong number of dimensions."""
        dfm = DFM()
    ...
    def test_validate_ndarray_with_none(self):
        """Test _validate_ndarray raises DataValidationError for None."""
        dfm = DFM()
        
        with pytest.raises(DataValidationError, match="test_array must be 1D numpy array"):
            dfm._validate_ndarray(None, "test_array", 1)
    
    def test_validate_ndarray_with_scalar(self):
        """Test _validate_ndarray raises DataValidationError for scalar."""
        dfm = DFM()
        scalar = 5.0
        
        with pytest.raises(DataValidationError, match="test_array must be 1D numpy array"):
            dfm._validate_ndarray(scalar, "test_array", 1)
    
    def test_validate_ndarray_with_tuple(self):
        """Test _validate_ndarray raises DataValidationError for tuple."""
        dfm = DFM()
        arr = (1.0, 2.0, 3.0)
    ...
    def test_validate_ndarray_with_3d_array_when_2d_expected(self):
        """Test _validate_ndarray raises DataValidationError for 3D array when 2D expected."""
        dfm = DFM()
