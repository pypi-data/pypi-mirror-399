...
# check_finite_array removed - use validate_finite_array from utils.helper instead
# This function was consolidated into validate_finite_array() which supports both
# validation (raises) and checking (with fallback) modes
