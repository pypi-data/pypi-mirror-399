...
class CandidateCommunicationFileDirectionEnum(int, Enum):
    """
    CandidateCommunicationFileDirectionEnum
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CandidateCommunicationFileDirectionEnum from a JSON string"""
