...
class JobPostingCategoryResponse(BaseModel):
    """
    JobPostingCategory
    """ # noqa: E501
    org_id: Optional[StrictInt] = Field(default=None, description="The Red Rover internal Id of Organization (numeric)", alias="orgId")
    name: Optional[StrictStr] = Field(default=None, description="The name of the JobPostingCategory")
    is_deleted: Optional[StrictBool] = Field(default=None, description="If the JobPostingCategory is deleted", alias="isDeleted")
    external_id: Optional[StrictStr] = Field(default=None, alias="externalId")
    id: Optional[StrictInt] = Field(default=None, description="The primary numeric identifier")
    __properties: ClassVar[List[str]] = ["orgId", "name", "isDeleted", "externalId", "id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of JobPostingCategoryResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of JobPostingCategoryResponse from a dict"""
        if obj is None:
            return None
