...
class TestNewHireResponse(unittest.TestCase):
    """NewHireResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewHireResponse:
        """Test NewHireResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewHireResponse`
        """
        model = NewHireResponse()
        if include_optional:
