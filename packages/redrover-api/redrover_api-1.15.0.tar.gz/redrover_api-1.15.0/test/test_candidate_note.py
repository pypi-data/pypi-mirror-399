...
class TestCandidateNote(unittest.TestCase):
    """CandidateNote unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CandidateNote:
        """Test CandidateNote
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CandidateNote`
        """
        model = CandidateNote()
        if include_optional:
