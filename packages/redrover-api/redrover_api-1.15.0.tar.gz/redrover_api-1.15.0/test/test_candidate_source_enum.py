...
class TestCandidateSourceEnum(unittest.TestCase):
    """CandidateSourceEnum unit test stubs"""
    ...
    def testCandidateSourceEnum(self):
        """Test CandidateSourceEnum"""
        # inst = CandidateSourceEnum()
