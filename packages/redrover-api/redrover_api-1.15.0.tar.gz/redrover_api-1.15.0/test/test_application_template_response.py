...
class TestApplicationTemplateResponse(unittest.TestCase):
    """ApplicationTemplateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationTemplateResponse:
        """Test ApplicationTemplateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationTemplateResponse`
        """
        model = ApplicationTemplateResponse()
        if include_optional:
    ...
    def testApplicationTemplateResponse(self):
        """Test ApplicationTemplateResponse"""
