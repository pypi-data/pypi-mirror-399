...
class AbsenceFileAttachmentResponse(BaseModel):
    """
    AbsenceFileAttachmentResponse
    """ # noqa: E501
    absence_file_attachment_id: Optional[StrictInt] = Field(default=None, alias="absenceFileAttachmentId")
    file_name: Optional[StrictStr] = Field(default=None, alias="fileName")
    __properties: ClassVar[List[str]] = ["absenceFileAttachmentId", "fileName"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AbsenceFileAttachmentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AbsenceFileAttachmentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "absenceFileAttachmentId": obj.get("absenceFileAttachmentId"),
