...
class EmployeeResponse(BaseModel):
    ...
    ignore_ip_restrictions: Optional[StrictBool] = Field(default=None, description="Can this employee clock in from anywhere?", alias="ignoreIPRestrictions")
    ...
    __properties: ClassVar[List[str]] = ["positions", "ignoreIPRestrictions", "orgId", "createdUtc", "changedUtc", "firstName", "middleName", "lastName", "email", "notificationEmail", "loginEmail", "dateOfBirth", "address1", "address2", "city", "state", "postalCode", "country", "phoneNumber", "active", "permissionSetId", "isDeleted", "secondaryIdentifier", "externalId", "id"]
