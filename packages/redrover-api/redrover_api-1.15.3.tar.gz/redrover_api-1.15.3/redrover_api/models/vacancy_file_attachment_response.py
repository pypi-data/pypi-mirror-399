...
class VacancyFileAttachmentResponse(BaseModel):
    """
    VacancyFileAttachmentResponse
    """ # noqa: E501
    vacancy_file_attachment_id: Optional[StrictInt] = Field(default=None, alias="vacancyFileAttachmentId")
    file_name: Optional[StrictStr] = Field(default=None, alias="fileName")
    __properties: ClassVar[List[str]] = ["vacancyFileAttachmentId", "fileName"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VacancyFileAttachmentResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of VacancyFileAttachmentResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "vacancyFileAttachmentId": obj.get("vacancyFileAttachmentId"),
