...
class TestInt32IdNameLocator(unittest.TestCase):
    """Int32IdNameLocator unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Int32IdNameLocator:
        """Test Int32IdNameLocator
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Int32IdNameLocator`
        """
        model = Int32IdNameLocator()
        if include_optional:
            return Int32IdNameLocator(
                name = '',
                external_id = '',
                id = 56
            )
    ...
    def testInt32IdNameLocator(self):
        """Test Int32IdNameLocator"""
