...
class JobPostingCreateResponse(BaseModel):
    """
    JobPosting
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["name", "externalId", "id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of JobPostingCreateResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of JobPostingCreateResponse from a dict"""
        if obj is None:
            return None
