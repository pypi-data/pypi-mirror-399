...
class SubstituteRelatedOrgRequest(BaseModel):
    ...
    active: Optional[StrictBool] = Field(default=None, description="If the Substitute is considered active")
    __properties: ClassVar[List[str]] = ["orgId", "payCode", "attributes", "active"]
