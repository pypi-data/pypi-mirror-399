...
class PositionTypeApi:
    ...
    def get_position_types(
        ...
        page_size: Annotated[Optional[StrictInt], Field(description="Number of Position Types to include per page")] = None,
        ...
        :type page: int
        :param page_size: Number of Position Types to include per page
        :type page_size: int
        ...
        _param = self._get_position_types_serialize(
            org_id=org_id,
            page=page,
            page_size=page_size,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "PositionTypeResponsePagedResponse",
            '401': None,
            '404': None,
            '400': None,
        }
    ...
    @validate_call
    def get_position_types_with_http_info(
        self,
        org_id: Annotated[StrictInt, Field(description="The Red Rover Id of the Organization")],
        page: Annotated[Optional[StrictInt], Field(description="Page number to return")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of Position Types to include per page")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PositionTypeResponsePagedResponse]:
        """Get list of Position Types
    ...
    @validate_call
    def get_position_types_without_preload_content(
        self,
        org_id: Annotated[StrictInt, Field(description="The Red Rover Id of the Organization")],
        page: Annotated[Optional[StrictInt], Field(description="Page number to return")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of Position Types to include per page")] = None,
    ...
    def _get_position_types_serialize(
        self,
        org_id,
        page,
        page_size,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/{orgId}/PositionType',
