...
class UploadAbsenceFileAttachmentRequest(BaseModel):
    """
    UploadAbsenceFileAttachmentRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["ContentType", "ContentDisposition", "Headers", "Length", "Name", "FileName"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UploadAbsenceFileAttachmentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UploadAbsenceFileAttachmentRequest from a dict"""
        if obj is None:
            return None
