...
class CustomListOptionResponse(BaseModel):
    """
    CustomField
    """ # noqa: E501
    label: Optional[StrictStr] = Field(default=None, description="Label of this option")
    id: Optional[StrictInt] = Field(default=None, description="The primary numeric identifier")
    __properties: ClassVar[List[str]] = ["label", "id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CustomListOptionResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CustomListOptionResponse from a dict"""
        if obj is None:
            return None
