...
class TestJobPostingCreateResponse(unittest.TestCase):
    """JobPostingCreateResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPostingCreateResponse:
        """Test JobPostingCreateResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPostingCreateResponse`
        """
        model = JobPostingCreateResponse()
        if include_optional:
    ...
    def testJobPostingCreateResponse(self):
        """Test JobPostingCreateResponse"""
