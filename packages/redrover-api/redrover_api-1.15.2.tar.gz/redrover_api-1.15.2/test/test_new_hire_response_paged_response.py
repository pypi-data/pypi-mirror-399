...
class TestNewHireResponsePagedResponse(unittest.TestCase):
    """NewHireResponsePagedResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> NewHireResponsePagedResponse:
        """Test NewHireResponsePagedResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `NewHireResponsePagedResponse`
        """
        model = NewHireResponsePagedResponse()
        if include_optional:
            return NewHireResponsePagedResponse(
                page = 56,
                page_size = 56,
                total_items = 56,
                total_pages = 56,
                data = [
                    redrover_api.models.new_hire_response.NewHireResponse(
                        first_name = '', 
                        middle_name = '', 
                        last_name = '', 
                        applicant_id = '', 
    ...
    def testNewHireResponsePagedResponse(self):
        """Test NewHireResponsePagedResponse"""
