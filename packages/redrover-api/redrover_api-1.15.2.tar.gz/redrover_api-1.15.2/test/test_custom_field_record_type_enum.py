...
class TestCustomFieldRecordTypeEnum(unittest.TestCase):
    """CustomFieldRecordTypeEnum unit test stubs"""
    ...
    def testCustomFieldRecordTypeEnum(self):
        """Test CustomFieldRecordTypeEnum"""
        # inst = CustomFieldRecordTypeEnum()
