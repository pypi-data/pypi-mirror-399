...
class TestPublishToVendorEnum(unittest.TestCase):
    """PublishToVendorEnum unit test stubs"""
    ...
    def testPublishToVendorEnum(self):
        """Test PublishToVendorEnum"""
        # inst = PublishToVendorEnum()
