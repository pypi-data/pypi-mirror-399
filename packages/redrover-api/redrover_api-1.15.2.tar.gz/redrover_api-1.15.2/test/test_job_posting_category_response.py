...
class TestJobPostingCategoryResponse(unittest.TestCase):
    """JobPostingCategoryResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> JobPostingCategoryResponse:
        """Test JobPostingCategoryResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `JobPostingCategoryResponse`
        """
        model = JobPostingCategoryResponse()
        if include_optional:
            return JobPostingCategoryResponse(
                org_id = 56,
                name = '',
                is_deleted = True,
                external_id = '',
    ...
    def testJobPostingCategoryResponse(self):
        """Test JobPostingCategoryResponse"""
