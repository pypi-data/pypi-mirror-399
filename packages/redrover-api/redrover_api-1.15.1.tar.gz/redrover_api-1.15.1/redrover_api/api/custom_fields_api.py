...
class CustomFieldsApi:
    ...
    def get_custom_fields(
        ...
        record_type: Annotated[Optional[CustomFieldRecordTypeEnum], Field(description="Record Type. Which object do these fields apply to?")] = None,
        page: Annotated[Optional[StrictInt], Field(description="Page number to return")] = None,
        page_size: Annotated[Optional[StrictInt], Field(description="Number of Custom Fields to include per page")] = None,
        ...
        :type org_id: int
        :param record_type: Record Type. Which object do these fields apply to?
        :type record_type: CustomFieldRecordTypeEnum
        :param page: Page number to return
        :type page: int
        :param page_size: Number of Custom Fields to include per page
        :type page_size: int
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CustomFieldResponsePagedResponse",
            '401': None,
            '404': None,
            '400': None,
        }
    ...
    def get_custom_fields_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CustomFieldResponsePagedResponse]:
        """Get list of Custom Fields
    ...
    def _get_custom_fields_serialize(
        ...
        if record_type is not None:
            ...
            _query_params.append(('recordType', record_type.value))
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/v1/{orgId}/CustomField',
