...
class VacancyDetailLocation(BaseModel):
    """
    Contains the Id, ExternalId, and Name
    """ # noqa: E501
    code: Optional[StrictStr] = Field(default=None, description="The code value of the Location")
    name: Optional[StrictStr] = None
    external_id: Optional[StrictStr] = Field(default=None, alias="externalId")
    id: Optional[StrictInt] = Field(default=None, description="The primary numeric identifier")
    __properties: ClassVar[List[str]] = ["code", "name", "externalId", "id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of VacancyDetailLocation from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of VacancyDetailLocation from a dict"""
        if obj is None:
            return None
