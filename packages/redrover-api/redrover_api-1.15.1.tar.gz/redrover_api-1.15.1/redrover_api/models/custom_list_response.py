...
class CustomListResponse(BaseModel):
    ...
    CustomField
    """ # noqa: E501
    options: Optional[List[CustomListOptionResponse]] = None
    name: Optional[StrictStr] = None
    external_id: Optional[StrictStr] = Field(default=None, alias="externalId")
    id: Optional[StrictInt] = Field(default=None, description="The primary numeric identifier")
    __properties: ClassVar[List[str]] = ["options", "name", "externalId", "id"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "options": [CustomListOptionResponse.from_dict(_item) for _item in obj.get("options")] if obj.get("options") is not None else None,
            "name": obj.get("name"),
