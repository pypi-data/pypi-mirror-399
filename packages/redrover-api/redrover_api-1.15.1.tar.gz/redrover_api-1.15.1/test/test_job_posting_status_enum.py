...
class TestJobPostingStatusEnum(unittest.TestCase):
    """JobPostingStatusEnum unit test stubs"""
    ...
    def testJobPostingStatusEnum(self):
        """Test JobPostingStatusEnum"""
        # inst = JobPostingStatusEnum()
