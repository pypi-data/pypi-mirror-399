...
class TestJobPostingTypeEnum(unittest.TestCase):
    """JobPostingTypeEnum unit test stubs"""
    ...
    def testJobPostingTypeEnum(self):
        """Test JobPostingTypeEnum"""
        # inst = JobPostingTypeEnum()
