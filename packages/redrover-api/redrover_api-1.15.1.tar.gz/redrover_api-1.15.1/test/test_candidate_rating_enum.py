...
class TestCandidateRatingEnum(unittest.TestCase):
    """CandidateRatingEnum unit test stubs"""
    ...
    def testCandidateRatingEnum(self):
        """Test CandidateRatingEnum"""
        # inst = CandidateRatingEnum()
