...
class TestCustomListOptionResponse(unittest.TestCase):
    """CustomListOptionResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CustomListOptionResponse:
        """Test CustomListOptionResponse
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CustomListOptionResponse`
        """
        model = CustomListOptionResponse()
        if include_optional:
            return CustomListOptionResponse(
                label = '',
                id = 56
            )
        else:
    ...
    def testCustomListOptionResponse(self):
        """Test CustomListOptionResponse"""
