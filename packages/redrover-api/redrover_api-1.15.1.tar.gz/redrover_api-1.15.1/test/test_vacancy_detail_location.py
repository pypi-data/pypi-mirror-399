...
class TestVacancyDetailLocation(unittest.TestCase):
    """VacancyDetailLocation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> VacancyDetailLocation:
        """Test VacancyDetailLocation
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `VacancyDetailLocation`
        """
        model = VacancyDetailLocation()
        if include_optional:
            return VacancyDetailLocation(
                code = '',
                name = '',
                external_id = '',
                id = 56
    ...
    def testVacancyDetailLocation(self):
        """Test VacancyDetailLocation"""
