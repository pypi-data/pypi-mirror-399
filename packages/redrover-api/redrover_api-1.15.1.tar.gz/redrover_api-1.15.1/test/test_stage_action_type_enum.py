...
class TestStageActionTypeEnum(unittest.TestCase):
    """StageActionTypeEnum unit test stubs"""
    ...
    def testStageActionTypeEnum(self):
        """Test StageActionTypeEnum"""
        # inst = StageActionTypeEnum()
