...
class TestCandidateRating(unittest.TestCase):
    """CandidateRating unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CandidateRating:
        """Test CandidateRating
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CandidateRating`
        """
