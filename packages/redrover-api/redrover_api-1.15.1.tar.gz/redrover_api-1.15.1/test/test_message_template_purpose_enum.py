...
class TestMessageTemplatePurposeEnum(unittest.TestCase):
    """MessageTemplatePurposeEnum unit test stubs"""
    ...
    def testMessageTemplatePurposeEnum(self):
        """Test MessageTemplatePurposeEnum"""
        # inst = MessageTemplatePurposeEnum()
