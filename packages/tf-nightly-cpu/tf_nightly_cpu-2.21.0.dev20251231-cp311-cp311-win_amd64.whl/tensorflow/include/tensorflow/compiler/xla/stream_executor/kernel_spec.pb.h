...
/* @@protoc_insertion_point(class_definition:stream_executor.KernelLoaderSpecProto) */ {
 ...
 public:
  ...
  public:
  // optional .stream_executor.KernelArgumentsPackingSpecProto kernel_args_packing_spec = 5;
  bool has_kernel_args_packing_spec() const;
  void clear_kernel_args_packing_spec() ;
  const ::stream_executor::KernelArgumentsPackingSpecProto& kernel_args_packing_spec() const;
  [[nodiscard]] ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE release_kernel_args_packing_spec();
  ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NONNULL mutable_kernel_args_packing_spec();
  void set_allocated_kernel_args_packing_spec(::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE value);
  void unsafe_arena_set_allocated_kernel_args_packing_spec(::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE value);
  ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE unsafe_arena_release_kernel_args_packing_spec();

  private:
  const ::stream_executor::KernelArgumentsPackingSpecProto& _internal_kernel_args_packing_spec() const;
  ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NONNULL _internal_mutable_kernel_args_packing_spec();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE kernel_args_packing_spec_;
    ::int32_t arity_;
    union PayloadUnion {
...
inline const ::stream_executor::KernelArgumentsPackingSpecProto& KernelLoaderSpecProto::_internal_kernel_args_packing_spec() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  const ::stream_executor::KernelArgumentsPackingSpecProto* p = _impl_.kernel_args_packing_spec_;
  return p != nullptr ? *p : reinterpret_cast<const ::stream_executor::KernelArgumentsPackingSpecProto&>(::stream_executor::_KernelArgumentsPackingSpecProto_default_instance_);
}
inline const ::stream_executor::KernelArgumentsPackingSpecProto& KernelLoaderSpecProto::kernel_args_packing_spec() const ABSL_ATTRIBUTE_LIFETIME_BOUND {
...
inline void KernelLoaderSpecProto::unsafe_arena_set_allocated_kernel_args_packing_spec(
    ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (GetArena() == nullptr) {
    delete reinterpret_cast<::google::protobuf::MessageLite*>(_impl_.kernel_args_packing_spec_);
  }
  _impl_.kernel_args_packing_spec_ = reinterpret_cast<::stream_executor::KernelArgumentsPackingSpecProto*>(value);
  if (value != nullptr) {
...
inline ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE KernelLoaderSpecProto::release_kernel_args_packing_spec() {
  ::google::protobuf::internal::TSanWrite(&_impl_);

  _impl_._has_bits_[0] &= ~0x00000002u;
  ::stream_executor::KernelArgumentsPackingSpecProto* released = _impl_.kernel_args_packing_spec_;
...
inline ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE KernelLoaderSpecProto::unsafe_arena_release_kernel_args_packing_spec() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  // @@protoc_insertion_point(field_release:stream_executor.KernelLoaderSpecProto.kernel_args_packing_spec)

  _impl_._has_bits_[0] &= ~0x00000002u;
  ::stream_executor::KernelArgumentsPackingSpecProto* temp = _impl_.kernel_args_packing_spec_;
  _impl_.kernel_args_packing_spec_ = nullptr;
  return temp;
}
inline ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NONNULL KernelLoaderSpecProto::_internal_mutable_kernel_args_packing_spec() {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  if (_impl_.kernel_args_packing_spec_ == nullptr) {
    auto* p = ::google::protobuf::Message::DefaultConstruct<::stream_executor::KernelArgumentsPackingSpecProto>(GetArena());
    _impl_.kernel_args_packing_spec_ = reinterpret_cast<::stream_executor::KernelArgumentsPackingSpecProto*>(p);
  }
  return _impl_.kernel_args_packing_spec_;
}
inline ::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NONNULL KernelLoaderSpecProto::mutable_kernel_args_packing_spec()
    ABSL_ATTRIBUTE_LIFETIME_BOUND {
  _impl_._has_bits_[0] |= 0x00000002u;
  ::stream_executor::KernelArgumentsPackingSpecProto* _msg = _internal_mutable_kernel_args_packing_spec();
  // @@protoc_insertion_point(field_mutable:stream_executor.KernelLoaderSpecProto.kernel_args_packing_spec)
  return _msg;
}
inline void KernelLoaderSpecProto::set_allocated_kernel_args_packing_spec(::stream_executor::KernelArgumentsPackingSpecProto* PROTOBUF_NULLABLE value) {
