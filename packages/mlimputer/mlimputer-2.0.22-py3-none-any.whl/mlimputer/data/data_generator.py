...
class ImputationDatasetGenerator(BaseDatasetGenerator):
    ...
    def generate(
        ...
        n_samples: int = 1000,
        n_features: int = 20,
        task: Literal['regression', 'binary_classification', 'multiclass_classification'] = 'regression',
        n_classes: int = 3,
    ...
    def _make_multiclass_classification(self, params: Dict[str, Any]) -> Tuple[np.ndarray, np.ndarray]:
    ...
    def quick_multiclass(self, n_samples: int = 1000, n_classes: int = 3, **kwargs) -> Tuple[pd.DataFrame, pd.Series]:
