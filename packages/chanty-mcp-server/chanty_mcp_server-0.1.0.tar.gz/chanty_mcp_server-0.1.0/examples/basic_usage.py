"""
Basic usage example for Chanty MCP Server.
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Chanty MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install chanty-mcp-server")
