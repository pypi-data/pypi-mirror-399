...
class AIModelServingInstance(BaseModel):
    ...
    serving_instance_version: int = Field(default=1, ge=1, description="Version number of this serving instance configuration (1, 2, 3...)")
    serving_instance_metadata_version: int = Field(default=1, ge=1, description="Metadata version for tracking non-breaking changes to this instance (1, 2, 3...)")
    ...
    changelog_history: Optional[Dict[str, str]] = Field(default=None, description="Dictionary with timestamp keys (yyyymmddhhmm, optionally yyyymmddhhmmss for within-minute changes) and change description values documenting evolution of this hosting instance")
    lessons_learned: Optional[Dict[str, str]] = Field(default=None, description="Dictionary with timestamp keys (yyyymmddhhmm, optionally yyyymmddhhmmss for within-minute changes) documenting lessons learned from hosting instance operation and improvements")
