...
class TimeSeriesPredictionStatus(BaseModel):
    ...
    prediction_task_config_id: Optional[str] = Field(default=None, description="Cross-reference ID linking subject, model, and IO format for accurate charging and tracking")
