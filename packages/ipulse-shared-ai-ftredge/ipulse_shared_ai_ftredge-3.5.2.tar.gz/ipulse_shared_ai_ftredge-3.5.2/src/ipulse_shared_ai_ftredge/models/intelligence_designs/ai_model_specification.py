...
class AIModelSpecification(BaseVersionedModel):
    ...
    model_spec_metadata_version: int = Field(default=1, ge=1, description="Metadata version for tracking non-breaking changes to this specification (1, 2, 3...)")
    ...
    target_record_type: Optional[str] = Field(default=None, description="In highly specialized models: record type of this model's targets, e.g., 'eod_adjc', 'intraday_adjc', 'eod_vol'")
    ...
    # Development details
    model_development_framework: Optional[Dict[str, Any]] = Field(default=None, description="Information about the model framework, e.g., {'framework': 'TensorFlow', 'version': '2.14', 'gpu_support': True}.")
    ...
    hyperparameters_schema: Optional[Dict[str, Any]] = Field(default=None, description="The hyperparameters used to train the model, e.g., {'learning_rate': 0.001, 'batch_size': 32, 'epochs': 100}.")
