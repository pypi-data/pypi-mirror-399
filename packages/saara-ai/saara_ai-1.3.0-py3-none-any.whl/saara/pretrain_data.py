...
Expanded text:"""
    ...
    def extract_text_from_pdfs(self, input_path: str, use_ocr: bool = False) -> List[Dict[str, Any]]:
        """
        Extract raw text from PDF files.
        
        Args:
            input_path: Path to PDF file or directory
            use_ocr: Whether to use Vision OCR for extraction
...
def run_pretrain_dataset_wizard(config: dict = None):
    ...
    console.print("\n[bold]Step 3: LLM Enhancement (Optional)[/bold]")
    ...
    if use_llm:
        ...
        console.print("  1. granite4:latest (recommended)")
        console.print("  2. llama3.2:3b")
        console.print("  3. qwen2.5:7b")
        console.print("  4. Other (enter custom)")
    ...
    console.print("\n[bold]Step 5: Output Formats[/bold]")
