...
from langgraph_runtime_firestore import queue
from langgraph_runtime_firestore.database import start_pool, stop_pool
...
async def lifespan(
    ...
    **kwargs: Any,
    ...
    from langgraph_runtime_firestore import (
        __version__ as langgraph_runtime_firestore_version,
    )

    await logger.ainfo(
        f"Starting Firestore runtime with langgraph-api={__version__} and Firestore runtime={langgraph_runtime_firestore_version}",
        version=__version__,
        langgraph_runtime_firestore_version=langgraph_runtime_firestore_version,
    )
    try:
