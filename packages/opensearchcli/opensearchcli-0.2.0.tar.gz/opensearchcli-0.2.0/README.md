...
```
cd existing_repo
git remote add origin https://sbp.gitlab.schubergphilis.com/SaaS/opensearchcli.git
git branch -M main
...
- [ ] [Set up project integrations](https://sbp.gitlab.schubergphilis.com/SaaS/opensearchcli/-/settings/integrations)
