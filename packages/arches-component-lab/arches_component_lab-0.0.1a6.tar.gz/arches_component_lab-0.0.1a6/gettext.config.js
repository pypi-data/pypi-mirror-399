...
module.exports = {
  input: {
    path: "./arches_component_lab/src", // only files in this directory are considered for extraction
  ...
  output: {
    path: "./arches_component_lab/locale", // output path of all created files
