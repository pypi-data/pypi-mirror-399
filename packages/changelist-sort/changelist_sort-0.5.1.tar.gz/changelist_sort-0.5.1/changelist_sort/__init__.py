...
_SORT_FILE_CREATED_MSG = "Sort file created: .changelists/sort.xml"
_SORT_FILE_CREATION_FAILED_MSG = "Failed to create sort.xml file."


def _generate_sort_config():
    from changelist_sort.xml.generator import generate_sort_xml
    if generate_sort_xml(None):
        return _SORT_FILE_CREATED_MSG
    exit(_SORT_FILE_CREATION_FAILED_MSG)
