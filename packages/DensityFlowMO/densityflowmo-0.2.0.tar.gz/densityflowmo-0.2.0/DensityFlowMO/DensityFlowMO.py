...
class DensityFlowMO(nn.Module):
    ...
    def get_rna_codebook(self):
        ...
        """
        cb = self.rna_perturb_model.get_codebook()
        return cb
    
    def rna_codebook_map(self, xs_rna, soft_assign: bool=True, batch_size:int=1024, show_progress=True):
        Z = self.rna_perturb_model.codebook_map(xs_rna, soft_assign=soft_assign, batch_size=batch_size, show_progress=show_progress)
        return Z
    ...
    def get_atac_codebook(self):
        ...
        Return the mean part of metacell codebook
        """
        cb = self.atac_perturb_model.get_codebook()
        return cb
    
    def atac_codebook_map(self, xs_atac, soft_assign: bool=True, batch_size:int=1024, show_progress=True):
        Z = self.atac_perturb_model.codebook_map(xs_atac, soft_assign=soft_assign, batch_size=batch_size, show_progress=show_progress)
        return Z
    
    def get_rna_complete_embedding(self, xs_rna, us, ts, batch_size:int=1024, show_progress=True):
        Z = self.rna_perturb_model.get_complete_embedding(xs_rna, us, ts, batch_size=batch_size, show_progress=show_progress)
        return Z
    
    def get_atac_complete_embedding(self, xs_atac, us, ts, batch_size:int=1024, show_progress=True):
        Z = self.atac_perturb_model.get_complete_embedding(xs_atac, us, ts, batch_size=batch_size, show_progress=show_progress)
        return Z
    ...
    def get_rna_basal_embedding(self, 
        ...
        show_progress: bool
            Verbose on or off
        """
        Z = self.rna_perturb_model.get_basal_embedding(xs_rna,batch_size=batch_size,show_progress=show_progress)
        return Z
    ...
    def get_atac_basal_embedding(self, 
        ...
        show_progress: bool
            Verbose on or off
        """
        Z = self.atac_perturb_model.get_basal_embedding(xs_atac,batch_size=batch_size,show_progress=show_progress)
        return Z
    
    def rna_code(self, xs_rna, batch_size=1024, show_progress=True):
        A = self.rna_perturb_model.code(xs_rna, batch_size=batch_size, show_progress=show_progress)
        return A
    
    def atac_code(self, xs_atac, batch_size=1024, show_progress=True):
        A = self.atac_perturb_model.code(xs_atac, batch_size=batch_size, show_progress=show_progress)
        return A
    ...
    def rna_soft_assignments(self, xs_rna, batch_size=1024, show_progress=True):
        ...
        """
        A = self.rna_perturb_model.soft_assignments(xs_rna, batch_size=batch_size, show_progress=show_progress)
        return A
    ...
    def atac_soft_assignments(self, xs_atac, batch_size=1024, show_progress=True):
        ...
        Map cells to metacells and return the probabilistic values of metacell assignments
        """
        A = self.atac_perturb_model.soft_assignments(xs_atac, batch_size=batch_size, show_progress=show_progress)
        return A
    ...
    def rna_hard_assignments(self, xs_rna, batch_size=1024, show_progress=True):
        ...
        """
        A = self.rna_perturb_model.hard_assignments(xs_rna, batch_size=batch_size, show_progress=show_progress)
        return A
    ...
    def atac_hard_assignments(self, xs_atac, batch_size=1024, show_progress=True):
        ...
        Map cells to metacells and return the assigned metacell identities.
        """
        A = self.atac_perturb_model.hard_assignments(xs_atac, batch_size=batch_size, show_progress=show_progress)
        return A
    ...
    def get_rna_cell_shift(self, 
        ...
        show_progress: bool
            verbose on or off
        """
        Z = self.rna_perturb_model.get_cell_shift(xs_rna, perturb_us, perturb_type, soft_assign=soft_assign, batch_size=batch_size, show_progress=show_progress)
        return Z
    ...
    def get_atac_cell_shift(self, 
        ...
        show_progress: bool
            verbose on or off
        """
        Z = self.atac_perturb_model.get_cell_shift(xs_atac, perturb_us, perturb_type, soft_assign=soft_assign, batch_size=batch_size, show_progress=show_progress)
        return Z
    ...
    def get_rna_log_mu(self, zs, batch_size: int = 1024, show_progress=True):
        ...
        """
        R = self.rna_perturb_model.get_log_mu(zs, batch_size=batch_size, show_progress=show_progress)
        return R
    ...
    def get_atac_log_mu(self, zs, batch_size: int = 1024, show_progress=True):
        ...
        """
        R = self.atac_perturb_model.get_log_mu(zs, batch_size=batch_size, show_progress=show_progress)
        return R
    ...
    def get_counts(self, modality, zs, library_sizes, batch_size: int = 1024, show_progress=True):
        ...
        if modality=='rna':
            E = self.rna_perturb_model.get_counts(zs, library_sizes, batch_size, show_progress)
        else:
            E = self.atac_perturb_model.get_counts(zs, library_sizes, batch_size, show_progress)
        return E
    ...
    def fit(self, 
            adata_paired_dict, 
            adata_rna_unpaired_list = None,
            adata_atac_unpaired_list = None,
            num_epochs: int = 100, 
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            print('#### RNA ####')
            adata_rna_list = [a for a in adata_paired_dict['rna']]
            if adata_rna_unpaired_list is not None:
                adata_rna_list += adata_rna_unpaired_list
            adata_rna = sc.concat(adata_rna_list)
            
            xs_rna = adata_rna.X
            us,ts,cs = None,None,None
            if 'us' in adata_rna.obsm:
                us = adata_rna.obsm['us']
                ts = adata_rna.obsm['ts']
            if 'cs' in adata_rna.obsm:
                cs = adata_rna.obsm['cs']
            ...
            DensityFlow.save_model(self.rna_perturb_model, f'{temp_dir}/temp_df_rna_model.pth')
            
            print('#### ATAC ####')
            adata_atac_list = [a for a in adata_paired_dict['atac']] 
            if adata_atac_unpaired_list is not None:
                adata_atac_list += adata_atac_unpaired_list
            adata_atac = sc.concat(adata_atac_list)
            
            xs_atac = adata_atac.X
            us,ts,cs = None,None,None
            if 'us' in adata_atac.obsm:
                us = adata_atac.obsm['us']
                ts = adata_atac.obsm['ts']
            if 'cs' in adata_atac.obsm:
                cs = adata_atac.obsm['cs']
            ...
            DensityFlow.save_model(self.atac_perturb_model, f'{temp_dir}/temp_df_atac_model.pth')
            
            print('#### Cross-Omics ####')
            self.rna_perturb_model.requires_grad_(False)
            self.atac_perturb_model.requires_grad_(False)
            ...
            if 'us' in adata_rna.obsm:
                us_rna = adata_rna.obsm['us']
                ts_rna = adata_rna.obsm['ts']
                us_atac = adata_atac.obsm['us']
                ts_atac = adata_atac.obsm['ts']

            xs_rna = adata_rna.X
            xs_atac = adata_atac.X
            rna_ns_zs = self.rna_perturb_model.get_basal_embedding(xs_rna, show_progress=False)
            atac_ns_zs = self.atac_perturb_model.get_basal_embedding(xs_atac, show_progress=False)
            rna_shifts = self.rna_perturb_model.get_cell_shift(xs_rna, us_rna, ts_rna, show_progress=False)
            atac_shifts = self.atac_perturb_model.get_cell_shift(xs_atac, us_atac, ts_atac, show_progress=False)
            
            rna_ns_zs = convert_to_tensor(rna_ns_zs, device='cpu')
            atac_ns_zs = convert_to_tensor(atac_ns_zs, device='cpu')
            rna_shifts = convert_to_tensor(rna_shifts, device='cpu')
            atac_shifts = convert_to_tensor(atac_shifts, device='cpu')
            
            dataset = CustomDataset(rna_ns_zs)
            ...
            cross_guide = AutoDelta(self.cross_model)
            ...
            with tqdm(total=num_epochs, disable=not show_progress, desc='Training', unit='epoch') as pbar:
                for epoch in range(num_epochs):
                    ...
                    for batch_rna_ns_zs, idx in dataloader:
                        batch_rna_ns_zs = batch_rna_ns_zs.to(self.get_device())
                        batch_atac_ns_zs = atac_ns_zs[idx].to(self.get_device())
                        batch_rna_shifts = rna_shifts[idx].to(self.get_device())
                        batch_atac_shifts = atac_shifts[idx].to(self.get_device())

                        # cross-omics
                        loss_id = 0
                        new_loss = losses[loss_id].step(rna_ns_zs=batch_rna_ns_zs, rna_shifts=batch_rna_shifts, 
                                                        atac_ns_zs=batch_atac_ns_zs, atac_shifts=batch_atac_shifts)
            ...
            self.rna_perturb_model = DensityFlow.load_model(f'{temp_dir}/temp_df_rna_model.pth')
            self.atac_perturb_model = DensityFlow.load_model(f'{temp_dir}/temp_df_atac_model.pth')
