...
class DensityFlowMO3(nn.Module):
    ...
    def fit(self, 
        ...
        rna_shifts = self.rna_perturb_model.get_cell_shift(rna_ns_zs, us, ts, show_progress=False)
        atac_shifts = self.atac_perturb_model.get_cell_shift(atac_ns_zs, us, ts, show_progress=False)
