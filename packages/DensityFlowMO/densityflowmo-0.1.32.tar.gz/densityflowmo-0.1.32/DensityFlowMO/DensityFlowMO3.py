...
class DensityFlow3(nn.Module):
    ...
    Examples
    --------
    >>> from DensityFlow3 import DensityFlow3
    >>> from DensityFlow3.perturb import LabelMatrix
    >>> import scanpy as sc
    ...
    >>> ln = lb.labels_
    >>> model = DensityFlow3(input_size = xs.shape[1],
    ...
    def fit(self, 
        ...
        use_jax: bool
            ...
            the Python script or Jupyter notebook. It is OK if it is used when runing DensityFlow3 in the shell command.
        show_progress: bool
            verbose on or off
        """
        print('#### RNA ####')
        self.rna_perturb_model.fit(xs=xs_rna, us=us, ts=ts, cs=cs, num_epochs=num_epochs,
                                   ...
                                   use_jax=use_jax, threshold=threshold)
