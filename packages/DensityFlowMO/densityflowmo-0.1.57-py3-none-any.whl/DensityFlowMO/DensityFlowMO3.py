...
class DensityFlowMO3(nn.Module):
    ...
    def fit(self, 
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            rna_shifts = self.rna_perturb_model.get_cell_shift(xs_rna, us, ts, show_progress=False)
            atac_shifts = self.atac_perturb_model.get_cell_shift(xs_atac, us, ts, show_progress=False)
