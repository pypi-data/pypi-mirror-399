...
class PCard(MCard):
    ...
    def then(self, other_pcard: 'PCard') -> 'PCard':
        ...
        Connects the output of this PCard to the input of other_pcard.
        
        Args:
            other_pcard: The PCard to execute after this one.
            
        Returns:
            A new PCard representing the composed function.
        """
