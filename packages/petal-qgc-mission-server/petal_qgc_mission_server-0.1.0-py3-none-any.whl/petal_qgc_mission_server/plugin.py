...
class QGCMissionAdapterPetal(Petal):
    # logging that class is being loaded
    logger.info("Loading QGCMissionAdapterPetal plugin")

    """
    Main petal class for QGCMissionAdapterPetal.
    
    QGC Mission Adapter petal that provides connectivity between QGC and LeafSDK.
    """

    name = "petal_qgc_mission_adapter"
    version = __version__

    def __init__(self, *_: Any, **__: Any):
        logger.info("Initializing QGCMissionAdapterPetal plugin")
        super().__init__()
