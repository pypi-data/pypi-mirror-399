...
from leafsdk.core.mission.mission_step import Takeoff, GotoLocalPosition, Wait, Land
            ...
            if cmd == CMD_TAKEOFF:
                ...
                if self.fly_to_mission_start and lat and lon and lat != 0 and lon != 0:
                    ...
                    if explicit_yaw is not None and not (isinstance(explicit_yaw, float) and math.isnan(explicit_yaw)):
                        ...
                        yaw = calculate_yaw_to_target(current_enu[0], current_enu[1], target[0], target[1])
