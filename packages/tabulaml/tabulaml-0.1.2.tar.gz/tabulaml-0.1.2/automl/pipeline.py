...
class AutoMLPipeline:
    ...
    def predict(
        ...
        Args:
            ...
            decode_labels: If True, decode predictions to original labels (default: True)

        Returns:
            Predictions array (decoded to original labels if available)
        """
        label_encoder = None
        ...
        # Decode predictions to original labels if encoder is available
        if decode_labels and label_encoder is not None:
