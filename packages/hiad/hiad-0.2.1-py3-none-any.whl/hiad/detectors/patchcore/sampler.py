...
class ApproximateGreedyCoresetSampler(GreedyCoresetSampler):
    def __init__(
        ...
        super().__init__(percentage, device, logger,dimension_to_project_features_to)
    ...
    def _compute_greedy_coreset_indices(self, features: torch.Tensor) -> np.ndarray:
        ...
        if self.logger is not None:
            self.logger.info(f"Approximate Greedy Coreset Feature Num is {num_coreset_samples}")
