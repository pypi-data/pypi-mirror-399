...
class AgentObservabilityPlugin:
    ...
    def __init__(self):
        ...
        # Initialize logger if API key is available
        ...
        elif not AgentLogger:
            print("[Agent Observability] Warning: agent-observability package not installed")
        else:
            print("[Agent Observability] Warning: AGENT_OBS_API_KEY not set")
