...
class DevOpsWorkItemDto(BaseModel):
    ...
    def description(self) -> str:
        ...
        return self.fields.get("System.Description", "")
    ...
    def created_date(self) -> str:
        """Get created date."""
        return self.fields.get("System.CreatedDate", "")

    @property
    def changed_date(self) -> str:
        """Get last changed date."""
        return self.fields.get("System.ChangedDate", "")
    ...
    def area_path(self) -> str:
        """Get area path."""
        return self.fields.get("System.AreaPath", "")

    @property
    def iteration_path(self) -> str:
        """Get iteration path."""
        return self.fields.get("System.IterationPath", "")
