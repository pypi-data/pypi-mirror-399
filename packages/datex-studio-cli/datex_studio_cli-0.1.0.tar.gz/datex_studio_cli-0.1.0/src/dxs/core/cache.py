...
Caches configuration data for immutable branches (INACTIVE, ACTIVE, WORKSPACE_HISTORY)
to avoid redundant API calls across CLI invocations. Draft and WorkspaceActive branches
...
CACHEABLE_STATUSES = {
    ...
    BranchStatus.ACTIVE,  # 3 - Current release
...
class ExploreCache:
    ...
    Only caches data for immutable branches (INACTIVE, ACTIVE, WORKSPACE_HISTORY).
    Draft and WorkspaceActive branches are never cached.
    """
