...
def _get_kwargs(
    ...
    *,
    ...
    _kwargs: dict[str, Any] = {
        "method": "get",
        "url": f"/v1/policy-bundles/rules/{rule_id}/rego",
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    """Get rule Rego content


            Get single rule's Rego content for preview.

            Fetches from S3 with aggressive caching (24 hours).

            Args:
                rule_id: Rule ID (e.g., 'AC_AWS_0023')
                bundle_key: Bundle key (e.g., 'opa_aws_latest')

            Returns:
                JSON with rego_content field
