...
T = TypeVar("T", bound="EnvironmentUpdateSchema")


@_attrs_define
class EnvironmentUpdateSchema:
    """Schema for environment updates.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        environment_update_schema.additional_properties = d
        return environment_update_schema
