...
def sync_detailed(
    *,
    ...
    - Installation repository events (added, removed)
    - CI/CD events (workflow_run, workflow_job, check_run, check_suite, push, pull_request,
    pull_request_review)
    - Deployment events (deployment_status)
