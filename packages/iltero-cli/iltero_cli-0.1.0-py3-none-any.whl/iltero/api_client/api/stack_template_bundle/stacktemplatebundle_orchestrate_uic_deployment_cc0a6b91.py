...
from ...models.stacktemplatebundle_orchestrate_uic_deployment_cc_0a6b91_deployment_config_type_0 import (
...
def _get_kwargs(
    stack_id: str,
    *,
    deployment_config: None | StacktemplatebundleOrchestrateUicDeploymentCc0A6B91DeploymentConfigType0 | Unset = UNSET,
) -> dict[str, Any]:
    params: dict[str, Any] = {}
    ...
    elif isinstance(deployment_config, StacktemplatebundleOrchestrateUicDeploymentCc0A6B91DeploymentConfigType0):
    ...
    *,
    ...
    Args:
        ...
        deployment_config (None |
            StacktemplatebundleOrchestrateUicDeploymentCc0A6B91DeploymentConfigType0 | Unset):
