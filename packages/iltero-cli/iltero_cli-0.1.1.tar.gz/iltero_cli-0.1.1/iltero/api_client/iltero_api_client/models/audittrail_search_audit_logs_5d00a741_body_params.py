...
T = TypeVar("T", bound="AudittrailSearchAuditLogs5D00A741BodyParams")


@_attrs_define
class AudittrailSearchAuditLogs5D00A741BodyParams:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        audittrail_search_audit_logs_5d00a741_body_params = cls(
        ...
        audittrail_search_audit_logs_5d00a741_body_params.additional_properties = d
        return audittrail_search_audit_logs_5d00a741_body_params
