...
T = TypeVar("T", bound="RegistryTokenCreateRequestSchema")


@_attrs_define
class RegistryTokenCreateRequestSchema:
    """Registry token creation request schema.

    Attributes:
        scopes (list[str] | None | Unset): List of scopes to grant to this token
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registry_token_create_request_schema = cls(
            scopes=scopes,
            description=description,
            expires_in=expires_in,
        )

        registry_token_create_request_schema.additional_properties = d
        return registry_token_create_request_schema
