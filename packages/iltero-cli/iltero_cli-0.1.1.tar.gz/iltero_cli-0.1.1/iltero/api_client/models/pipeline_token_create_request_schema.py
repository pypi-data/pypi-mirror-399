...
T = TypeVar("T", bound="PipelineTokenCreateRequestSchema")


@_attrs_define
class PipelineTokenCreateRequestSchema:
    """Pipeline token creation request schema.
    ...
    Attributes:
        ...
        bound_stack_id (None | str | Unset): Optional stack ID to bind token to
    """
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pipeline_token_create_request_schema = cls(
            scopes=scopes,
        ...
        pipeline_token_create_request_schema.additional_properties = d
        return pipeline_token_create_request_schema
