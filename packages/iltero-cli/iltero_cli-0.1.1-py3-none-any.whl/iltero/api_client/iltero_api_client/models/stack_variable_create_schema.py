...
T = TypeVar("T", bound="StackVariableCreateSchema")


@_attrs_define
class StackVariableCreateSchema:
    """Schema for creating a new stack variable.

    Attributes:
        key (str): Variable key (name).
        value (str): Variable value (required on creation).
        is_secret (bool | Unset): Indicates if the variable is sensitive. Default: False.
        description (None | str | Unset): Optional description for the variable.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        stack_variable_create_schema = cls(
            key=key,
            value=value,
            is_secret=is_secret,
        ...
        stack_variable_create_schema.additional_properties = d
        return stack_variable_create_schema
