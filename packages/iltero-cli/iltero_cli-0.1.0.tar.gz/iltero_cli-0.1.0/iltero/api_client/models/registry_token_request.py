...
T = TypeVar("T", bound="RegistryTokenRequest")


@_attrs_define
class RegistryTokenRequest:
    """Registry token request schema for CLI authentication.

    Attributes:
        email (str): User email
        password (str): User password
        scopes (list[str] | None | Unset): Requested registry scopes
        remember (bool | None | Unset): Whether to extend token expiration Default: False.
    """

    email: str
    password: str
    scopes: list[str] | None | Unset = UNSET
    remember: bool | None | Unset = False
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        registry_token_request.additional_properties = d
        return registry_token_request
