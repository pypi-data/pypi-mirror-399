...
with (
    open(args.src_file, "r", encoding="utf8") as fs1,
    open(args.tgt_file, "r", encoding="utf8") as fs2,
    open(args.src_output_file, "w", encoding="utf8") as fos1,
    open(args.tgt_output_file, "w", encoding="utf8") as fos2,
):
    ls1 = fs1.readline()
    ls2 = fs2.readline()
