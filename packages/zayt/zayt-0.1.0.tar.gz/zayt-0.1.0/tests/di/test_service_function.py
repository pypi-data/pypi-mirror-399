...
from zayt.di.error import FactoryMissingReturnTypeError, ServiceAlreadyRegisteredError
...
def test_provides_option_should_log_warning(ioc: Container, log_output):
    ...
    assert log_output.entries[0]["service"] == "tests.di.test_service_function.factory"
