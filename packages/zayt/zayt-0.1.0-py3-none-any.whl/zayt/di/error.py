...
from zayt.di.service.model import InjectableType
...
class IncompatibleDependencyScopeError(DependencyInjectionError):
    def __init__(
        self, service_type: type, dependency: type, dependency_name: str | None
    ):
        super().__init__(
            "incompatible dependency scope in"
            f" '{service_type.__module__}.{service_type.__qualname__}'"
            f" for dependency '{dependency.__module__}.{dependency.__qualname__}'"
        )
...
class ScopedServiceWithoutContextError(DependencyInjectionError):
    def __init__(self, service: InjectableType):
        super().__init__(
            f"scoped service {service.__module__}.{service.__qualname__}"
            " requested without context"
        )
