"""
Quadratic Regression Model - Refactored for v3.0.0
...
class Quadratic(BaseModel):
    """
    Quadratic (Polynomial degree=2) Regression model.
    ...
    def __init__(
        ...
        """
        Initialize Quadratic Regression model.
    ...
    def plot_y_train(self):
        ...
        if options.plot.backend == 'plotly':
            ...
            fig.update_layout(
                title='Quadratic Regression Model - Train and Test Data',
    ...
    def plot_predict(self, X_new: Union[np.ndarray, pd.DataFrame], 
        ...
        if options.plot.backend == 'plotly':
            ...
            fig.update_layout(
                title='Quadratic Regression Model - New Data Prediction',
                xaxis_title=self.colX,
                yaxis_title=self.colY
            )
            return fig
