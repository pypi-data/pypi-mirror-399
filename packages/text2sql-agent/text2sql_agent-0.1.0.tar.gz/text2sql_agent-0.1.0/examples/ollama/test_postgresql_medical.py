"""
Medical Database Test with PostgreSQL - Advanced Features Demo

Tests the SQL Agent Toolkit with a real medical database using Ollama.
...
print(f"Using DATABASE_URL_MEDICAL: {DATABASE_URL}")

if not DATABASE_URL:
    print("ERROR: DATABASE_URL_MEDICAL environment variable not set!")
    print("Please create a .env file with:")
    print('DATABASE_URL_MEDICAL=postgresql://user:password@localhost:5432/medical_db')
    exit(1)

print("="*80)
print("SQL AGENT TOOLKIT - Medical Database Test")
print("="*80)
...
try:
    ...
    SQLAgent.configure_logging(
        level=logging.INFO,
        log_file="medical_sql_queries.log"
    )
    print("   ✓ Enhanced logging configured (logs: medical_sql_queries.log)")
