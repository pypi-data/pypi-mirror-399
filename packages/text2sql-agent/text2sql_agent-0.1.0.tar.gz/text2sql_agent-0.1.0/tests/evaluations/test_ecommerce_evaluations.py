...
To run:
    pytest tests/evaluations/test_ecommerce_evaluations.py --llm=ollama --model=mistral:7b
...
def sql_agent_ecommerce(sqlite_ecommerce_db, postgres_ecommerce_db, request):
    """
...
class TestEcommerceSQLCorrectness:
    ...
    def test_ecommerce_sql_suite(self, evaluator_ecommerce, sql_cases):
...
class TestEcommerceSchemaUnderstanding:
    ...
    def test_ecommerce_schema_suite(self, evaluator_ecommerce, schema_cases):
...
class TestEcommerceEdgeCases:
    ...
    def test_ecommerce_edge_suite(self, evaluator_ecommerce, edge_cases):
...
class TestEcommerceAmbiguityHandling:
    ...
    def test_ecommerce_ambiguity_suite(self, evaluator_ecommerce, ambiguity_cases):
...
class TestEcommerceErrorRecovery:
    ...
    def test_ecommerce_error_suite(self, evaluator_ecommerce, error_cases):
...
class TestEcommerceCompleteSuite:
    ...
    def test_complete_ecommerce_evaluation(self, request, evaluator_ecommerce, ecommerce_test_cases):
        ...
        for category, results in report.category_results.items():
            status = "✓" if results['pass_rate'] >= 0.65 else "⚠"
