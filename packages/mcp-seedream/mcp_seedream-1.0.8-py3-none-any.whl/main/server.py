...
IMPORTANT: Generated images are saved to the user's home directory under 'images' folder by default.
Users may need to move these files to their project directory as needed.
"""
...
config = {
    ...
    "output_dir": os.path.abspath(os.getenv("ARK_OUTPUT_DIR", "./images"))
}
...
async def handle_list_tools() -> list[types.Tool]:
    ...
    return [
        ...
        types.Tool(
            name="generate_image",
            description="Generate an image from text prompt using configured API. Use this when users ask to create images, generate pictures, visualize concepts, or turn text descriptions into visual content. IMPORTANT: Generated images are saved to the user's home directory under 'images' folder by default. Users may need to move these files to their project directory as needed.",
            inputSchema={
                "type": "object",
                "properties": {
                    "prompt": {
                ...
                if "data" in response_data:
                    for i, item in enumerate(response_data["data"]):
                        if "url" in item:
                            ...
                            # Use timestamp and random number for filename to avoid filesystem issues with prompts
