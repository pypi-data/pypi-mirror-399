...
def make_site_design(
    ...
    **constants,
    ...
    site_design.add_node(main_array)
    site_design.add_node(main_array.structure)
    site_design.add_node(main_array.structure.module)
    site_design.add_node(main_array.inverter)
    site_design.add_node(transformer)
    site_design.add_node(grid)
    return site_design
