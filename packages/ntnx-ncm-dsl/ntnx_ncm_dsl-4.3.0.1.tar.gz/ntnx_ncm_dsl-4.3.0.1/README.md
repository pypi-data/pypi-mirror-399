...
`Latest release version: 4.3.0.1, Latest-release-tag: v4.3.0.1`

`Latest Release Notes:` [read here](https://github.com/nutanix/calm-dsl/tree/master/release-notes/4.3.0.1)
