...
class HookParser(SimpleParser[HookBlock, HookNode]):
    ...
    # Hooks are only in the dvt_project.yml or dbt_project.yml file for the project
    def get_path(self) -> FilePath:
        ...
        import os
        dvt_path = os.path.join(self.project.project_root, "dvt_project.yml")
        relative_path = "dvt_project.yml" if os.path.exists(dvt_path) else "dbt_project.yml"
        path = FilePath(
