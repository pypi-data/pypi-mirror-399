...
class ManifestLoader:
    ...
    def build_manifest_state_check(self):
        ...
        for name, project in all_projects.items():
            ...
            dvt_path = os.path.join(project.project_root, "dvt_project.yml")
            dbt_path = os.path.join(project.project_root, "dbt_project.yml")
            path = dvt_path if os.path.exists(dvt_path) else dbt_path
