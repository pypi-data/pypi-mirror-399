...
with rstab.Application() as rstab_app:
    ...
    settings_ec3_uls_updated = rstab.steel_design_objects.SteelDesignUlsConfiguration.SettingsEc3TreeTable()
    ...
    # Modify the value
    # Create empty TreeTable and set only the values that we want to change
    settings_ec3_sls_updated =rstab.steel_design_objects.SteelDesignSlsConfiguration.SettingsEc3TreeTable()
    common.set_tree_value(
