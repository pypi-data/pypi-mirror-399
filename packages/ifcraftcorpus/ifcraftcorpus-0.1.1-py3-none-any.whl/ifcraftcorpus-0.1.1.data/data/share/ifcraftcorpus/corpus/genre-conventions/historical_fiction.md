...
- [Worldbuilding Patterns](worldbuilding_patterns.md) — Research-based world consistency
- [Dialogue Craft](dialogue_craft.md) — Period-appropriate speech
- [Character Voice](character_voice.md) — Historical voice authenticity
- [Accessibility Guidelines](accessibility_guidelines.md) — Handling sensitive historical content
