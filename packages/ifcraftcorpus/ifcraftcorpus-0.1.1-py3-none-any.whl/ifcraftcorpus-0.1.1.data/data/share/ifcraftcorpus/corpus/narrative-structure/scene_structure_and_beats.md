---
title: Scene Structure and Beat Integration
summary: Structuring scenes with paragraph cadence, beat integration, and the relationship between planning and prose.
topics:
  - scene-structure
  - paragraph-cadence
  - beats
...
# Scene Structure and Beat Integration
...
- [Prose Patterns](prose_patterns.md) — Sentence and paragraph craft
- [Pacing and Tension](pacing_and_tension.md) — Scene rhythm and flow
- [Branching Narrative Craft](branching_narrative_craft.md) — Choice design principles
- [Diegetic Design](diegetic_design.md) — Player-facing content standards
- [Dialogue Craft](dialogue_craft.md) — Conversation within scenes
