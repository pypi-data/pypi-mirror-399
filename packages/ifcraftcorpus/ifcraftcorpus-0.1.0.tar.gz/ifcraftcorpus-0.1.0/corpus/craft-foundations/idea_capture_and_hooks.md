---
title: Idea Capture and Deferred Work
summary: Capturing ideas during creative work for later development—hook types, when to defer, and managing creative backlog.
topics:
  - idea-capture
  - hooks
  - deferred-work
...
# Idea Capture and Deferred Work
...
- [Branching Narrative Construction](branching_narrative_construction.md) — Planning structure
- [Canon Management](canon_management.md) — Managing world truth and gaps
- [Scope and Length](scope_and_length.md) — Scoping creative work
- [Multi-Agent Patterns](multi_agent_patterns.md) — Handoffs between roles
- [Quality Standards](quality_standards_if.md) — When to fix vs defer
