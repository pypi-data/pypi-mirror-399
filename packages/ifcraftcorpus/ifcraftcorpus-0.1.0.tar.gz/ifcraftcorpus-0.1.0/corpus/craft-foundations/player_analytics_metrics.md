...
- [Episodic Serialized IF](episodic_serialized_if.md) — Using statistics between episodes
- [Branching Narrative Construction](branching_narrative_construction.md) — Structure affecting metrics
