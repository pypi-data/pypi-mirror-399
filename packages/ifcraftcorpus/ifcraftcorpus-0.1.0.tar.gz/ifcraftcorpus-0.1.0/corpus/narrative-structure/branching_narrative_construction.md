...
- [Diegetic Design](diegetic_design.md) — Gates as in-world obstacles, contrastive choices
...
- [Scope and Length](scope_and_length.md) — Managing branching scope
- [Agent Prompt Engineering](agent_prompt_engineering.md) — Prompt design for LLM agents
- [Multi-Agent Patterns](multi_agent_patterns.md) — Orchestration for complex generation
