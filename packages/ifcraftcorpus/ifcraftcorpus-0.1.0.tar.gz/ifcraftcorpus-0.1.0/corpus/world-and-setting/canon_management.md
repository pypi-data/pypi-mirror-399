...
- [Historical Fiction](historical_fiction.md) — Research and accuracy
- [Diegetic Design](diegetic_design.md) — Player-facing content
- [Quality Standards](quality_standards_if.md) — Canon validation bar
- [Branching Narrative Construction](branching_narrative_construction.md) — Structure planning
