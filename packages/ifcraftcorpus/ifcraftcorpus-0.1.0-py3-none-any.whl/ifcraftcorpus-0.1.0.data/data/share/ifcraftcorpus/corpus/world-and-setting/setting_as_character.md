...
- [Worldbuilding Patterns](worldbuilding_patterns.md) — Building consistent worlds
- [Prose Patterns](prose_patterns.md) — Descriptive writing for settings
- [Exposition Techniques](exposition_techniques.md) — Revealing setting naturally
- [Horror Conventions](horror_conventions.md) — Setting as threat
