---
title: Research and Verification for Creative Work
summary: Assessing certainty levels, structuring research memos, and handling uncertain facts in fiction writing.
topics:
  - research
  - verification
  - posture
...
> The factory opened in 1847.
> The guild controlled the waterfront trade.
> Three bridges crossed the river.

### Plausible (Soft Hedge)

> The practice was believed to date back centuries.
> By most accounts, the family had lived there for generations.
> The traditional explanation held that...

### Disputed (Present Disagreement)

> Some said the fire was accidental; others suspected arson.
> Historians disagreed about the colony's founding date.
> The truth, as with many things, depended on who you asked.

### Uncorroborated (Neutral Phrasing)

> No one knew for certain how the tradition began.
> The origins were lost to time.
> Whether by accident or design, the record was silent.
...
- [Historical Fiction](historical_fiction.md) — Period research and accuracy
- [Worldbuilding Patterns](worldbuilding_patterns.md) — Building coherent worlds
- [Canon Management](canon_management.md) — Managing world truth
- [Quality Standards](quality_standards_if.md) — Research posture quality bar
- [Exposition Techniques](exposition_techniques.md) — Integrating facts naturally
