---
title: Science Fiction Conventions for Interactive Fiction
summary: Writing science fiction with subgenres, scale, technology consistency, and plausible speculation.
topics:
  - sci-fi
  - cyberpunk
  - space-opera
...
Alien races where everyone shares the same single personality trait/job (The Warrior Race, The Merchant Race).
**Fix:** Show factions and dissent within alien cultures.

### Dates That Age Poorly

Setting the story in "2030" with flying cars.
**Fix:** Use relative dates ("20 years after the Event") or far future.

### Ignoring Linguistics

Universal Translators are convenient but erase cultural friction.
**Fix:** Use language barriers as puzzles or character building.
...
- [Worldbuilding Patterns](worldbuilding_patterns.md)
- [Pacing and Tension](pacing_and_tension.md)
