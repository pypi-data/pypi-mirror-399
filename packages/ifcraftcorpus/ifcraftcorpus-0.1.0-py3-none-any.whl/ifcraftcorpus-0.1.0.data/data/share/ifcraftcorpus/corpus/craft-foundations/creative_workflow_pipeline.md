...
- [Branching Narrative Construction](branching_narrative_construction.md) — Structure design
- [Scene Structure and Beats](scene_structure_and_beats.md) — Brief to prose
- [Quality Standards](quality_standards_if.md) — Validation bars
- [Canon Management](canon_management.md) — Cold store principles
- [Multi-Agent Patterns](multi_agent_patterns.md) — Role coordination
