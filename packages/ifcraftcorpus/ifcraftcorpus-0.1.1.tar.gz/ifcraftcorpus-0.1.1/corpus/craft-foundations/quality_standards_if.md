...
See [Voice Register Consistency](voice_register_consistency.md) for detailed guidance.
...
See [Accessibility Guidelines](accessibility_guidelines.md) for detailed standards.
...
- See [Historical Fiction](historical_fiction.md) for detailed methodology
...
- [Accessibility Guidelines](accessibility_guidelines.md) — Detailed accessibility standards
- [Voice Register Consistency](voice_register_consistency.md) — Style consistency guidance
- [Worldbuilding Patterns](worldbuilding_patterns.md) — Canon consistency
- [Historical Fiction](historical_fiction.md) — Research methodology
