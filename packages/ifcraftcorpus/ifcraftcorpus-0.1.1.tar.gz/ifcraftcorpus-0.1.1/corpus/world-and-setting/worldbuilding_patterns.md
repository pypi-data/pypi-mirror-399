...
See [Diegetic Design](diegetic_design.md) for player-safe reference guidelines.
...
- [Exposition Techniques](exposition_techniques.md) — Revealing world through action
- [Historical Fiction](historical_fiction.md) — Research and period authenticity
- [Fantasy Conventions](fantasy_conventions.md) — Fantasy-specific worldbuilding
