...
Example Usage:
    ...
    >>> # Delete item
    >>> result =
    fgt.api.cmdb.log.syslogd4_override_setting.delete(name="item_name")
    ...
    def put(
        ...
        **kwargs: Any,
        ...
        Args:
            ...
            use_management_vdom: Enable/disable use of management VDOM as
            source VDOM for logs sent to syslog server. (optional)
