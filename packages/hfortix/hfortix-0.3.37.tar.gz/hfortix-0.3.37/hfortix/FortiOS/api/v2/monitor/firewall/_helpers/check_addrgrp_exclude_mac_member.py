"""
Validation helpers for firewall check_addrgrp_exclude_mac_member endpoint.
...
def validate_check_addrgrp_exclude_mac_member_get(
    mkey: str | None = None,
    attr: str | None = None,
    ...
    **params: Any,
    ...
    Example:
        ...
        >>> # Get specific object
        >>> is_valid, error =
        validate_check_addrgrp_exclude_mac_member_get(mkey="value")
        >>> if not is_valid:
