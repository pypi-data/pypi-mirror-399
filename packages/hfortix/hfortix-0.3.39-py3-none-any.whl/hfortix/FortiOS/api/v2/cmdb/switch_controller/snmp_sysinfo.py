...
Configuration endpoint for managing cmdb switch controller snmp sysinfo
objects.
...
Example Usage:
    ...
    >>> item =
    fgt.api.cmdb.switch_controller.snmp_sysinfo.get(name="item_name")
    >>>
    ...
    >>> # Delete item
    >>> result =
    fgt.api.cmdb.switch_controller.snmp_sysinfo.delete(name="item_name")
