...
class Strategy:
    ...
    def run(self, relative=False):
        ...
        Args:
            relative (bool): Whether to calculate relative returns (default: False)
        ...
        # 这样无论使用哪种参数，结果都完全相同
        self._run_with_original_backend(relative)

    def _run_with_original_backend(self, relative: bool):
