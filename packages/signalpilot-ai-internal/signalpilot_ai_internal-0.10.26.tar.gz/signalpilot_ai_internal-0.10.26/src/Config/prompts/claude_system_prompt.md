...
- **Install packages in notebook cells** - Always use `!pip install package_name` or `%pip install package_name` in code cells to install packages. Never use terminal tools for package installation.
