...
# v040: Train a Llama-style model using the new Length-MAX vocab v038:
...
#
# NOTE: v040 exists to avoid clobbering logs/artifacts from an earlier v039 attempt.
...
TAG="lenmax_punctwhitelist_noincomplete_pack${PACK_CHARS}_evalval_steps${STEPS}_v040"
