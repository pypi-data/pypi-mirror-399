...
@dataclass_json
@dataclass
class V4VpnVpnGatewayRenewRequest(CtyunOpenAPIRequest):
    regionID: str  # 资源池ID, 例:100054c0416811e9a6690242ac110002
    resourceID: str  # VPN网关资源ID
    cycleType: str  # 包周期类型，YEAR/MONTH(SSL网关只支持MONTH，最大支持36个月)
...
@dataclass_json
@dataclass
class V4VpnVpnGatewayRenewResponse(CtyunOpenAPIResponse):
