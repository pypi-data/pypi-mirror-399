...
from ._optimizers.core_optimizer.utils import move_random
from ._optimizers.core_optimizer.converter import Converter
...
class Initializer:
    ...
    def set_pos(self):
        ...
        self.init_positions_l = iter(self.init_positions_l)
