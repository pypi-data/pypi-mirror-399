"""
Setup script for the faq-rai-sdk package.
This script uses setuptools to package the faq-rai-sdk library, which contains modules for faster Copilot Development.
Attributes:
