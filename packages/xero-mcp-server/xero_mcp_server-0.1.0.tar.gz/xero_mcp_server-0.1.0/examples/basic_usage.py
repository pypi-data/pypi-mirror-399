"""
Basic usage example for Xero MCP Server.
...
Prerequisites:
- Install the package: pip install xero-mcp-server
- Set required environment variables (see .env.example or README.md)
"""

import asyncio
import os
from xero_mcp.server import main


async def example_usage():
    """
    Example usage of Xero MCP Server.
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Xero MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install xero-mcp-server")
