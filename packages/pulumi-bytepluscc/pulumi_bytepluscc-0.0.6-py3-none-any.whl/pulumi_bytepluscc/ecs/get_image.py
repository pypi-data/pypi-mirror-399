...
def get_image(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:ecs/getImage:getImage', __args__, opts=opts, typ=GetImageResult).value
...
def get_image_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:ecs/getImage:getImage', __args__, opts=opts, typ=GetImageResult)
