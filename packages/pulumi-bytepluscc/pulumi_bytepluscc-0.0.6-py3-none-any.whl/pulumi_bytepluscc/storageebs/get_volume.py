...
def get_volume(id: Optional[builtins.str] = None,
    ...
    __ret__ = pulumi.runtime.invoke('bytepluscc:storageebs/getVolume:getVolume', __args__, opts=opts, typ=GetVolumeResult).value
...
def get_volume_output(id: Optional[pulumi.Input[builtins.str]] = None,
    ...
    __ret__ = pulumi.runtime.invoke_output('bytepluscc:storageebs/getVolume:getVolume', __args__, opts=opts, typ=GetVolumeResult)
