...
class CDNRecipeBase:
    ...
    def install(self):
        ...
        with io.open(zcmlPath, 'w', encoding='utf-8') as f:
            # Ensure unicode for Python 2 compatibility
            if sys.version_info[0] < 3 and isinstance(zcml, str):
                zcml = zcml.decode('utf-8')
            f.write(zcml)
