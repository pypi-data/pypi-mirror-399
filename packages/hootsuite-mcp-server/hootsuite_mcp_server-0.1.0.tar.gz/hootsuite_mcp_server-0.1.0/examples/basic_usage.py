"""
Basic usage example for Hootsuite MCP Server.
...
Prerequisites:
- Install the package: pip install hootsuite-mcp-server
- Set required environment variables (see .env.example or README.md)
"""

import asyncio
import os
from hootsuite_mcp.server import main


async def example_usage():
    """
    Example usage of Hootsuite MCP Server.

    Make sure to set the required environment variables before running:
    - See the README.md for complete environment variable requirements
    - Copy .env.example to .env and fill in your credentials
    """
    print("Starting Hootsuite MCP Server...")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Hootsuite MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install hootsuite-mcp-server")
