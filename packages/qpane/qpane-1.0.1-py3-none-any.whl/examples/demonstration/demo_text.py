...
SAM_CHAPTER = (
    ...
    "a local checkpoint, and sam_model_url to change the download source. The launcher lets you "
    "override both so you can simulate host-provided checkpoints. The status bar mirrors checkpoint "
