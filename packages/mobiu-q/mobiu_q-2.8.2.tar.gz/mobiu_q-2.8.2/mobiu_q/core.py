...
Version: 2.8.2 - Universal MobiuOptimizer + Hybrid Mode
        ...
        if should_sync:
            ...
            try:
                ...
                if data.get('success') and 'adaptive_lr' in data:
                    ...
                    # This prevents "GPS collision" - old momentum fighting new direction
                    lr_change_ratio = abs(new_lr - old_lr) / (old_lr + 1e-9)
                    if lr_change_ratio > 0.05:  # 5% threshold
