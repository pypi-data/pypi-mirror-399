...
class UnsignedContentAbsorber:
    ...
    def __init__(self, signature: aspose.pdf.facades.PdfFileSignature):
        '''Represents a class used for processing unsigned content.
        
        :param signature: A :class:`aspose.pdf.facades.PdfFileSignature` object representing a digital signature.'''
        ...
    
    def try_get_content(self) -> None:
        '''Attempt to retrieve the unsigned content from the associated document.
        
        :returns: A aspose.pdf.security.UnsignedContentAbsorber.Result object containing details
    ...
    class Result:
          ...
          @property
          def unsigned_content(self) -> aspose.pdf.security.UnsignedContentAbsorber.UnsignedContent:
          ...
          @property
          def coverage(self) -> aspose.pdf.signatures.SignaturesCoverage:
    ...
    class UnsignedContent:
          '''Encapsulates unsigned content elements extracted from a PDF document.
            This class provides access to pages and form fields
            that are part of the unsigned content within the document.'''
          
          @property
    	  def pages(self) -> list[aspose.pdf.Page]:
              '''Gets a list of pages whose content is unsigned or has been incrementally changed.'''
          ...
    
          @property
          def forms(self) -> list[aspose.pdf.annotations.WidgetAnnotation]:
