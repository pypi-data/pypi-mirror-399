...
class FreeTextAnnotation(aspose.pdf.annotations.MarkupAnnotation):
    ...
    @overload
    def set_text_style(self, text_styles: aspose.pdf.annotations.RichTextFontStyles, font_name: str, font_size: float, font_color: aspose.pydrawing.Color) -> None:
        '''Sets the formatting determined by the parameter textStyle for all annotation text.
        
        :param text_styles: Style(s) applied for annotation text.
        :param font_name: Font name applied for annotation text.
        :param font_size: Font size applied for annotation text.
        :param font_color: Font color applied for annotation text.'''
        ...
    
    @overload
    def set_text_style(self, from_ind: int, to_ind: int, text_styles: aspose.pdf.annotations.RichTextFontStyles) -> None:
        '''Sets the formatting determined by the parameter textStyle for a text fragment from fromInd index to toInd index.
        
        :param from_ind: Starting index of the text fragment (from 0).
        :param to_ind: End index of the text fragment (counting from 0, this not included).
        :param text_styles: Style(s) applied for text fragment.'''
        ...
...
class RichTextFontStyles:
    '''Options for styling text fragments in RichText.'''
    
    CLEAR_EXISTING: RichTextFontStyles
    BOLD: RichTextFontStyles
    ITALIC: RichTextFontStyles
    UNDERLINE: RichTextFontStyles
