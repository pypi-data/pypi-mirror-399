...
class TextReplaceOptions(aspose.pdf.text.TextOptions):
    ...
    @property
    def font_size_adjustment_action(self) -> None:
        '''Gets or sets the policy for adjusting the font size to fit within the bounds
        defined by the :attr:`TextReplaceOptions.rectangle`.'''
        ...
    
    @font_size_adjustment_action.setter
    def font_size_adjustment_action(self, value: None):
        ...
    ...
    class FontSizeAdjustment:
          ...
          SHRINK_TO_FIT - the font size is reduced if the text is too large to fit the bounds. The font size is never increased if the text is smaller than the bounds;
          SCALE_TO_FILL - the font size is adjusted (both shrinking and growing) to make the text fill the bounds of the rectangle as much as possible.'''
 
          NONE: FontSizeAdjustment
          SHRINK_TO_FIT: FontSizeAdjustment 
          SCALE_TO_FILL: FontSizeAdjustment         
    ...
    class ReplaceAdjustment:
          ...
          ADJUST_SPACE_WIDTH - tries adjust spaces between words to keep line length;
          WHOLE_WORDS_HYPHENATION - tries distribute words between paragraph lines to keep paragraph's right field;
          IS_FORM_FILLING_MODE - shifts rest of the line according to changing length of text, length of the line may be changed;
          Default value is SHIFT_REST_OF_LINE.'''
