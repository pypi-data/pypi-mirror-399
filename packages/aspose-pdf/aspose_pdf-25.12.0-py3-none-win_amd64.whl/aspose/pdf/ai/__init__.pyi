...
class ChatMessageResponse:
    ...
    @overload
    def __init__(self):
        '''Initializes a new instance of the :class:`ChatMessageResponse` class.'''
        ...
...
class Choice:
    ...
    @property
    def message(self) -> aspose.pdf.ai.ChatMessageResponse:
        '''Gets or sets a chat completion message generated by the model.'''
        ...
    
    @message.setter
    def message(self, value: aspose.pdf.ai.ChatMessageResponse):
        ...
...
class OcrDetail:
    ...
    def compare_to(self, other: aspose.pdf.ai.OcrDetail) -> int:
        '''Compares the current OcrDetail instance with another OcrDetail object based on their PageNumber property.'''
        ...
    
    @property
    def page_number(self) -> int:
        '''The 1-based page number within the source document.
        For single-page images, this will always be 1.'''
        ...
    ...
    def success(self) -> bool:
        '''Indicates whether the OCR extraction for this specific page was successful.'''
        ...
    ...
    def extracted_text(self, value: str):
        ...
    
    @property
    def error_message(self) -> str:
        '''An error message describing why OCR failed for this page, if Success is false. Null otherwise.'''
        ...
...
class OpenAIOcrCopilotOptions(aspose.pdf.ai.OpenAIAssistantCopilotOptionsBase):
    '''Represents the options for configuring the OpenAIOcrCopilot.'''
    
    @overload
    def with_documents(self, document_collection: aspose.pdf.ai.DocumentCollection) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        '''Sets the document collection.
        
        :param document_collection: The document collection to set.
        :returns: The current instance of :class:`OpenAIOcrCopilotOptions`.'''
        ...
    
    @overload
    def with_documents(self, pdf_documents) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        ...
    
    @overload
    def with_documents(self, file_paths) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        ...
    
    @overload
    def with_document(self, pdf_document: aspose.pdf.ai.PdfDocument) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
    ...
    @overload
    def with_document(self, file_path: str) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
    ...
    def get_options(self) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        '''Gets the current :class:`OpenAIOcrCopilotOptions`.
        
        :returns: The current instance of :class:`OpenAIOcrCopilotOptions`.'''
        ...
    
    @staticmethod
    def create(self) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        '''Creates a new instance of :class:`OpenAIOcrCopilotOptions`.
        
        :returns: A new instance of :class:`OpenAIOcrCopilotOptions`.'''
        ...
    
    def with_model(self, model: str) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        '''Sets the model.
    ...
    def with_temperature(self, temperature: float) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        ...
    
    def with_top_p(self, top_p: float) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        ...
    
    def with_max_completion_tokens(self, max_completion_tokens: int) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
        ...
    
    def with_system_instructions(self, text: str) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
    ...
    def with_user_instructions(self, text: str) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
    ...
    def with_resolution(self, resolution: int) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
    ...
    def with_detail(self, detail: aspose.pdf.ai.Detail) -> aspose.pdf.ai.OpenAIOcrCopilotOptions:
    ...
    def user_instructions(self, value: str):
        ...
    ...
    @property
    def detail(self) -> aspose.pdf.ai.Detail:
        '''Gets or sets the level of detail for image analysis.'''
        ...
    
    @detail.setter
    def detail(self, value: aspose.pdf.ai.Detail):
        ...
...
class TextRecognitionResult:
    ...
    def source_identifier(self, value: str):
        ...
    ...
    @overall_success.setter
    def overall_success(self, value: bool):
        ...
    
    @property
    def ocr_details(self) -> None:
        ...
    
    @ocr_details.setter
    def ocr_details(self, value: None):
        ...
    
    @property
    def summary_error_message(self) -> str:
        ...
    
    @summary_error_message.setter
    def summary_error_message(self, value: str):
        ...
    
    @property
    def total_usage(self) -> aspose.pdf.ai.Usage:
        ...
    
    @total_usage.setter
    def total_usage(self, value: aspose.pdf.ai.Usage):
        ...
