...
class OptimizationOptions:
    ...
    @compress_objects.setter
    def compress_objects(self, value: bool):
        ...
    
    @property
    def compress_all_content_streams(self) -> bool:
        '''If set to True, all uncompressed page content streams will be
        compressed using the FlateDecode filter during :meth:`aspose.pdf.Document.optimize_resources`.
        Default is False to preserve backward compatibility.'''
        ...
    
    @compress_all_content_streams.setter
    def compress_all_content_streams(self, value: bool):
        ...
