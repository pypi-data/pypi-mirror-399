...
class HeaderElement(aspose.pdf.logicalstructure.BLSTextElement):
    ...
    @overload
    def add_entry_to_toc_page(self, toc_page: aspose.pdf.Page, toc_entry: aspose.pdf.logicalstructure.TOCIElement) -> None:
        '''Creates a header on the specified Table of Contents (TOC) page and associates it with a TOCI element.
        
        :param toc_page: The :class:`aspose.pdf.Page` object representing the TOC page where the header should be created.
        :param toc_entry: The :class:`TOCIElement` serving as the TOC entry to associate with the header being created.
    ...
    @overload
    def add_entry_to_toc_page(self, toc_page: aspose.pdf.Page, toc_entry: aspose.pdf.logicalstructure.ListLIElement) -> None:
        '''Creates a header on the specified Table of Contents (TOC) page and associates it with a TOCI element.
        
        :param toc_page: The :class:`aspose.pdf.Page` object representing the TOC page where the header should be created.
        :param toc_entry: The :class:`ListLIElement` object acting as the TOCI entry to associate with the created header on the specified TOC page.
        ...
        elements. This method facilitates the association of the header element with such a :class:`ListLIElement`
...
class HeaderElementTextConflictException(aspose.pdf.PdfException):
...
class ListLIElement(aspose.pdf.logicalstructure.ListChildElement):
    ...
    def add_ref(self, referenced_structure_element: aspose.pdf.logicalstructure.StructureElement) -> None:
        '''Adds a reference to the specified :class:`StructureElement` within this Table of Contents Item (TOCI) element.
        This is typically used when ListLIElement serves as a TOC header in nested tables of contents.
        
        :param referenced_structure_element: The :class:`StructureElement` to be referenced by this TOCI element.
...
class TOCElement(aspose.pdf.logicalstructure.GroupingElement):
    ...
    def link_toc_page_title_to_header_element(self, toc_page: aspose.pdf.Page, toc_title_header: aspose.pdf.logicalstructure.HeaderElement) -> None:
        '''Links the Table of Contents (TOC) page title to a header element for document structure.
        
        :param toc_page: The TOC page containing the title to which the header will be linked.
        :param toc_title_header: The header element that will be linked to the title of the TOC page.
        :raises TOCpageHasNoTitleException: Thrown if the TOC page does not have a title.'''
        ...
...
class TOCpageHasNoTitleException(aspose.pdf.PdfException):
