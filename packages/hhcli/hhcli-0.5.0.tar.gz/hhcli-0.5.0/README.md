...
После установки запустите программу. Вам будет предложено создать новый профиль. Придумать короткое имя для вашего профиля (go, python, pm, analyst и т.д). В системном браузере загрузится страница hh.ru для аутентификации на сайте. После успешного входа нужно запустить приложение. Если в аккаунте несколько резюме, приложение предложит выбрать, какое из них использовать для поиска.
