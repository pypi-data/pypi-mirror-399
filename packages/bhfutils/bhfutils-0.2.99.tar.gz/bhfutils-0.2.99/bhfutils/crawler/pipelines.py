...
class LoggingBeforePipeline(object):
    ...
    def process_item(self, item, spider):
        ...
        if isinstance(item, RawResponseItem):
            ...
            self.logger.debug('Scraped page', extra=item_copy)
            return item
        else:
...
class KafkaPipeline(object):
    ...
    def from_settings(cls, settings):
        ...
        try:
            ...
            logger.error("Unable to connect to Kafka in Pipeline"", raising exit flag.")
    ...
    def _kafka_success(self, item, spider, response):
        ...
        self.logger.debug("Sent page to Kafka", item)
