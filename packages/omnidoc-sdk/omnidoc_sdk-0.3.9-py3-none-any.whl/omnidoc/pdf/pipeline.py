...
def extract_pdf(
    ...
    *,
    ...
    - Slide → report semantic normalization
    ...
    # =================================================
    # 1️⃣ DIGITAL PDF — SIMPLE (no layout)
    # =================================================
    ...
    # 🔥 REQUIRED METADATA ENRICHMENT (NON-BREAKING)
    doc.metadata.update({
        "source_type": "pdf",
        "pipeline": "pdf",
        "scanned": scanned,
        "semantic_chunks": enable_semantic_chunks,
    })
