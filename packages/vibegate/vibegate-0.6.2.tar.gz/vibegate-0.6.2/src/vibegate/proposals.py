...
"""
    ...
    return str(
        cluster_dir.relative_to(repo_root / ".vibegate" / "artifacts" / "proposals")
    )
...
def generate_proposals(
    ...
    proposals = []
    proposals_dir = repo_root / ".vibegate" / "artifacts" / "proposals"
        ...
        if proposal.regression_snippet_path:
            lines.extend(
                [
                    "#### Regression Snippets",
                    "",
                    f"Code snippets extracted to: `.vibegate/artifacts/proposals/{proposal.regression_snippet_path}/`",
                    "",
