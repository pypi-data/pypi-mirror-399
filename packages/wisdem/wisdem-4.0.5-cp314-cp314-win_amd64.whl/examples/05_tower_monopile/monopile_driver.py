...
print("freq (Hz) =", wt_opt["fixedse.structural_frequencies"])
print("Fore-aft mode shapes =", wt_opt["fixedse.fore_aft_modes"])
print("Side-side mode shapes =", wt_opt["fixedse.side_side_modes"])
