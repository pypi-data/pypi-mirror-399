...
async def call_websocket_workflow(
    url: str = "ws://localhost:37200/api/v1/tag-service-0-0-1/test_websocket",
...
async def main():
    ...
    parser.add_argument(
        "--url",
        type=str,
        default="ws://localhost:37200/api/v1/tag-service-0-0-1/test_websocket",
    ...
    await call_websocket_workflow(url=args.url, message=args.message)
