...
echo '{"session_id":"<ID>","vectors":{"engagement":0.9,"foundation":{"know":0.8,"do":0.9,"context":0.7},"comprehension":{"clarity":0.85,"coherence":0.8,"signal":0.75,"density":0.6},"execution":{"state":0.6,"change":0.7,"completion":0.5,"impact":0.6},"uncertainty":0.25},"reasoning":"Baseline assessment"}' | empirica preflight-submit -

# 3. [DO YOUR WORK] - System observes via git diffs

# 4. CHECK (if: uncertainty >0.5 OR scope >0.6 OR complex decisions OR >2 hours)
