...
class User:
    ...
    def __init__(self, username: str, password: str):
        ...
        # Property conflicts with module-level/import names
        self.result = None
    ...
    def authenticate(self) -> bool:
        ...
        validate = self._internal_validate  # Shadows module-level validate
        result = validate(self.password)  # Shadows module-level result
...
def process(data: Any) -> str:
    ...
    if isinstance(data, str):
        # Local validate shadows module-level validate
...
class AuthManager:
    ...
    def add_user(self, username: str, password: str) -> "User":
        ...
        # No globals() usage - use module-level directly
        User_class = User  # Get class from module level
        user = User_class(username, password)  # Local var shadows class name
...
# Module-level function/variable assignments with conflicts
