...
Options:
    ...
    exactextract: High-performance raster-native zonal statistics using exactextract.
        This engine is significantly faster but only supports non-weighted statistics.
"""
...
class ZonalGen:
    ...
    def __init__(
        ...
        self.agg: ZonalEngineSerial | ZonalEngineParallel | ZonalEngineDask | ZonalEngineExactExtract
        ...
        elif self._zonal_engine == "exactextract":
            self.agg = ZonalEngineExactExtract()
        else:
...
class WeightedZonalGen:
    ...
    def __init__(
        ...
        if self._zonal_engine == "exactextract":
            raise TypeError(
                "exactextract engine does not support weighted zonal statistics. "
                "Use 'serial', 'parallel', or 'dask' instead."
            )
        elif self._zonal_engine == "serial":
            self.agg = ZonalEngineSerial()
        elif self._zonal_engine == "parallel":
            self.agg = ZonalEngineParallel()
        elif self._zonal_engine == "dask":
