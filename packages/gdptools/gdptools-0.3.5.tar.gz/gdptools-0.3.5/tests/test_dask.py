...
def test_dask_usercatdata_out_netcdf(get_xarray, get_gdf, get_out_path) -> None:
    """Test dask versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_dask_usercatdata_out_parquet(get_xarray, get_gdf, get_out_path) -> None:
    """Test dask versions."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
...
def test_dask_usercatdata_out_json(get_xarray, get_gdf, get_out_path) -> None:
    """Test Dask USERCatData."""
    sdate = "2021-01-01T00:00"
    edate = "2021-01-01T02:00"
    user_data = UserCatData(
        source_ds=get_xarray,
