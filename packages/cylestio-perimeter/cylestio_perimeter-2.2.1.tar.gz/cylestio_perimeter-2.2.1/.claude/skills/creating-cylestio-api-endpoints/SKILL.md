---
name: creating-cylestio-api-endpoints
description: Use when creating or modifying API endpoints for the Cylestio frontend. Triggers on API type definitions, fetch functions, or working with src/api/ directory.
---

# Creating Cylestio API Endpoints
