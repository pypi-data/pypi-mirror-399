...
def main():
    ...
    text_area_str = "hello bu bir deneme yazisidir bakalaim bu bolme islemi duzgun bir sekilde yapilabilcek mi acaba??"
    text_area = TextArea((20,650,300,200),text_area_str,text_color=(0,0,0),max_chars_per_line=20)
