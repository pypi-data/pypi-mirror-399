...
async def test_get_source_dist_file_zip(init_package_info, ado_token):
    ...
    package.extra_index_url = None
    package.prefer_source_distribution = True
    base_url = "pkgs.dev.azure.com/ceapex/d3d54af3-265a-4f18-95f6-9a46397ca583/_packaging/134734a5-2191-4e19-b4df-730065d6ebd3/pypi/download/azure-common/1.1.28/azure-common-1.1.28.zip"
    package.location = f"https://:{ado_token}@{base_url}"
    await get_source.get_source(sys.executable, package, 1, vststoken=ado_token)
...
async def test_get_source_dist_file_whl(init_package_info, ado_token):
    ...
    package.extra_index_url = None
    package.prefer_source_distribution = True
    base_url = "pkgs.dev.azure.com/ceapex/d3d54af3-265a-4f18-95f6-9a46397ca583/_packaging/134734a5-2191-4e19-b4df-730065d6ebd3/pypi/download/azure-common/1.1.28/azure_common-1.1.28-py2.py3-none-any.whl"
    package.location = f"https://:{ado_token}@{base_url}"
    await get_source.get_source(sys.executable, package, 2, vststoken=ado_token)
...
async def test_get_source_dist_file_tar(init_package_info, ado_token):
    ...
    package.extra_index_url = None
    package.prefer_source_distribution = True
    base_url = "pkgs.dev.azure.com/ceapex/d3d54af3-265a-4f18-95f6-9a46397ca583/_packaging/134734a5-2191-4e19-b4df-730065d6ebd3/pypi/download/azure-core/1.29.4/azure-core-1.29.4.tar.gz"
    package.location = f"https://:{ado_token}@{base_url}"
    await get_source.get_source(sys.executable, package, 3, vststoken=ado_token)
