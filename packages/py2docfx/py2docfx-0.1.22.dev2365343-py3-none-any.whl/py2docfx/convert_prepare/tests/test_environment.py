...
async def test_install_required_packages_dist_file(ado_token):
    ...
    required_package_info.name = "azure-core"
    base_url = "pkgs.dev.azure.com/ceapex/d3d54af3-265a-4f18-95f6-9a46397ca583/_packaging/134734a5-2191-4e19-b4df-730065d6ebd3/pypi/download/azure-core/1.32.0/azure_core-1.32.0-py3-none-any.whl"
    required_package_info.location = f"https://:{ado_token}@{base_url}"
