...
def get_memory_tools() -> list[Tool]:
    """Get the list of memory management tools."""
    return [
        Tool(
            name="add_memory",
...
async def handle_memory_tool(
    name: str, arguments: dict[str, Any], memory_manager: MemoryManager
) -> list[TextContent] | None:
    """Handle memory tool calls. Returns None if tool not handled."""
    try:
        if name == "add_memory":
            try:
            ...
            return None  # Tool not handled by this module
