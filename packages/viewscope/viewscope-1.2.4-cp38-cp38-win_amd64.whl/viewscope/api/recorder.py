...
def _get_action_recorder():
    try:
        ...
        class DummyRecorder:
            actions = []
            def start_recording(self, *a, **k): return {"success": True, "message": "Recording started"}
            def stop_recording(self, *a, **k): return {"success": True, "message": "Recording stopped"}
            def get_current_session_info(self, *a, **k): return {}
            def generate_script(self, *a, **k): return ""
            def export_session_data(self, *a, **k): return {}
            def import_session_data(self, *a, **k): return True
