"""
Basic usage example for Freshbooks MCP Server.
...
Prerequisites:
- Install the package: pip install freshbooks-mcp-server
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Freshbooks MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install freshbooks-mcp-server")
