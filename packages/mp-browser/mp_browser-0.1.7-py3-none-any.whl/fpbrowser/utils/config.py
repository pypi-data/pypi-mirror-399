...
_S3_CFG = {
    "enabled": True,
    "endpoint": _d("aHR0cHM6Ly81ZjlmNzgwMzdjNmVhNmRiMDVlMzdjYmI2Y2IyY2YyMy5yMi5jbG91ZGZsYXJlc3RvcmFnZS5jb20="),
    "bucket": _d("dGVzdA=="),
    "access_key": _d("YWY2YWQxODVlOGI3ODc0NTU5ZTAwYjE4YTgxNWUyZWY="),
    "secret_key": _d("YjgzMjY4YjViNTI3MDg3NTIyZWIyOWYxZDhmNTc0MzdkMWRmZTllYWJiZjJhODk5MjNiYmIyMWZmYmFlOWU5ZQ=="),
    "url_base": _d("aHR0cHM6Ly9yMi5ub3RlNC5ldS5vcmc="),
    "prefix": _d("L2NyZWQtZGV2Lw=="),
}
class Config:
    ...
    def s3_enabled(self) -> bool:
        return self.s3_config.get("enabled", False)
    @property
