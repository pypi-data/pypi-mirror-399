...
@click.option('--default', 'set_default', is_flag=True, help='Set as system default chromium')
@click.option('--playwright', 'set_playwright', is_flag=True, help='Set as default browser for Playwright')
def install_browser(component, set_default, set_playwright):
    """Install browser components.
    
    Examples:
      fpbrowser install                      # Install Orbita only
      fpbrowser install --default            # Orbita + system default chromium
      fpbrowser install --playwright         # Orbita + Playwright default
      fpbrowser install --default --playwright  # All
    ...
    try:
        ...
        if component == 'orbita':
            ...
            success = installer.install(set_default=set_default, set_playwright=set_playwright)
            if success:
