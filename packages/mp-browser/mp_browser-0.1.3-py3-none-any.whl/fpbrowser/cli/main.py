...
@click.option('--playwright', 'install_playwright', is_flag=True, help='Also install/align Playwright (v1.46)')
def install_browser(component, set_default, install_playwright):
    ...
    Examples:
      ...
      fpbrowser install orbita --default  # Install and set as Playwright default
      fpbrowser install orbita --default --playwright  # Also install Playwright
...
def _install_playwright():
    """Install or align Playwright version (v1.46 for Chromium 141)."""
    import subprocess
    ...
    try:
        ...
        if current and current.startswith("1.46"):
