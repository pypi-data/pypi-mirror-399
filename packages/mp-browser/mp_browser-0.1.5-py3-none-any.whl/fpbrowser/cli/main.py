...
@click.option('--default', 'set_default', is_flag=True, help='Set as default browser for Playwright')
@click.option('--playwright', 'install_playwright', is_flag=True, help='Also install/align Playwright v1.56')
def install_browser(component, set_default, install_playwright):
    ...
    Examples:
      ...
      fpbrowser install --default            # Orbita + set as Playwright default
      fpbrowser install --default --playwright  # Full: Orbita + default + Playwright
