...
hyrrokkin.DirectorySystem = class extends hyrrokkin.SystemBase {
    ...
    render_application(application_id) {
        ...
        let application_url = this.options["application_url"] || "hyrrokkin-application.html";
        label.append("a").attr("href",application_url + "?application_id="+application_id).attr("target","_self").text(this.l10n_utils.localise("open_application"))
            .add_class("open_link");
    }
}
