...
Python code) using [Hatch] and then uploads them to PyPI using [Trusted
publishing][trusted-publishing]. These artifacts are general-purpose and can be used on
...
Like the previous job group, the built wheels are uploaded to PyPI using [Trusted
