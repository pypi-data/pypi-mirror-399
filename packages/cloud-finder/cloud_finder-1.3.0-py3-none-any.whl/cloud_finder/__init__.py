...
class TopicFinder:
    ...
    def __init__(
        ...
        Args:
            ...
            fuzzy_threshold: Jaro-Winkler similarity threshold (default 0.86)
            max_edit_ratio: Max edit distance as ratio of word length (default 0.15)
                           Prevents false positives like "космические" -> "экономически"
        ...
        self._finder = _CloudFinder(text, fuzzy_threshold=fuzzy_threshold, max_edit_ratio=max_edit_ratio)
