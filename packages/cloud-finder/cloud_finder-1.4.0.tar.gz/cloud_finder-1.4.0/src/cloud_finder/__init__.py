...
__all__ = [
    ...
    "analyze_relevance",
    "normalize_query",
    # Presets (re-exported from vibe-finder)
    "PRESETS",
    "get_preset",
]
...
class TopicFinder:
    ...
    Example:
        ...
        # Override preset params
        finder = TopicFinder(document, preset="morphological", fuzzy_threshold=0.82)
    """
    ...
    def __init__(
        ...
        self._finder = _CloudFinder(text, preset=preset, fuzzy_threshold=fuzzy_threshold, max_edit_ratio=max_edit_ratio)
...
def find_topics(
    ...
    **kwargs,
    ...
    Example:
        ...
        # With preset for OCR documents
        find_topics(doc, keywords, preset="ocr")

        # With custom parameters
        find_topics(doc, keywords, fuzzy_threshold=0.90)
    """
