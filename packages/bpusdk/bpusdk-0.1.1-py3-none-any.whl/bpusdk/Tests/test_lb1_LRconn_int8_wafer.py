...
def gen_net(nNeuron,fanOut):
    t0 = time.time()
    conn_list = gen_conn_int8_lb1_LRconn(nNeuron, fanOut)
    net = EINet(nNeuron, conn=["customized",conn_list], method = "euler")
    t1 = time.time()
...
if __name__ == "__main__":
    ...
    target_dir = "../data7/lb1_int8_wafer"
    nNeuron = 16*2*4*1024
    #nNeuron = 1*1024
    nStep = 2
    fanOut = 13
    ...
    #bpuset = lb1_SNN(net, config={"Dtype":"int8","Npu_NeuronNum":8192,"Npu_EdgeNum":40960,"group_to_disable":128})
    ...
    # bpuset = lb1_SNN(net, inpS, inpE, config={"Dtype":"int8","Npu_NeuronNum":8192,"Npu_EdgeNum":40960,"group_to_disable":0})
