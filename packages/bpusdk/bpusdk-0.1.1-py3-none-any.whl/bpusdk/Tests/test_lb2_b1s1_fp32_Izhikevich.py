...
if __name__ == "__main__":
    download_dir = "../data8/Lb2_Izhikevich_tmp"
    upload_dir = "../upload8/ResLb2_Izhikevich_tmp"
    nExc = 8*1024
    nInh = 8*1024
    fanout = 2
    nStep = 20
    ...
    deploy.run_from_host(nStep=nStep,sender_path=sender_path,device_id=0,run=True)
