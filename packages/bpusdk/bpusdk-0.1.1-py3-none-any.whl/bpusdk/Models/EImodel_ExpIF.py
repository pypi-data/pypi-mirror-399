...
class EINet(bp.DynamicalSystem):
    def __init__(self, population_sizes, conn, method, allow_multi_conn=False):
        ...
        tauRef = 0+0.0001 
        self.E = bp.dyn.ExpIF(population_sizes[0], V_th=-30.,tau=10.,V_rest=-65.,V_reset=-68.,V_T=-59.9,delta_T=3.48,R=1.,
                              V_initializer=bp.init.Constant(-32.4399),
                            #    V_initializer=bp.init.Uniform(-80,-15.0),
                               method=method)
        self.I = bp.dyn.ExpIF(population_sizes[1], V_th=-30., tau=10., V_rest=-65.,V_reset=-68.,V_T=-59.9,delta_T=3.48,R=1.,
                               V_initializer=bp.init.Constant(-32.4399),
                            #    V_initializer=bp.init.Uniform(-80,-15.0),
                               method=method)
