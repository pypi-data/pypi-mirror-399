...
class EINet(bp.DynamicalSystem):
    def __init__(self, population_sizes, conn, method, allow_multi_conn=True):
        ...
        tauRef = 0+0.0001 
        self.E = bp.dyn.HH(population_sizes[0], V_th=-10.,
                            #    V_initializer=bp.init.Uniform(-70,-68),
                               V_initializer=bp.init.Constant(-30),
                               m_initializer=bp.init.Constant(0.),
                               h_initializer=bp.init.Constant(0.),
                               n_initializer=bp.init.Constant(0.),
                               method=method)
        self.I = bp.dyn.HH(population_sizes[1], V_th=-10.,
                            #    V_initializer=bp.init.Uniform(-70,-68),
                               V_initializer=bp.init.Constant(-30),
                               m_initializer=bp.init.Constant(0.),
                               h_initializer=bp.init.Constant(0.),
