...
class AsyncNodeConnection:
    ...
    * encapsulates handshake and reconnection.
    ...
    @property
    def ready(self) -> bool:
        """Tells if connection is ready for sending requests."""
        return self.alive and self.alive
    ...
    def process_message(self, data: bytearray):
        ...
        if resp_header.assignment_ts:
            self._cluster_connection.on_assignment_ts(resp_header.assignment_ts)
    ...
    async def send_heartbeat(self) -> bool:
        ...
        try:
            ...
            logger.debug("Error during heartbeat: %s, cause: %s", err, err.__cause__ or "None")
            return False
    ...
    def _on_handshake_success(self, resp: HandshakeResponse):
        ...
        self._node_name = resp.node_name
        ...
        if self._heartbeat_interval is not None:
            ...
            if idle_timeout:
                ...
                actual_heartbeat_interval = self._heartbeat_interval
