...
if (${USE_LOCAL_DEPS})
    ...
    fetch_dependency(msgpack-c https://nexus.gridgain.com/repository/github-raw/msgpack/msgpack-c/releases/download/c-6.0.1/msgpack-c-6.0.1.tar.gz 090df53a59b845767fcfc48221b30ee9)
    fetch_dependency(mbedtls https://nexus.gridgain.com/repository/github-raw/Mbed-TLS/mbedtls/releases/download/v3.6.0/mbedtls-3.6.0.tar.bz2 6b5a45b10e7d1c768ecec69ecf8e7abd)
    fetch_dependency(uni-algo https://nexus.gridgain.com/repository/github-raw/uni-algo/uni-algo/archive/v1.2.0.tar.gz 6e0cce94a6b45ebee7b904316df9f87f)
    if (${ENABLE_TESTS})
        fetch_dependency(googletest https://nexus.gridgain.com/repository/github-raw/google/googletest/archive/refs/tags/v1.14.0.tar.gz c8340a482851ef6a3fe618a082304cfc)
    endif()
endif()
