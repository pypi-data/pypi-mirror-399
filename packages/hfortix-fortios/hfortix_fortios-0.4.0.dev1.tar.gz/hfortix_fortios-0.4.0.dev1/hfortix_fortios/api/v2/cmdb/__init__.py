...
class CMDB:
    ...
    def __init__(self, client: "IHTTPClient") -> None:
        ...
        diameter_filter_mod = import_module(
            ".diameter_filter", "hfortix_fortios.api.v2.cmdb"
        )
        from .dlp import Dlp
        ...
        endpoint_control_mod = import_module(
            ".endpoint_control", "hfortix_fortios.api.v2.cmdb"
        )
        ethernet_oam_mod = import_module(
            ".ethernet_oam", "hfortix_fortios.api.v2.cmdb"
        )
        extension_controller_mod = import_module(
            ".extension_controller", "hfortix_fortios.api.v2.cmdb"
        )
        file_filter_mod = import_module(
            ".file_filter", "hfortix_fortios.api.v2.cmdb"
        )
        from .firewall import Firewall

        ftp_proxy_mod = import_module(
            ".ftp_proxy", "hfortix_fortios.api.v2.cmdb"
        )
        ...
        sctp_filter_mod = import_module(
            ".sctp_filter", "hfortix_fortios.api.v2.cmdb"
        )
