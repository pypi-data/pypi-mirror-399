...
- hfortix_fortios.api.v2.cmdb.* (Configuration endpoints)
- hfortix_fortios.api.v2.monitor.* (Monitoring endpoints)
- hfortix_fortios.firewall.* (Convenience wrappers)
- hfortix_fortios.system.* (Future convenience wrappers)
