...
# 3. Run API tests (parallel-safe tests with 8 workers)
codemie-test-harness run --marks "api and not not_for_parallel_run" -n 8 --reruns 2
```
...
pytest -n 8 -m "api and not not_for_parallel_run" --reruns 2
```
...
```shell
codemie-test-harness config set PYTEST_MARKS "api and not not_for_parallel_run"
...
codemie-test-harness run --marks "api and not not_for_parallel_run and (gitlab or jira_kb)" -n 8 --reruns 2

# Override API domain for this run
codemie-test-harness --api-domain https://api.example.com run --marks "api and llm" --reruns 2
```
...
codemie-test-harness run --marks "api and not not_for_parallel_run" -n 10
...
codemie-test-harness run --marks "api and not (jira or not_for_parallel_run)" -n 10
...
codemie-test-harness run --timeout 1200 --marks "api and not not_for_parallel_run" -n 8 --reruns 2
```
...
```shell
# Phase 1: Run parallel-safe API tests (8 workers)
codemie-test-harness run --marks "api and not not_for_parallel_run" -n 8 --reruns 2
...
codemie-test-harness run --marks "api and not not_for_parallel_run and jira" -n 8 --reruns 2

# Test Jira or Confluence integrations
codemie-test-harness run --marks "api and not not_for_parallel_run and (jira or confluence)" -n 8 --reruns 2
```
...
codemie-test-harness --api-domain https://preview.codemie.ai run --marks "api and llm" --reruns 2
codemie-test-harness --api-domain https://prod.codemie.ai run --marks "api and not not_for_parallel_run" -n 8 --reruns 2
...
```shell
# Test all LLMs
pytest -m "api and llm" --reruns 2

# Test codemie-code CLI and proxy endpoints
pytest -m "api and proxy" --reruns 2

# Test workflows
pytest -n 8 -m "api and not not_for_parallel_run and workflow" --reruns 2

# Test assistants
pytest -n 8 -m "api and not not_for_parallel_run and assistant" --reruns 2

# Test code executor tool
pytest -n 8 -m "api and not not_for_parallel_run and code_executor" --reruns 2
```
...
```shell
# Test Jira integration
pytest -n 8 -m "api and not not_for_parallel_run and jira" --reruns 2

# Test Jira or Confluence integrations
pytest -n 8 -m "api and not not_for_parallel_run and (jira or confluence)" --reruns 2
```
...
pytest -n 8 -m "api and not not_for_parallel_run" --timeout 900 --reruns 2  # 15 minutes
