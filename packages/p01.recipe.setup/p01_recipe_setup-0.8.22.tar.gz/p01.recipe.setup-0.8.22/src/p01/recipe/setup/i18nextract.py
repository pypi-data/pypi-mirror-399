...
$Id: i18nextract.py 5759 2025-12-09 14:11:39Z roger.ineichen $
"""
...
class POTMaker(POTMaker):
    ...
    def __init__ (self, output_fn, path, header_template=None):
        ...
        if header_template is not None and os.path.exists(header_template):
            with io.open(header_template, 'r', encoding='utf-8') as file:
    ...
    def write(self):
        ...
        if isinstance(header_text, bytes):
            ...
            header_bytes = header_text.encode(DEFAULT_CHARSET)
