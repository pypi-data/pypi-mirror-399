...
class PasteServeSetup:
    ...
    def install(self):
        ...
        with io.open(site_zcml_path, 'w', encoding='utf-8') as f:
            f.write(six.text_type(zcml))
        ...
        with io.open(paste_ini_path, 'w', encoding='utf-8') as f:
            f.write(six.text_type(ini))
        ...
        with io.open(zope_conf_path, 'w', encoding='utf-8') as f:
