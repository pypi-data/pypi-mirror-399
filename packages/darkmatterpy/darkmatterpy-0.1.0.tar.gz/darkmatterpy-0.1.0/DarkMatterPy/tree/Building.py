...
In the "darkmatterpy.tree.TreeHelpers" module, the dispatching is happening. One function
...
from darkmatterpy import ModuleRegistry, OutputDirectories, SourceCodeReferences
from darkmatterpy.__past__ import long, unicode
from darkmatterpy.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from darkmatterpy.Bytecodes import loadCodeObjectData
from darkmatterpy.containers.OrderedSets import OrderedSet
from darkmatterpy.Errors import CodeTooComplexCode
from darkmatterpy.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from darkmatterpy.importing import Importing
from darkmatterpy.importing.ImportCache import addImportedModule
from darkmatterpy.importing.PreloadedPackages import getPthImportedPackages
...
from darkmatterpy.nodes.BuiltinRefNodes import quick_names
from darkmatterpy.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from darkmatterpy.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from darkmatterpy.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from darkmatterpy.nodes.ExceptionNodes import StatementRaiseException
from darkmatterpy.nodes.FutureSpecs import FutureSpec
from darkmatterpy.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from darkmatterpy.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from darkmatterpy.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from darkmatterpy.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from darkmatterpy.nodes.ModuleNodes import (
...
from darkmatterpy.nodes.OperatorNodes import makeBinaryOperationNode
from darkmatterpy.nodes.OperatorNodesUnary import makeExpressionOperationUnary
...
from darkmatterpy.nodes.StatementNodes import StatementExpressionOnly
from darkmatterpy.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from darkmatterpy.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from darkmatterpy.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from darkmatterpy.pgo.PGO import decideCompilationFromPGO
...
from darkmatterpy.utils import MemoryUsage
from darkmatterpy.utils.ModuleNames import ModuleName
from darkmatterpy.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_DarkMatterPy"):
                    raise
