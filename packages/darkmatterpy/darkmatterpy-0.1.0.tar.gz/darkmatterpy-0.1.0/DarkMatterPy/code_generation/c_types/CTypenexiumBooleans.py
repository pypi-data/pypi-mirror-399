...
""" CType classes for DarkMatterPy_bool, an enum to represent True, False, unassigned.

"""

from darkmatterpy.code_generation.ErrorCodes import getReleaseCode
...
class CTypeOxNJACBoolEnum(CTypeNotReferenceCountedMixin, CTypeBase):
    ...
    def emitVariableAssignCode(
        ...
        if tmp_name.c_type == "DarkMatterPy_bool":
