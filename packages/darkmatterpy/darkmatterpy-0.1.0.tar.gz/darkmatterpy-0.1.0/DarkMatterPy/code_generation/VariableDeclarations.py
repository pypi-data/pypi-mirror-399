...
from .c_types.CTypeOxNJACInts import CTypeOxNJACIntOrLongStruct
...
class VariableDeclaration(object):
    ...
    def getCType(self):
        ...
        elif c_type == "struct OxNJAC_CellObject *":
            return CTypeCellObject
        elif c_type == "PyObject **":
            return CTypePyObjectPtrPtr
        elif c_type == "DarkMatterPy_bool":
            return CTypeOxNJACBoolEnum
        elif c_type == "bool":
            return CTypeBool
        elif c_type == "DarkMatterPy_ilong":
            return CTypeOxNJACIntOrLongStruct
        elif c_type == "module_var":
            return CTypeModuleDictVariable
        elif c_type == "DarkMatterPy_void":
            return CTypeOxNJACVoidEnum
        elif c_type == "long":
            return CTypeCLong
        elif c_type == "DarkMatterPy_digit":
...
class VariableStorage(object):
    ...
    def addFrameCacheDeclaration(self, frame_identifier):
        return self.addVariableDeclarationFunction(
            "static struct OxNJAC_FrameObject *", "cache_%s" % frame_identifier, "NULL"
        )
        ...
        if self.exception_variable_name is None:
            self.exception_variable_name = (
                self.addVariableDeclarationTop(
                    ...
                    "exception_state",
                    "Empty_OxNJAC_ExceptionPreservationItem",
                ),
                self.addVariableDeclarationTop(
