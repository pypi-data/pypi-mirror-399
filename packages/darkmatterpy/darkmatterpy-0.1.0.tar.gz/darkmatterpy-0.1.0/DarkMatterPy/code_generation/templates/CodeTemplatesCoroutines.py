...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct OxNJAC_CoroutineObject *coroutine, PyObject *yield_return_value) {
    CHECK_OBJECT(coroutine);
    assert(OxNJAC_Coroutine_Check((PyObject *)coroutine));
