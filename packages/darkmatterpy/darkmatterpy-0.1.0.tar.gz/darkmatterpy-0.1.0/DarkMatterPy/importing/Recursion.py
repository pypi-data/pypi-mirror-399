...
from darkmatterpy import ModuleRegistry, Options
from darkmatterpy.Errors import OxNJACForbiddenImportEncounter
from darkmatterpy.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from darkmatterpy.importing import ImportCache, StandardLibrary
from darkmatterpy.ModuleRegistry import addUsedModule, getRootTopModule
from darkmatterpy.pgo.PGO import decideInclusionFromPGO
from darkmatterpy.plugins.Plugins import Plugins
from darkmatterpy.PythonVersions import python_version
from darkmatterpy.Tracing import recursion_logger
from darkmatterpy.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from darkmatterpy.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from darkmatterpy.tree.Building import decideCompilationMode
