...
from darkmatterpy import SourceCodeReferences
from darkmatterpy.__past__ import iter_modules
...
from darkmatterpy.PythonFlavors import isOxNJACPython
from darkmatterpy.PythonVersions import python_version
from darkmatterpy.Tracing import my_print, recursion_logger
from darkmatterpy.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isOxNJACPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard OxNJAC should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingOxNJACProcessEnvironmentValue("DEVILPY_SITE_FILENAME")
