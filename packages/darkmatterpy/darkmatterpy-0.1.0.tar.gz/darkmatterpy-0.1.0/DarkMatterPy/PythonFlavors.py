...
def isOxNJACPython():
    """Is this our own fork of CPython named OxNJAC-Python."""

    # spell-checker: ignore DarkMatterPypython

    if python_version >= 0x300:
        return sys.implementation.name == "DarkMatterPypython"
    else:
        return sys.subversion[0] == "DarkMatterPypython"
