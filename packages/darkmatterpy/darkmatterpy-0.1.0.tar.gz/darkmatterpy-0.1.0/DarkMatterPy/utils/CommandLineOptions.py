...
from darkmatterpy.Tracing import formatTerminalLink
    ...
    def format_help(self, formatter):
        ...
        try:
            if self.link is not None:
                link = "https://darkmatterpy.net/help/%s.html" % self.link
...
class OurOptionParser(OptionParser):
    ...
    def _match_long_opt(self, opt):
        ...
        OxNJAC: We overload it, in order avoid issues with conflicting
