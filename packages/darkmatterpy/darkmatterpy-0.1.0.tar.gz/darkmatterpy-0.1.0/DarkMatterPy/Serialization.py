...
from darkmatterpy import OutputDirectories
from darkmatterpy.__past__ import (  # pylint: disable=I0021,redefined-builtin
    BaseExceptionGroup,
    ExceptionGroup,
    GenericAlias,
    UnionType,
...
from darkmatterpy.Builtins import (
    builtin_anon_codes,
    builtin_anon_values,
...
from darkmatterpy.utils.FileOperations import openPickleFile
...
class BlobData(object):
    ...
    def __repr__(self):
        return "<darkmatterpy.Serialization.BlobData %s>" % self.name
...
class GlobalConstantAccessor(object):
    ...
    def getConstantCode(self, constant):
        ...
        if constant is None:
            ...
            # TODO: Maybe make this a mapping in darkmatterpy.Builtins
