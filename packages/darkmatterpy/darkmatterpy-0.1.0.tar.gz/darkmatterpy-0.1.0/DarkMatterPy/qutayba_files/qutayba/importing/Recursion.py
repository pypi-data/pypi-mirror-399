...
from JACK import ModuleRegistry, Options
from JACK.Errors import OxNForbiddenImportEncounter
from JACK.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from JACK.importing import ImportCache, StandardLibrary
from JACK.ModuleRegistry import addUsedModule, getRootTopModule
from JACK.pgo.PGO import decideInclusionFromPGO
from JACK.plugins.Plugins import Plugins
from JACK.PythonVersions import python_version
from JACK.Tracing import recursion_logger
from JACK.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from JACK.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from JACK.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except OxNForbiddenImportEncounter as e:
