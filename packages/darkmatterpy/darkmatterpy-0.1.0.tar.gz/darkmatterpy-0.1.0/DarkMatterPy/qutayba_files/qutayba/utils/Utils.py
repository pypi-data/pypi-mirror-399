...
from JACK.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingOxNProcessEnvironmentValue(environment_variable_name):
    ...
    from JACK import getLaunchingOxNProcessEnvironmentValue

    return getLaunchingOxNProcessEnvironmentValue(environment_variable_name)
