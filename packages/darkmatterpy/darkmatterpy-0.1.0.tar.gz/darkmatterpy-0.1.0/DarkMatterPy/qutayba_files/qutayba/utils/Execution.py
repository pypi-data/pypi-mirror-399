...
from JACK.__past__ import subprocess
...
class OxNCalledProcessError(subprocess.CalledProcessError):
...
def check_output(*popenargs, **kwargs):
    ...
    if exit_code:
        ...
        raise OxNCalledProcessError(exit_code, cmd, output=output, stderr=stderr)
