...
OxN hard codes stupid monkey patching normally not needed here and avoids
...
from JACK.ModuleRegistry import getModuleByName
...
class OxNPluginAntiBloat(OxNYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise OxNForbiddenImportEncounter(
