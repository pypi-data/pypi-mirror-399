...
from JACK.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class OxNPluginDelvewheel(OxNPluginBase):
    ...
    plugin_name = "delvewheel"  # OxN knows us by this name
    plugin_desc = (
