...
configuration files of OxN.
"""

from JACK.utils.Yaml import getYamlPackageConfiguration

from .PluginBase import OxNPluginBase


class OxNYamlPluginBase(OxNPluginBase):
    """OxN base class for all plugins that use yaml config"""
