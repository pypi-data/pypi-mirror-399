...
from JACK.__past__ import unicode, xrange
from JACK.Errors import OxNAssumptionError
from JACK.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from JACK.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from JACK.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from JACK.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from JACK.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from JACK.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from JACK.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from JACK.nodes.BuiltinFormatNodes import (
...
from JACK.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from JACK.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from JACK.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from JACK.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from JACK.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from JACK.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from JACK.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from JACK.nodes.BuiltinRangeNodes import (
...
from JACK.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from JACK.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from JACK.nodes.BuiltinTypeNodes import (
...
from JACK.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from JACK.nodes.CallNodes import makeExpressionCall
from JACK.nodes.ClassNodes import ExpressionBuiltinType3
from JACK.nodes.ComparisonNodes import ExpressionComparisonIs
from JACK.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from JACK.nodes.ConstantRefNodes import makeConstantRefNode
from JACK.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from JACK.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from JACK.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from JACK.nodes.ImportNodes import ExpressionBuiltinImport
from JACK.nodes.KeyValuePairNodes import (
    makeKeyValuePairExpressionsFromKwArgs,
)
from JACK.nodes.NodeMakingHelpers import (
    makeConstantReplacementNode,
    makeExpressionBuiltinLocals,
    makeRaiseExceptionReplacementExpression,
    makeRaiseExceptionReplacementExpressionFromInstance,
)
from JACK.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from JACK.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from JACK.nodes.OutlineNodes import ExpressionOutlineBody
from JACK.nodes.ReturnNodes import makeStatementReturn
from JACK.nodes.SliceNodes import makeExpressionBuiltinSlice
from JACK.nodes.TypeNodes import (
...
from JACK.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from JACK.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from JACK.PythonVersions import python_version
from JACK.specs import BuiltinParameterSpecs
from JACK.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from JACK.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from JACK.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise OxNAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from JACK.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from JACK.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise OxNAssumptionError("open without argument is expected to raise")
...
def check():
    from JACK.Builtins import builtin_names
