...
def isOxNPython():
    """Is this our own fork of CPython named OxN-Python."""

    # spell-checker: ignore JACKpython

    if python_version >= 0x300:
        return sys.implementation.name == "JACKpython"
    else:
        return sys.subversion[0] == "JACKpython"
