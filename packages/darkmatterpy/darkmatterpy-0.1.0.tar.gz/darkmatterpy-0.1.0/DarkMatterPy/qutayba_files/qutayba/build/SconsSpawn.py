...
from JACK.Tracing import my_print, scons_logger
from JACK.utils.Execution import executeProcess
from JACK.utils.FileOperations import getReportPath
...
OxN with '--clean-cache=%s' once to repair it, or else will
surely happen again."""
        % cache_name
    )
