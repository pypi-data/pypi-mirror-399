...
what fortran version we have installed to compile with OxN.
...
from JACK.Tracing import scons_details_logger
from JACK.utils.Execution import executeProcess
from JACK.utils.FileOperations import openTextFile
from JACK.utils.Utils import isLinux, isMacOS
