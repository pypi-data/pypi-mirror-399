...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct OxN_AsyncgenObject *asyncgen, PyObject *yield_return_value) {
    CHECK_OBJECT(asyncgen);
    assert(OxN_Asyncgen_Check((PyObject *)asyncgen));
