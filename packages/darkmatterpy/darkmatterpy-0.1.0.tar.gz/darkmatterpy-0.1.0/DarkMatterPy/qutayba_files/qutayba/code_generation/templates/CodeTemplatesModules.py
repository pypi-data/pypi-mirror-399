 ...
 * created by OxN version %(version)s
 *
...
DEVILPY_MAY_BE_UNUSED static uint32_t _OxN_PyDictKeys_GetVersionForCurrentState(PyInterpreterState *interp, PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
...
static uint32_t _OxN_next_dict_keys_version = 2;

DEVILPY_MAY_BE_UNUSED static uint32_t _OxN_PyDictKeys_GetVersionForCurrentState(PyDictKeysObject *dk)
{
    if (dk->dk_version != 0) {
        return dk->dk_version;
    }
    uint32_t result = _OxN_next_dict_keys_version++;
    dk->dk_version = result;
    return result;
}
#endif
...
extern PyTypeObject OxN_Loader_Type;
...
static PyObject *_reduce_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    if (OxN_Function_Check(func) == false) {
    ...
    struct OxN_FunctionObject *function = (struct OxN_FunctionObject *)func;

    return OxN_Function_GetFunctionState(function, function_table_%(module_identifier)s);
}
...
static PyObject *_create_compiled_function(PyObject *self, PyObject *args, PyObject *kwds) {
    ...
    return (PyObject *)OxN_Function_CreateFunctionViaCodeIndex(
...
PyObject *modulecode_%(module_identifier)s(PyThreadState *tstate, PyObject *module, struct OxN_MetaPathBasedLoaderEntry const *loader_entry) {
    // Report entry to PGO.
    ...
    if (init_done == false) {
        ...
        module_full_name = strdup(OxN_String_AsString(real_module_name));
#endif
...
#endif
        /* Initialize the compiled types of OxN. */
...
#ifdef _DEVILPY_PLUGIN_DILL_ENABLED
    {
        ...
        if (loader_entry != NULL) {
            ...
            PyObject *module_name = GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (OxN_StringObject *)const_str_plain___name__);
            module_name_c = OxN_String_AsString(module_name);
        }
    ...
    UPDATE_STRING_DICT0(
        ...
        (OxN_StringObject *)const_str_plain___compiled__,
        OxN_dunder_compiled_value
    );
    ...
    // Update "__package__" value to what it ought to be.
    {
        ...
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (OxN_StringObject *)const_str_plain___package__,
    ...
    if (GET_STRING_DICT_VALUE(moduledict_%(module_identifier)s, (OxN_StringObject *)const_str_plain___builtins__) == NULL) {
        ...
        UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (OxN_StringObject *)const_str_plain___builtins__, value);
    }

    PyObject *module_loader = OxN_Loader_New(loader_entry);
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (OxN_StringObject *)const_str_plain___loader__, module_loader);
...
// Set the "__spec__" value
    ...
    UPDATE_STRING_DICT0(moduledict_%(module_identifier)s, (OxN_StringObject *)const_str_plain___spec__, Py_None);
#else
    // Other modules get a "ModuleSpec" from the standard mechanism.
    {
        ...
        UPDATE_STRING_DICT1(moduledict_%(module_identifier)s, (OxN_StringObject *)const_str_plain___spec__, spec_value);
    }
#endif
#endif
...
static int OxN_TopLevelModule_tp_setattro(PyObject *module, PyObject *name, PyObject *value) {
    PyModule_Type.tp_setattro = orig_PyModule_Type_tp_setattro;

    if (orig_dunder_file_value != NULL) {
        UPDATE_STRING_DICT0(
            moduledict_%(module_identifier)s,
            (OxN_StringObject *)const_str_plain___file__,
...
extern struct OxN_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name);
...
static PyObject *%(module_dll_entry_point)s_phase2(PyObject *module) {
    ...
    if (result != NULL) {
        ...
        PyModule_Type.tp_setattro = OxN_TopLevelModule_tp_setattro;
...
DEVILPY_MODULE_INIT_FUNCTION (%(module_dll_entry_point)s)(void) {
    ...
    {
        DEVILPY_MAY_BE_UNUSED bool res = OxN_SetModuleString(module_full_name, module);
        assert(res != false);
    }
...
template_module_exception_exit = """\
...
#if _DEVILPY_MODULE_MODE && %(is_top)d
    {
        ...
        if (module_name != NULL) {
            OxN_DelModule(tstate, module_name);
        }
    }
#endif
    PGO_onModuleExit("%(module_identifier)s", false);
