...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct OxN_GeneratorObject *generator, PyObject *yield_return_value) {
    CHECK_OBJECT(generator);
    assert(OxN_Generator_Check((PyObject *)generator));
...
%(closure_copy)s
%(to_name)s = OxN_Generator_NewEmpty(
    %(generator_module)s,
    %(generator_name_obj)s,
#if PYTHON_VERSION >= 0x350
    %(generator_qualname_obj)s,
