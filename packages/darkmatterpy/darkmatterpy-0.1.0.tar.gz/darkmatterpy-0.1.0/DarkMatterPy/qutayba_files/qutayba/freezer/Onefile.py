...
from JACK.Options import getOnefileTempDirSpec, isOnefileTempDirMode
from JACK.OutputDirectories import getResultFullpath
from JACK.plugins.Plugins import Plugins
from JACK.PostProcessing import executePostProcessingResources
from JACK.PythonVersions import (
    getZstandardSupportingVersions,
    python_version,
)
from JACK.Tracing import onefile_logger, postprocessing_logger
from JACK.utils.Execution import withEnvironmentVarsOverridden
...
from JACK.utils.SharedLibraries import cleanupHeaderForAndroid
from JACK.utils.Signing import addMacOSCodeSignature
...
from JACK.utils.WindowsResources import RT_RCDATA, addResourceToFile
...
def runOnefileCompressor(
    ...
    if compressor_python is None or areSamePaths(
        ...
        from JACK.tools.onefile_compressor.OnefileCompressor import (
        ...
        mapping = {
            "DEVILPY_PACKAGE_HOME": os.path.dirname(
                os.path.abspath(sys.modules["JACK"].__path__[0])
            )
        }
