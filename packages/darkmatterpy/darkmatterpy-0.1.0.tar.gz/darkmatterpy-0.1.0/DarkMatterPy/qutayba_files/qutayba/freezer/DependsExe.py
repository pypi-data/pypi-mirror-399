...
from JACK.Options import assumeYesForDownloads
from JACK.Tracing import inclusion_logger
from JACK.utils.Download import getCachedDownload
from JACK.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from JACK.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
OxN will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="OxN does not work in --standalone or --onefile on Windows without.",
