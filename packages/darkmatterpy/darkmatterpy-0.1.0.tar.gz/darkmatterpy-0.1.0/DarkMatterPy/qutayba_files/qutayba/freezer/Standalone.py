...
from JACK.Errors import OxNForbiddenDLLEncounter, OxNNotYetSupported
...
from JACK.PythonVersions import getSystemPrefixPath
from JACK.Tracing import general, inclusion_logger
from JACK.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from JACK.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from JACK import ModuleRegistry
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isOxNPython():
        return OrderedSet()
    elif (
...
def _detectUsedDLLs(standalone_entry_point, source_dir):
    ...
    except OxNForbiddenDLLEncounter:
