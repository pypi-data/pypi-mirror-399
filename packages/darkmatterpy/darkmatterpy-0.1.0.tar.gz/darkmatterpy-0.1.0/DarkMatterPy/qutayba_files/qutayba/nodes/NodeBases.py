...
from JACK import Options, Tracing, TreeXML
from JACK.__past__ import iterItems
from JACK.Errors import OxNNodeError
from JACK.PythonVersions import python_version
from JACK.SourceCodeReferences import SourceCodeReference
...
from JACK.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise OxNNodeError("Problem cloning node", self, e)
