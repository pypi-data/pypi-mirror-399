...
from darkmatterpy.utils.Utils import hasMacOSIntelSupport, isMacOS
        ...
        if ccache_binary is None:
            if hasMacOSIntelSupport():
                ...
                if tuple(int(d) for d in platform.release().split(".")) >= (18, 2):
                    url = "https://darkmatterpy.net/ccache/v4.2.1/ccache-4.2.1.zip"
                    ...
                    ccache_binary = getCachedDownload(
                        ...
                        flatten=True,
                        binary="ccache",
                        message="OxNJAC will make use of ccache to speed up repeated compilation.",
                        reject=None,
