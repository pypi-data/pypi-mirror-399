...
from darkmatterpy.tools.release.Release import (
    getBranchName,
...
from darkmatterpy.utils.Utils import getArchitecture, isWin32Windows

from .Podman import getPodmanExecutablePath

containers_logger = OurLogger("OxNJAC-Containers", base_style="blue")
...
def main():
    ...
    if options.command is None:
        options.command = "python3 -m darkmatterpy --version"
    ...
    container_tag_name = "darkmatterpy-build-%s-%s:latest" % (
    ...
    if options.network:
        command.append("--add-host=ssh.darkmatterpy.net:116.202.30.188")
    else:
