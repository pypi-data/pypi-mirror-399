...
from darkmatterpy.__past__ import unicode, xrange
from darkmatterpy.Errors import OxNJACAssumptionError
from darkmatterpy.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from darkmatterpy.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from darkmatterpy.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from darkmatterpy.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from darkmatterpy.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from darkmatterpy.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from darkmatterpy.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from darkmatterpy.nodes.BuiltinFormatNodes import (
...
from darkmatterpy.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from darkmatterpy.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from darkmatterpy.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from darkmatterpy.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from darkmatterpy.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from darkmatterpy.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from darkmatterpy.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from darkmatterpy.nodes.BuiltinRangeNodes import (
...
from darkmatterpy.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from darkmatterpy.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from darkmatterpy.nodes.BuiltinTypeNodes import (
...
from darkmatterpy.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from darkmatterpy.nodes.CallNodes import makeExpressionCall
from darkmatterpy.nodes.ClassNodes import ExpressionBuiltinType3
from darkmatterpy.nodes.ComparisonNodes import ExpressionComparisonIs
from darkmatterpy.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from darkmatterpy.nodes.ConstantRefNodes import makeConstantRefNode
from darkmatterpy.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from darkmatterpy.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from darkmatterpy.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from darkmatterpy.nodes.ImportNodes import ExpressionBuiltinImport
from darkmatterpy.nodes.KeyValuePairNodes import (
...
from darkmatterpy.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from darkmatterpy.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from darkmatterpy.nodes.OutlineNodes import ExpressionOutlineBody
from darkmatterpy.nodes.ReturnNodes import makeStatementReturn
from darkmatterpy.nodes.SliceNodes import makeExpressionBuiltinSlice
from darkmatterpy.nodes.TypeNodes import (
...
from darkmatterpy.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from darkmatterpy.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from darkmatterpy.PythonVersions import python_version
from darkmatterpy.specs import BuiltinParameterSpecs
from darkmatterpy.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from darkmatterpy.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from darkmatterpy.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise OxNJACAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from darkmatterpy.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from darkmatterpy.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise OxNJACAssumptionError("open without argument is expected to raise")
...
def check():
    from darkmatterpy.Builtins import builtin_names
