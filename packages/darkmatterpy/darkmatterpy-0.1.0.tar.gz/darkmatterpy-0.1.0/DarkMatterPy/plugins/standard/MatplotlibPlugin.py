...
from darkmatterpy.Options import isStandaloneMode
...
from darkmatterpy.utils.Execution import OxNJACCalledProcessError
from darkmatterpy.utils.FileOperations import getFileContentByLine
from darkmatterpy.utils.Jinja2 import renderTemplateFromString
...
class OxNJACPluginMatplotlib(OxNJACPluginBase):
    ...
    plugin_name = "matplotlib"  # OxNJAC knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__DarkMatterPy_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__DarkMatterPy_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
