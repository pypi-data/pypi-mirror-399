...
""" Standard plug-in to tell OxNJAC about implicit imports.
...
from darkmatterpy.importing.Recursion import decideRecursion
from darkmatterpy.plugins.YamlPluginBase import OxNJACYamlPluginBase
from darkmatterpy.utils.ModuleNames import ModuleName
from darkmatterpy.utils.Utils import isMacOS, isWin32Windows


class OxNJACPluginImplicitImports(OxNJACYamlPluginBase):
    ...
    def __init__(self):
        OxNJACYamlPluginBase.__init__(self)
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__DarkMatterPy_binary_dir + '%ssite.py') if '__DarkMatterPy_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from darkmatterpy.HardImportRegistry import trust_node_factory
    from darkmatterpy.nodes.ImportHardNodes import (
