...
""" Standard plug-in to tell OxNJAC about DLLs needed for standalone imports.
...
from darkmatterpy.utils.SharedLibraries import getPyWin32Dir
from darkmatterpy.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class OxNJACPluginDllFiles(OxNJACYamlPluginBase):
