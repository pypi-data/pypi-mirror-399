...
from darkmatterpy.importing.StandardLibrary import (
...
from darkmatterpy.Tracing import general, printError
from darkmatterpy.utils.Execution import executeProcess
from darkmatterpy.utils.FileOperations import areSamePaths
...
print("\\n".join(sorted(
    ...
    # Make sure the right import path (the one OxNJAC binary is running with)
    # is used.
    command = (
