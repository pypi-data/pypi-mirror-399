...
DLLs or extension modules, these need to be seen by OxNJAC as entry points
...
from darkmatterpy.OutputDirectories import getStandaloneDirectoryPath
from darkmatterpy.Tracing import general, inclusion_logger, options_logger
