...
from darkmatterpy.Options import assumeYesForDownloads
from darkmatterpy.Tracing import inclusion_logger
from darkmatterpy.utils.Download import getCachedDownload
from darkmatterpy.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from darkmatterpy.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
OxNJAC will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="OxNJAC does not work in --standalone or --onefile on Windows without.",
