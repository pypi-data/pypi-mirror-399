...
from darkmatterpy.Options import getOnefileTempDirSpec, isOnefileTempDirMode
from darkmatterpy.OutputDirectories import getResultFullpath
from darkmatterpy.plugins.Plugins import Plugins
from darkmatterpy.PostProcessing import executePostProcessingResources
from darkmatterpy.PythonVersions import (
    getZstandardSupportingVersions,
    python_version,
)
from darkmatterpy.Tracing import onefile_logger, postprocessing_logger
...
from darkmatterpy.utils.SharedLibraries import cleanupHeaderForAndroid
...
from darkmatterpy.utils.WindowsResources import RT_RCDATA, addResourceToFile
...
def runOnefileCompressor(
    ...
    if compressor_python is None or areSamePaths(
        ...
        from darkmatterpy.tools.onefile_compressor.OnefileCompressor import (
