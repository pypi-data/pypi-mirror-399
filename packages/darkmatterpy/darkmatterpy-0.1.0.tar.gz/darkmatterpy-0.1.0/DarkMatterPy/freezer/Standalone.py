...
from darkmatterpy.Errors import OxNJACForbiddenDLLEncounter, OxNJACNotYetSupported
...
from darkmatterpy.PythonVersions import getSystemPrefixPath
from darkmatterpy.Tracing import general, inclusion_logger
from darkmatterpy.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from darkmatterpy.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
from darkmatterpy.utils.Signing import addMacOSCodeSignature
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from darkmatterpy import ModuleRegistry
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isOxNJACPython():
        return OrderedSet()
    elif (
...
def _detectUsedDLLs(standalone_entry_point, source_dir):
    ...
    except OxNJACForbiddenDLLEncounter:
