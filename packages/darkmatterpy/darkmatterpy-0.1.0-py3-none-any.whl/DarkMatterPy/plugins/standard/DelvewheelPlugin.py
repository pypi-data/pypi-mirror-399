...
from darkmatterpy.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class OxNJACPluginDelvewheel(OxNJACPluginBase):
    ...
    plugin_name = "delvewheel"  # OxNJAC knows us by this name
    plugin_desc = (
