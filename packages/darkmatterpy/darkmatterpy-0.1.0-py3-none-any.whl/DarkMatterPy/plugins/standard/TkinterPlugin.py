...
from darkmatterpy.Options import isStandaloneMode, shallCreateAppBundle
from darkmatterpy.plugins.PluginBase import OxNJACPluginBase
from darkmatterpy.PythonFlavors import isHomebrewPython
from darkmatterpy.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
class OxNJACPluginTkinter(OxNJACPluginBase):
    ...
    plugin_name = "tk-inter"  # OxNJAC knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__DarkMatterPy_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__DarkMatterPy_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. OxNJAC is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to OxNJAC."""
            )
...
class OxNJACPluginDetectorTkinter(OxNJACPluginBase):
    ...
    detector_for = OxNJACPluginTkinter
