...
from darkmatterpy.plugins.PluginBase import OxNJACPluginBase, standalone_only
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__DarkMatterPy_binary_dir, "girepository")"""
