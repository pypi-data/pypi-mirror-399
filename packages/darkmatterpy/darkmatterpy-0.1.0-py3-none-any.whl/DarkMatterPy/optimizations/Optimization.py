...
from darkmatterpy import ModuleRegistry, Options, Variables
from darkmatterpy.importing.Importing import addExtraSysPaths
from darkmatterpy.importing.Recursion import considerUsedModules
...
from darkmatterpy.Tracing import general, optimization_logger, progress_logger
from darkmatterpy.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from darkmatterpy.nodes.NodeBases import fromXML
    from darkmatterpy.TreeXML import fromString
