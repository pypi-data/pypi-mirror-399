...
static PyObject *%(function_identifier)s_context(PyThreadState *tstate, struct OxNJAC_AsyncgenObject *asyncgen, PyObject *yield_return_value) {
    CHECK_OBJECT(asyncgen);
    assert(OxNJAC_Asyncgen_Check((PyObject *)asyncgen));
