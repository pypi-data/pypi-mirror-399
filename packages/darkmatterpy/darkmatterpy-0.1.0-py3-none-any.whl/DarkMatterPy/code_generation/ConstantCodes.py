...
from darkmatterpy.Serialization import GlobalConstantAccessor
from darkmatterpy.utils.CStrings import encodePythonStringToC
from darkmatterpy.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from darkmatterpy.Version import getOxNJACVersionTuple
...
#    major, minor, micro, is_final, _rc_number = getOxNJACVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "DarkMatterPy_version_major": major,
        "DarkMatterPy_version_minor": minor,
        "DarkMatterPy_version_micro": micro,
        "DarkMatterPy_version_level": "release" if is_final else "candidate",
