...
from darkmatterpy.nodes.NodeMetaClasses import OxNJACNodeDesignError
from darkmatterpy.Options import shallTraceExecution
from darkmatterpy.PythonVersions import python_version
from darkmatterpy.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "DarkMatterPy_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "DarkMatterPy_void":
