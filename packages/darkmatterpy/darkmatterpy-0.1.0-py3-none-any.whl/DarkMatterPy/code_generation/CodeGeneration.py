...
from darkmatterpy.nodes.AttributeNodesGenerated import (
    attribute_classes,
    attribute_typed_classes,
)
from darkmatterpy.nodes.BytesNodes import getBytesOperationClasses
from darkmatterpy.nodes.StrNodes import getStrOperationClasses
