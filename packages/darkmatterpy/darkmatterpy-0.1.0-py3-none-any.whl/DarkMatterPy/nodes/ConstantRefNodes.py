...
from darkmatterpy.__past__ import (
    GenericAlias,
    UnionType,
    iterItems,
    long,
...
from darkmatterpy.Constants import (
...
from darkmatterpy.Tracing import optimization_logger
...
class ExpressionConstantTypeRef(ExpressionConstantUntrackedRefBase):
    ...
    def computeExpressionCall(self, call_node, call_args, call_kw, trace_collection):
        ...
        if call_kw is not None and not call_kw.isMappingWithConstantStringKeys():
            ...
            from darkmatterpy.optimizations.OptimizeBuiltinCalls import (
                computeBuiltinCall,
            )
