...
from darkmatterpy.optimizations.TraceCollections import (
    TraceCollectionPureFunction,
    withChangeIndicationsTo,
)
from darkmatterpy.PythonVersions import python_version
from darkmatterpy.specs.ParameterSpecs import (
    ParameterSpec,
    TooManyArguments,
    matchCall,
)
from darkmatterpy.Tracing import optimization_logger, printError
from darkmatterpy.tree.Extractions import updateVariableUsage
from darkmatterpy.tree.SourceHandling import readSourceLines
from darkmatterpy.tree.TreeHelpers import makeDictCreationOrConstant2
...
class ExpressionFunctionRef(ExpressionNoSideEffectsMixin, ExpressionBase):
    ...
    def getFunctionBody(self):
        if self.function_body is None:
            ...
            from darkmatterpy.ModuleRegistry import getModuleFromCodeName
...
class ExpressionFunctionCall(ChildrenHavingFunctionValuesTupleMixin, ExpressionBase):
    ...
    def computeExpression(self, trace_collection):
        ...
        if cost is not None and cost < 50:
            from darkmatterpy.optimizations.FunctionInlining import (
