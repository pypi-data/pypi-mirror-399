...
from darkmatterpy.__past__ import (  # pylint: disable=redefined-builtin
    BrokenPipeError,
    raw_input,
)
...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://darkmatterpy.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from darkmatterpy.Progress import closeProgressBar
...
general = OurLogger("OxNJAC")
plugins_logger = OurLogger("OxNJAC-Plugins")
recursion_logger = OurLogger("OxNJAC-Inclusion")
progress_logger = OurLogger("OxNJAC-Progress", quiet=True)
memory_logger = OurLogger("OxNJAC-Memory")
metadata_logger = OurLogger("OxNJAC-Metadata")
optimization_logger = FileLogger("OxNJAC-Optimization")
pgo_logger = FileLogger("OxNJAC-PGO")
code_generation_logger = OurLogger("OxNJAC-CodeGen")
inclusion_logger = FileLogger("OxNJAC-Inclusion")
scons_logger = OurLogger("OxNJAC-Scons")
scons_details_logger = OurLogger("OxNJAC-Scons")
postprocessing_logger = OurLogger("OxNJAC-Postprocessing")
options_logger = OurLogger("OxNJAC-Options")
unusual_logger = OurLogger("OxNJAC-Unusual")
data_composer_logger = OurLogger("OxNJAC-DataComposer")
onefile_logger = OurLogger("OxNJAC-Onefile")
tools_logger = OurLogger("OxNJAC-Tools")
wheel_logger = OurLogger("OxNJAC-Wheel", base_style="blue")
cache_logger = OurLogger("OxNJAC-Cache")
reports_logger = OurLogger("OxNJAC-Reports")
offsets_logger = OurLogger("OxNJAC-Offsets")
