...
from JACK import SourceCodeReferences
from JACK.__past__ import iter_modules
...
from JACK.PythonFlavors import isOxNPython
from JACK.PythonVersions import python_version
from JACK.Tracing import my_print, recursion_logger
from JACK.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isOxNPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard OxN should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingOxNProcessEnvironmentValue("DEVILPY_SITE_FILENAME")
