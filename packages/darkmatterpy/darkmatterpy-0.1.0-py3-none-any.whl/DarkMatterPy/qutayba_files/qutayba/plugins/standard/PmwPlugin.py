...
from JACK.__past__ import StringIO
from JACK.plugins.PluginBase import OxNPluginBase
from JACK.utils.FileOperations import getFileContents, listDir
...
class OxNPluginPmw(OxNPluginBase):
...
class OxNPluginDetectorPmw(OxNPluginBase):
    detector_for = OxNPluginPmw
