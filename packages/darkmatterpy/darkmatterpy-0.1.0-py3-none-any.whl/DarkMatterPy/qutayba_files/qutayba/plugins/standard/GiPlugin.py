...
from JACK.plugins.PluginBase import OxNPluginBase, standalone_only


class OxNPluginGi(OxNPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__JACK_binary_dir, "girepository")"""
