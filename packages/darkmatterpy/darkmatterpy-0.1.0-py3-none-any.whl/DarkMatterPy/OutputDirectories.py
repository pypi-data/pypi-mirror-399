...
""" Directories and paths to for output of OxNJAC.
...
from darkmatterpy.utils.SharedLibraries import getDllSuffix
from darkmatterpy.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".darkmatterpy-pgo"
