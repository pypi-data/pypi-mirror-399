...
from darkmatterpy.build.DataComposerInterface import getConstantBlobFilename
from darkmatterpy.ModuleRegistry import getImportedModuleNames
from darkmatterpy.PythonFlavors import isSelfCompiledPythonUninstalled
from darkmatterpy.PythonVersions import getTargetPythonDLLPath, python_version
from darkmatterpy.Tracing import postprocessing_logger
from darkmatterpy.utils.Execution import wrapCommandForDebuggerForExec
...
from darkmatterpy.utils.Images import convertImageToIconFormat
from darkmatterpy.utils.Importing import importFromInlineCopy
from darkmatterpy.utils.MacOSApp import createPlistInfoFile
...
from darkmatterpy.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from darkmatterpy.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def createScriptFileForExecution(result_filename):
    ...
    if isWin32Windows():
        script_contents = """
@echo off
rem This script was created by OxNJAC to execute '%(exe_filename)s' with Python DLL being found.
...
def _createModulePyiFile():
    ...
    contents = """\
# This file was generated by OxNJAC
"""
