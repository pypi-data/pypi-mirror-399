...
from darkmatterpy.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingOxNJACProcessEnvironmentValue(environment_variable_name):
    ...
    from darkmatterpy import getLaunchingOxNJACProcessEnvironmentValue

    return getLaunchingOxNJACProcessEnvironmentValue(environment_variable_name)
