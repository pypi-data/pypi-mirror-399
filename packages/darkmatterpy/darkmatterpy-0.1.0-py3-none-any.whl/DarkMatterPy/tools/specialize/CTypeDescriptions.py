...
from darkmatterpy.__past__ import long
from darkmatterpy.code_generation.BinaryOperationHelperDefinitions import (
    isCommutativeType,
)
from darkmatterpy.code_generation.Namify import namifyConstant
...
class NBoolDesc(ConcreteCTypeBase):
    ...
    def getToValueFromObjectExpression(cls, operand):
        # TODO: Seems wrong, int return values only happen to match DarkMatterPy_bool here
