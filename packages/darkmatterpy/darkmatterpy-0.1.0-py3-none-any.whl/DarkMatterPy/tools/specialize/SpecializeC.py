...
import darkmatterpy.Options

darkmatterpy.Options.is_full_compat = False

# isort:start

import os

import darkmatterpy.specs.BuiltinBytesOperationSpecs
import darkmatterpy.specs.BuiltinDictOperationSpecs
import darkmatterpy.specs.BuiltinListOperationSpecs
import darkmatterpy.specs.BuiltinStrOperationSpecs
import darkmatterpy.specs.BuiltinUnicodeOperationSpecs
from darkmatterpy.code_generation.BinaryOperationHelperDefinitions import (
    getSpecializedBinaryOperations,
    isCommutativeOperation,
    parseTypesFromHelper,
)
from darkmatterpy.code_generation.c_types.CTypePyObjectPointers import (
    make_list_constant_direct_threshold,
    make_list_constant_hinted_threshold,
)
from darkmatterpy.code_generation.CallCodes import (
    getQuickCallCode,
...
from darkmatterpy.code_generation.ComparisonHelperDefinitions import (
    getSpecializedComparisonOperations,
)
from darkmatterpy.code_generation.ImportCodes import getImportModuleHardCodeName
from darkmatterpy.containers.OrderedSets import OrderedSet
from darkmatterpy.HardImportRegistry import (
    hard_modules,
    hard_modules_non_stdlib,
    hard_modules_version,
)
from darkmatterpy.nodes.shapes.BuiltinTypeShapes import (
    tshape_bool,
    tshape_bytes,
    tshape_dict,
    tshape_int,
...
from darkmatterpy.utils.Jinja2 import getTemplateC
...
def getDoExtensionUsingTemplateC(template_name):
    return getTemplateC(
        package_name="darkmatterpy.code_generation",
...
#ifdef __IDE_ONLY__
#include "darkmatterpy/prelude.h"
#endif
"""
    )
...
def makeHelpersComparisonOperation(operand, op_code):
    ...
    filename_c = "darkmatterpy/build/static_src/HelpersComparison%s.c" % op_code.capitalize()
    filename_h = "darkmatterpy/build/include/darkmatterpy/helper/comparisons_%s.h" % op_code.lower()
...
def makeHelpersComparisonDualOperation(operand, op_code):
    ...
    filename_c = (
        "darkmatterpy/build/static_src/HelpersComparisonDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "darkmatterpy/build/include/darkmatterpy/helper/comparisons_dual_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryOperation(operator, op_code):
    ...
    filename_c = (
        "darkmatterpy/build/static_src/HelpersOperationBinary%s.c" % op_code.capitalize()
    )
    filename_h = (
        "darkmatterpy/build/include/darkmatterpy/helper/operations_binary_%s.h" % op_code.lower()
    )
...
def makeHelpersInplaceOperation(operator, op_code):
    ...
    filename_c = (
        "darkmatterpy/build/static_src/HelpersOperationInplace%s.c" % op_code.capitalize()
    )
    filename_h = (
        "darkmatterpy/build/include/darkmatterpy/helper/operations_inplace_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryDualOperation(operand, op_code):
    ...
    filename_c = (
        "darkmatterpy/build/static_src/HelpersOperationBinaryDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "darkmatterpy/build/include/darkmatterpy/helper/operations_binary_dual_%s.h"
        % op_code.lower()
    )
...
def makeHelpersImportHard():
    filename_c = "darkmatterpy/build/static_src/HelpersImportHard.c"
    filename_h = "darkmatterpy/build/include/darkmatterpy/helper/import_hard.h"
...
def makeHelperCalls():
    filename_c = "darkmatterpy/build/static_src/HelpersCallingGenerated.c"
    filename_h = "darkmatterpy/build/include/darkmatterpy/helper/calling_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "darkmatterpy.code_generation", "CodeTemplateCallsPositional.c.j2"
            )
            ...
            template = getTemplateC(
                "darkmatterpy.code_generation", "CodeTemplateCallsMixed.c.j2"
            )
...
def makeHelperLists():
    filename_c = "darkmatterpy/build/static_src/HelpersListsGenerated.c"
    filename_h = "darkmatterpy/build/include/darkmatterpy/helper/lists_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "darkmatterpy.code_generation", "CodeTemplateMakeListSmall.c.j2"
            )
            ...
            template = getTemplateC(
                "darkmatterpy.code_generation", "CodeTemplateMakeListHinted.c.j2"
            )
...
generate_builtin_type_operations = [
    ...
    # OxNJAC-Python eventually.
    (
        "tshape_dict",
        dict_desc,
        darkmatterpy.specs.BuiltinDictOperationSpecs,
        ("pop", "popitem", "setdefault"),
    ),
    (
        "tshape_list",
        list_desc,
        darkmatterpy.specs.BuiltinListOperationSpecs,
        (
            "pop",
    ...
    # that we do not have easy access to, but we might one day for OxNJAC-Python
    # expose it for the static linking of it and then we could in fact call
    # these directly.
    (
        "tshape_str",
        str_desc,
        darkmatterpy.specs.BuiltinStrOperationSpecs,
        (
            "strip",
            "rstrip",
            "lstrip",
    ...
    (
        "tshape_unicode",
        unicode_desc,
        darkmatterpy.specs.BuiltinUnicodeOperationSpecs,
        (
            "strip",
            "rstrip",
            "lstrip",
    ...
    (
        "tshape_bytes",
        bytes_desc,
        darkmatterpy.specs.BuiltinBytesOperationSpecs,
        (
            "capitalize",
            "center",
            "count",
...
def makeDictCopyHelperCodes():
    filename_c = "darkmatterpy/build/static_src/HelpersDictionariesGenerated.c"
...
def _getCheckForShape(shape):
    ...
    if shape is tshape_str:
        return "OxNJAC_String_CheckExact"
...
def makeHelperBuiltinTypeMethods():
    ...
    filename_c = "darkmatterpy/build/static_src/HelpersBuiltinTypeMethods.c"
    filename_h = "darkmatterpy/build/include/darkmatterpy/helper/operations_builtin_types.h"
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
