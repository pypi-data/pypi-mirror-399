...
""" Conda backend for maintaining locked package state with darkmatterpy-watch. """

from darkmatterpy.utils.Execution import check_call, executeToolChecked
from darkmatterpy.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "darkmatterpy-watch-case-%(python_version)s-%(case)s" % {
