...
""" Pacman backend for maintaining locked package state with darkmatterpy-watch. """

from darkmatterpy.utils.Execution import check_call, executeToolChecked
from darkmatterpy.utils.FileOperations import changeTextFileContents, openTextFile
