...
from darkmatterpy.tools.quality.Git import (
    getCheckoutFileChangeDesc,
    getFileHashContent,
    putFileHashContent,
    updateGitFile,
)
from darkmatterpy.TreeXML import fromString, toString
from darkmatterpy.utils.FileOperations import getFileContents, withTemporaryFile
...
def onCompilationReportChange(filename, git_stage):
    ...
    new_DarkMatterPy_version = new_report.attrib["DarkMatterPy_version"]
    changed = False
    if old_report.attrib["DarkMatterPy_version"] != new_DarkMatterPy_version:
        old_report.attrib["DarkMatterPy_version"] = new_DarkMatterPy_version
