...
from darkmatterpy.freezer.DependsExe import getDependsExePath, parseDependsExeOutput
...
from darkmatterpy.utils.Utils import isFreeBSD, isMacOS, isWin32Windows
...
def _getRuntimeTraceOfLoadedFilesWin32(logger, command, required):
    ...
    # TODO: Move the handling of this into darkmatterpy.tools.Execution module methods.
    try:
