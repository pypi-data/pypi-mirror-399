...
# Tool name aliases to handle common LLM mistakes
# Maps incorrect names -> correct names
TOOL_ALIASES: dict[str, str] = {
    # Terminal aliases
    "terminal": "terminal_execute",
    "terminal_tools.terminal": "terminal_execute",
    "terminal_tools.terminal_execute": "terminal_execute",
    # Python aliases
    "python": "python_action",
    "python_tools.python": "python_action",
    "python_tools.python_action": "python_action",
    # File edit aliases
    "file_edit": "str_replace_editor",
    "file_edit_tools.read_file": "search_files",
    "file_edit_tools.str_replace_editor": "str_replace_editor",
    "file_edit_tools.list_files": "list_files",
    "file_edit_tools.search_files": "search_files",
    "read_file": "search_files",
    # Notes aliases
    "notes": "create_note",
    "notes_tools.create_note": "create_note",
    "notes_tools.list_notes": "list_notes",
    # Agents graph aliases
    "agents_graph_tools.create_agent": "create_agent",
    "agents_graph_tools.wait_for_message": "wait_for_message",
    "agents_graph_tools.send_message_to_agent": "send_message_to_agent",
    "agents_graph_tools.agent_finish": "agent_finish",
    "agents_graph_tools.view_agent_graph": "view_agent_graph",
    # Thinking aliases
    "thinking": "think",
    "thinking_tools.think": "think",
    # Browser aliases
    "browser": "browser_action",
    "browser_tools.browser_action": "browser_action",
    # Reporting aliases
    "reporting_tools.create_vulnerability_report": "create_vulnerability_report",
    # Finish aliases
    "finish_tools.finish_scan": "finish_scan",
    # GitHub PR aliases
    "github_pr": "create_github_pr",
    "github_pr_tools.create_github_pr": "create_github_pr",
}


def normalize_tool_name(tool_name: str) -> str:
    """Normalize tool name by applying aliases for common LLM mistakes."""
    return TOOL_ALIASES.get(tool_name, tool_name)


SANDBOX_EXECUTION_TIMEOUT = float(os.getenv("ESPRIT_SANDBOX_EXECUTION_TIMEOUT", "120"))
SANDBOX_CONNECT_TIMEOUT = float(os.getenv("ESPRIT_SANDBOX_CONNECT_TIMEOUT", "10"))
...
def validate_tool_availability(tool_name: str | None) -> tuple[bool, str]:
    ...
    if normalized_name not in get_tool_names():
