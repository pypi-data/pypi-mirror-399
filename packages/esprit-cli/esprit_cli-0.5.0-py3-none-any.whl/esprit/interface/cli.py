...
async def run_cli(args: Any) -> None:  # noqa: PLR0915
    ...
    start_text.append("ESPRIT CYBERSECURITY AGENT", style="bold green")
    ...
    results_text.append(f"esprit_runs/{args.run_name}", style="bold white")
    ...
    startup_panel = Panel(
        ...
        title="[bold green]🛡️  ESPRIT PENETRATION TEST INITIATED",
        title_align="center",
        border_style="green",
        padding=(1, 2),
    )
