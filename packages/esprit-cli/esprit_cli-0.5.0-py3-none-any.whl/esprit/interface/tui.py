...
from esprit.interface.utils import build_live_stats_text
...
class SplashScreen(Static):  # type: ignore[misc]
    ...
    def _build_start_line_text(self, phase: int) -> Text:
        ...
        esprit_style = Style(color=self.PRIMARY_GREEN, bold=bool(emphasize))

        text = Text("Starting ", style=base_style)
        text.append("Esprit", style=esprit_style)
