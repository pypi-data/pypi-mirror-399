# 📚 Esprit Prompt Modules

## 🎯 Overview

Prompt modules are specialized knowledge packages that enhance Esprit agents with deep expertise in specific vulnerability types, technologies, and testing methodologies. Each module provides advanced techniques, practical examples, and validation methods that go beyond baseline security knowledge.
...
Community contributions are more than welcome — contribute new modules via [pull requests](https://github.com/improdead/Esprit-cli/pulls) or [GitHub issues](https://github.com/improdead/Esprit-cli/issues) to help expand the collection and improve extensibility for Esprit agents.
