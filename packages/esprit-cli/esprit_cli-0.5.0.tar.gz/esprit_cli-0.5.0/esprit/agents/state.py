...
class AgentState(BaseModel):
    ...
    task: str = ""
    iteration: int = 0
    max_iterations: int = 10000  # Very high - budget is the real limiter
    ...
    # Budget warnings (primary cost constraint, soft limits)
    budget_warning_75_sent: bool = False   # Notice at 75% budget used
    budget_warning_90_sent: bool = False   # Warning at 90% budget used
    budget_warning_100_sent: bool = False  # Urgent at 100% budget used
    force_finish: bool = False  # Force agent to finish (budget exceeded 120%)
    # Legacy time warnings (keep for backward compatibility, more generous now)
    time_warning_20min_sent: bool = False
    time_warning_25min_sent: bool = False
