...
@LastEditTime: 2025-12-25 19:16:56
...
class CdpClient:
    ...
    def __init__(self, base_url: str, app_key: str, secret: str, brand_id: str, context=None, logging_error=None, logging_info=None, debug_config={}):
        ...
        :param secret: 应用密钥
        :param brand_id: 商家标识
        :param debug_config: {'is_debug': 是否为联调环境true-联调环境，false-生产环境, "customer_id":"由营销云分配", "token":"由营销云分配"}
        :return: 
        """
    ...
    def request(self, url: str, headers: Dict[str, str], param_json: str, business_name=None, is_log: bool = False):
        """
        发送POST请求
        :param url: 请求地址
        :param headers: 请求头
    ...
    def member_reg_and_bind_v2(self, account: str, mix_mobile: str, extend: Dict[str, Any] = None, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        """
        # 接口URL
        url = f"{self.base_url}/CrmMemberV2/memberRegAndBindV2"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def query_member_bind_status(self, account: str, mix_mobile: str = None, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        """
        # 接口URL
        url = f"{self.base_url}/CrmMember/queryMemberBindStatus"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def modify_member_point_to_cdp(self, account: str, point: int, change_type: int, content: str, point_type: int, occur_time: str, extend: str = None, support_over_draft: bool = None, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        invoke_result_data = InvokeResultData()
        # 接口URL
        url = f"{self.base_url}/CrmMemberPoint/modifyMemberPointToCdp"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def modify_member_grade_to_cdp(self, account: str, expire_type: int, grade: int, content: str, type: int = 38, start_time: str = None, end_time: str = None, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        invoke_result_data = InvokeResultData()
        # 接口URL
        url = f"{self.base_url}/CrmMemberGrade/adjustMemberGradeToCDP"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def member_unbind(self, account: str, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        invoke_result_data = InvokeResultData()
        # 接口URL
        url = f"{self.base_url}/CrmMember/memberUnbind"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def query_member_point(self, account: str, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        invoke_result_data = InvokeResultData()
        # 接口URL
        url = f"{self.base_url}/CrmMemberPoint/queryMemberPoint"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def query_member_point_detail(self, account: str, page: int, page_size: int, start_time: str, end_time: str, start_row_key: str = None, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        invoke_result_data = InvokeResultData()
        # 接口URL
        url = f"{self.base_url}/CrmMemberPoint/queryMemberPointDetail"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
    ...
    def pin2xid_v2(self, pin: str, platform: str = "JD", ruid: str = None, is_log=False):
        ...
        invoke_result_data = InvokeResultData()
        # 接口URL
        url = f"{self.base_url}/CrmMember/pin2xidV2"
        # 生成请求ID
        if ruid is None:
            ruid = str(uuid.uuid4())
        # 构建请求体参数（不包含token）
        ...
        # 构建请求头
        headers = {"ruid": ruid, "Content-Type": "application/json"}
        invoke_result_data = self.request(url=url, headers=headers, json=body_params, business_name="pin转xid接口", is_log=is_log)
        return invoke_result_data
