...
class MarketplaceListingDescriptionGenerationCompletedMessage(TypedDict, total=False):
    ...
    targetMarketplace: str  # Target marketplace ID (e.g., 'etsy', 'ebay') (optional)
    ...
    suggestedPrice: Dict[str, object]  # Volume-based price calculation for 3D printed item (optional)
