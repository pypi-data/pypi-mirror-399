...
def load(
    ...
    Parameters:
        filename: The path to the file to load. The file must exist and have one of the following extensions:
                 .mzML, .wiff, or .raw.
...
def load_noms1(
    ...
    Args:
        filename: The path to the file to load. If None, uses self.file_path.
...
def chrom_extract(
    ...
    Returns:
        None: Updates chrom_df in-place with scan_uid and chrom columns.
    ...
    Example:
        ::
            ...
            scan_uids = s.chrom_df["scan_uid"][0]
            print(f"Found {len(scan_uids)} scans")
    ...
    Note:
        ...
        **Scan Identification:**
        ...
        For each trace, identifies all scan_uid values in scans_df that fall within
        ...
        **In-Place Updates:**
        ...
        Modifies chrom_df directly by adding/updating scan_uid and chrom columns.
        No return value.
