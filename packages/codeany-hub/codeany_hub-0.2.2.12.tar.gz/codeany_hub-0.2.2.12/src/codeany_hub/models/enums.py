...
class CheckerType(StrEnum):
    """Available checker types for validation logic."""

    NO_CHECKER = "no_checker"
    LINES_STRICT = "compare_lines_not_ignore_whitespaces"
    LINES_IGNORE_WS = "compare_lines_ignore_whitespaces"
    YES_NO = "single_yes_or_no_case_insensitive"
    YES_NO_MULTI = "single_or_multiple_yes_or_no_case_insensitive"
    INT64_IGNORE_WS = "single_or_multiple_int64_ignore_whitespaces"
    DOUBLE_IGNORE_WS = "single_or_multiple_double_ignore_whitespaces"
