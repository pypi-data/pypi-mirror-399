...
from codeany_hub.filters import SubmissionsFilter
from codeany_hub.models import CheckerType, SubmissionOrdering, SubmissionVerdict
...
if checker["checker_type"] != CheckerType.DOUBLE_IGNORE_WS:
    client.tasks.update_checker(
        "awesome-hub",
        42,
        {"checker_type": CheckerType.DOUBLE_IGNORE_WS, "precision": 9},
    )
```
