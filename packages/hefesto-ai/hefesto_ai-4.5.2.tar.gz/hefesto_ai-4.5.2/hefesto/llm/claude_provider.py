"""
Claude API Provider - Anthropic Claude Integration

This provider integrates Anthropic's Claude API for code analysis and refactoring.
Uses the official anthropic SDK for reliable, high-quality responses.
...
# Model configuration
DEFAULT_MODEL = "claude-3-5-sonnet-20240307"
...
class ClaudeProvider(LLMProvider):
    ...
    This provider uses Anthropic's Claude models for code analysis,
    ...
    def __init__(
        ...
        **kwargs,
        ...
        logger.info(f"✅ Claude API provider initialized with model: {self.model_name}")
...
{{
  ...
  "severity": "{severity}"
    ...
    def initialize(self) -> bool:
        """Initialize the Claude API provider and validate credentials."""
...
{{
  ...
  "edge_cases": ["...", "..."]
    ...
    def health_check(self) -> Dict[str, Any]:
        """
        Perform health check on the Claude API provider.
...
def create_claude_client(
    ...
    **kwargs,
    ...
    """
    Create and configure Claude API client.
