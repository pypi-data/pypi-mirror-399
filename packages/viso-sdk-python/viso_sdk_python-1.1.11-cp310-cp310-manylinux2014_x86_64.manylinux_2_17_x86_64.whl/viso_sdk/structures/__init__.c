...
#define __pyx_kp_u_viso_sdk_rollingq __pyx_string_tab[2]
#define __pyx_kp_u_viso_sdk_structures___init __pyx_string_tab[3]
#define __pyx_n_u_RQueue __pyx_string_tab[4]
#define __pyx_n_u_RollingQueue __pyx_string_tab[5]
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_RollingQueue};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_rollingq, __pyx_imported_names, 1, __pyx_mstate_global->__pyx_kp_u_viso_sdk_rollingq, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
    ...
    __pyx_t_3 = 0; {
      ...
      switch (__pyx_t_3) {
        case 0:
        if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_RQueue, __pyx_t_4) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
        break;
        default:;
      }
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{17},{28},{6},{12},{18},{8},{10},{8},{12},{8},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (136 bytes) */
const char* const cstring = "BZh91AY&SY\227\242\373\030\000\000\001\333\200@\000\000\001\000\000\260\000\277\257\277\000 \000t\032\206A\246H\304\310\320J\232\233\"\006\236\246\214F`\273\213>\232\210\006\004\207\261%=\031\032\026\022X{\374\245\265\360E\335\316#\352\004\321\356\310\206+7/J\003\370\016\241h\371:\316\241\322\003_\007\312\016\014;\335\306\346\374*\354\262C\214\n,V9\003\274\332#\2038nO\361w$S\205\t\tz/\261\200";
    PyObject *data = __Pyx_DecompressString(cstring, 136, 2);
    if (unlikely(!data)) __PYX_ERR(0, 1, __pyx_L1_error)
    const char* const bytes = __Pyx_PyBytes_AsString(data);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 1, __pyx_L1_error) }
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (106 bytes) */
const char* const cstring = "x\332=\215\353\r\3030\010\2047\362\n\235\241Y\000Q\373ZY\301\266l\240\363\227&J\356\007|<t\227\036\337\252\203\264\354i\r\221\332?\363^\250-\317\346\013\232\210j\257F\264=\035\216\355\374<8\007!\256d\2133^\234w\242\3061\207\332(.\370S\347v\364\351,'_i\n+x\263K\270\0334\352\017\364};\020";
...
const char* const bytes = ".?viso_sdk.rollingqviso_sdk.structures.__init__RQueueRollingQueuecline_in_traceback__main____module____name____qualname__rollingqsetdefault__test__";
    PyObject *data = NULL;
