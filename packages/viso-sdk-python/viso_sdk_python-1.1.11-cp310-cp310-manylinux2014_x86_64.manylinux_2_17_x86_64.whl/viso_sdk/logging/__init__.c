...
#define __pyx_kp_u_viso_sdk_logger __pyx_string_tab[2]
#define __pyx_kp_u_viso_sdk_logging___init __pyx_string_tab[3]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[4]
#define __pyx_n_u_exception_traceback __pyx_string_tab[5]
#define __pyx_n_u_get_logger __pyx_string_tab[6]
#define __pyx_n_u_logger __pyx_string_tab[7]
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_get_logger,__pyx_mstate_global->__pyx_n_u_exception_traceback};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_logger, __pyx_imported_names, 2, __pyx_mstate_global->__pyx_kp_u_viso_sdk_logger, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{15},{25},{18},{19},{10},{6},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) == 2 /* compression: bz2 (138 bytes) */
const char* const cstring = "BZh91AY&SY\\\315\207\364\000\000\001\333\200@\000\000\001\000\000\200\000\277\257\377@ \000u\rL\210z'\352M\036\220\300\2244\221=G\242zh'\250\203\335\211L\335\273^\302\236\222\244<>\0074(X\307\222qS\351\227+\363\000\375\310\245\307\250\360dg\257\022\204h\002\222b\263\310b\010\355&\355q\262\310u\341\274n\233\203\010\026(\367\034\253I\032\306\210\237\316f\366\315\365\376.\344\212p\241 \271\233\017\350";
    ...
    #endif
    #elif (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (103 bytes) */
const char* const cstring = "x\332U\215Q\016\202!\014\203o\304\025<J3\241\222\345\037\240?\303x|\247\274h\037\332oK\266\246\313S\347\300,G\262Q+\317\277Q{M\200vu \233v\006\303O\311\274J>\370\312\274\273\216\237U\245c\377\331\0164\211\223P\033e\031?\324\245}\363\261\3046Oz\341M\226E\215s\206\277\001\320\267<}";
    ...
    if (likely(bytes)); else { Py_DECREF(data); __PYX_ERR(0, 2, __pyx_L1_error) }
    #endif
    #else /* compression: none (151 bytes) */
const char* const bytes = ".?viso_sdk.loggerviso_sdk.logging.__init__cline_in_tracebackexception_tracebackget_loggerlogger__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
