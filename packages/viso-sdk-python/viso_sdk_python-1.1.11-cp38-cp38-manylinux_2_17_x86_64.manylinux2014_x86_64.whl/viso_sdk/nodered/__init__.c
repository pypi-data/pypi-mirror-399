...
#define __pyx_kp_u_viso_sdk_flow __pyx_string_tab[2]
#define __pyx_kp_u_viso_sdk_nodered___init __pyx_string_tab[3]
#define __pyx_n_u_FlowAPIWrapper __pyx_string_tab[4]
#define __pyx_n_u_VisoFlow __pyx_string_tab[5]
#define __pyx_n_u_cline_in_traceback __pyx_string_tab[6]
#define __pyx_n_u_flow __pyx_string_tab[7]
...
*/
  {
    PyObject* const __pyx_imported_names[] = {__pyx_mstate_global->__pyx_n_u_FlowAPIWrapper};
    __pyx_t_1 = __Pyx_Import(__pyx_mstate_global->__pyx_n_u_flow, __pyx_imported_names, 1, __pyx_mstate_global->__pyx_kp_u_viso_sdk_flow, 1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  __pyx_t_2 = __pyx_t_1;
  __Pyx_GOTREF(__pyx_t_2);
  {
    ...
    __pyx_t_3 = 0; {
      ...
      switch (__pyx_t_3) {
        case 0:
        if (PyDict_SetItem(__pyx_mstate_global->__pyx_d, __pyx_mstate_global->__pyx_n_u_VisoFlow, __pyx_t_4) < (0)) __PYX_ERR(0, 1, __pyx_L1_error)
        break;
        default:;
      }
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{1},{13},{25},{14},{8},{18},{4},{8},{10},{8},{12},{10},{8}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (111 bytes) */
const char* const cstring = "x\332=LI\016\2030\014\374Q\276P\365R\211[O\345h\231x\220\"\234\204f\201\357\327\241\022>\214g\323\270\307\021j\246*\233[5\237\267HYP \216(\244\320\210^\026>\337\323\\x\337Q>V\033\216\327\220`\rj\205=\026\366\333\030!\212l\236]\314\322\025\203%\216\327\377v\326?\257h\202\225\273\332zC5\374\001\036\2267\206";
    ...
    #endif
    #else /* compression: none (140 bytes) */
const char* const bytes = ".?viso_sdk.flowviso_sdk.nodered.__init__FlowAPIWrapperVisoFlowcline_in_tracebackflow__main____module____name____qualname__setdefault__test__";
    PyObject *data = NULL;
