...
class ServiceDiscovery:
    ...
    @classmethod
    async def discover_servers(cls, discovery_time: float = 3.0) -> list[DiscoveredServer]:
        """Discover Sendspin servers on the network.

        This is a convenience method that creates a temporary ServiceDiscovery instance,
        starts discovery, waits for the specified time, and returns all discovered servers.
