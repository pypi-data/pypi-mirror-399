...
class SpikeSafeEvents(IntEnum):
    ...
    # Deprecated starting with Ethernet Processor version 3.0.11.10: Use INTERNAL_BULK_OVER_CURRENT (209)
    INTERNAL_BULK_OVER_CURRENT_OLD = 317
    # Deprecated starting with Ethernet Processor version 3.0.11.10: Use MAX_BULK_VOLTAGE_BOOST_EXCEEDED (210)
    MAXIMUM_BULK_VOLTAGE_BOOST_EXCEEDED_OLD = 318
    ...
    # Deprecated starting with Ethernet Processor version 3.0.11.10: Use PULSE_WIDTH_ADJUSTMENT_ERROR (211)
    PULSE_WIDTH_ADJUSTMENT_ERROR_OLD = 329
    ...
    # Deprecated starting with Ethernet Processor version 3.0.11.10: Use EXCESSIVE_BULK_VOLTAGE (212)
    EXCESSIVE_BULK_VOLTAGE_OLD = 332
    ...
    I2C_BAD_COMMAND = 377
    # Deprecated starting with Ethernet Processor version 3.0.11.10: Use BULK_POWER_FAILURE (213)
    BULK_POWER_FAILURE_OLD = 378
    ...
    # Deprecated starting with Ethernet Processor version 3.0.11.10: Use INVALID_VOLTAGE_PROTECTION_MODE (600)
    INVALID_VOLTAGE_PROTECTION_MODE_OLD = 500
