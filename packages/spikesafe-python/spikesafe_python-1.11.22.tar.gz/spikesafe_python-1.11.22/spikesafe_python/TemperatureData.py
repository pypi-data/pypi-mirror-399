...
class TemperatureData:
    ...
    Methods
    -------
    parse_temperature_data(self, temperature_memory_table_read_response: str) -> Self
    ...
    def __init__(self) -> None:
        self.heat_sink_number = 0
        self.temperature_reading = math.nan

    def parse_temperature_data(self, temperature_memory_table_read_response: str) -> TemperatureData:
        """
        Parses a heat sink in SpikeSafe's event response into a simple accessible object
        ...
        try:
            ...
            temperature_response_split = temperature_parsable_format.split(' ')
