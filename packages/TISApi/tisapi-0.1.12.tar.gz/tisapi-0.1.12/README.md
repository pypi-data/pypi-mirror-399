...
![Version 0.1.12](https://img.shields.io/badge/version-0.1.12-blue)
...
4. **Verify**:
   ...
   ```bash
   gpg --verify tisapi-0.1.0.tar.gz.asc tisapi-0.1.12.tar.gz
   gpg --verify tisapi-0.1.0-py3-none-any.whl.asc tisapi-0.1.12-py3-none-any.whl
