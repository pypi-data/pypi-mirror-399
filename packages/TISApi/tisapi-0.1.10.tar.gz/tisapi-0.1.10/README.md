...
![Version 0.1.10](https://img.shields.io/badge/version-0.1.10-blue)
...
4. **Verify**:
   ...
   ```bash
   gpg --verify tisapi-0.1.0.tar.gz.asc tisapi-0.1.10.tar.gz
   gpg --verify tisapi-0.1.0-py3-none-any.whl.asc tisapi-0.1.10-py3-none-any.whl
