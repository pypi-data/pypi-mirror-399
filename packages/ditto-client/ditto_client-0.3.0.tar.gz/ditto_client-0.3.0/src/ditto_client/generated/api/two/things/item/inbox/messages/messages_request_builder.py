...
class MessagesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2/things/{thingId}/inbox/messages
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2/things/{thingId}/inbox/messages", path_parameters)
    
    def by_message_subject(self,message_subject: str) -> WithMessageSubjectItemRequestBuilder:
        """
        Gets an item from the ApiSdk.api.Two.things.item.inbox.messages.item collection
