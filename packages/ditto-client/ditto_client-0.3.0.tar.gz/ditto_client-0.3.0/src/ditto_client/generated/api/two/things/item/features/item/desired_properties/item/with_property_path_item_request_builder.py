...
class WithPropertyPathItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2/things/{thingId}/features/{featureId}/desiredProperties/{propertyPath}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2/things/{thingId}/features/{featureId}/desiredProperties/{propertyPath}{?channel*,condition*,live%2Dchannel%2Dcondition*,live%2Dchannel%2Dtimeout%2Dstrategy*,requested%2Dacks*,response%2Drequired*,timeout*}", path_parameters)
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[WithPropertyPathItemRequestBuilderDeleteQueryParameters]] = None) -> None:
        """
        Deletes a specific desired property of the feature identified by the `thingId`and `featureId` path parameter.The desired property (JSON) can be referencedhierarchically, by applying JSON Pointer notation (RFC-6901)### ExampleTo delete the value of the brewingTemp in the water-tank of our coffeemaker example the full path is:`/things/{thingId}/features/water-tank/desiredProperties/configuration/brewingTemp`
    ...
    async def get(self,request_configuration: Optional[RequestConfiguration[WithPropertyPathItemRequestBuilderGetQueryParameters]] = None) -> None:
        """
        Returns the a specific desired property path of the feature identified by the `thingId` and `featureId` path parameter.The desired property (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901)### ExampleTo retrieve the value of the `brewingTemp` in the `water-tank` of our coffeemaker example the full path is:`/things/{thingId}/features/water-tank/desiredProperties/configuration/brewingTemp`
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: None
        """
    ...
    async def patch(self,body: WithPropertyPathPatchRequestBody, request_configuration: Optional[RequestConfiguration[WithPropertyPathItemRequestBuilderPatchQueryParameters]] = None) -> None:
        """
        Patch a specific desired property of a feature identified by the `thingId` and `featureId` path parameter.The exisiting desired property of a feature will be merged with the JSON content set in the request body.Notice that the `null` value can be used to delete the specified propertyPath.For further documentation see [RFC 7396](https://tools.ietf.org/html/rfc7396).The desired property (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### ExampleTo set the value of the brewingTemp in the water-tank of our coffeemaker example the full path is:`/things/{thingId}/features/water-tank/desiredProperties/configuration/brewingTemp`
    ...
    async def put(self,body: WithPropertyPathPutRequestBody, request_configuration: Optional[RequestConfiguration[WithPropertyPathItemRequestBuilderPutQueryParameters]] = None) -> None:
        """
        Create or update a specific desired property of a feature identified by the `thingId` and `featureId` path parameter.The desired property will be created if it doesn't exist or else updated.The desired property (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901),### ExampleTo set the value of the brewingTemp in the water-tank of our coffeemaker example the full path is:`/things/{thingId}/features/water-tank/desiredProperties/configuration/brewingTemp`
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: None
        """
