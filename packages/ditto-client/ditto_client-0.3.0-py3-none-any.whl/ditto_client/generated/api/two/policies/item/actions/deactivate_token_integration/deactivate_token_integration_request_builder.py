...
class DeactivateTokenIntegrationRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2/policies/{policyId}/actions/deactivateTokenIntegration
    """
