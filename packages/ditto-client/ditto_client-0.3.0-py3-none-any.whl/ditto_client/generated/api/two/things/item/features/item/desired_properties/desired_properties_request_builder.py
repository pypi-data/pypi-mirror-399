...
if TYPE_CHECKING:
    ...
    from ........models.desired_properties424_error import DesiredProperties424Error
...
class DesiredPropertiesRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2/things/{thingId}/features/{featureId}/desiredProperties
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new DesiredPropertiesRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2/things/{thingId}/features/{featureId}/desiredProperties{?channel*,condition*,fields*,live%2Dchannel%2Dcondition*,live%2Dchannel%2Dtimeout%2Dstrategy*,requested%2Dacks*,response%2Drequired*,timeout*}", path_parameters)
    
    def by_property_path(self,property_path: str) -> WithPropertyPathItemRequestBuilder:
        """
        Gets an item from the ApiSdk.api.Two.things.item.features.item.desiredProperties.item collection
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderDeleteQueryParameters]] = None) -> None:
        """
        ...
        error_mapping: dict[str, type[ParsableFactory]] = {
            ...
            "404": AdvancedError,
            "412": AdvancedError,
            "424": DesiredProperties424Error,
        }
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_no_response_content_async(request_info, error_mapping)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderGetQueryParameters]] = None) -> Optional[FeatureProperties]:
        """
    ...
    async def patch(self,body: FeatureProperties, request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderPatchQueryParameters]] = None) -> None:
        """
        Patch the desired properties of a feature identified by the `thingId` and `featureId` path parameter.The existing desired properties will be merged with the JSON content set in the request body.Notice that the `null` value can be used to delete the whole feature or specific parts of it.For further documentation see [RFC 7396](https://tools.ietf.org/html/rfc7396).**Note**: In contrast to the "PUT things/{thingId}/features/{featureId}/desiredProperties" request,a partial update is supported here and request body is merged with the existing desired properties.
    ...
    async def put(self,body: FeatureProperties, request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderPutQueryParameters]] = None) -> Optional[FeatureProperties]:
        """
        Create or update the desired properties of a feature identified by the `thingId` and `featureId` path parameter.The desired properties will be overwritten with the JSON content from the request body.
        param body: An arbitrary JSON object describing the properties of a feature.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[FeatureProperties]
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderDeleteQueryParameters]] = None) -> RequestInformation:
        """
        Deletes all desired properties of the feature identified by the `thingId` and `featureId` path parameter.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Returns all desired properties of the feature identified by the `thingId` and `featureId` path parameter.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def to_patch_request_information(self,body: FeatureProperties, request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Patch the desired properties of a feature identified by the `thingId` and `featureId` path parameter.The existing desired properties will be merged with the JSON content set in the request body.Notice that the `null` value can be used to delete the whole feature or specific parts of it.For further documentation see [RFC 7396](https://tools.ietf.org/html/rfc7396).**Note**: In contrast to the "PUT things/{thingId}/features/{featureId}/desiredProperties" request,a partial update is supported here and request body is merged with the existing desired properties.
        param body: An arbitrary JSON object describing the properties of a feature.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_put_request_information(self,body: FeatureProperties, request_configuration: Optional[RequestConfiguration[DesiredPropertiesRequestBuilderPutQueryParameters]] = None) -> RequestInformation:
        """
        Create or update the desired properties of a feature identified by the `thingId` and `featureId` path parameter.The desired properties will be overwritten with the JSON content from the request body.
        param body: An arbitrary JSON object describing the properties of a feature.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> DesiredPropertiesRequestBuilder:
        """
        Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
        param raw_url: The raw URL to use for the request builder.
        Returns: DesiredPropertiesRequestBuilder
        """
        if raw_url is None:
            raise TypeError("raw_url cannot be null.")
        return DesiredPropertiesRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class DesiredPropertiesRequestBuilderDeleteQueryParameters():
        """
        Deletes all desired properties of the feature identified by the `thingId` and `featureId` path parameter.
        """
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderDeleteRequestConfiguration(RequestConfiguration[DesiredPropertiesRequestBuilderDeleteQueryParameters]):
        """
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderGetQueryParameters():
        """
        Returns all desired properties of the feature identified by the `thingId` and `featureId` path parameter.
        """
        def get_query_parameter(self,original_name: str) -> str:
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderGetRequestConfiguration(RequestConfiguration[DesiredPropertiesRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderPatchQueryParameters():
        """
        Patch the desired properties of a feature identified by the `thingId` and `featureId` path parameter.The existing desired properties will be merged with the JSON content set in the request body.Notice that the `null` value can be used to delete the whole feature or specific parts of it.For further documentation see [RFC 7396](https://tools.ietf.org/html/rfc7396).**Note**: In contrast to the "PUT things/{thingId}/features/{featureId}/desiredProperties" request,a partial update is supported here and request body is merged with the existing desired properties.
        """
        def get_query_parameter(self,original_name: str) -> str:
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderPatchRequestConfiguration(RequestConfiguration[DesiredPropertiesRequestBuilderPatchQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderPutQueryParameters():
        """
        Create or update the desired properties of a feature identified by the `thingId` and `featureId` path parameter.The desired properties will be overwritten with the JSON content from the request body.
        """
        def get_query_parameter(self,original_name: str) -> str:
    ...
    @dataclass
    class DesiredPropertiesRequestBuilderPutRequestConfiguration(RequestConfiguration[DesiredPropertiesRequestBuilderPutQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
