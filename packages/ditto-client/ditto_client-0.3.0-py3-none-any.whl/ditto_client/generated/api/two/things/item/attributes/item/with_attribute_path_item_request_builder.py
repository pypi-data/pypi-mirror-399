...
if TYPE_CHECKING:
    ...
    from .......models.with_attribute_path424_error import WithAttributePath424Error
    ...
    from .with_attribute_path_patch_request_body import WithAttributePathPatchRequestBody
    from .with_attribute_path_put_request_body import WithAttributePathPutRequestBody

class WithAttributePathItemRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2/things/{thingId}/attributes/{attributePath}
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        """
        Instantiates a new WithAttributePathItemRequestBuilder and sets the default values.
        param path_parameters: The raw url or the url-template parameters for the request.
        param request_adapter: The request adapter to use to execute the requests.
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2/things/{thingId}/attributes/{attributePath}{?channel*,condition*,live%2Dchannel%2Dcondition*,live%2Dchannel%2Dtimeout%2Dstrategy*,requested%2Dacks*,response%2Drequired*,timeout*}", path_parameters)
    
    async def delete(self,request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderDeleteQueryParameters]] = None) -> None:
        """
        ...
        error_mapping: dict[str, type[ParsableFactory]] = {
            ...
            "404": AdvancedError,
            "412": AdvancedError,
            "424": WithAttributePath424Error,
        }
        if not self.request_adapter:
            raise Exception("Http core is null") 
        return await self.request_adapter.send_no_response_content_async(request_info, error_mapping)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderGetQueryParameters]] = None) -> None:
        """
    ...
    async def put(self,body: WithAttributePathPutRequestBody, request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderPutQueryParameters]] = None) -> None:
        """
        Create or update a specific attribute of the thing identified by the `thingId` path parameter.* If you specify a new attribute path, this will be created* If you specify an existing attribute path, this will be updatedThe attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to put the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: None
        """
    ...
    def to_delete_request_information(self,request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderDeleteQueryParameters]] = None) -> RequestInformation:
        """
        Deletes a specific attribute of the thing identified by the `thingId` path parameter.The attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to delete the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_get_request_information(self,request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderGetQueryParameters]] = None) -> RequestInformation:
        """
        Returns a specific attribute of the thing identified by the `thingId` path parameter.The attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to retrieve the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: RequestInformation
    ...
    def to_patch_request_information(self,body: WithAttributePathPatchRequestBody, request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderPatchQueryParameters]] = None) -> RequestInformation:
        """
        Patch a specific attribute of a thing identified by the `thingId` path parameter.* If you specify a new attribute path, this will be created* If you specify an existing attribute path, this will be merged* If you set the request body to `null` for an existing attribute path then the attribute will be deleted.  For further documentation see [RFC 7396](https://tools.ietf.org/html/rfc7396).The attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to patch the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def to_put_request_information(self,body: WithAttributePathPutRequestBody, request_configuration: Optional[RequestConfiguration[WithAttributePathItemRequestBuilderPutQueryParameters]] = None) -> RequestInformation:
        """
        Create or update a specific attribute of the thing identified by the `thingId` path parameter.* If you specify a new attribute path, this will be created* If you specify an existing attribute path, this will be updatedThe attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to put the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        param body: The request body
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
    ...
    def with_url(self,raw_url: str) -> WithAttributePathItemRequestBuilder:
        """
        ...
        return WithAttributePathItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithAttributePathItemRequestBuilderDeleteQueryParameters():
        """
        Deletes a specific attribute of the thing identified by the `thingId` path parameter.The attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to delete the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        """
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[WithAttributePathItemRequestBuilderDeleteQueryParameters]):
        """
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderGetQueryParameters():
        """
        Returns a specific attribute of the thing identified by the `thingId` path parameter.The attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to retrieve the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        """
        def get_query_parameter(self,original_name: str) -> str:
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderGetRequestConfiguration(RequestConfiguration[WithAttributePathItemRequestBuilderGetQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderPatchQueryParameters():
        """
        Patch a specific attribute of a thing identified by the `thingId` path parameter.* If you specify a new attribute path, this will be created* If you specify an existing attribute path, this will be merged* If you set the request body to `null` for an existing attribute path then the attribute will be deleted.  For further documentation see [RFC 7396](https://tools.ietf.org/html/rfc7396).The attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to patch the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        """
        def get_query_parameter(self,original_name: str) -> str:
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderPatchRequestConfiguration(RequestConfiguration[WithAttributePathItemRequestBuilderPatchQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderPutQueryParameters():
        """
        Create or update a specific attribute of the thing identified by the `thingId` path parameter.* If you specify a new attribute path, this will be created* If you specify an existing attribute path, this will be updatedThe attribute (JSON) can be referenced hierarchically, by applying JSON Pointer notation (RFC-6901).### Example:In order to put the `name` field of an `manufacturer` attribute, the full path would be`/things/{thingId}/attributes/manufacturer/name`
        """
        def get_query_parameter(self,original_name: str) -> str:
    ...
    @dataclass
    class WithAttributePathItemRequestBuilderPutRequestConfiguration(RequestConfiguration[WithAttributePathItemRequestBuilderPutQueryParameters]):
        """
        Configuration for the request such as headers, query parameters, and middleware options.
        """
        warn("This class is deprecated. Please use the generic RequestConfiguration class generated by the generator.", DeprecationWarning)
