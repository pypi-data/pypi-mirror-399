...
class StatusRequestBuilder(BaseRequestBuilder):
    """
    Builds and executes requests for operations under /api/2/connections/{connectionId}/status
    """
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/api/2/connections/{connectionId}/status", path_parameters)
    
    async def get(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[ConnectionStatus]:
        """
        Returns the status of the connection identified by the `connectionId` path parameter.
        param request_configuration: Configuration for the request such as headers, query parameters, and middleware options.
        Returns: Optional[ConnectionStatus]
        """
        ...
        return await self.request_adapter.send_async(request_info, ConnectionStatus, error_mapping)
