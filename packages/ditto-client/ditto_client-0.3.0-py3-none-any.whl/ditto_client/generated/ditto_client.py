...
if TYPE_CHECKING:
    ...
    from .devops.devops_request_builder import DevopsRequestBuilder

class DittoClient(BaseRequestBuilder):
    """
    The main entry point of the SDK, exposes the configuration and the fluent API.
    """
    def __init__(self,request_adapter: RequestAdapter) -> None:
        """
        Instantiates a new DittoClient and sets the default values.
        ...
        if not self.request_adapter.base_url:
            self.request_adapter.base_url = "https://ditto.eclipseprojects.io"
    ...
    @property
    def devops(self) -> DevopsRequestBuilder:
        """
        The devops property
        """
        from .devops.devops_request_builder import DevopsRequestBuilder

        return DevopsRequestBuilder(self.request_adapter, self.path_parameters)
