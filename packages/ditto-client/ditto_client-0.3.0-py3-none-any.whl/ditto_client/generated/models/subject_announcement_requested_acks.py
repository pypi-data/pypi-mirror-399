...
@dataclass
class SubjectAnnouncement_requestedAcks(AdditionalDataHolder, Parsable):
    """
    ...
    @staticmethod
    def create_from_discriminator_value(parse_node: ParseNode) -> SubjectAnnouncement_requestedAcks:
        """
        Creates a new instance of the appropriate class based on discriminator value
        param parse_node: The parse node to use to read the discriminator value and create the object
        Returns: SubjectAnnouncement_requestedAcks
        """
        if parse_node is None:
            raise TypeError("parse_node cannot be null.")
        return SubjectAnnouncement_requestedAcks()
    ...
    def get_field_deserializers(self,) -> dict[str, Callable[[ParseNode], None]]:
        ...
        fields: dict[str, Callable[[Any], None]] = {
            ...
            "timeout": lambda n : setattr(self, 'timeout', n.get_str_value()),
        }
        return fields
    ...
    def serialize(self,writer: SerializationWriter) -> None:
        ...
        writer.write_str_value("timeout", self.timeout)
