...
SPFlow requires Python 3.10+.

If you see `ImportError: cannot import name 'from_numpy_matrix' from 'networkx'`, upgrade to the latest SPFlow release (or pin `networkx<3` when using an older SPFlow version).
