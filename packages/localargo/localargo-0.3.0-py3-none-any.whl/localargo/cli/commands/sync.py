...
def _validate_sync_arguments(path: str | None, app: str | None, *, watch: bool, sync_all: bool) -> bool:
...
def _determine_sync_mode(path: str | None, app: str | None, *, watch: bool, sync_all: bool) -> str:
...
def _sync_all_applications(*, force: bool = False) -> None:
    ...
    try:
        ...
        logger.info(
            "❌ Error listing applications: %s. Consider re-authenticating via 'localargo cluster password'",
            e,
        )
