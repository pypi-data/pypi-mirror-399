...
class TestStepLogger:
    ...
    def test_context_manager_exit_with_warnings(self) -> None:
    ...
    def test_context_manager_exit_with_errors(self) -> None:
    ...
    def test_step_warning(self) -> None:
    ...
    def test_step_with_info(self) -> None:
    ...
    def test_step_unknown_step(self) -> None:
    ...
    def test_step_with_progress_context_manager(self) -> None:
    ...
    def test_step_with_progress_exception(self) -> Never:
    ...
    def test_console_recording(self) -> None:
    ...
    def test_step_summary_display(self) -> None:
