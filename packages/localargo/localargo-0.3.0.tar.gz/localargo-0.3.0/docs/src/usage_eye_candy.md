...
[ok] loading manifest (manifest_path=clusters.yaml)
[ok] creating clusters
[ok] configuring contexts
[ok] finalizing
...
- **Warning**: Yellow warning for steps with issues
...
3. **Unicode issues**: Some terminals may not display special characters correctly
