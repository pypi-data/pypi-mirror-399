...
from localargo.utils.cli import ensure_argocd_available, run_subprocess
...
def _build_template_config(  # noqa: PLR0913
    name: str,
    app_type: str,
    *,
    repo: str,
...
def _create_argocd_app(name: str, app_config: dict[str, Any]) -> None:
    ...
    try:
        ...
        run_subprocess([argocd_path, "app", "create", name, "--file", temp_file], check=True)
