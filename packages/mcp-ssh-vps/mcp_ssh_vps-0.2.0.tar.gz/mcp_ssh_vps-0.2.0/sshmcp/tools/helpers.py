...
from sshmcp.config import get_config, list_machines, get_machine
            ...
            "profiles": [
                {
                    ...
                    "allowed": ["git pull/status", "ls", "cat", "tail", "df", "free", "uptime"],
                ...
                },
                {
                    ...
                    "allowed": ["git", "npm", "yarn", "pip", "pm2", "systemctl", "docker", "ls", "cat", "ps", "top"],
