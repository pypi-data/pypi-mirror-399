...
def authenticate() -> bool:
    ...
    while True:
        ...
        if choice == "1":
            ...
            # ════════════════════════════════════════════════════════════════════
            # REGISTRO - PASO 1: TÉRMINOS Y CONDICIONES
            # ════════════════════════════════════════════════════════════════════
...
1. El uso es responsabilidad EXCLUSIVA del usuario.
2. Solo usar en sistemas propios o con autorización.
3. Los creadores NO se hacen responsables por mal uso.
"""
            ...
            while True:
                terms_choice = get_input("Selecciona")
                
                if terms_choice == "0":
                    break  # Volver al menú de autenticación
                elif terms_choice == "1":
                    print_success("¡Términos aceptados!")
                    time.sleep(1)
                    
                    # ════════════════════════════════════════════════════════════════════
                    # REGISTRO - PASO 2: FORMULARIO DE REGISTRO
                    # ════════════════════════════════════════════════════════════════════
                    ...
                    # Email
                    email = get_input("📧 Correo electrónico").lower().strip()
                    if not email or not is_valid_email(email):
                        print_error("Formato de email inválido")
                        continue
                    ...
                    # Username
                    username = get_input("👤 Nombre de usuario (opcional)").strip()
                    if not username:
                    ...
                    confirm_choice = get_input("Selecciona")
                    ...
                    # ════════════════════════════════════════════════════════════════════
                    # REGISTRO - PASO 3: MENSAJE DE CONFIRMACIÓN
                    # ════════════════════════════════════════════════════════════════════
    ...
    while True:
        ...
        if result["success"]:
            ...
            if "credits" in error_msg.lower() or "créditos" in error_msg.lower():
                ...
                clear_screen()
                console.print("\n[bold red]😔 ¡Ups! Te quedaste sin créditos de hoy...[/bold red]\n")
                console.print("[bold white]Pero no te preocupes, tienes opciones:[/bold white]\n")
                
                console.print("[bold yellow]🔥 OPCIÓN 1: PREMIUM[/bold yellow]")
                console.print("  • Créditos ilimitados")
                console.print("  • IA más potente (GPT-4 level)")
                console.print("  • Solo $20/mes\n")
                
                console.print("[bold cyan]💎 OPCIÓN 2: COMPRAR CRÉDITOS[/bold cyan]")
                console.print("  • 500 créditos - $10")
                console.print("  • 1200 créditos - $20")
                console.print("  • 2500 créditos - $35\n")
                
                console.print("[bold green]⏰ OPCIÓN 3: ESPERAR[/bold green]")
                console.print("  • Tus 20 créditos se resetean en 24h")
                console.print("  • Vuelve mañana y sigue usando KR-CLI\n")
                
                console.rule(style="yellow")
                print_menu_option("1", "💎 Ir a la Tienda", "Comprar Premium o Créditos")
