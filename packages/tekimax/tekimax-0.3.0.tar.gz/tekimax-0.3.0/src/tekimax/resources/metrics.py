...
from ..types.metric_retrieve_dashboard_response import MetricRetrieveDashboardResponse
...
class MetricsResource(SyncAPIResource):
    ...
    def retrieve_dashboard(
        ...
        *,
    ...
    ) -> MetricRetrieveDashboardResponse:
        ...
        return self._get(
            ...
            cast_to=MetricRetrieveDashboardResponse,
        )
