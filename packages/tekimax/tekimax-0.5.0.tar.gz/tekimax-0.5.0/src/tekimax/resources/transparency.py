...
class TransparencyResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Returns transparency metadata including **dark pattern detection** and **AI
        disclosure badges** for outputs.

        **Use Cases:**

        - Display transparency badges in user interfaces
        - Verify AI content isn't using manipulative dark patterns
        - Show users how and why content was adapted

        **Key Checks:**

        - **Dark Pattern Detection**: Scans for manipulative UI/content patterns
        - **Modality Adjustment**: Why content format was changed
        - **Supervisory Agent Status**: Secondary AI verification results

        **Compliance:** Supports EU AI Act transparency requirements and FTC dark
        pattern guidelines.
