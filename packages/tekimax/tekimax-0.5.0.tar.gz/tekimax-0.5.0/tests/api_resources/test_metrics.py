...
class TestMetrics:
    ...
    @parametrize
    def test_method_retrieve_dashboard(self, client: TekimaxLlc) -> None:
        metric = client.metrics.retrieve_dashboard()
        assert_matches_type(MetricRetrieveDashboardResponse, metric, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_raw_response_retrieve_dashboard(self, client: TekimaxLlc) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    def test_streaming_response_retrieve_dashboard(self, client: TekimaxLlc) -> None:
...
class TestAsyncMetrics:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_method_retrieve_dashboard(self, async_client: AsyncTekimaxLlc) -> None:
        metric = await async_client.metrics.retrieve_dashboard()
        assert_matches_type(MetricRetrieveDashboardResponse, metric, path=["response"])

    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_raw_response_retrieve_dashboard(self, async_client: AsyncTekimaxLlc) -> None:
    ...
    @pytest.mark.skip(reason="Prism tests are disabled")
    @parametrize
    async def test_streaming_response_retrieve_dashboard(self, async_client: AsyncTekimaxLlc) -> None:
