...
class ProvenanceResource(SyncAPIResource):
    ...
    def retrieve(
        ...
        *,
        ...
        """
        Returns **C2PA provenance metadata** and **Human Agency Score** for any
        AI-generated content.

        **Use Cases:**

        - Verify authenticity of AI-generated content
        - Audit the origin chain of content modifications
        - Calculate human oversight levels for compliance reporting

        **Key Metrics:**

        - **Human Agency Score** (0-100): Quantifies human involvement in content
          creation
        - **C2PA Signature**: Cryptographic proof of content origin and modifications
        - **Origin Chain**: Full trace of content from creation to current state

        **Compliance:** Required by EU AI Act for content authenticity and C2PA for
        provenance.
