...
### Added
- Screenshots showcasing different themes and features in README

### Changed
- Updated app title to display "Flint - <filename>" in the header

### Fixed
- Fixed image widget ID generation that caused rendering errors with dots in filenames
