...
from pycaroline.adapters.dataframe import adapt_dataframe, detect_dataframe_type
...
class DataComparator:
    ...
    def compare(
        ...
        Supports polars, pandas, and snowpark DataFrames. Non-polars DataFrames
        are automatically converted to polars before comparison.

        Args:
            source_df: Source DataFrame to compare (polars, pandas, or snowpark).
            target_df: Target DataFrame to compare (polars, pandas, or snowpark).
