...
class TrainingAgent:
    ...
    def __init__(
        ...
        Args:
            ...
            ephemeral: If True, agent will delete itself from Firestore on shutdown
        """
        ...
        try:
            ...
            if existing_doc.exists:
                ...
                agent_doc = {
                    ...
                    "isEphemeral": getattr(self, 'ephemeral', False)
                }
            else:
        ...
        if self.db:
            try:
                ...
                if getattr(self, 'ephemeral', False):
                    self.db.collection("agents").document(self.agent_id).delete()
                    logger.info(f"🧹 Ephemeral agent {self.agent_id} deleted from registry")
