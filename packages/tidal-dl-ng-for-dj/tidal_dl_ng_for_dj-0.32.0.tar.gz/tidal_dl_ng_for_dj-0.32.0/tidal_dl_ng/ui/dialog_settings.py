...
class Ui_DialogSettings:
    def setupUi(self, DialogSettings):
        ...
        self.sw_categories.setCurrentIndex(1)
    ...
    def retranslateUi(self, DialogSettings):
        ...
        self.c_quality_audio.setPlaceholderText(QCoreApplication.translate("DialogSettings", "text", None))
        ...
        self.c_quality_video.setPlaceholderText(QCoreApplication.translate("DialogSettings", "text", None))
        ...
        self.c_metadata_cover_dimension.setPlaceholderText(QCoreApplication.translate("DialogSettings", "text", None))
