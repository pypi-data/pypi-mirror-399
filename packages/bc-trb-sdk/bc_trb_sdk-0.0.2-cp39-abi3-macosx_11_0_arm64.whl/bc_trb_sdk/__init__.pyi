...
bc_trb SDK - Python bindings for TriggerHub device communication.
"""
...
async def subscribe_eeg_data(
    ...
    Args:
        handle: DeviceApi handle from open_triggerhub_serial or open_triggerhub_ble
