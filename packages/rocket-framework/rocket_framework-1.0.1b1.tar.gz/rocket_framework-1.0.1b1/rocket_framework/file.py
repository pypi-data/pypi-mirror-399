...
:LastEditTime: 2025-12-30 13:50:01
:LastEditors: ChenXiaolei
:Description: 文件操作类
"""


class UFileHelper(object):
    def __init__(self,
                 public_key,
                 private_key,
                 bucket=None,
        ...
        """
        from ufile.filemanager import FileManager
        import ufile.config

        self.file_manager = FileManager(public_key, private_key)
    ...
    def put_file(self, put_key, localfile, header=None, bucket=None):
        ...
        :last_editors: ChenXiaolei
        """
        ret, resp = self.file_manager.putfile(self._get_bucket(bucket),
                                              put_key,
                                              localfile,
                                              header=header)
    ...
    def download_file(self,
        ...
        return self.file_manager.download_file(bucket,
                                               key,
                                               localfile,
                                               isprivate=isprivate,
    ...
    def put_file(self, bucket_name, object_name, source_file_object):
        ...
        try:
            ...
            self.s3_client.upload_fileobj(
                BytesIO(source_file_object), bucket_name, object_name)
