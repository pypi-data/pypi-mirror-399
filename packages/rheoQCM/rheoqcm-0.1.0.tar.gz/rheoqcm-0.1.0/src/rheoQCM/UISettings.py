...
config_default = {
    ...
    "mech_table_rowheaders": {
        "delf_exps": "\u0394" + "f (Hz)",  # Δf (Hz)
        "delfn_exps": "\u0394" + "f/n (Hz)",  # Δf (Hz)
        "delf_calcs": "\u0394" + "fcalc (Hz)",  # Δfcalc (Hz)
        "delfn_calcs": "\u0394" + "fcalc/n (Hz)",  # Δfₙcalc (Hz)
        "delg_exps": "\u0394\u0393" + " (Hz)",  # ΔΓ (Hz)
        "delg_calcs": "\u0394\u0393" + "calc (Hz)",  # ΔΓcalc (Hz)
        "delD_exps": "\u0394" + "D " + "\u00d7" + "10" + "\u207b\u2076",  # D ×10⁻⁶
        "delD_calcs": "\u0394"
        + "D "
        + "\u00d7"
        + "10"
    ...
    "change_thresh": (
        0.05,
        0.5,
    ),  # span change threshold. the value should be between (0, 1)
    # min(
    #     max(
