...
from badauth.protocols.ntlm.structures.version import Version, WindowsMajorVersion, WindowsMinorVersion
...
class NTLMCredential(UniCredential):
	...
	def build_context(self, *args, **kwargs):
		if self.subprotocol.type == asyauthSubProtocol.NATIVE:
			...
			from badauth.protocols.ntlm.client.sspi import NTLMClientSSPI
			return NTLMClientSSPI(self)

		elif self.subprotocol.type == asyauthSubProtocol.SSPIPROXY:
			from badauth.protocols.ntlm.client.sspiproxy import NTLMClientSSPIProxy
			return NTLMClientSSPIProxy(self)

		elif self.subprotocol.type == asyauthSubProtocol.WSNET:
			from badauth.protocols.ntlm.client.wsnet import NTLMClientWSNET
			return NTLMClientWSNET(self)
		
		elif self.subprotocol.type == asyauthSubProtocol.WSNETDIRECT:
			from badauth.protocols.ntlm.client.wsnetdirect import NTLMClientWSNETDirect
