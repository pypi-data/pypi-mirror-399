...
import enum
from badauth.common.winapi.constants import SECPKG_ATTR, SECPKG_CRED, ISC_REQ, SEC_E, SSPIResult
from badauth.common.winapi.functiondefs import AcquireCredentialsHandle, InitializeSecurityContext,\
