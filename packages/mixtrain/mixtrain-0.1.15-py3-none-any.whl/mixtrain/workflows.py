...
class Workflow:
    ...
    def create(
        ...
        response = client._make_request(
            "POST", f"/workspaces/{client._workspace_name}/workflows/", json=payload
        )
    ...
    def submit(self, config: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
...
def get_workflow(name: str, client: Optional[MixClient] = None) -> Workflow:
...
def list_workflows(client: Optional[MixClient] = None) -> List[Workflow]:
