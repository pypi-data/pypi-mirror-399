...
import epicAI
from epicAI.mini_notebook import run as _original_run
from epicAI.auth import get_current_user as _get_current_user
from epicAI.auth import logout as _logout
