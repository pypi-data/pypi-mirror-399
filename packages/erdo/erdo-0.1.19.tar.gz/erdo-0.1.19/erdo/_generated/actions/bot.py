...
class InvokeParams(BaseActionParams):
    ...
    source_invocation_id: Optional[Union[str, TemplateString]] = (
        None  # If set, bot_key is resolved from source and messages/resources are inherited
    )
...
def invoke(
    ...
    source_invocation_id: Optional[Union[str, TemplateString]] = None,
    ...
    **params: Any,
    ...
    Args:
        ...
        source_invocation_id: If provided, bot_key is resolved from this invocation
                              and its message history/resources are inherited.
                              Enables "continue from" / "interrogate" functionality.
