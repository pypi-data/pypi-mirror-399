...
class Agent(BaseModel):
    ...
    running_message: Optional[Union[str, TemplateString]] = None
    finished_message: Optional[Union[str, TemplateString]] = None
    running_status_template: Optional[Union[str, TemplateString]] = None
    finished_status_template: Optional[Union[str, TemplateString]] = None
    version: str = "1.0"
    ...
    @field_serializer(
        "running_message", "finished_message", "running_status_template", "finished_status_template", mode="wrap", when_used="always"
    )
    def serialize_message_fields(
        self, value: Optional[Union[str, TemplateString]], _info
    ) -> Optional[str]:
