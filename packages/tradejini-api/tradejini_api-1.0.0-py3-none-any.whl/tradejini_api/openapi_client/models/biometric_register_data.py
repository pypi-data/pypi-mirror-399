...
class BiometricRegisterData(BaseModel):
    """
    BiometricRegisterData
    """ # noqa: E501
    msg: Optional[StrictStr] = None
    biometric_id: Optional[StrictStr] = Field(default=None, alias="biometricID")
    __properties: ClassVar[List[str]] = ["msg", "biometricID"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "msg": obj.get("msg"),
            "biometricID": obj.get("biometricID")
        })
        return _obj
