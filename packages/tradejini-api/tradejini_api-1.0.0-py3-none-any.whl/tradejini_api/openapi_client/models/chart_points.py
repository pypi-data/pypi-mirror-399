...
class ChartPoints(BaseModel):
    ...
    minute_oi: Optional[StrictInt] = Field(default=None, alias="minuteOi")
    __properties: ClassVar[List[str]] = ["time", "open", "high", "low", "close", "volume", "minuteOi"]
