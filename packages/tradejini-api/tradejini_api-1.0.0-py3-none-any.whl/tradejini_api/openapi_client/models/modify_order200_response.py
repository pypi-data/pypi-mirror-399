...
MODIFYORDER200RESPONSE_ANY_OF_SCHEMAS = ["IouMessageResponse", "ModifyOrderResponse"]

class ModifyOrder200Response(BaseModel):
    """
    ModifyOrder200Response
    """

    # data type: ModifyOrderResponse
    anyof_schema_1_validator: Optional[ModifyOrderResponse] = None
    # data type: IouMessageResponse
    anyof_schema_2_validator: Optional[IouMessageResponse] = None
    if TYPE_CHECKING:
        actual_instance: Optional[Union[IouMessageResponse, ModifyOrderResponse]] = None
    else:
        actual_instance: Any = None
    any_of_schemas: List[str] = Literal[MODIFYORDER200RESPONSE_ANY_OF_SCHEMAS]
    ...
    def actual_instance_must_validate_anyof(cls, v):
        instance = ModifyOrder200Response.model_construct()
        error_messages = []
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when setting the actual_instance in ModifyOrder200Response with anyOf schemas: IouMessageResponse, ModifyOrderResponse. Details: " + ", ".join(error_messages))
        else:
            return v
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        if error_messages:
            # no match
            raise ValueError("No match found when deserializing the JSON string into ModifyOrder200Response with anyOf schemas: IouMessageResponse, ModifyOrderResponse. Details: " + ", ".join(error_messages))
        else:
            return instance
