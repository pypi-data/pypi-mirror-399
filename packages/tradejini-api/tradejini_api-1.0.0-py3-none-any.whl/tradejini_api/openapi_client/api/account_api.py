...
class AccountApi:
    ...
    def get_logout_web_response(
        ...
        _param = self._get_logout_web_response_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "GetLogoutWebResponse200Response",
            '400': "LogoutResponse",
            '401': "LogoutResponse",
        }
    ...
    @validate_call
    def get_logout_web_response_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetLogoutWebResponse200Response]:
        """Logout
    ...
    @validate_call
    def get_logout_web_response_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_logout_web_response_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    def _get_user_details_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/account/details',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
