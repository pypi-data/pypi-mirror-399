...
class BasketOrderMarginResponse(BaseModel):
    """
    BasketOrderMarginResponse
    """ # noqa: E501
    s: Optional[StrictStr] = None
    d: Optional[BasketOrderMarginData] = None
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "s": obj.get("s"),
            "d": BasketOrderMarginData.from_dict(obj.get("d")) if obj.get("d") is not None else None
        })
        return _obj
