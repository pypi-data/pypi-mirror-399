...
class ArizePhoenixTracer(BaseTracer):
    ...
    def __init__(
        ...
        try:
            ...
            self.root_span.set_attribute("primeagent.project.name", self.project_name)
            self.root_span.set_attribute("primeagent.flow.name", self.flow_name)
            self.root_span.set_attribute("primeagent.flow.id", self.flow_id)
