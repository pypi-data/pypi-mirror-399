...
class PurePythonBdistWheel(bdist_wheel):
    """Custom bdist_wheel command to build pure Python wheels (py3-none-any)"""
    
    def finalize_options(self):
        super().finalize_options()
        # Mark as pure Python wheel (no platform-specific code)
...
setup(
    ...
    cmdclass={
        ...
        "bdist_wheel": PurePythonBdistWheel,
    },
    entry_points={
        "console_scripts": [
