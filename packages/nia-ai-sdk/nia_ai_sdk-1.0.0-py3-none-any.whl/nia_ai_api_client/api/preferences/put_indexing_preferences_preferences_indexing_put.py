...
from ...models.indexing_preferences_update_request import IndexingPreferencesUpdateRequest
from ...types import UNSET, Response, Unset


def _get_kwargs(
    *,
    body: IndexingPreferencesUpdateRequest,
...
def sync_detailed(
    *,
    ...
    """Update indexing notification preferences

     Update indexing notification preferences for the authenticated user.
