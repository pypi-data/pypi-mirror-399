...
from ...models.body_chat_with_project_projects_project_id_chat_post import BodyChatWithProjectProjectsProjectIdChatPost
...
def _get_kwargs(
    project_id: str,
    *,
    body: BodyChatWithProjectProjectsProjectIdChatPost,
    ...
    _kwargs: dict[str, Any] = {
        "method": "post",
        "url": "/projects/{project_id}/chat".format(
