...
def efield_stats_conformal_numba(face_centers, face_normals, sigma, distances, eps_h=1.0, cutoff2=1e-2):
    ...
    Notes:
      ...
      - If sigma is complex in your pipeline, either:
          (a) run twice for real/imag and combine, or
          (b) store sigma as two float arrays.
    """
...
def calc_integral_decay_profile(face_centers, face_normals, sigma, distances, eps_h=1.0):
    ...
    # If sigma is complex, decide what “field” means physically in your model.
    # If you only need magnitude stats from real charges:
