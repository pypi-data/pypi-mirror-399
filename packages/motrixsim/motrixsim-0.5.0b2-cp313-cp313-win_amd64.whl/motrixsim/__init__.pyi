...
class Geom:
    ...
    Returns:
        NDArray[float]: The size parameters as a numpy array of shape `(3,)` with `[s0, s1,
    s2]`.
    ...
    Returns:
        NDArray[float]: The local pose as a numpy array of shape `(7,)` with `[x, y, z, i, j, k,
    w]`         format where the first 3 elements are translation and the last 4 are
    quaternion rotation.
