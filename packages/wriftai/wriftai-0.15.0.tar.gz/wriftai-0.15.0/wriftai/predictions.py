...
class Predictions(Resource):
    ...
    def _parse_model(self, model: str) -> tuple[str, str, str | None]:
        ...
        Args:
            model (str): The model reference in either owner/name or
                owner/name:version-number format (for example: deepseek-ai/deepseek-r1
                or deepseek-ai/deepseek-r1:1).

        Returns:
            tuple[str, str, str | None]: A tuple containing owner, name, and version
                number of the model.
