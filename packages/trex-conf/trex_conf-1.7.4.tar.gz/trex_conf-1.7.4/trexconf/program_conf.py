...
MEMBERSHIP_EXPIRY_EXTEND_FIXED_MODE         = 'fixed'
MEMBERSHIP_EXPIRY_EXTEND_ROLLING_MODE       = 'rolling'
...
REWARD_BASE_SET                             = (REWARD_BASE_ON_SPENDING, REWARD_BASE_ON_PROMOTION_SPENDING, REWARD_BASE_ON_GIVEAWAY, REWARD_BASE_ON_BIRTHDAY, REWARD_BASE_ON_REFER, REWARD_BASE_ON_TIER, REWARD_BASE_ON_GIVEAWAY_VIA_PROMOTION_CODE)
...
REWARD_LIMIT_TYPE_BY_PROGRAM                = 'limit_by_program'
