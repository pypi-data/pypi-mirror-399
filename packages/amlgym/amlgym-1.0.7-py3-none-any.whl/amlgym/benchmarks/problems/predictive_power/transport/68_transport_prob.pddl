...
(define (problem transport_three_cities_sequential_6nodes_10size_3degree_10mindistance_1trucks_2packages_534seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (road city_1_loc_3 city_3_loc_5)
  (road city_3_loc_5 city_1_loc_3)
