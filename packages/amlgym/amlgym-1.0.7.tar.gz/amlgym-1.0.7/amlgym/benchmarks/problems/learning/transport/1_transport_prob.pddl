...
(define (problem transport_two_cities_sequential_6nodes_10size_3degree_10mindistance_1trucks_2packages_366seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (road city_1_loc_3 city_2_loc_1)
  (road city_2_loc_1 city_1_loc_3)
