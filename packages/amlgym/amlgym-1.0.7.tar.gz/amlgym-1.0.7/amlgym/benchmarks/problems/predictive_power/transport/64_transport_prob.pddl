...
(define (problem transport_two_cities_sequential_6nodes_10size_3degree_10mindistance_1trucks_2packages_940seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (road city_1_loc_5 city_2_loc_2)
  (road city_2_loc_2 city_1_loc_5)
