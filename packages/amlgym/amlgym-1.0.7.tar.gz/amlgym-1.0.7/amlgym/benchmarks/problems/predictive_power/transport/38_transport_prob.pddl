...
(define (problem transport_three_cities_sequential_6nodes_10size_3degree_10mindistance_1trucks_2packages_73seed)
 (:domain transport)
 (:objects
 ...
 (:init
  ...
  (road city_2_loc_3 city_3_loc_4)
  (road city_3_loc_4 city_2_loc_3)
