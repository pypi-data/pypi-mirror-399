"""
Basic usage example for Quickbooks MCP Server.
...
Prerequisites:
- Install the package: pip install quickbooks-mcp-server
- Set required environment variables (see .env.example or README.md)
"""

import asyncio
import os
from quickbooks_mcp.server import main


async def example_usage():
    """
    Example usage of Quickbooks MCP Server.
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Quickbooks MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install quickbooks-mcp-server")
