"""Backend client for communicating with mai-tai API (v3 - workspace edition).

This module provides the HTTP client for communicating with the Mai-Tai backend.
In v3, we use the simplified workspace architecture (no channels).
...
class MaiTaiBackend:
    """Synchronous client for mai-tai backend API (v3 - workspace edition).
