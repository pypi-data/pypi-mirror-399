"""
Mai-Tai mode state management (v2).
...
class MaiTaiState:
    ...
    # Channel ID for mai-tai communications
    ...
    def enter_mai_tai_mode(
        ...
        Args:
            ...
            channel_id: Channel for mai-tai communications
        ...
        logger.info(f"Entered mai-tai mode: scenario={scenario.value}, channel={channel_id}")
    ...
    def exit_mai_tai_mode(self) -> None:
        ...
        self.plan = None
        self.initial_status_sent = False
        # Keep channel_id for potential future communications
