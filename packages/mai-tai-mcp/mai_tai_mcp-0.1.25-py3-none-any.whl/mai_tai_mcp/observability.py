...
def log_mai_tai_enter(channel_id: str, scenario: str) -> None:
...
def log_mai_tai_exit(channel_id: str) -> None:
    """Log exiting mai-tai mode."""
    log_event(EventType.MAI_TAI_EXIT, "Exited mai-tai mode", channel_id=channel_id)
...
def log_message_sent(channel_id: str, content_preview: str) -> None:
    """Log a sent message."""
    preview = content_preview[:50] + "..." if len(content_preview) > 50 else content_preview
    log_event(EventType.MESSAGE_SENT, f"Sent: {preview}", channel_id=channel_id)


def log_message_received(channel_id: str, content_preview: str) -> None:
    """Log a received message."""
    preview = content_preview[:50] + "..." if len(content_preview) > 50 else content_preview
    log_event(EventType.MESSAGE_RECEIVED, f"Received: {preview}", channel_id=channel_id)
