...
[![PyPI version](https://badge.fury.io/py/wecom-bot-mcp-server-remotefile.svg)](https://badge.fury.io/py/wecom-bot-mcp-server-remotefile)
[![Python Version](https://img.shields.io/pypi/pyversions/wecom-bot-mcp-server-remotefile.svg)](https://pypi.org/project/wecom-bot-mcp-server-remotefile/)
[![smithery badge](https://smithery.ai/badge/wecom-bot-mcp-server-remotefile)](https://smithery.ai/server/wecom-bot-mcp-server-remotefile)
