...
class EventFormatter:
    ...
    def format_llm_call(
        ...
        # Get request context for conversation correlation
        url = ScopeContext.get_url()
        referrer = ScopeContext.get_referrer()
        thread_id = ScopeContext.get_thread_id()
        user_agent = ScopeContext.get_user_agent()
        ...
        event = {
            ...
            # Request context for conversation correlation
            # This enables the fallback chain: thread_id → session_id+url → session_id
            "url": url,
            "referrer": referrer,
            "thread_id": thread_id,  # For ChatGPT-style apps with multiple threads
