...
# Request context for LLM event correlation
url_context: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    'scope_url', default=None
)

referrer_context: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    'scope_referrer', default=None
)

thread_id_context: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    'scope_thread_id', default=None
)

user_agent_context: contextvars.ContextVar[Optional[str]] = contextvars.ContextVar(
    'scope_user_agent', default=None
)
...
class ScopeContext:
    ...
    # =========================================================================
    # Request Context - URL, Referrer, Thread ID, User Agent
    # =========================================================================

    @staticmethod
    def set_url(url: str) -> None:
        """Set the request URL for the current context"""
        url_context.set(url)

    @staticmethod
    def get_url() -> Optional[str]:
        """Get the request URL from current context"""
        return url_context.get()

    @staticmethod
    def set_referrer(referrer: str) -> None:
        """Set the referrer for the current context"""
        referrer_context.set(referrer)

    @staticmethod
    def get_referrer() -> Optional[str]:
        """Get the referrer from current context"""
        return referrer_context.get()

    @staticmethod
    def set_thread_id(thread_id: str) -> None:
        """Set the thread ID for the current context (for ChatGPT-style apps)"""
        thread_id_context.set(thread_id)

    @staticmethod
    def get_thread_id() -> Optional[str]:
        """Get the thread ID from current context"""
        return thread_id_context.get()

    @staticmethod
    def set_user_agent(user_agent: str) -> None:
        """Set the user agent for the current context"""
        user_agent_context.set(user_agent)

    @staticmethod
    def get_user_agent() -> Optional[str]:
        """Get the user agent from current context"""
    ...
    def clear() -> None:
        ...
        url_context.set(None)
        referrer_context.set(None)
