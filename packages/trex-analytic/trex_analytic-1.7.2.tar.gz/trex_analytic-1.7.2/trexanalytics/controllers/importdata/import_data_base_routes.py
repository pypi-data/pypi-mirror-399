    ...
    def get(self):
        ...
        try:
            ...
            create_task(task_url, queue_name, 
                        ...
                        payload         = payload,
                        credential_path = analytics_conf.SYSTEM_TASK_SERVICE_CREDENTIAL_PATH, 
                        project_id      = analytics_conf.SYSTEM_TASK_GCLOUD_PROJECT_ID,
                        location        = analytics_conf.SYSTEM_TASK_GCLOUD_LOCATION,
                        service_email   = analytics_conf.SYSTEM_TASK_SERVICE_ACCOUNT_EMAIL
                        )
        except:
