...
class TestFunctionNotebookExport:
    ...
    def test_autogenerated_warning(self, simple_function_notebook: Notebook, tmp_path: Path) -> None:
    ...
    def test_no_autogenerated_warning(self, simple_function_notebook: Notebook, tmp_path: Path) -> None:
