...
class ConvertValidationFailedResponse(BaseModel):
    ...
    """ # noqa: E501
    status: Optional[StrictStr] = 'validation_failed'
    conversion_id: StrictStr
    message: Optional[StrictStr] = 'Donnees extraites avec erreurs de validation. Completez le formulaire et appelez /resume.'
