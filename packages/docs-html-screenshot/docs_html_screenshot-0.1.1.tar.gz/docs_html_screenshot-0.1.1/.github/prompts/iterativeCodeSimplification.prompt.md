...
argument-hint: file="src/docs_html_screenshot/cli.py" verify="uv run pytest tests/ -v"
---

## TechDocs Research
Use `#techdocs` for simplification techniques, async patterns, and architecture guidance. Run `list_tenants` first, then explore tenants like `python`, `playwright`. Follow the workflow in **.github/instructions/techdocs.instructions.md**.
