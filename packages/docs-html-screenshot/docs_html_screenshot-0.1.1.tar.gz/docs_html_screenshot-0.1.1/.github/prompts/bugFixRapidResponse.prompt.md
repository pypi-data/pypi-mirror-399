...
argument-hint: file="src/docs_html_screenshot/cli.py" repro="steps" tests="test_cli_helpers"
---

## TechDocs Research
Use `#techdocs` to verify correct API usage for the buggy component. Key tenants: `python`, `playwright`, `pytest`. Always run `list_tenants` first, then `describe_tenant` to get optimal queries. See `.github/instructions/techdocs.instructions.md` for full usage guide.
