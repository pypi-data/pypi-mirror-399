"""
Basic usage example for Harness MCP Server.
...
Prerequisites:
- Install the package: pip install harness-mcp-server
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Harness MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install harness-mcp-server")
