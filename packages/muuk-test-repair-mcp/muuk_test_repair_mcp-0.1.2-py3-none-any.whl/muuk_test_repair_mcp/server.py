    ...
    return [
        Tool(
            ...
            description=(
                ...
                "IMPORTANT: Always provide workspace_path with the absolute path to the project root. "
                "All other paths can be relative to the workspace."
            ),
            inputSchema={
                "type": "object",
                "properties": {
                    "workspace_path": {
                        "type": "string",
                        "description": "REQUIRED: Absolute path to the workspace/project root directory (e.g., /Users/user/my-project)",
                    },
                    "test_file_path": {
                        "type": "string",
