"""Unit tests for Limitry SDK Client"""

import pytest
from unittest.mock import AsyncMock, MagicMock, patch

from limitry.client import Client, AuthenticationError, APIError
...
class TestClient:
    ...
    def test_client_initialization(self):
        ...
        assert client._config.base_url == "https://api.limitry.com/v1"
