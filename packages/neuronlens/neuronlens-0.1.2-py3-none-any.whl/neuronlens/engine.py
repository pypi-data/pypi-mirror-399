...
class Engine:
    ...
    def analyze_agent_query(self, query: str, **kwargs) -> Dict[str, Any]:
        ...
        if _USE_CLOUD_API_FUNCTIONS:
            ...
            return self._make_request("/agent_lens", {"query": query})
    ...
    def analyze_hallucination(self, prompt: str, max_tokens: int = 256, 
        ...
        if _USE_CLOUD_API_FUNCTIONS:
            ...
            return self._make_request(
                "/hallucination_lens",
                {"prompt": prompt, "max_tokens": max_tokens, "temperature": temperature, "use_cloud": False}
            )
    ...
    def compare_probe_sae(self, text: str, **kwargs) -> Dict[str, Any]:
        ...
        if _USE_CLOUD_API_FUNCTIONS:
            ...
            return self._make_request(
                "/slm_lens",
                {"action": "compare_probe_sae", "text": text, "use_cloud": False}
            )
    ...
    def extract_trading_signals(self, text: str, ticker: str, **kwargs) -> Dict[str, Any]:
        ...
        if _USE_CLOUD_API_FUNCTIONS:
            ...
            return self._make_request(
                "/trading_lens",
                {"action": "extract_signals", "text": text, "ticker": ticker, "use_cloud": False}
            )
    ...
    def steer_features(self, prompt: str, features: List[Dict[str, Any]], 
        ...
        if _USE_CLOUD_API_FUNCTIONS:
            ...
            return self._make_request(
                "/searchsteer/steer",
                {"prompt": prompt, "features": features, "model": model}
            )
