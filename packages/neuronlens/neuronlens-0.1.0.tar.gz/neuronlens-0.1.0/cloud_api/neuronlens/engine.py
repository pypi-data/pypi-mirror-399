...
# Import base functions from cloud_api
try:
    ...
    raise ImportError(
        f"Could not import from cloud_api. Make sure cloud_api is in the Python path. Error: {e}"
    )
...
class Engine:
    ...
    def _call_with_api_key(self, func, *args, **kwargs):
        ...
        # Patch requests.post to inject API key
