...
class PostInstallCommand(install):
    ...
    def run(self):
        ...
        try:
            from controlgit.post_install import post_install
            post_install()
...
setup(
    ...
    description="ControlGit - Git account and repository settings management",
    long_description=long_description + "\n\n" + SYSTEM_REQUIREMENTS,
    long_description_content_type="text/markdown",
    url="https://github.com/abucodingai/controlgit-py",
    ...
    entry_points={
        "console_scripts": [
            "controlgit=controlgit.cli:main",
        ],
    },
    install_requires=[
        "requests>=2.28.0",
    ...
    project_urls={
        ...
        "Documentation": "https://github.com/abucodingai/controlgit-py",
    },
    cmdclass={
