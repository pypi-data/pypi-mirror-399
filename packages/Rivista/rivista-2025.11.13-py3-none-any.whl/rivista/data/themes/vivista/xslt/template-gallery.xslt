    ...
    <xsl:template match="/atom:feed">
        ...
        <html>
            ...
            <body>
                        ...
                        <xsl:choose>
                            <xsl:when test="atom:entry">
                                <xsl:for-each select="atom:entry[not(position() &gt; 1)]">
                                    <xsl:call-template name="element-article-content-photo">
                ...
                <footer>
                    <xsl:text>This is a single-entry Atom </xsl:text>
                    <xsl:text>Syndication Format document </xsl:text>
                    <xsl:text>which was transformed to HTML </xsl:text>
                    <xsl:text>with an XSLT stylesheet. This </xsl:text>
                    <xsl:text>document can be monitored for </xsl:text>
                    <xsl:text>changes with syndication Feed </xsl:text>
