...
class UserFileResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["file_hash", "name", "content_type", "size", "is_public"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserFileResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserFileResponse from a dict"""
        if obj is None:
            return None
