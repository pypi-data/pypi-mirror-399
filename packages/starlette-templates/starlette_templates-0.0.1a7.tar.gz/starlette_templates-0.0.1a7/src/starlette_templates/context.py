...
@pass_context
def url_for(context: dict, name: str, query_params: dict | None = None, **path_params: t.Any) -> str:
...
@pass_context
def url(
    context: dict, name: str, path: str = "/", query_params: dict | None = None, path_params: dict | None = None
) -> str:
    ...
    Args:
        ...
        query_params: Optional dictionary of query parameters to include
        path_params: Optional dictionary of path parameters for the mount
    ...
    """
    request: Request = context["request"]
    _path_params = path_params or {}
    url: URL = request.url_for(name, path=path, **_path_params)
    if query_params:
        url = url.include_query_params(**query_params)
    return str(url)
