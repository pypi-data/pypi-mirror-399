...
class JinjaMiddleware:
    ...
    Args:
        ...
        extra_components: Additional component modules or classes to register in the Jinja2 environment.
            Can be a single module, a single component class, or a list of either.
