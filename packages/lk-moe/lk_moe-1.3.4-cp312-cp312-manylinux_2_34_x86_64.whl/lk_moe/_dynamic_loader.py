...
def _load_library():
    ...
    try: 
        ...
        if hasattr(module, 'MOE') and hasattr(module, 'MOEConfig') and hasattr(module, 'MOE_FP8') and hasattr(module, 'MOE_FP8Config') and hasattr(module, 'MOE_WNA16') and hasattr(module, 'MOE_WNA16Config') and hasattr(module, 'MOE_WNA16Repack') and hasattr(module, 'MOE_WNA16RepackConfig'):
            print("Successfully loaded MOE, MOEConfig, MOE_FP8, MOE_FP8Config, MOE_WNA16, MOE_WNA16Config, MOE_WNA16Repack, and MOE_WNA16RepackConfig") 
            return module.MOE, module.MOEConfig, module.MOE_FP8, module.MOE_FP8Config, module.MOE_WNA16, module.MOE_WNA16Config, module.MOE_WNA16Repack, module.MOE_WNA16RepackConfig
        else:
            raise AttributeError("MOE, MOEConfig, MOE_FP8, MOE_FP8Config, MOE_WNA16, MOE_WNA16Config, MOE_WNA16Repack, or MOE_WNA16RepackConfig not found in the module")
    except Exception as e:
