...
from decoder.core.tools.base import BaseTool
...
class APIToolFormatHandler:
    ...
    def get_available_tools(
        self, tool_manager: ToolManager, config: DecoderConfig
    ) -> list[AvailableTool]:
    ...
    def resolve_tool_calls(
        self, parsed: ParsedMessage, tool_manager: ToolManager, config: DecoderConfig
    ) -> ResolvedMessage:
        resolved_calls = []
        failed_calls = []
