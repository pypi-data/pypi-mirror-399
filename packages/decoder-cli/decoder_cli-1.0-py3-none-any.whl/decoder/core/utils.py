...
from decoder.core.paths.global_paths import LOG_DIR, LOG_FILE
from decoder.core.types import BaseEvent, ToolResultEvent

CANCELLATION_TAG = "user_cancellation"
TOOL_ERROR_TAG = "tool_error"
DECODER_STOP_EVENT_TAG = "vibe_stop_event"
DECODER_WARNING_TAG = "vibe_warning"

KNOWN_TAGS = [CANCELLATION_TAG, TOOL_ERROR_TAG, DECODER_STOP_EVENT_TAG, DECODER_WARNING_TAG]
