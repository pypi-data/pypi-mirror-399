...
from decoder.cli.textual_ui.widgets.spinner import SpinnerMixin, SpinnerType
...
class LoadingWidget(SpinnerMixin, Static):
    ...
    STATUS_PHRASES: ClassVar[list[str]] = [
        "Attuning",
        "Unfolding",
        "Invoking",
        "Listening",
    ...
    def _get_default_status(self) -> str:
        return self._get_easter_egg() or random.choice(self.STATUS_PHRASES)
