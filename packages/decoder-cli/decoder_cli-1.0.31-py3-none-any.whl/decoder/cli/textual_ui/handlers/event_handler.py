...
from decoder.cli.textual_ui.widgets.messages import AssistantMessage, ReasoningMessage
...
from decoder.core.utils import TaggedText
...
class EventHandler:
    ...
    async def _handle_tool_call(
        ...
        if loading_widget and event.tool_class:
            from decoder.core.tools.ui import ToolUIDataAdapter
