...
from decoder.core.output_formatters import create_formatter
from decoder.core.types import AssistantEvent, LLMMessage, OutputFormat, Role
from decoder.core.utils import ConversationLimitException, logger
...
def run_programmatic(
    ...
    Args:
        config: Configuration for the Decoder agent
