...
from decoder.core.config import PROJECT_DOC_FILENAMES
from decoder.core.llm.format import get_active_tool_classes
from decoder.core.paths.config_paths import INSTRUCTIONS_FILE
from decoder.core.prompts import UtilityPrompt
from decoder.core.utils import is_dangerous_directory, is_windows

if TYPE_CHECKING:
    from decoder.core.config import ProjectContextConfig, DecoderConfig
...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by Decoder with the appropriate co-authoring information.\n"
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        "Generated by Decoder.\n"
        "Co-Authored-By: Decoder <noreply@decoder.dev>\n"
        "```"
    )
