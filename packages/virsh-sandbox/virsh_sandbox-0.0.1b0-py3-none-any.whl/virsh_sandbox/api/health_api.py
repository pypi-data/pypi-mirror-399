...
class HealthApi:
    ...
    def _get_health_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/virsh-sandbox/v1/health",
    ...
    async def get_health1(
        ...
        _param = self._get_health1_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index,
    ...
    async def get_health1_with_http_info(
        self,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        _request_auth: Optional[Dict[str, Any]] = None,
        _content_type: Optional[str] = None,
    ...
    async def get_health1_without_preload_content(
        self,
        _request_timeout: Union[None, float, Tuple[float, float]] = None,
        _request_auth: Optional[Dict[str, Any]] = None,
        _content_type: Optional[str] = None,
    ...
    def _get_health1_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/tmux-client/v1/health",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
