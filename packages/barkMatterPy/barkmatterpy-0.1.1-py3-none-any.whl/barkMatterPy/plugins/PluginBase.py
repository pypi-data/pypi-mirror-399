...
from barkMatterPy.__past__ import iter_modules, unicode
from barkMatterPy.containers.Namedtuples import makeNamedtupleClass
...
from barkMatterPy.Tracing import plugins_logger
from barkMatterPy.utils.AppDirs import getAppdirsModule
...
from barkMatterPy.utils.Importing import (
...
from barkMatterPy.utils.SharedLibraries import locateDLL, locateDLLsInDirectory
from barkMatterPy.utils.SlotMetaClasses import getMetaClassBase
...
def _getEvaluationContext():
    ...
    if _context_dict is None:
        _context_dict = {
            ...
            "barkMatterPy_python": isOxNJACPython(),
...
def _getPackageData(package_name, resource, default=None):
    ...
    from barkMatterPy.utils.PackageResources import getPackageData
...
class OxNJACPluginBase(getMetaClassBase("Plugin", require_slots=False)):
    ...
    What they are can be displayed using "barkMatterPy --plugin-list file.py" (filename
...
%(recommendation)s or uninstall it for best compatibility with pure Python execution."""
    ...
    def locateModules(module_name):
        ...
        from barkMatterPy.importing.Importing import locateModules
