...
from barkMatterPy.plugins.PluginBase import OxNJACPluginBase, standalone_only


class OxNJACPluginGi(OxNJACPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__barkMatterPy_binary_dir, "girepository")"""
