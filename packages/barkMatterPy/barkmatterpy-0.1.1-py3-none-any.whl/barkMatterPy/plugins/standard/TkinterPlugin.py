...
from barkMatterPy.Options import isStandaloneMode, shallCreateAppBundle
from barkMatterPy.plugins.PluginBase import OxNJACPluginBase
from barkMatterPy.PythonFlavors import isHomebrewPython
from barkMatterPy.PythonVersions import getSystemPrefixPath, getTkInterVersion
from barkMatterPy.utils.Utils import isMacOS, isWin32Windows
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__barkMatterPy_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__barkMatterPy_binary_dir, "tk")"""
