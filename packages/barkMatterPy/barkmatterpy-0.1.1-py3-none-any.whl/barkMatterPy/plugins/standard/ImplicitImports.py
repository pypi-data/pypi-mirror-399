...
from barkMatterPy.importing.Recursion import decideRecursion
from barkMatterPy.plugins.YamlPluginBase import OxNJACYamlPluginBase
...
class OxNJACPluginImplicitImports(OxNJACYamlPluginBase):
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__barkMatterPy_binary_dir + '%ssite.py') if '__barkMatterPy_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from barkMatterPy.HardImportRegistry import trust_node_factory
    from barkMatterPy.nodes.ImportHardNodes import (
