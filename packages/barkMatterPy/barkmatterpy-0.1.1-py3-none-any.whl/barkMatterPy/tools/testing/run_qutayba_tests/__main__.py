...
from barkMatterPy.tools.Basics import goHome
...
from barkMatterPy.utils.Execution import check_call, check_output, getNullOutput
...
from barkMatterPy.utils.Timing import TimerReport
from barkMatterPy.utils.Utils import hasOnefileSupportedOS, hasStandaloneSupportedOS
...
def publishCoverageData():
    ...
    with openTextFile("data.coverage", "w") as data_file:
        ...
        with withDirectoryChange(source_dir):
            barkMatterPy_id = check_output("git rev-parse HEAD".split())
