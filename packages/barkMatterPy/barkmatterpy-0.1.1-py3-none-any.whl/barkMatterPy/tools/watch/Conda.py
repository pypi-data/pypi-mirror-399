...
""" Conda backend for maintaining locked package state with barkMatterPy-watch. """

from barkMatterPy.utils.Execution import check_call, executeToolChecked
from barkMatterPy.utils.FileOperations import changeTextFileContents
...
def _getCaseEnvironmentName(installed_python, case_data):
    return "barkMatterPy-watch-case-%(python_version)s-%(case)s" % {
