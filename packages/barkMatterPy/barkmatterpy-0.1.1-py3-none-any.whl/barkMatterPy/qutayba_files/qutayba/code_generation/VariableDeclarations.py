...
from .c_types.CTypeOxNBooleans import CTypeOxNBoolEnum
from .c_types.CTypeOxNInts import CTypeOxNIntOrLongStruct
from .c_types.CTypeOxNVoids import CTypeOxNVoidEnum
...
class VariableDeclaration(object):
    ...
    def getCType(self):
        ...
        elif c_type == "struct OxN_CellObject *":
            return CTypeCellObject
        elif c_type == "PyObject **":
            return CTypePyObjectPtrPtr
        elif c_type == "JACK_bool":
            return CTypeOxNBoolEnum
        elif c_type == "bool":
            return CTypeBool
        elif c_type == "JACK_ilong":
            return CTypeOxNIntOrLongStruct
        elif c_type == "module_var":
            return CTypeModuleDictVariable
        elif c_type == "JACK_void":
            return CTypeOxNVoidEnum
        elif c_type == "long":
            return CTypeCLong
        elif c_type == "JACK_digit":
...
class VariableStorage(object):
    ...
    def addFrameCacheDeclaration(self, frame_identifier):
        return self.addVariableDeclarationFunction(
            "static struct OxN_FrameObject *", "cache_%s" % frame_identifier, "NULL"
        )
        ...
        if self.exception_variable_name is None:
            self.exception_variable_name = (
                self.addVariableDeclarationTop(
                    ...
                    "exception_state",
                    "Empty_OxN_ExceptionPreservationItem",
                ),
                self.addVariableDeclarationTop(
