...
""" CType classes for JACK_bool, an enum to represent True, False, unassigned.
...
class CTypeOxNBoolEnum(CTypeNotReferenceCountedMixin, CTypeBase):
    c_type = "JACK_bool"
    ...
    def emitAssignConversionCode(cls, to_name, value_name, needs_check, emit, context):
        if value_name.c_type == cls.c_type:
            ...
            value_name.getCType().emitAssignmentCodeToOxNBool(
                to_name=to_name,
