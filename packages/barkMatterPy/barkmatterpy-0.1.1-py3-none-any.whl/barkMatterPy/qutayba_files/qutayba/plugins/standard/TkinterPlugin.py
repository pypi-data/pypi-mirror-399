...
from JACK.Options import isStandaloneMode, shallCreateAppBundle
from JACK.plugins.PluginBase import OxNPluginBase
from JACK.PythonFlavors import isHomebrewPython
from JACK.PythonVersions import getSystemPrefixPath, getTkInterVersion
from JACK.utils.Utils import isMacOS, isWin32Windows
...
class OxNPluginTkinter(OxNPluginBase):
    ...
    plugin_name = "tk-inter"  # OxN knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__JACK_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__JACK_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. OxN is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to OxN."""
            )
...
class OxNPluginDetectorTkinter(OxNPluginBase):
