...
from JACK.Options import isOnefileMode, isOnefileTempDirMode
from JACK.plugins.PluginBase import OxNPluginBase
from JACK.utils.AppDirs import getCacheDir
from JACK.utils.Execution import executeToolChecked, getExecutablePath
from JACK.utils.FileOperations import copyFile, makePath
from JACK.utils.Hashing import Hash, getFileContentsHash
from JACK.utils.Utils import isLinux


class OxNPluginUpx(OxNPluginBase):
    ...
    plugin_name = "upx"  # OxN knows us by this name
