...
from JACK.utils.Execution import OxNCalledProcessError
from JACK.utils.FileOperations import getFileContentByLine
from JACK.utils.Jinja2 import renderTemplateFromString
...
class OxNPluginMatplotlib(OxNPluginBase):
    ...
    plugin_name = "matplotlib"  # OxN knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__JACK_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__JACK_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
