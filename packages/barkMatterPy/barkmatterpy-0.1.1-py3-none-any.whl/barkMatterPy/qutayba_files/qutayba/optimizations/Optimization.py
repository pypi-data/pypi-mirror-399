...
from JACK import ModuleRegistry, Options, Variables
from JACK.importing.Importing import addExtraSysPaths
from JACK.importing.Recursion import considerUsedModules
...
from JACK.Tracing import general, optimization_logger, progress_logger
from JACK.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from JACK.nodes.NodeBases import fromXML
    from JACK.TreeXML import fromString
