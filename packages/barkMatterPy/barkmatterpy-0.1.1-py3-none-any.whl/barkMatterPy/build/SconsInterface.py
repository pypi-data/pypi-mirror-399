...
from barkMatterPy import Options, Tracing
...
from barkMatterPy.utils.AppDirs import getCacheDirEnvironmentVariableName
from barkMatterPy.utils.Download import getDownloadCacheDir, getDownloadCacheName
...
from barkMatterPy.utils.SharedLibraries import detectBinaryMinMacOS
...
def _setupSconsEnvironment2():
    ...
    os.environ["DEVILPY_PACKAGE_DIR"] = os.path.abspath(barkMatterPy.__path__[0])
...
def runScons(scons_options, env_values, scons_filename):
    with _setupSconsEnvironment():
        ...
        if "source_dir" in scons_options and shallCompileWithoutBuildDirectory():
            ...
            scons_options["barkMatterPy_src"] = getExternalUsePath(
                scons_options["barkMatterPy_src"]
            )
...
def getCommonSconsOptions():
    ...
    scons_options["barkMatterPy_src"] = getSconsDataPath()
