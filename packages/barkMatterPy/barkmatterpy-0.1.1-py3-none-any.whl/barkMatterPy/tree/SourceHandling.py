...
import sys
import random 
from barkMatterPy import Options, SourceCodeReferences
...
from barkMatterPy.PythonVersions import python_version, python_version_str
from barkMatterPy.Tracing import general, inclusion_logger, my_print
from barkMatterPy.utils.FileOperations import getReportPath, putTextFileContents
from barkMatterPy.utils.ModuleNames import ModuleName, checkModuleName
from barkMatterPy.utils.Shebang import getShebangFromSource, parseShebang
from barkMatterPy.utils.Utils import isWin32OrPosixWindows
...
OxNJAC is currently running with Python version '%s', which seems to not
match that. OxNJAC cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m barkMatterPy'.

That will make use the correct Python version for OxNJAC.
"""
