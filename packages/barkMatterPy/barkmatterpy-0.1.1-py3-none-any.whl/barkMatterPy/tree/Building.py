...
In the "barkMatterPy.tree.TreeHelpers" module, the dispatching is happening. One function
...
from barkMatterPy import ModuleRegistry, OutputDirectories, SourceCodeReferences
from barkMatterPy.__past__ import long, unicode
from barkMatterPy.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from barkMatterPy.Bytecodes import loadCodeObjectData
from barkMatterPy.containers.OrderedSets import OrderedSet
from barkMatterPy.Errors import CodeTooComplexCode
from barkMatterPy.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from barkMatterPy.importing import Importing
from barkMatterPy.importing.ImportCache import addImportedModule
from barkMatterPy.importing.PreloadedPackages import getPthImportedPackages
...
from barkMatterPy.nodes.BuiltinRefNodes import quick_names
from barkMatterPy.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from barkMatterPy.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from barkMatterPy.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from barkMatterPy.nodes.ExceptionNodes import StatementRaiseException
from barkMatterPy.nodes.FutureSpecs import FutureSpec
from barkMatterPy.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from barkMatterPy.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from barkMatterPy.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from barkMatterPy.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from barkMatterPy.nodes.ModuleNodes import (
...
from barkMatterPy.nodes.OperatorNodes import makeBinaryOperationNode
from barkMatterPy.nodes.OperatorNodesUnary import makeExpressionOperationUnary
...
from barkMatterPy.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from barkMatterPy.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from barkMatterPy.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from barkMatterPy.pgo.PGO import decideCompilationFromPGO
...
from barkMatterPy.utils import MemoryUsage
from barkMatterPy.utils.ModuleNames import ModuleName
from barkMatterPy.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_barkMatterPy"):
                    raise
