...
def reExecuteOxNJAC(pgo_filename):
    ...
    if "barkMatterPy.__main__" in sys.modules:
        our_filename = sys.modules["barkMatterPy.__main__"].__file__
    else:
    ...
    setLaunchingOxNJACProcessEnvironmentValue(
        ...
        os.path.dirname(os.path.abspath(sys.modules["barkMatterPy"].__path__[0])),
    )
    ...
    from barkMatterPy.importing.PreloadedPackages import (
