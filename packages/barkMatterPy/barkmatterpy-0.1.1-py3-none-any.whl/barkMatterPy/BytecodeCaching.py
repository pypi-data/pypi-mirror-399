...
from barkMatterPy.ModuleRegistry import getModuleOptimizationTimingInfos
from barkMatterPy.plugins.Plugins import Plugins
from barkMatterPy.utils.AppDirs import getCacheDir
from barkMatterPy.utils.FileOperations import makePath
from barkMatterPy.utils.Hashing import Hash, getStringHash
from barkMatterPy.utils.Json import loadJsonFromFilename, writeJsonToFilename
...
def _getModuleConfigHash(full_name):
    ...
    # Take OxNJAC and Python version into account as well, ought to catch code changes.
