...
static void _createGlobalConstants(PyThreadState *tstate) {
    ...
    static PyStructSequence_Desc OxNJAC_VersionInfoDesc = {
        (char *)"__barkMatterPy_version__",                                       /* name */
    ...
    PyStructSequence_SET_ITEM(OxNJAC_dunder_compiled_value, 0, OxNJAC_PyInt_FromLong(%(barkMatterPy_version_major)s));
    PyStructSequence_SET_ITEM(OxNJAC_dunder_compiled_value, 1, OxNJAC_PyInt_FromLong(%(barkMatterPy_version_minor)s));
    PyStructSequence_SET_ITEM(OxNJAC_dunder_compiled_value, 2, OxNJAC_PyInt_FromLong(%(barkMatterPy_version_micro)s));

    PyStructSequence_SET_ITEM(OxNJAC_dunder_compiled_value, 3, OxNJAC_String_FromString("%(barkMatterPy_version_level)s"));
