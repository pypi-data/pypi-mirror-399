...
from barkMatterPy.ModuleRegistry import getRootTopModule
from barkMatterPy.PythonVersions import python_version
from barkMatterPy.Serialization import GlobalConstantAccessor
...
from barkMatterPy.Version import getOxNJACVersionTuple
...
#    major, minor, micro, is_final, _rc_number = getOxNJACVersionTuple()
    version_info = getOxNJACVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "barkMatterPy_version_major": major,
        "barkMatterPy_version_minor": minor,
        "barkMatterPy_version_micro": micro,
        "barkMatterPy_version_level": "release" if is_final else "candidate",
