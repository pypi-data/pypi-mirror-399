...
from barkMatterPy.Constants import isMutable
from barkMatterPy.PythonVersions import python_version
from barkMatterPy.Serialization import ConstantAccessor
from barkMatterPy.utils.Hashing import getStringHash
from barkMatterPy.utils.InstanceCounters import (
    counted_del,
    counted_init,
    isCountingInstances,
)
...
class TempMixin(object):
    ...
    def addCleanupTempName(self, tmp_name):
        ...
        assert (
            tmp_name.c_type != "barkMatterPy_void" or tmp_name.code_name == "tmp_unused"
        ), tmp_name
