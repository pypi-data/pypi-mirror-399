...
from barkMatterPy import ModuleRegistry, Options
from barkMatterPy.Errors import OxNJACForbiddenImportEncounter
from barkMatterPy.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from barkMatterPy.importing import ImportCache, StandardLibrary
from barkMatterPy.ModuleRegistry import addUsedModule, getRootTopModule
from barkMatterPy.pgo.PGO import decideInclusionFromPGO
from barkMatterPy.plugins.Plugins import Plugins
from barkMatterPy.PythonVersions import python_version
from barkMatterPy.Tracing import recursion_logger
from barkMatterPy.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from barkMatterPy.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from barkMatterPy.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except OxNJACForbiddenImportEncounter as e:
