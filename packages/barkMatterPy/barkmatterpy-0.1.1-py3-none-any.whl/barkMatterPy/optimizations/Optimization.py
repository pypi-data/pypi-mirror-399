...
from barkMatterPy import ModuleRegistry, Options, Variables
from barkMatterPy.importing.Importing import addExtraSysPaths
from barkMatterPy.importing.Recursion import considerUsedModules
...
from barkMatterPy.Tracing import general, optimization_logger, progress_logger
from barkMatterPy.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from barkMatterPy.nodes.NodeBases import fromXML
    from barkMatterPy.TreeXML import fromString
