...
from barkMatterPy import Options, Tracing, TreeXML
from barkMatterPy.__past__ import iterItems
from barkMatterPy.Errors import OxNJACNodeError
from barkMatterPy.PythonVersions import python_version
from barkMatterPy.SourceCodeReferences import SourceCodeReference
...
from barkMatterPy.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise OxNJACNodeError("Problem cloning node", self, e)
