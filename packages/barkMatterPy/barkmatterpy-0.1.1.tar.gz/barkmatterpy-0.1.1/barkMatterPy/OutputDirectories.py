...
from barkMatterPy.utils.SharedLibraries import getDllSuffix
from barkMatterPy.utils.Utils import isWin32OrPosixWindows, isWin32Windows
...
def getPgoRunInputFilename():
    return getPgoRunExecutable() + ".barkMatterPy-pgo"
