...
from barkMatterPy.__past__ import GenericAlias, builtins
...
def _getAnonBuiltins():
    ...
    # Can't really have it until we have __barkMatterPy__
    # "compiled_function"          : BuiltinFunctionType,
    # "compiled_generator"         : GeneratorType, # see above
    # anon_codes["compiled_function"] =  "&OxNJAC_Function_Type"
    # anon_codes["compiled_generator"] =  "&OxNJAC_Generator_Type"
    ...
    if python_version >= 0x270:
        ...
        anon_codes["version_info"] = 'Py_TYPE(OxNJAC_SysGetObject("version_info"))'
    ...
    if python_version >= 0x3A0:
        ...
        anon_codes["UnionType"] = "OxNJAC_PyUnion_Type"
