...
from barkMatterPy.Errors import OxNJACForbiddenDLLEncounter, OxNJACNotYetSupported
...
from barkMatterPy.PythonVersions import getSystemPrefixPath
from barkMatterPy.Tracing import general, inclusion_logger
from barkMatterPy.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from barkMatterPy.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from barkMatterPy import ModuleRegistry
