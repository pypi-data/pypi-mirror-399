...
from barkMatterPy.Options import getOnefileTempDirSpec, isOnefileTempDirMode
from barkMatterPy.OutputDirectories import getResultFullpath
from barkMatterPy.plugins.Plugins import Plugins
from barkMatterPy.PostProcessing import executePostProcessingResources
from barkMatterPy.PythonVersions import (
    getZstandardSupportingVersions,
    python_version,
)
from barkMatterPy.Tracing import onefile_logger, postprocessing_logger
from barkMatterPy.utils.Execution import withEnvironmentVarsOverridden
...
from barkMatterPy.utils.SharedLibraries import cleanupHeaderForAndroid
from barkMatterPy.utils.Signing import addMacOSCodeSignature
...
from barkMatterPy.utils.WindowsResources import RT_RCDATA, addResourceToFile
...
def runOnefileCompressor(
    ...
    if compressor_python is None or areSamePaths(
        ...
        from barkMatterPy.tools.onefile_compressor.OnefileCompressor import (
        ...
        mapping = {
            "DEVILPY_PACKAGE_HOME": os.path.dirname(
                os.path.abspath(sys.modules["barkMatterPy"].__path__[0])
            )
        }
