...
from barkMatterPy.__past__ import (  # pylint: disable=redefined-builtin
    BrokenPipeError,
    raw_input,
)
...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://barkMatterPy.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from barkMatterPy.Progress import closeProgressBar
