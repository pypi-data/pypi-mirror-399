...
from barkMatterPy.Tracing import scons_details_logger, scons_logger
from barkMatterPy.utils.Download import getCachedDownloadedMinGW64
...
def _enableLtoSettings(
    ...
    if (
        ...
        and not env.barkMatterPy_python
    ):
        lto_mode = False
        reason = (
...
def setupCCompiler(env, lto_mode, pgo_mode, job_count, onefile_compile):
    ...
    zlib_inline_copy_dir = os.path.join(env.barkMatterPy_src, "inline_copy", "zlib")
