...
from barkMatterPy.utils.Execution import OxNJACCalledProcessError
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__barkMatterPy_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__barkMatterPy_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
