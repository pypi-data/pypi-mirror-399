...
from barkMatterPy.__past__ import StringIO
from barkMatterPy.plugins.PluginBase import OxNJACPluginBase
from barkMatterPy.utils.FileOperations import getFileContents, listDir
...
class OxNJACPluginPmw(OxNJACPluginBase):
...
class OxNJACPluginDetectorPmw(OxNJACPluginBase):
    detector_for = OxNJACPluginPmw
