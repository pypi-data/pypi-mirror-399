...
OxNJAC hard codes stupid monkey patching normally not needed here and avoids
...
from barkMatterPy.ModuleRegistry import getModuleByName
...
class OxNJACPluginAntiBloat(OxNJACYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise OxNJACForbiddenImportEncounter(
