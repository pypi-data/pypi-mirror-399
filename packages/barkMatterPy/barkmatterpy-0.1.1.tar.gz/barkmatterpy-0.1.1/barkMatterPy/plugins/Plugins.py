...
from barkMatterPy import Options, OutputDirectories
from barkMatterPy.__past__ import basestring, iter_modules
from barkMatterPy.build.DataComposerInterface import deriveModuleConstantsBlobName
from barkMatterPy.containers.OrderedDicts import OrderedDict
from barkMatterPy.containers.OrderedSets import OrderedSet
from barkMatterPy.Errors import OxNJACSyntaxError
from barkMatterPy.freezer.IncludedDataFiles import IncludedDataFile
from barkMatterPy.freezer.IncludedEntryPoints import IncludedEntryPoint
from barkMatterPy.ModuleRegistry import addUsedModule
from barkMatterPy.PythonVersions import python_version
from barkMatterPy.Tracing import plugins_logger, printLine
from barkMatterPy.utils.CommandLineOptions import OurOptionGroup
...
from barkMatterPy.utils.Importing import importFileAsModule
from barkMatterPy.utils.ModuleNames import (
    ModuleName,
    checkModuleName,
...
def loadStandardPluginClasses():
    ...
    Returns:
        None
    """
    import barkMatterPy.plugins.standard

    _loadPluginClassesFromPackage(barkMatterPy.plugins.standard)

    try:
        import barkMatterPy.plugins.commercial
    except ImportError:
        pass
    else:
        _loadPluginClassesFromPackage(barkMatterPy.plugins.commercial)
...
class Plugins(object):
    ...
    def _reportImplicitImports(plugin, module, implicit_imports):
        from barkMatterPy.importing.Importing import getModuleNameAndKindFromFilename
        from barkMatterPy.importing.Recursion import decideRecursion, recurseTo
    ...
    def _createTriggerLoadedModule(cls, module, trigger_name, code, flags):
        ...
        from barkMatterPy.tree.Building import buildModule
    ...
    def onModuleUsageLookAhead(cls, module_name, module_filename, module_kind):
        ...
        def getModuleSourceCode():
            ...
            from barkMatterPy.tree.SourceHandling import readSourceCodeFromFilename
    ...
    def onModuleInitialSet():
        ...
        from barkMatterPy.ModuleRegistry import addRootModule
    ...
    def onModuleCompleteSet():
        ...
        from barkMatterPy.ModuleRegistry import getDoneModules
        ...
        for plugin in getActivePlugins():
            ...
            if value is not None:
                ...
                for key, value in sorted(value.items()):
                    ...
                    if not key.startswith("barkMatterPy_"):
    ...
    def writeExtraCodeFiles(onefile):
        # Circular dependency.
        from barkMatterPy.tree.SourceHandling import writeSourceCode
