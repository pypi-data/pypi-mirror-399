...
from barkMatterPy.freezer.DependsExe import getDependsExePath, parseDependsExeOutput
...
from barkMatterPy.utils.Utils import isFreeBSD, isMacOS, isWin32Windows
...
def _getRuntimeTraceOfLoadedFilesWin32(logger, command, required):
    ...
    # TODO: Move the handling of this into barkMatterPy.tools.Execution module methods.
    try:
