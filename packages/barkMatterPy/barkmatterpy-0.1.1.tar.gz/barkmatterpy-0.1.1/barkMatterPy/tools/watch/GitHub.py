...
""" GitHub interfacing for barkMatterPy-watch. """

import os
import sys

from barkMatterPy.tools.quality.Git import getModifiedPaths, getRemoteURL
from barkMatterPy.Tracing import tools_logger
from barkMatterPy.utils.Execution import callProcess, check_call
...
if __name__ == "__main__":
    # TODO: This runner should be directly used from barkMatterPy-watch binary,
