...
import barkMatterPy.Options

barkMatterPy.Options.is_full_compat = False

# isort:start

import os

import barkMatterPy.specs.BuiltinBytesOperationSpecs
import barkMatterPy.specs.BuiltinDictOperationSpecs
import barkMatterPy.specs.BuiltinListOperationSpecs
import barkMatterPy.specs.BuiltinStrOperationSpecs
import barkMatterPy.specs.BuiltinUnicodeOperationSpecs
from barkMatterPy.code_generation.BinaryOperationHelperDefinitions import (
    getSpecializedBinaryOperations,
    isCommutativeOperation,
    parseTypesFromHelper,
)
from barkMatterPy.code_generation.c_types.CTypePyObjectPointers import (
    make_list_constant_direct_threshold,
    make_list_constant_hinted_threshold,
)
from barkMatterPy.code_generation.CallCodes import (
    getQuickCallCode,
...
from barkMatterPy.code_generation.ComparisonHelperDefinitions import (
    getSpecializedComparisonOperations,
)
from barkMatterPy.code_generation.ImportCodes import getImportModuleHardCodeName
from barkMatterPy.containers.OrderedSets import OrderedSet
from barkMatterPy.HardImportRegistry import (
    hard_modules,
...
from barkMatterPy.utils.Jinja2 import getTemplateC
...
def getDoExtensionUsingTemplateC(template_name):
    return getTemplateC(
        package_name="barkMatterPy.code_generation",
...
def makeHelpersComparisonOperation(operand, op_code):
    ...
    filename_c = "barkMatterPy/build/static_src/HelpersComparison%s.c" % op_code.capitalize()
    filename_h = "barkMatterPy/build/include/barkMatterPy/helper/comparisons_%s.h" % op_code.lower()
...
def makeHelpersComparisonDualOperation(operand, op_code):
    ...
    filename_c = (
        "barkMatterPy/build/static_src/HelpersComparisonDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "barkMatterPy/build/include/barkMatterPy/helper/comparisons_dual_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryOperation(operator, op_code):
    ...
    filename_c = (
        "barkMatterPy/build/static_src/HelpersOperationBinary%s.c" % op_code.capitalize()
    )
    filename_h = (
        "barkMatterPy/build/include/barkMatterPy/helper/operations_binary_%s.h" % op_code.lower()
    )
...
def makeHelpersInplaceOperation(operator, op_code):
    ...
    filename_c = (
        "barkMatterPy/build/static_src/HelpersOperationInplace%s.c" % op_code.capitalize()
    )
    filename_h = (
        "barkMatterPy/build/include/barkMatterPy/helper/operations_inplace_%s.h" % op_code.lower()
    )
...
def makeHelpersBinaryDualOperation(operand, op_code):
    ...
    filename_c = (
        "barkMatterPy/build/static_src/HelpersOperationBinaryDual%s.c" % op_code.capitalize()
    )
    filename_h = (
        "barkMatterPy/build/include/barkMatterPy/helper/operations_binary_dual_%s.h"
        % op_code.lower()
    )
...
def makeHelpersImportHard():
    filename_c = "barkMatterPy/build/static_src/HelpersImportHard.c"
    filename_h = "barkMatterPy/build/include/barkMatterPy/helper/import_hard.h"
...
def makeHelperCalls():
    filename_c = "barkMatterPy/build/static_src/HelpersCallingGenerated.c"
    filename_h = "barkMatterPy/build/include/barkMatterPy/helper/calling_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "barkMatterPy.code_generation", "CodeTemplateCallsPositional.c.j2"
            )
            ...
            template = getTemplateC(
                "barkMatterPy.code_generation", "CodeTemplateCallsMixed.c.j2"
            )
...
def makeHelperLists():
    filename_c = "barkMatterPy/build/static_src/HelpersListsGenerated.c"
    filename_h = "barkMatterPy/build/include/barkMatterPy/helper/lists_generated.h"
    ...
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
            ...
            template = getTemplateC(
                "barkMatterPy.code_generation", "CodeTemplateMakeListSmall.c.j2"
            )
            ...
            template = getTemplateC(
                "barkMatterPy.code_generation", "CodeTemplateMakeListHinted.c.j2"
            )
...
generate_builtin_type_operations = [
    ...
    (
        "tshape_dict",
        dict_desc,
        barkMatterPy.specs.BuiltinDictOperationSpecs,
        ("pop", "popitem", "setdefault"),
    ),
    (
        "tshape_list",
        list_desc,
        barkMatterPy.specs.BuiltinListOperationSpecs,
        (
            "pop",
    ...
    (
        "tshape_str",
        str_desc,
        barkMatterPy.specs.BuiltinStrOperationSpecs,
        (
            "strip",
            "rstrip",
            "lstrip",
    ...
    (
        "tshape_unicode",
        unicode_desc,
        barkMatterPy.specs.BuiltinUnicodeOperationSpecs,
        (
            "strip",
            "rstrip",
            "lstrip",
    ...
    (
        "tshape_bytes",
        bytes_desc,
        barkMatterPy.specs.BuiltinBytesOperationSpecs,
        (
            "capitalize",
            "center",
            "count",
...
def makeDictCopyHelperCodes():
    filename_c = "barkMatterPy/build/static_src/HelpersDictionariesGenerated.c"
...
def makeHelperBuiltinTypeMethods():
    ...
    filename_c = "barkMatterPy/build/static_src/HelpersBuiltinTypeMethods.c"
    filename_h = "barkMatterPy/build/include/barkMatterPy/helper/operations_builtin_types.h"
    with withFileOpenedAndAutoFormatted(filename_c) as output_c:
        with withFileOpenedAndAutoFormatted(filename_h) as output_h:
