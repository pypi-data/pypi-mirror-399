...
from barkMatterPy.tools.release.Release import (
    getBranchName,
...
from barkMatterPy.utils.Utils import getArchitecture, isWin32Windows
...
def main():
    ...
    if options.command is None:
        options.command = "python3 -m barkMatterPy --version"
    ...
    container_tag_name = "barkMatterPy-build-%s-%s:latest" % (
    ...
    if options.network:
        command.append("--add-host=ssh.barkMatterPy.net:116.202.30.188")
    else:
