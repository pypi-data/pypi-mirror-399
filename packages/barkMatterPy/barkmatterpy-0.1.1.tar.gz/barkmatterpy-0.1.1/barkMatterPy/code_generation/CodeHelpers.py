...
from barkMatterPy.nodes.NodeMetaClasses import OxNJACNodeDesignError
from barkMatterPy.Options import shallTraceExecution
from barkMatterPy.PythonVersions import python_version
from barkMatterPy.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "barkMatterPy_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "barkMatterPy_void":
