...
from barkMatterPy.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingOxNJACProcessEnvironmentValue(environment_variable_name):
    ...
    from barkMatterPy import getLaunchingOxNJACProcessEnvironmentValue
