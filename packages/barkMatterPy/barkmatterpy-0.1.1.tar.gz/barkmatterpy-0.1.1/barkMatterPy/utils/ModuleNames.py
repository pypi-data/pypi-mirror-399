...
These are used in OxNJAC for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from barkMatterPy.Errors import OxNJACCodeDeficit
    raise OxNJACCodeDeficit('''
...
Check API documentation of barkMatterPy.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
