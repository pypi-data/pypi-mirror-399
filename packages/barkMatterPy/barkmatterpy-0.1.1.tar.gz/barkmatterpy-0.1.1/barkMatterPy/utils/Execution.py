...
from barkMatterPy.__past__ import subprocess
...
class OxNJACCalledProcessError(subprocess.CalledProcessError):
...
def check_output(*popenargs, **kwargs):
    ...
    if exit_code:
        ...
        raise OxNJACCalledProcessError(exit_code, cmd, output=output, stderr=stderr)
