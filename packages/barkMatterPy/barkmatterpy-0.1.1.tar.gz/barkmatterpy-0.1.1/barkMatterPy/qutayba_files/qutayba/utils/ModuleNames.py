...
These are used in OxN for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from JACK.Errors import OxNCodeDeficit
    raise OxNCodeDeficit('''
...
Check API documentation of JACK.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
