...
In the "JACK.tree.TreeHelpers" module, the dispatching is happening. One function
...
from JACK import ModuleRegistry, OutputDirectories, SourceCodeReferences
from JACK.__past__ import long, unicode
from JACK.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from JACK.Bytecodes import loadCodeObjectData
from JACK.containers.OrderedSets import OrderedSet
from JACK.Errors import CodeTooComplexCode
from JACK.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from JACK.importing import Importing
from JACK.importing.ImportCache import addImportedModule
from JACK.importing.PreloadedPackages import getPthImportedPackages
...
from JACK.nodes.BuiltinRefNodes import quick_names
from JACK.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from JACK.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from JACK.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from JACK.nodes.ExceptionNodes import StatementRaiseException
from JACK.nodes.FutureSpecs import FutureSpec
from JACK.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from JACK.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from JACK.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from JACK.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from JACK.nodes.ModuleNodes import (
...
from JACK.nodes.OperatorNodes import makeBinaryOperationNode
from JACK.nodes.OperatorNodesUnary import makeExpressionOperationUnary
...
from JACK.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from JACK.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from JACK.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from JACK.pgo.PGO import decideCompilationFromPGO
...
from JACK.utils import MemoryUsage
from JACK.utils.ModuleNames import ModuleName
from JACK.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_JACK"):
                    raise
