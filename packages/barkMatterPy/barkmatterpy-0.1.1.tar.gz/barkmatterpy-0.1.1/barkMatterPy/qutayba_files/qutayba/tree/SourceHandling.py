...
import sys
import random 
from JACK import Options, SourceCodeReferences
...
from JACK.PythonVersions import python_version, python_version_str
from JACK.Tracing import general, inclusion_logger, my_print
from JACK.utils.FileOperations import getReportPath, putTextFileContents
from JACK.utils.ModuleNames import ModuleName, checkModuleName
from JACK.utils.Shebang import getShebangFromSource, parseShebang
from JACK.utils.Utils import isWin32OrPosixWindows
...
OxN is currently running with Python version '%s', which seems to not
match that. OxN cannot guess the Python version of your source code. You
therefore might want to specify: '%s -m JACK'.

That will make use the correct Python version for OxN.
"""
