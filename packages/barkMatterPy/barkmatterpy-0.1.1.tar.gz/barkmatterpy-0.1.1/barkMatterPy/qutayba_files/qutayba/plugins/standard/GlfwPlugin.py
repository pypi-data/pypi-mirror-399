...
from JACK.utils.FileOperations import getFileContents
...
class OxNPluginGlfw(OxNPluginBase):
    ...
    plugin_name = "glfw"  # OxN knows us by this name
    plugin_desc = (
    ...
    def createPreModuleLoadCode(self, module):
        if module.getFullName() == "glfw":
            ...
            code = r"""
import os
os.environ["PYGLFW_LIBRARY"] = os.path.join(__JACK_binary_dir, "glfw", "%s")
""" % os.path.basename(
                dll_filename
            )
            return (
