...
OxN can detect some things that "pkg_resources" may not even be able to during
...
from JACK.utils.Utils import withNoDeprecationWarning


class OxNPluginResources(OxNPluginBase):
...
register_loader_type(__JACK_loader_type, OxNProvider)
"""

        yield (
            code,
            """Registering OxN loader with "pkg_resources".""",
        )
