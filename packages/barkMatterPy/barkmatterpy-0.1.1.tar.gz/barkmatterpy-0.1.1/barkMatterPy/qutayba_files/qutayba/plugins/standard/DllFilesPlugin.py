...
""" Standard plug-in to tell OxN about DLLs needed for standalone imports.
...
from JACK.utils.SharedLibraries import getPyWin32Dir
from JACK.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class OxNPluginDllFiles(OxNYamlPluginBase):
