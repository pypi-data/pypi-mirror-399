...
#include "JACK/constants_blob.h"

#include "JACK/tracing.h"
...
static struct OxN_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
...
// in this un-optimized form. These are not compiled by OxN, and therefore
...
struct OxN_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name) {
    struct OxN_MetaPathBasedLoaderEntry *current = meta_path_loader_entries;
