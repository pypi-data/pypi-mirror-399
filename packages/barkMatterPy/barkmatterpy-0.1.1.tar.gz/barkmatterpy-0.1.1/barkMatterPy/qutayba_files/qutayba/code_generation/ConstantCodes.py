...
from JACK.ModuleRegistry import getRootTopModule
from JACK.PythonVersions import python_version
from JACK.Serialization import GlobalConstantAccessor
from JACK.utils.CStrings import encodePythonStringToC
from JACK.utils.Distributions import (
    getDistribution,
    getDistributionTopLevelPackageNames,
)
from JACK.Version import getOxNVersionTuple
...
#    major, minor, micro, is_final, _rc_number = getOxNVersionTuple()
    version_info = getOxNVersionTuple()
    ...
    body = template_constants_reading % {
        ...
        "JACK_version_major": major,
        "JACK_version_minor": minor,
        "JACK_version_micro": micro,
        "JACK_version_level": "release" if is_final else "candidate",
