...
from JACK.ModuleRegistry import getModuleOptimizationTimingInfos
from JACK.plugins.Plugins import Plugins
from JACK.utils.AppDirs import getCacheDir
from JACK.utils.FileOperations import makePath
from JACK.utils.Hashing import Hash, getStringHash
from JACK.utils.Json import loadJsonFromFilename, writeJsonToFilename
...
def _getModuleConfigHash(full_name):
    ...
    # Take OxN and Python version into account as well, ought to catch code changes.
