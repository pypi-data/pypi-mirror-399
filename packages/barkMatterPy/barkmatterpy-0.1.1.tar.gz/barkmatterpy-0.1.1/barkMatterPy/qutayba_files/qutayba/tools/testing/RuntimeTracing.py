...
from JACK.freezer.DependsExe import getDependsExePath, parseDependsExeOutput
...
from JACK.utils.Utils import isFreeBSD, isMacOS, isWin32Windows
...
def _getRuntimeTraceOfLoadedFilesWin32(logger, command, required):
    ...
    # TODO: Move the handling of this into JACK.tools.Execution module methods.
    try:
