...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://JACK.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from JACK.Progress import closeProgressBar
...
general = OurLogger("OxN")
plugins_logger = OurLogger("OxN-Plugins")
recursion_logger = OurLogger("OxN-Inclusion")
progress_logger = OurLogger("OxN-Progress", quiet=True)
memory_logger = OurLogger("OxN-Memory")
metadata_logger = OurLogger("OxN-Metadata")
optimization_logger = FileLogger("OxN-Optimization")
pgo_logger = FileLogger("OxN-PGO")
code_generation_logger = OurLogger("OxN-CodeGen")
inclusion_logger = FileLogger("OxN-Inclusion")
scons_logger = OurLogger("OxN-Scons")
scons_details_logger = OurLogger("OxN-Scons")
postprocessing_logger = OurLogger("OxN-Postprocessing")
options_logger = OurLogger("OxN-Options")
unusual_logger = OurLogger("OxN-Unusual")
data_composer_logger = OurLogger("OxN-DataComposer")
onefile_logger = OurLogger("OxN-Onefile")
tools_logger = OurLogger("OxN-Tools")
wheel_logger = OurLogger("OxN-Wheel", base_style="blue")
cache_logger = OurLogger("OxN-Cache")
reports_logger = OurLogger("OxN-Reports")
offsets_logger = OurLogger("OxN-Offsets")
