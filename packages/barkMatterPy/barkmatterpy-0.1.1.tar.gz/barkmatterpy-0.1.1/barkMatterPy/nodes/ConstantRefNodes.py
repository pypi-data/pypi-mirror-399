...
from barkMatterPy.__past__ import (
    GenericAlias,
    UnionType,
    iterItems,
    long,
...
from barkMatterPy.Constants import (
...
from barkMatterPy.Tracing import optimization_logger
...
class ExpressionConstantTypeRef(ExpressionConstantUntrackedRefBase):
    ...
    def computeExpressionCall(self, call_node, call_args, call_kw, trace_collection):
        ...
        if call_kw is not None and not call_kw.isMappingWithConstantStringKeys():
            ...
            from barkMatterPy.optimizations.OptimizeBuiltinCalls import (
                computeBuiltinCall,
            )
