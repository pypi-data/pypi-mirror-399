...
class PackagePreset(BaseModel):
    ...
    package_version: str | None = Field(default=None, serialization_alias="packageVersion")
    package_directory: str | None = Field(default=None, serialization_alias="packageDirectory")
...
class CMakePresets(BaseModel):
    ...
    build_presets: list[BuildPreset] | None = Field(default=None, serialization_alias="buildPresets")
    test_presets: list[TestPreset] | None = Field(default=None, serialization_alias="testPresets")
