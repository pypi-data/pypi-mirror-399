...
from portal_tool.installer.configurators.configurator import Configurator, CompilerDetails
...
class LinuxConfigurator(Configurator):
    ...
    def validate_compilers(self) -> list[CompilerDetails]:
        ...
        try:
            ...
            found_compilers.append(CompilerDetails(name="clang", c_compiler="clang", cpp_compiler="clang++"))
