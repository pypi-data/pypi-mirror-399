...
from installer.configurators.configurator import CompilerDetails
...
class RepoMaker:
    ...
    def _configure_build_system(self) -> None:
        ...
        if len(compilers) == 0:
            raise typer.Abort("No valid compilers found, please run `portal-tool install` and follow the instructions.")
        ...
        (self.project_path / "vcpkg-configuration.json").write_text(json.dumps(vcpkg_config, indent=4))
