#  musecbox/dialogs/copy_sfz_dialog.py
#
...
from PyQt5.QtWidgets import QApplication, QFileDialog, QRadioButton, QCheckBox, QLabel, \
...
class CopySFZDialog(QFileDialog):
	"""
...
#  end musecbox/dialogs/copy_sfz_dialog.py
