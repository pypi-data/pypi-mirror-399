...
def _build_parser_inner(
    ...
    if dataclasses.is_dataclass(parsed_type):
        dc_merged_map: dict[typing.TypeVar, type] = {}
        _resolve_base_type_vars(cls=parsed_type, type_var_map=dc_merged_map)
        return _build_parser_dataclass(parsed_type, context, dc_merged_map)
