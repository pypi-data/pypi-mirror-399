...
__all__: list[str] = [
    ...
    "RecipeInputEditSetPropagatedPercentage",
...
class RecipeInputEditType(StrEnum):
    ...
    SET_LOT = "set_lot"
    SET_PROPAGATED_PERCENTAGE = "set_propagated_percentage"
...
# DO NOT MODIFY -- This file is generated by type_spec
@serial_class(
    named_type_path="sdk.api.recipes.edit_recipe_inputs.RecipeInputEditSetPropagatedPercentage",
    to_string_values={"propagated_percentage"},
    parse_require={"type"},
)
@dataclasses.dataclass(slots=base_t.ENABLE_SLOTS, kw_only=True)  # type: ignore[literal-required]
class RecipeInputEditSetPropagatedPercentage(RecipeInputEditBase):
    type: typing.Literal[RecipeInputEditType.SET_PROPAGATED_PERCENTAGE] = RecipeInputEditType.SET_PROPAGATED_PERCENTAGE
    ingredient_key: identifier_t.IdentifierKey
    propagated_percentage: Decimal
    mix_step_match_strategy: MixStepMatchStrategy = MixStepMatchStrategy.FIRST
...
RecipeInputEdit = typing.Annotated[
    RecipeInputEditClearInputs | RecipeInputEditUpsertInput | RecipeInputEditAddInput | RecipeInputEditUpdateAnnotations | RecipeInputEditSetLot | RecipeInputEditSetPropagatedPercentage | RecipeInputEditChangeBasisViewed | RecipeInputEditAddInstructions | RecipeInputEditSetRole | RecipeInputEditPlaceholder,
    serial_union_annotation(
    named_type_path="sdk.api.recipes.edit_recipe_inputs.RecipeInputEdit",
        ...
        discriminator_map={
            ...
            "set_propagated_percentage": RecipeInputEditSetPropagatedPercentage,
