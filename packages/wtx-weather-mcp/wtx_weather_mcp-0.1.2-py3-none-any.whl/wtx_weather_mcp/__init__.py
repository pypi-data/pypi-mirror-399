...
# 全国城市15天逐日预报
@mcp.tool()
def query_forecast_day15(lon: float, lat: float) -> dict:
    """
根据经纬度查询全国城市15天逐日预报: 可获取中国任意经纬度的分钟级天气实况，包含天气现象、实时温度、体感温度、风力风向、相对湿度、海平面气压、降水量（多时间维度统计）、能见度、露点温度、云量、太阳辐射等诸多要素。
调取方式：区域/任意经纬度
数据要素：天气现象、温度、体感温度、小时最高温、小时高温出现时间、24小时变温、24小时变温描述、相对湿度、露点温度、风向角度数值、风向描述、风速、风力、阵风、阵风级别、紫外线级别、紫外线描述、能见度、云量、地面气压、过去24小时变压、过去24小时变压描述、过去3小时变压、过去3小时变压描述、过去1小时降水、过去3小时累计降水、过去6小时累计降水、过去12小时累计降水、过去24小时累计降水、太阳短波辐射
:param lon: 经度
:param lat: 纬度
