 ...
 *
 */
public class SIMDAlignByte128 {

	//Example from https://medium.com/@Styp/java-18-vector-api-do-we-get-free-speed-up-c4510eda50d2
	/** Vector species for 128-bit float vectors, used for SIMD float operations */
	...
	/** Number of float elements that fit in a 128-bit vector */
	private static final int FWIDTH=FSPECIES.length();
	//		private static final int boundMask=~(FWIDTH-1);

	/** Vector species for 128-bit byte vectors, used for SIMD byte operations */
	private static final VectorSpecies<Byte> BSPECIES=ByteVector.SPECIES_128;
	/** Number of byte elements that fit in a 128-bit vector */
	private static final int BWIDTH=BSPECIES.length();

	/**
	 * Vector species for 128-bit integer vectors, used for SIMD integer operations
	 */
	private static final VectorSpecies<Integer> ISPECIES=IntVector.SPECIES_128;
	/** Number of integer elements that fit in a 128-bit vector */
	private static final int IWIDTH=ISPECIES.length();

	/** Vector species for 128-bit short vectors, used for SIMD short operations */
	private static final VectorSpecies<Short> SSPECIES=ShortVector.SPECIES_128;
	/** Number of short elements that fit in a 128-bit vector */
	private static final int SWIDTH=SSPECIES.length();

	/**
	 * Vector species for 128-bit double vectors, used for SIMD double operations
	 */
	private static final VectorSpecies<Double> DSPECIES=DoubleVector.SPECIES_128;
	/** Number of double elements that fit in a 128-bit vector */
	private static final int DWIDTH=DSPECIES.length();

	/** Vector species for 128-bit long vectors, used for SIMD long operations */
	private static final VectorSpecies<Long> LSPECIES=LongVector.SPECIES_128;
	/** Number of long elements that fit in a 128-bit vector */
	...
	public static final IntList alignDiagonal(byte[] query, byte[] ref, int maxSubs){
		assert(maxSubs<=255) : "This method can only handle up to 255 substitutions.";
