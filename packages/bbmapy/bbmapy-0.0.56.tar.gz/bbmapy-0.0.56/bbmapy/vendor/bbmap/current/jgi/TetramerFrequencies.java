...
/**
 * Calculates k-mer frequencies in sequences using a sliding window approach.
 * Processes reads to generate tetramer (4-mer) frequency profiles across sequence windows with configurable step size and window dimensions.
 * Supports GC compensation and both count and frequency output formats.
 * @author syao
