...
/**
 * Translates nucleotide sequences to amino acids in up to six reading frames.
 * Supports both forward and reverse strand translation for all three frames.
 * Can also convert amino acid sequences back to nucleotide representation.
