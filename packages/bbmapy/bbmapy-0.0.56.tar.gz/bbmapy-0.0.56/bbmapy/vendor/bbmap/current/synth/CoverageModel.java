...
class CoverageModel{
	...
	/**
	 * Legacy main method that simulates reads using random sampling.
	 * Generates actual read positions and outputs coverage histogram.
	 * @param args Command-line arguments: numWaves, coverage, readLength, genomeLength
	 */
