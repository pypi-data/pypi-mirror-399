...
/**
 * Bit-packed count array for storing k-mer frequencies in Bloom filters.
 * Uses multiple parallel arrays to distribute load and bit-level packing for memory efficiency.
 * Supports variable bit widths per cell to optimize memory usage based on expected counts.
 *
