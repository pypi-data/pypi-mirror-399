...
/**
 * Renames sequence read headers using various renaming strategies.
 * Supports prefix/suffix addition, trimming, coordinate-based naming, insert size-based naming, and SRA format fixing.
