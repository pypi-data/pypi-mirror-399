...
/**
 * Merges multiple SAM files while filtering out invalid entries.
 * Maintains proper header ordering by collecting all headers first,
 * then processing alignment records from all input files sequentially.
 *
