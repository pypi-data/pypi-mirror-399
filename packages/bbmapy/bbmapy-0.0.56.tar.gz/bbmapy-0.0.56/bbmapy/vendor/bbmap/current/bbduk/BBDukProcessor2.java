...
//		strictOverlap=p.strictOverlap;
	...
	public BBDukProcessor2(BBDukProcessor2 proc) {
		this(proc.parser, proc.index, proc.cris, proc.ros, proc.rosb, proc.ross);
	}
	
	@Override
	public BBDukProcessor2 clone() {
		return new BBDukProcessor2(this);
	}
	
	public void add(BBDukProcessor2 pt) {
		readsIn+=pt.readsIn;
		basesIn+=pt.basesIn;
