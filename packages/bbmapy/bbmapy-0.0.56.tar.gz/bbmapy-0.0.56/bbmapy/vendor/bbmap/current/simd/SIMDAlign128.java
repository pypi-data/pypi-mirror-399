 ...
 *
 */
public class SIMDAlign128 {
	
	/** Vector species for 128-bit Float operations */
	private static final VectorSpecies<Float> FSPECIES=FloatVector.SPECIES_128;
	...
	/** Vector species for 128-bit Byte operations */
	...
	/** Designed to eliminate scalar loop by reprocessing some final elements 
	 * Handles deletions 
	 * TODO: Fails on Glocal+5 with input "AAAA" "AAGAA" */
