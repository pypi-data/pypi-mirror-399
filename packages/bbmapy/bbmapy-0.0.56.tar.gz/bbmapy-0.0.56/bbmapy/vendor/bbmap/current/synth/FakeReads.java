...
/**
 * Generates paired-end reads from single-end reads by extracting sequences from
 * both ends of input reads. Creates forward and reverse-complement read pairs
 * with configurable overlap and length parameters for simulation purposes.
 *
