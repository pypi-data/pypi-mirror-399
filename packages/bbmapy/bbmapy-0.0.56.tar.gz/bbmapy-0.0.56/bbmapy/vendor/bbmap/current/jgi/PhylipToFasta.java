...
/**
 * Converts Phylip format sequence files to FASTA format.
 * Reads interleaved or sequential Phylip files and outputs standard FASTA.
 * Parses sequence names and concatenates sequence data across multiple lines.
 *
