...
/**
 * Generates smaller sketches from input sketches with configurable processing
 * parameters.
 * Reads input sketches, processes and resizes them based on target sketch size,
 * and supports multiple output configuration modes.
 *
...
public class SubSketch extends SketchObject {
	...
	/**
	 * Program entry point that initializes SubSketch processing.
	 * Sets up timer, creates SubSketch instance, and manages global settings.
	...
	/**
	 * Constructor that parses command line arguments and initializes sketch
	 * processing parameters.
	 * Configures input files, output settings, sketch tool, and validation checks.
	 *
