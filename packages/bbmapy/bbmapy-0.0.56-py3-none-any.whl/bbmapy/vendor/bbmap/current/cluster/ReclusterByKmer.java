...
/**
 * Read-processing scaffold for k-mer–based clustering of reads.
 * Parses input/output configuration, sets up dual k-mer parameters (k1,k2), and runs streaming I/O.
 * Cluster creation and reclustering are handled by ClusterThreads using k1/k2-based spectra.
...
//			System.err.println("Fetched "+reads);
	...
	/**
	 * Creates clusters and generates k-mer spectra for initial clustering.
	 * Spawns ClusterThread instances in CREATE mode to process reads and build k-mer frequency profiles per cluster.
	...
	/**
	 * Reassigns reads to clusters using additional k-mer information.
	 * Spawns ClusterThread instances in RECLUSTER mode to evaluate reads against existing clusters and update assignments.
	 * @param t Timer for tracking execution time
	 */
	...
	private class ClusterThread extends Thread{
		...
		/**
		 * Main thread execution method that processes read lists from the input stream and dispatches clustering operations.
		 */
		@Override
		public void run(){
	...
	/**
	 * Primary k-mer length for clustering analysis (1–15; 0 disables this k-mer).
	 */
	public final int k1;
	/**
	 * Secondary k-mer length for refined clustering analysis (1–6; 0 disables this k-mer).
	 */
	public final int k2;
