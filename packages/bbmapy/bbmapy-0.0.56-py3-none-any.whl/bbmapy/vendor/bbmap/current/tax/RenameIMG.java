 ...
 * taxonomy ID prefixes. Processes FASTA files from IMG database and prepends
 * "tid|{taxid}|img|{imgid}" to sequence headers.
 * Enables taxonomic tracking and identification of sequences from IMG genome collections.
 *
