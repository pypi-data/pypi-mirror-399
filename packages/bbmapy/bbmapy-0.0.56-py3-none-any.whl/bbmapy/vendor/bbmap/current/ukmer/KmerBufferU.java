...
/**
 * Buffered k-mer storage system for efficient batch processing of k-mers.
 * Provides temporary storage for k-mers with optional associated values before
 * flushing to permanent k-mer tables. Optimized for memory-efficient k-mer handling
 * in genomic sequence analysis pipelines.
 *
