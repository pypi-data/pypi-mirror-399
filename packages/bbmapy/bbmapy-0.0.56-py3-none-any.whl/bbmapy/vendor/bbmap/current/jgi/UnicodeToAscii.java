...
/**
 * Converts Unicode-encoded text files to ASCII format by attempting multiple character encodings.
 * Processes text files by trying UTF-8 and UTF-16 encodings, then applies header cleanup.
 * Useful for normalizing text files with mixed or problematic Unicode characters.
 *
