...
public class Foo5 {
	...
	/**
	 * Main processing method that reads file metadata from input file and
	 * generates comprehensive statistical analysis. Processes pipe-delimited
	 * data to extract file sizes and access times, then outputs percentile
	 * distributions and storage summaries in both binary and decimal units.
	 * @param args Command-line arguments where args[0] is input file path
	...
	static class LongList{
		...
		public long[] array;
		/** Number of occupied elements in array */
		public int size=0;
