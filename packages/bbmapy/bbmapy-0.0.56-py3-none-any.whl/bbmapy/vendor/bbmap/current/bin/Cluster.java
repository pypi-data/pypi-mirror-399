...
public class Cluster extends Bin {
	 ...
	 * Cluster IDs cannot be changed after creation.
	 *
	 * @param id_ Attempted new ID (ignored)
	 * @throws RuntimeException Always thrown since operation is not supported
	 * @deprecated Use constructor to set ID
	 */
	@Override
	@Deprecated
...
//			pairMap.incrementAll(c.pairMap);//Remember, the targets are contig IDs.
	...
	/** Returns the total size in bases of all contigs in this cluster */
	@Override
	public long size() {return size;}

	/**
	 * Generates a MinHash sketch from all contigs in this cluster.
	 * Processes each contig's sequence through the sketch maker using a shared Read object.
	 *
	 * @param smm SketchMakerMini for generating the sketch
	 * @param r Read object for sketch processing (created if null)
	 * @return Generated sketch representing the entire cluster
	 */
	@Override
