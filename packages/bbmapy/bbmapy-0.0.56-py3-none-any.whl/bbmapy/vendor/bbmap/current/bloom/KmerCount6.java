...
/**
 * K-mer counting implementation that uses a KCountArray to track k-mer frequencies over input reads.
 * Supports configurable k-mer length, cell bits, and optional gaps for split k-mers.
 * Provides command-line entry point and summary statistics including frequency histograms and singleton rates.
