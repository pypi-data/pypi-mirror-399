...
//		}
	...
	/**
	 * Closes both sequence and quality input streams.
	 * Cleans up internal state and marks stream as closed.
...
//		if(verbose){new Exception().printStackTrace(System.err);}
	...
	/** Resets the input stream to initial state for re-reading.
	 * Clears buffers, resets counters, and reopens input files. */
	@Override
	 ...
	 * @return true if reads are paired/interleaved, false otherwise */
	@Override
	...
	/** Returns combined file names of sequence and quality files.
	 * @return Comma-separated string of sequence and quality file names */
	@Override
