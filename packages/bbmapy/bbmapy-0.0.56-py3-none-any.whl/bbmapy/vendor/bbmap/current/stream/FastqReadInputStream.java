...
//		assert(false) : interleaved;
	 ...
	 * Reports closing status if verbose mode is enabled.
	...
	/** Resets the stream to beginning for re-reading.
	 * Clears all counters, buffer state, and resets underlying file position. */
	@Override
	 ...
	 * @return true if reads are interleaved paired-end, false for single-end */
	@Override
	public boolean paired() {return interleaved;}
	
	/** Returns the filename being processed.
	 * @return Input filename or stream identifier */
	@Override
