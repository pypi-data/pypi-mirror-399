...
/**
 * Handles custom headers for synthetic reads generated by BBTools.
 * Parses and generates synthetic read identifiers with mapping information.
 * This class is ancient and supports legacy custom header formats.
...
//		assert(rname.equals(h.rname)) : rname+"\n"+h.rname;
	...
	/** Converts CustomHeader to string representation.
	 * @return String representation of the header fields */
	@Override
