...
/**
 * Shreds FASTA sequences into overlapping reads of specified length.
 * Reads long sequences from FASTA files and generates shorter synthetic reads
 * with configurable length and overlap for downstream processing.
 * Extends ReadInputStream to provide streaming interface for shredded reads.
 *
...
//			if(i==1){assert(false) : r.numericID+", "+r.mate.numericID;}
	...
	/** Returns the filename of the input file being processed */
	@Override
	...
	/** Minimum length required before generating a read */
