...
/**
 * Summarizes SEAL crosstalk analysis from multiple statistics files.
 * Processes SEAL output files to calculate contamination rates and primary matching rates.
 * Outputs results in parts-per-million (PPM) format for easy comparison across samples.
 *
