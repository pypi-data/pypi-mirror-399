...
/**
 * Processes web check log files to extract and analyze HTTP response statistics.
 * Parses log entries containing URLs, response codes, and latency data.
 * Generates aggregated statistics and separates failed/invalid requests.
 *
