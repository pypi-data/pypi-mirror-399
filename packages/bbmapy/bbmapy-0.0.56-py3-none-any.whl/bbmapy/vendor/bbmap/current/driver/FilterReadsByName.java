...
/**
 * Filters sequence reads by name/header matching criteria.
 * Supports exact matching, substring matching, prefix matching, and coordinate-based filtering.
 * Handles both single and paired-end reads with configurable inclusion/exclusion modes.
