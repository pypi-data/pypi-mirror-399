...
/**
 * Parses tab-separated results files from crossblock filtering operations.
 * Processes removal/retention statistics and tracks bases and contigs kept or discarded.
 * Designed to work with crossblock.sh output format containing tab-delimited result lines.
 *
