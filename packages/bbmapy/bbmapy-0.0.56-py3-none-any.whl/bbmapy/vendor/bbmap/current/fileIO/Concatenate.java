...
/**
 * Concatenates multiple input files into a single output file with format conversion support.
 * Reads input files sequentially and outputs everything to a single destination file.
 * Can be used to concatenate files while recompressing them and avoiding stdio usage.
 *
