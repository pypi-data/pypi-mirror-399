...
//			outstream.println("NOTE: No reference files specified, no trimming mode, no min avg quality, no histograms - read sequences will not be changed.");
	...
	public void process(){
		...
		{//TODO: State sync can be mostly eliminated once Index is used for complete encapsulation 
			...
			//4. Sync Statistics
			refReads=index.refReads;
			refBases=index.refBases;
			refKmers=index.refKmers;
		}
...
//	private ArrayList<String> altRefNames;
...
//	private final String samref;
	...
	private final long maxBasesOutm;
	/** Quit after this many bases written to outu */
	private final long maxBasesOutu;
