...
from march_history import AsyncMarchHistoryClient, MarchHistoryClient
...
@pytest.fixture
def async_client(base_url: str) -> AsyncMarchHistoryClient:
    """Return test async client instance."""
    return AsyncMarchHistoryClient(
        base_url=base_url,
        timeout=10.0,
        max_retries=2,
    )
...
@pytest.fixture
def async_client_with_api_key(base_url: str) -> AsyncMarchHistoryClient:
    """Return test async client with API key."""
    return AsyncMarchHistoryClient(
        base_url=base_url,
        api_key="test-api-key-123",
        timeout=10.0,
