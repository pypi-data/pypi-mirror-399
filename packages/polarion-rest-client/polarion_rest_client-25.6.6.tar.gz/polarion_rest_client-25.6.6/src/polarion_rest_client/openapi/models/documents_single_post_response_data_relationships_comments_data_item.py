...
T = TypeVar("T", bound="DocumentsSinglePostResponseDataRelationshipsCommentsDataItem")
...
class DocumentsSinglePostResponseDataRelationshipsCommentsDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_post_response_data_relationships_comments_data_item = cls(
            type_=type_,
            id=id,
        )

        documents_single_post_response_data_relationships_comments_data_item.additional_properties = d
        return documents_single_post_response_data_relationships_comments_data_item
