...
class UsersListGetResponseDataItem:
    ...
    relationships: Union[Unset, "UsersListGetResponseDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = UsersListGetResponseDataItemAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = UsersListGetResponseDataItemRelationships.from_dict(
                _relationships
            )
