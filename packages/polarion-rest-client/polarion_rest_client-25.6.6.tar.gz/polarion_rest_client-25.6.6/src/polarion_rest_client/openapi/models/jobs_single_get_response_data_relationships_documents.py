...
class JobsSingleGetResponseDataRelationshipsDocuments:
    ...
    meta: Union[Unset, "JobsSingleGetResponseDataRelationshipsDocumentsMeta"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                JobsSingleGetResponseDataRelationshipsDocumentsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = JobsSingleGetResponseDataRelationshipsDocumentsMeta.from_dict(_meta)

        jobs_single_get_response_data_relationships_documents = cls(
            data=data,
            meta=meta,
        )

        jobs_single_get_response_data_relationships_documents.additional_properties = d
        return jobs_single_get_response_data_relationships_documents
