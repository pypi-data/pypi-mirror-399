...
class RevisionsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revisions_list_get_response_data_item_attributes = cls(
            created=created,
            id=id,
        ...
        revisions_list_get_response_data_item_attributes.additional_properties = d
        return revisions_list_get_response_data_item_attributes
