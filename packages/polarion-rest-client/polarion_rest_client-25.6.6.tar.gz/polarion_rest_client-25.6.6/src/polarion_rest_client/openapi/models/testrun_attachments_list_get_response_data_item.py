...
class TestrunAttachmentsListGetResponseDataItem:
    ...
    links: Union[Unset, "TestrunAttachmentsListGetResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunAttachmentsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = (
                TestrunAttachmentsListGetResponseDataItemRelationships.from_dict(
                    _relationships
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = TestrunAttachmentsListGetResponseDataItemMeta.from_dict(_meta)
        ...
        if isinstance(_links, Unset):
            ...
            links = TestrunAttachmentsListGetResponseDataItemLinks.from_dict(_links)

        testrun_attachments_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testrun_attachments_list_get_response_data_item.additional_properties = d
        return testrun_attachments_list_get_response_data_item
