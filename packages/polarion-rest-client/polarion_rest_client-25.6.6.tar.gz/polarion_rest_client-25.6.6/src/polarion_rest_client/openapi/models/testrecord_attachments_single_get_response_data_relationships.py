...
class TestrecordAttachmentsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                TestrecordAttachmentsSingleGetResponseDataRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        testrecord_attachments_single_get_response_data_relationships = cls(
            author=author,
            project=project,
        )

        testrecord_attachments_single_get_response_data_relationships.additional_properties = d
        return testrecord_attachments_single_get_response_data_relationships
