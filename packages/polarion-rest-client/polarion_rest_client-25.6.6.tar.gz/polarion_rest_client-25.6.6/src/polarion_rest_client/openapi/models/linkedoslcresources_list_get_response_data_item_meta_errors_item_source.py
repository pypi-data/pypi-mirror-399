...
T = TypeVar("T", bound="LinkedoslcresourcesListGetResponseDataItemMetaErrorsItemSource")
...
class LinkedoslcresourcesListGetResponseDataItemMetaErrorsItemSource:
    ...
    resource: Union[
        Unset, "LinkedoslcresourcesListGetResponseDataItemMetaErrorsItemSourceResource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linkedoslcresources_list_get_response_data_item_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        linkedoslcresources_list_get_response_data_item_meta_errors_item_source.additional_properties = d
        return linkedoslcresources_list_get_response_data_item_meta_errors_item_source
