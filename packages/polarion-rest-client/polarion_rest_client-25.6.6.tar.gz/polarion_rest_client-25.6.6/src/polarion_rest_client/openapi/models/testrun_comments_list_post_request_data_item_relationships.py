...
class TestrunCommentsListPostRequestDataItemRelationships:
    ...
    parent_comment: Union[
        Unset, "TestrunCommentsListPostRequestDataItemRelationshipsParentComment"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                TestrunCommentsListPostRequestDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        testrun_comments_list_post_request_data_item_relationships = cls(
            author=author,
            parent_comment=parent_comment,
        )

        testrun_comments_list_post_request_data_item_relationships.additional_properties = d
        return testrun_comments_list_post_request_data_item_relationships
