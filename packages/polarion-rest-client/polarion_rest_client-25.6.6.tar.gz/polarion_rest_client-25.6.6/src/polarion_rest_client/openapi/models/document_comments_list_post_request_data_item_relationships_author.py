...
T = TypeVar("T", bound="DocumentCommentsListPostRequestDataItemRelationshipsAuthor")
...
class DocumentCommentsListPostRequestDataItemRelationshipsAuthor:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_comments_list_post_request_data_item_relationships_author = cls(
            data=data,
        )

        document_comments_list_post_request_data_item_relationships_author.additional_properties = d
        return document_comments_list_post_request_data_item_relationships_author
