...
class DocumentCommentsSingleGetResponseDataRelationships:
    ...
    child_comments: Union[
        Unset, "DocumentCommentsSingleGetResponseDataRelationshipsChildComments"
    ] = UNSET
    parent_comment: Union[
        Unset, "DocumentCommentsSingleGetResponseDataRelationshipsParentComment"
    ] = UNSET
    project: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                DocumentCommentsSingleGetResponseDataRelationshipsProject.from_dict(
                    _project
                )
            )
        ...
        document_comments_single_get_response_data_relationships.additional_properties = d
