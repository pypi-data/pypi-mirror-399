...
class PatchTestStepResultAttachmentsRequestBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        patch_test_step_result_attachments_request_body = cls(
            resource=resource,
            content=content,
        )

        patch_test_step_result_attachments_request_body.additional_properties = d
        return patch_test_step_result_attachments_request_body
