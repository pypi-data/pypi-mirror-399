...
class ExternallylinkedworkitemsListPostRequestDataItem:
    ...
    type_: Union[Unset, ExternallylinkedworkitemsListPostRequestDataItemType] = UNSET
    attributes: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ExternallylinkedworkitemsListPostRequestDataItemType(_type_)
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                ExternallylinkedworkitemsListPostRequestDataItemAttributes.from_dict(
                    _attributes
                )
            )

        externallylinkedworkitems_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
        )

        externallylinkedworkitems_list_post_request_data_item.additional_properties = d
        return externallylinkedworkitems_list_post_request_data_item
