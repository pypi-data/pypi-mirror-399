...
class PlansListPostRequestDataItem:
    ...
    relationships: Union[Unset, "PlansListPostRequestDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = PlansListPostRequestDataItemAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = PlansListPostRequestDataItemRelationships.from_dict(
                _relationships
            )

        plans_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        plans_list_post_request_data_item.additional_properties = d
        return plans_list_post_request_data_item
