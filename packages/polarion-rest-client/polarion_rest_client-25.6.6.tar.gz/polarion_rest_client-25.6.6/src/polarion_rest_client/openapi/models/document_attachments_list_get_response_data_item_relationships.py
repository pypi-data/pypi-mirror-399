...
T = TypeVar("T", bound="DocumentAttachmentsListGetResponseDataItemRelationships")
...
class DocumentAttachmentsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                DocumentAttachmentsListGetResponseDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        document_attachments_list_get_response_data_item_relationships.additional_properties = d
