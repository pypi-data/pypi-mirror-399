...
class UsersSingleGetResponseDataMetaErrorsItem:
    ...
    source: Union[Unset, "UsersSingleGetResponseDataMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = UsersSingleGetResponseDataMetaErrorsItemSource.from_dict(_source)
        ...
        users_single_get_response_data_meta_errors_item.additional_properties = d
