...
class TestrunsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "TestrunsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "TestrunsListPostRequestDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrunsListPostRequestDataItemRelationships.from_dict(
                _relationships
            )

        testruns_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        testruns_list_post_request_data_item.additional_properties = d
        return testruns_list_post_request_data_item
