...
class WorkflowActionsActionResponseBody:
    ...
    data: Union[Unset, list["WorkflowActionsActionResponseBodyDataItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_actions_action_response_body = cls(
            meta=meta,
            data=data,
            links=links,
        )

        workflow_actions_action_response_body.additional_properties = d
        return workflow_actions_action_response_body
