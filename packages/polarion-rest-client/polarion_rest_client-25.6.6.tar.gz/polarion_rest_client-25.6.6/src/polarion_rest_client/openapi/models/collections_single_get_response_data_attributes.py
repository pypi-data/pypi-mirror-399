...
class CollectionsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                CollectionsSingleGetResponseDataAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        collections_single_get_response_data_attributes = cls(
            closed_on=closed_on,
            created=created,
        ...
        collections_single_get_response_data_attributes.additional_properties = d
        return collections_single_get_response_data_attributes
