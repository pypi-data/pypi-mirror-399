...
class FeatureselectionsSingleGetResponse:
    ...
    included: Union[Unset, list["FeatureselectionsSingleGetResponseIncludedItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for included_item_data in _included or []:
            included_item = FeatureselectionsSingleGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        featureselections_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        featureselections_single_get_response.additional_properties = d
        return featureselections_single_get_response
