...
class PlansSingleGetResponseDataAttributes:
    ...
    description: Union[Unset, "PlansSingleGetResponseDataAttributesDescription"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_calculation_type, Unset):
            ...
            calculation_type = PlansSingleGetResponseDataAttributesCalculationType(
                _calculation_type
            )
        ...
        if isinstance(_description, Unset):
            ...
            description = PlansSingleGetResponseDataAttributesDescription.from_dict(
                _description
            )
        ...
        plans_single_get_response_data_attributes = cls(
        ...
        plans_single_get_response_data_attributes.additional_properties = d
        return plans_single_get_response_data_attributes
