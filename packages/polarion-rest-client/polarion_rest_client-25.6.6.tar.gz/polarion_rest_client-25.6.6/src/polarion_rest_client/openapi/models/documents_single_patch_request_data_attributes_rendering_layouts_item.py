...
T = TypeVar("T", bound="DocumentsSinglePatchRequestDataAttributesRenderingLayoutsItem")
...
class DocumentsSinglePatchRequestDataAttributesRenderingLayoutsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_patch_request_data_attributes_rendering_layouts_item.additional_properties = d
