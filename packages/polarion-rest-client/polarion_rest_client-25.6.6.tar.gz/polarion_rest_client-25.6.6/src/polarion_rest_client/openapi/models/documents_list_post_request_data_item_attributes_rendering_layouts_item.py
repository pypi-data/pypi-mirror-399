...
T = TypeVar("T", bound="DocumentsListPostRequestDataItemAttributesRenderingLayoutsItem")
...
class DocumentsListPostRequestDataItemAttributesRenderingLayoutsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_list_post_request_data_item_attributes_rendering_layouts_item.additional_properties = d
