...
class TestrunCommentsSingleGetResponse:
    ...
    included: Union[Unset, list["TestrunCommentsSingleGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for included_item_data in _included or []:
            included_item = TestrunCommentsSingleGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        testrun_comments_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        testrun_comments_single_get_response.additional_properties = d
        return testrun_comments_single_get_response
