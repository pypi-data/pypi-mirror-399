...
class JobsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = JobsSingleGetResponseDataAttributesStatus.from_dict(_status)

        jobs_single_get_response_data_attributes = cls(
            job_id=job_id,
            name=name,
            state=state,
            status=status,
        ...
        jobs_single_get_response_data_attributes.additional_properties = d
        return jobs_single_get_response_data_attributes
