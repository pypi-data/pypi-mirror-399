...
class GlobalrolesSingleGetResponseDataRelationships:
    ...
    users: Union[Unset, "GlobalrolesSingleGetResponseDataRelationshipsUsers"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_users, Unset):
            ...
            users = GlobalrolesSingleGetResponseDataRelationshipsUsers.from_dict(_users)

        globalroles_single_get_response_data_relationships = cls(
            users=users,
        )

        globalroles_single_get_response_data_relationships.additional_properties = d
