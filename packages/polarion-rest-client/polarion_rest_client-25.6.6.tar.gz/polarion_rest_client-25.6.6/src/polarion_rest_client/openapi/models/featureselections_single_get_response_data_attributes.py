...
class FeatureselectionsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        featureselections_single_get_response_data_attributes = cls(
            selection_type=selection_type,
        )

        featureselections_single_get_response_data_attributes.additional_properties = d
        return featureselections_single_get_response_data_attributes
