...
T = TypeVar("T", bound="EnumerationsSingleGetResponseDataAttributesOptionsItem")
...
class EnumerationsSingleGetResponseDataAttributesOptionsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enumerations_single_get_response_data_attributes_options_item.additional_properties = d
