...
class TeststepsSinglePatchRequestData:
    ...
    attributes: Union[Unset, "TeststepsSinglePatchRequestDataAttributes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_single_patch_request_data = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        teststeps_single_patch_request_data.additional_properties = d
        return teststeps_single_patch_request_data
