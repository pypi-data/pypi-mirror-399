...
class DocumentsSingleGetResponseDataRelationshipsComments:
    ...
    data: Union[
        Unset, list["DocumentsSingleGetResponseDataRelationshipsCommentsDataItem"]
    ] = UNSET
    meta: Union[Unset, "DocumentsSingleGetResponseDataRelationshipsCommentsMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                DocumentsSingleGetResponseDataRelationshipsCommentsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        documents_single_get_response_data_relationships_comments.additional_properties = d
