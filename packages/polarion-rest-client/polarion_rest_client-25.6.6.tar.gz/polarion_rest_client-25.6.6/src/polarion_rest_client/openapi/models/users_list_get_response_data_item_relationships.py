...
class UsersListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project_roles, Unset):
            ...
            project_roles = (
                UsersListGetResponseDataItemRelationshipsProjectRoles.from_dict(
                    _project_roles
                )
            )
        ...
        if isinstance(_user_groups, Unset):
            ...
            user_groups = UsersListGetResponseDataItemRelationshipsUserGroups.from_dict(
                _user_groups
            )
        ...
        users_list_get_response_data_item_relationships.additional_properties = d
