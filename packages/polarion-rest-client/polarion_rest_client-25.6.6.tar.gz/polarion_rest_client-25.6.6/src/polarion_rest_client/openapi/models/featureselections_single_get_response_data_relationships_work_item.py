...
class FeatureselectionsSingleGetResponseDataRelationshipsWorkItem:
    ...
    data: Union[
        Unset, "FeatureselectionsSingleGetResponseDataRelationshipsWorkItemData"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        featureselections_single_get_response_data_relationships_work_item = cls(
            data=data,
        )

        featureselections_single_get_response_data_relationships_work_item.additional_properties = d
        return featureselections_single_get_response_data_relationships_work_item
