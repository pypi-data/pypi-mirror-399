...
class TeststepsSingleGetResponseData:
    ...
    attributes: Union[Unset, "TeststepsSingleGetResponseDataAttributes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TeststepsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        teststeps_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        teststeps_single_get_response_data.additional_properties = d
        return teststeps_single_get_response_data
