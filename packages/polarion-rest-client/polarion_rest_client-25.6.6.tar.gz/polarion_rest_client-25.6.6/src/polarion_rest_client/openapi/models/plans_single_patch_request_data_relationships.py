...
class PlansSinglePatchRequestDataRelationships:
    ...
    parent: Union[Unset, "PlansSinglePatchRequestDataRelationshipsParent"] = UNSET
    project_span: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parent, Unset):
            ...
            parent = PlansSinglePatchRequestDataRelationshipsParent.from_dict(_parent)
        ...
        if isinstance(_work_items, Unset):
            ...
            work_items = PlansSinglePatchRequestDataRelationshipsWorkItems.from_dict(
                _work_items
            )

        plans_single_patch_request_data_relationships = cls(
            parent=parent,
            project_span=project_span,
            work_items=work_items,
        )

        plans_single_patch_request_data_relationships.additional_properties = d
        return plans_single_patch_request_data_relationships
