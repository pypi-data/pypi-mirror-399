...
class TeststepsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "TeststepsListPostRequestDataItemAttributes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
        )

        teststeps_list_post_request_data_item.additional_properties = d
        return teststeps_list_post_request_data_item
