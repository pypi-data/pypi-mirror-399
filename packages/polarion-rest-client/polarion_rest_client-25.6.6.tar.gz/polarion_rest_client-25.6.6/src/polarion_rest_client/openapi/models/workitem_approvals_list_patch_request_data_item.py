...
class WorkitemApprovalsListPatchRequestDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkitemApprovalsListPatchRequestDataItemAttributes.from_dict(
                _attributes
            )

        workitem_approvals_list_patch_request_data_item = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        workitem_approvals_list_patch_request_data_item.additional_properties = d
        return workitem_approvals_list_patch_request_data_item
