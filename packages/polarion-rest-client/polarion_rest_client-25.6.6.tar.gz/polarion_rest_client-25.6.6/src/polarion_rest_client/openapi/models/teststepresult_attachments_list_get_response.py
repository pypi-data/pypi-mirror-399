...
class TeststepresultAttachmentsListGetResponse:
    ...
    data: Union[Unset, list["TeststepresultAttachmentsListGetResponseDataItem"]] = UNSET
    included: Union[
        Unset, list["TeststepresultAttachmentsListGetResponseIncludedItem"]
    ] = UNSET
    links: Union[Unset, "TeststepresultAttachmentsListGetResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = TeststepresultAttachmentsListGetResponseMeta.from_dict(_meta)

        data = []
        _data = d.pop("data", UNSET)
        for data_item_data in _data or []:
            data_item = TeststepresultAttachmentsListGetResponseDataItem.from_dict(
                data_item_data
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TeststepresultAttachmentsListGetResponseLinks.from_dict(_links)

        teststepresult_attachments_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        teststepresult_attachments_list_get_response.additional_properties = d
        return teststepresult_attachments_list_get_response
