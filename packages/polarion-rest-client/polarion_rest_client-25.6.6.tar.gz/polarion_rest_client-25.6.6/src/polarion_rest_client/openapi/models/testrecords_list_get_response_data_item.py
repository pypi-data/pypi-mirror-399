...
class TestrecordsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "TestrecordsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[Unset, "TestrecordsListGetResponseDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrecordsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrecordsListGetResponseDataItemRelationships.from_dict(
                _relationships
            )
        ...
        testrecords_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testrecords_list_get_response_data_item.additional_properties = d
        return testrecords_list_get_response_data_item
