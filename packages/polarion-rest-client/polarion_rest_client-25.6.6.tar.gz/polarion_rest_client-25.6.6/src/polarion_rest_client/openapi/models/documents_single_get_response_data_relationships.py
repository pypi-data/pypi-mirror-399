...
class DocumentsSingleGetResponseDataRelationships:
    ...
    author: Union[Unset, "DocumentsSingleGetResponseDataRelationshipsAuthor"] = UNSET
    branched_from: Union[
    ...
    project: Union[Unset, "DocumentsSingleGetResponseDataRelationshipsProject"] = UNSET
    updated_by: Union[Unset, "DocumentsSingleGetResponseDataRelationshipsUpdatedBy"] = (
        UNSET
    )
    variant: Union[Unset, "DocumentsSingleGetResponseDataRelationshipsVariant"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attachments, Unset):
            ...
            attachments = (
                DocumentsSingleGetResponseDataRelationshipsAttachments.from_dict(
                    _attachments
                )
            )
        ...
        if isinstance(_author, Unset):
            ...
            author = DocumentsSingleGetResponseDataRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_branched_from, Unset):
            ...
            branched_from = (
                DocumentsSingleGetResponseDataRelationshipsBranchedFrom.from_dict(
                    _branched_from
                )
            )
        ...
        if isinstance(_comments, Unset):
            ...
            comments = DocumentsSingleGetResponseDataRelationshipsComments.from_dict(
                _comments
            )
        ...
        if isinstance(_derived_from, Unset):
            ...
            derived_from = (
                DocumentsSingleGetResponseDataRelationshipsDerivedFrom.from_dict(
                    _derived_from
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = DocumentsSingleGetResponseDataRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_updated_by, Unset):
            ...
            updated_by = DocumentsSingleGetResponseDataRelationshipsUpdatedBy.from_dict(
                _updated_by
            )
        ...
        if isinstance(_variant, Unset):
            ...
            variant = DocumentsSingleGetResponseDataRelationshipsVariant.from_dict(
                _variant
            )
        ...
        documents_single_get_response_data_relationships.additional_properties = d
