...
T = TypeVar("T", bound="PlansListPostRequestDataItemRelationshipsWorkItemsDataItem")
...
class PlansListPostRequestDataItemRelationshipsWorkItemsDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansListPostRequestDataItemRelationshipsWorkItemsDataItemType(
                _type_
            )

        id = d.pop("id", UNSET)

        plans_list_post_request_data_item_relationships_work_items_data_item = cls(
            type_=type_,
            id=id,
        )

        plans_list_post_request_data_item_relationships_work_items_data_item.additional_properties = d
        return plans_list_post_request_data_item_relationships_work_items_data_item
