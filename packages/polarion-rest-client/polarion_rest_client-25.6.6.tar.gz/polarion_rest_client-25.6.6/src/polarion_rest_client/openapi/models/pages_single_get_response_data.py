...
from ..models.pages_single_get_response_data_type import PagesSingleGetResponseDataType
...
class PagesSingleGetResponseData:
    ...
    relationships: Union[Unset, "PagesSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = PagesSingleGetResponseDataAttributes.from_dict(_attributes)
