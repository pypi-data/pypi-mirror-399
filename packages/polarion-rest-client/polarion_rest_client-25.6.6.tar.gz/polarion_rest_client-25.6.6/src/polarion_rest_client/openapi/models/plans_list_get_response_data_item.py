...
class PlansListGetResponseDataItem:
    ...
    relationships: Union[Unset, "PlansListGetResponseDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = PlansListGetResponseDataItemAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = PlansListGetResponseDataItemRelationships.from_dict(
                _relationships
            )
        ...
        plans_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        plans_list_get_response_data_item.additional_properties = d
        return plans_list_get_response_data_item
