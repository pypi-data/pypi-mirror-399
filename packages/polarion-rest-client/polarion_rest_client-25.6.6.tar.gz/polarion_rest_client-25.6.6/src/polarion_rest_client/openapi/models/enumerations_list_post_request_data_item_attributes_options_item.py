...
T = TypeVar("T", bound="EnumerationsListPostRequestDataItemAttributesOptionsItem")
...
class EnumerationsListPostRequestDataItemAttributesOptionsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enumerations_list_post_request_data_item_attributes_options_item.additional_properties = d
