...
class TestrunAttachmentsListDeleteRequestDataItem:
    ...
    type_: Union[Unset, TestrunAttachmentsListDeleteRequestDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_list_delete_request_data_item = cls(
            type_=type_,
            id=id,
        )

        testrun_attachments_list_delete_request_data_item.additional_properties = d
        return testrun_attachments_list_delete_request_data_item
