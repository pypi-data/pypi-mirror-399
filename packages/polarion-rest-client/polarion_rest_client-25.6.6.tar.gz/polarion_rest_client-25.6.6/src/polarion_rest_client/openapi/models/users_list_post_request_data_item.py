...
class UsersListPostRequestDataItem:
    ...
    relationships: Union[Unset, "UsersListPostRequestDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = UsersListPostRequestDataItemAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = UsersListPostRequestDataItemRelationships.from_dict(
                _relationships
            )
