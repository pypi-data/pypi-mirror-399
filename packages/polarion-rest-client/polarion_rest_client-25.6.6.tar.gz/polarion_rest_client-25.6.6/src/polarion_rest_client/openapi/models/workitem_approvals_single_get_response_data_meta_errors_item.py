...
class WorkitemApprovalsSingleGetResponseDataMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                WorkitemApprovalsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                    _source
                )
            )

        workitem_approvals_single_get_response_data_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        workitem_approvals_single_get_response_data_meta_errors_item.additional_properties = d
        return workitem_approvals_single_get_response_data_meta_errors_item
