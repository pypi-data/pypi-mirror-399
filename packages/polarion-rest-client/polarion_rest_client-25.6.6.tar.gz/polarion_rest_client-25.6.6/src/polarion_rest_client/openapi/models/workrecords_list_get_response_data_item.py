...
class WorkrecordsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "WorkrecordsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[Unset, "WorkrecordsListGetResponseDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkrecordsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkrecordsListGetResponseDataItemRelationships.from_dict(
                _relationships
            )
        ...
        workrecords_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        workrecords_list_get_response_data_item.additional_properties = d
        return workrecords_list_get_response_data_item
