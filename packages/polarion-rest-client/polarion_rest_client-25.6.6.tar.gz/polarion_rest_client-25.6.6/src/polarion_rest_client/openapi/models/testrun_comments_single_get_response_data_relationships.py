...
class TestrunCommentsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                TestrunCommentsSingleGetResponseDataRelationshipsProject.from_dict(
                    _project
                )
            )

        testrun_comments_single_get_response_data_relationships = cls(
            author=author,
        ...
        testrun_comments_single_get_response_data_relationships.additional_properties = d
        return testrun_comments_single_get_response_data_relationships
