...
class CollectionsListGetResponse:
    ...
    included: Union[Unset, list["CollectionsListGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = CollectionsListGetResponseDataItem.from_dict(data_item_data)
        ...
        collections_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        collections_list_get_response.additional_properties = d
        return collections_list_get_response
