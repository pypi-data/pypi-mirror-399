...
T = TypeVar("T", bound="WorkitemAttachmentsListGetResponseDataItemMetaErrorsItem")
...
class WorkitemAttachmentsListGetResponseDataItemMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_attachments_list_get_response_data_item_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        workitem_attachments_list_get_response_data_item_meta_errors_item.additional_properties = d
        return workitem_attachments_list_get_response_data_item_meta_errors_item
