...
class TeststepResultsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "TeststepResultsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TeststepResultsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TeststepResultsListGetResponseDataItemLinks.from_dict(_links)

        teststep_results_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        teststep_results_list_get_response_data_item.additional_properties = d
        return teststep_results_list_get_response_data_item
