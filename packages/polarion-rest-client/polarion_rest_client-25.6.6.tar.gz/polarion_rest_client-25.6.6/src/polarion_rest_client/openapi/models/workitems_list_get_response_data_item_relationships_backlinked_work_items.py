...
T = TypeVar(
    "T", bound="WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItems"
)
...
class WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItems:
    ...
    meta: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItemsMeta"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_backlinked_work_items = cls(
            data=data,
            meta=meta,
        )

        workitems_list_get_response_data_item_relationships_backlinked_work_items.additional_properties = d
        return workitems_list_get_response_data_item_relationships_backlinked_work_items
