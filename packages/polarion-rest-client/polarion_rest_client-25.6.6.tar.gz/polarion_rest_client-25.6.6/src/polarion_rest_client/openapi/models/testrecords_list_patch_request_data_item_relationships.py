...
class TestrecordsListPatchRequestDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_executed_by, Unset):
            ...
            executed_by = (
                TestrecordsListPatchRequestDataItemRelationshipsExecutedBy.from_dict(
                    _executed_by
                )
            )

        testrecords_list_patch_request_data_item_relationships = cls(
            defect=defect,
            executed_by=executed_by,
        )

        testrecords_list_patch_request_data_item_relationships.additional_properties = d
        return testrecords_list_patch_request_data_item_relationships
