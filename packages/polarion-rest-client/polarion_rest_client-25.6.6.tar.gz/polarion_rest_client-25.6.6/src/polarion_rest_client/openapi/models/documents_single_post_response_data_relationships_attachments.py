...
T = TypeVar("T", bound="DocumentsSinglePostResponseDataRelationshipsAttachments")
...
class DocumentsSinglePostResponseDataRelationshipsAttachments:
    ...
    data: Union[
        Unset, list["DocumentsSinglePostResponseDataRelationshipsAttachmentsDataItem"]
    ] = UNSET
    links: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = (
                DocumentsSinglePostResponseDataRelationshipsAttachmentsLinks.from_dict(
                    _links
                )
            )

        documents_single_post_response_data_relationships_attachments = cls(
            data=data,
            links=links,
        )

        documents_single_post_response_data_relationships_attachments.additional_properties = d
        return documents_single_post_response_data_relationships_attachments
