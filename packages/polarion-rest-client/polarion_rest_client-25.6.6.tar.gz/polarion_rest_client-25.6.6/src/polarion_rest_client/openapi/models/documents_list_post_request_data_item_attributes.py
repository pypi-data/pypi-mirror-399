...
class DocumentsListPostRequestDataItemAttributes:
    ...
    rendering_layouts: Union[
        Unset, list["DocumentsListPostRequestDataItemAttributesRenderingLayoutsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                DocumentsListPostRequestDataItemAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        if isinstance(_outline_numbering, Unset):
            ...
            outline_numbering = (
                DocumentsListPostRequestDataItemAttributesOutlineNumbering.from_dict(
                    _outline_numbering
                )
            )
        ...
        documents_list_post_request_data_item_attributes.additional_properties = d
