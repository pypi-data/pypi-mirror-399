...
class PlansListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_calculation_type, Unset):
            ...
            calculation_type = PlansListPostRequestDataItemAttributesCalculationType(
                _calculation_type
            )
        ...
        if isinstance(_description, Unset):
            ...
            description = PlansListPostRequestDataItemAttributesDescription.from_dict(
                _description
            )
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                PlansListPostRequestDataItemAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        plans_list_post_request_data_item_attributes = cls(
        ...
        plans_list_post_request_data_item_attributes.additional_properties = d
        return plans_list_post_request_data_item_attributes
