...
class TeststepresultAttachmentsSinglePatchRequestData:
    ...
    type_: Union[Unset, TeststepresultAttachmentsSinglePatchRequestDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                TeststepresultAttachmentsSinglePatchRequestDataAttributes.from_dict(
                    _attributes
                )
            )

        teststepresult_attachments_single_patch_request_data = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        teststepresult_attachments_single_patch_request_data.additional_properties = d
        return teststepresult_attachments_single_patch_request_data
