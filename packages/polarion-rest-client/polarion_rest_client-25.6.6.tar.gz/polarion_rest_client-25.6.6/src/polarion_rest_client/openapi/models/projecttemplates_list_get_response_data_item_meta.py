...
class ProjecttemplatesListGetResponseDataItemMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = (
                ProjecttemplatesListGetResponseDataItemMetaErrorsItem.from_dict(
                    errors_item_data
                )
            )
        ...
        projecttemplates_list_get_response_data_item_meta = cls(
            errors=errors,
        )

        projecttemplates_list_get_response_data_item_meta.additional_properties = d
        return projecttemplates_list_get_response_data_item_meta
