...
class TestrecordAttachmentsListPostRequest:
    ...
    data: Union[Unset, list["TestrecordAttachmentsListPostRequestDataItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_list_post_request = cls(
            data=data,
        )

        testrecord_attachments_list_post_request.additional_properties = d
        return testrecord_attachments_list_post_request
