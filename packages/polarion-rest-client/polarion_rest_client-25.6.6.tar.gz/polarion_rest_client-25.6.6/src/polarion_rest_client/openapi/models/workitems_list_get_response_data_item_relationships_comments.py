...
class WorkitemsListGetResponseDataItemRelationshipsComments:
    ...
    data: Union[
        Unset, list["WorkitemsListGetResponseDataItemRelationshipsCommentsDataItem"]
    ] = UNSET
    meta: Union[Unset, "WorkitemsListGetResponseDataItemRelationshipsCommentsMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                WorkitemsListGetResponseDataItemRelationshipsCommentsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = (
                WorkitemsListGetResponseDataItemRelationshipsCommentsLinks.from_dict(
                    _links
                )
            )
        ...
        workitems_list_get_response_data_item_relationships_comments.additional_properties = d
