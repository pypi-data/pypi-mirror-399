...
class ProjectsListGetResponseDataItemRelationshipsLeadData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ProjectsListGetResponseDataItemRelationshipsLeadDataType(_type_)
        ...
        projects_list_get_response_data_item_relationships_lead_data.additional_properties = d
