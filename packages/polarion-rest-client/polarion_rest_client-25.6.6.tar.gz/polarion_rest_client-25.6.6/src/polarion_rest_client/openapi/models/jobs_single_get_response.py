...
if TYPE_CHECKING:
    from ..models.jobs_single_get_response_data import JobsSingleGetResponseData
    from ..models.jobs_single_get_response_included_item import (
        JobsSingleGetResponseIncludedItem,
    )
    from ..models.jobs_single_get_response_links import JobsSingleGetResponseLinks
...
class JobsSingleGetResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        jobs_single_get_response.additional_properties = d
        return jobs_single_get_response
