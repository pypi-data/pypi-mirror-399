...
class WorkitemApprovalsSingleGetResponseData:
    ...
    attributes: Union[Unset, "WorkitemApprovalsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkitemApprovalsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = WorkitemApprovalsSingleGetResponseDataLinks.from_dict(_links)

        workitem_approvals_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        workitem_approvals_single_get_response_data.additional_properties = d
        return workitem_approvals_single_get_response_data
