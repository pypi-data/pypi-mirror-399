...
class DocumentsSinglePostResponseDataRelationshipsComments:
    ...
    data: Union[
        Unset, list["DocumentsSinglePostResponseDataRelationshipsCommentsDataItem"]
    ] = UNSET
    links: Union[Unset, "DocumentsSinglePostResponseDataRelationshipsCommentsLinks"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                DocumentsSinglePostResponseDataRelationshipsCommentsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        documents_single_post_response_data_relationships_comments = cls(
            data=data,
            links=links,
        )

        documents_single_post_response_data_relationships_comments.additional_properties = d
        return documents_single_post_response_data_relationships_comments
