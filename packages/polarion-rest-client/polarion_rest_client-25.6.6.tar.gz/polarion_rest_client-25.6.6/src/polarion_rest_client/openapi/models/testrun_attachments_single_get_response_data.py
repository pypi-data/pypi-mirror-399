...
class TestrunAttachmentsSingleGetResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunAttachmentsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TestrunAttachmentsSingleGetResponseDataLinks.from_dict(_links)

        testrun_attachments_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testrun_attachments_single_get_response_data.additional_properties = d
        return testrun_attachments_single_get_response_data
