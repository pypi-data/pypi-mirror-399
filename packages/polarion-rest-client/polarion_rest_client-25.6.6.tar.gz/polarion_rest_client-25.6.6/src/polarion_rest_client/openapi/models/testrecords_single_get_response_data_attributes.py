...
class TestrecordsSingleGetResponseDataAttributes:
    ...
    comment: Union[Unset, "TestrecordsSingleGetResponseDataAttributesComment"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = TestrecordsSingleGetResponseDataAttributesComment.from_dict(
                _comment
            )
        ...
        testrecords_single_get_response_data_attributes = cls(
            comment=comment,
            duration=duration,
            executed=executed,
            iteration=iteration,
        ...
        testrecords_single_get_response_data_attributes.additional_properties = d
        return testrecords_single_get_response_data_attributes
