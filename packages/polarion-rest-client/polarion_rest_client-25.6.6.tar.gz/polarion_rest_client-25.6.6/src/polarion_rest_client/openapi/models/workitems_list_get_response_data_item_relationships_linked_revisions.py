...
class WorkitemsListGetResponseDataItemRelationshipsLinkedRevisions:
    ...
    data: Union[
        Unset,
        list["WorkitemsListGetResponseDataItemRelationshipsLinkedRevisionsDataItem"],
    ] = UNSET
    meta: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsLinkedRevisionsMeta"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_linked_revisions = cls(
            data=data,
            meta=meta,
        )

        workitems_list_get_response_data_item_relationships_linked_revisions.additional_properties = d
        return workitems_list_get_response_data_item_relationships_linked_revisions
