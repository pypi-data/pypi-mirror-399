...
class TeststepResultsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_test_step, Unset):
            ...
            test_step = (
                TeststepResultsSingleGetResponseDataRelationshipsTestStep.from_dict(
                    _test_step
                )
            )

        teststep_results_single_get_response_data_relationships = cls(
            test_step=test_step,
        )

        teststep_results_single_get_response_data_relationships.additional_properties = d
        return teststep_results_single_get_response_data_relationships
