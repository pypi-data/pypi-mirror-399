...
class TestrecordsListGetResponseDataItemAttributes:
    ...
    comment: Union[Unset, "TestrecordsListGetResponseDataItemAttributesComment"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = TestrecordsListGetResponseDataItemAttributesComment.from_dict(
                _comment
            )
        ...
        testrecords_list_get_response_data_item_attributes = cls(
            comment=comment,
            duration=duration,
            executed=executed,
            iteration=iteration,
        ...
        testrecords_list_get_response_data_item_attributes.additional_properties = d
        return testrecords_list_get_response_data_item_attributes
