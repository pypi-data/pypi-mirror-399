...
class CollectionsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_get_response_data_links = cls(
            self_=self_,
            portal=portal,
        )

        collections_single_get_response_data_links.additional_properties = d
        return collections_single_get_response_data_links
