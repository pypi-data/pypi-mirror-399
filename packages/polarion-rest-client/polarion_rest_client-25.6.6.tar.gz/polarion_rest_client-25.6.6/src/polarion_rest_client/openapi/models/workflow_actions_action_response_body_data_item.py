...
class WorkflowActionsActionResponseBodyDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_actions_action_response_body_data_item = cls(
            id=id,
            available=available,
        ...
        workflow_actions_action_response_body_data_item.additional_properties = d
        return workflow_actions_action_response_body_data_item
