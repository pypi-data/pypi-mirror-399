...
class TestrecordsListPatchRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = TestrecordsListPatchRequestDataItemAttributesComment.from_dict(
                _comment
            )
        ...
        testrecords_list_patch_request_data_item_attributes = cls(
            comment=comment,
            duration=duration,
            executed=executed,
            result=result,
        ...
        testrecords_list_patch_request_data_item_attributes.additional_properties = d
        return testrecords_list_patch_request_data_item_attributes
