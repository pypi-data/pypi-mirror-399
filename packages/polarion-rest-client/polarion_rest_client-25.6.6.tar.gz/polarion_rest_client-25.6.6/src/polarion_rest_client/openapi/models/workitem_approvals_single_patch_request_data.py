...
class WorkitemApprovalsSinglePatchRequestData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkitemApprovalsSinglePatchRequestDataAttributes.from_dict(
                _attributes
            )

        workitem_approvals_single_patch_request_data = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        workitem_approvals_single_patch_request_data.additional_properties = d
        return workitem_approvals_single_patch_request_data
