...
T = TypeVar("T", bound="WorkitemsListPostRequestDataItemAttributesHyperlinksItem")
...
class WorkitemsListPostRequestDataItemAttributesHyperlinksItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_post_request_data_item_attributes_hyperlinks_item.additional_properties = d
