...
class WorkitemCommentsListPostRequestDataItemRelationships:
    ...
    parent_comment: Union[
        Unset, "WorkitemCommentsListPostRequestDataItemRelationshipsParentComment"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                WorkitemCommentsListPostRequestDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        workitem_comments_list_post_request_data_item_relationships.additional_properties = d
