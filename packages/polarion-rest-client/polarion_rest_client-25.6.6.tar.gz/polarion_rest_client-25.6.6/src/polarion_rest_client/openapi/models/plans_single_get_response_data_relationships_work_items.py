...
class PlansSingleGetResponseDataRelationshipsWorkItems:
    ...
    meta: Union[Unset, "PlansSingleGetResponseDataRelationshipsWorkItemsMeta"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                PlansSingleGetResponseDataRelationshipsWorkItemsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = PlansSingleGetResponseDataRelationshipsWorkItemsMeta.from_dict(_meta)

        plans_single_get_response_data_relationships_work_items = cls(
            data=data,
            meta=meta,
        )

        plans_single_get_response_data_relationships_work_items.additional_properties = d
        return plans_single_get_response_data_relationships_work_items
