...
class LinkedoslcresourcesListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linkedoslcresources_list_post_request_data_item_attributes = cls(
            label=label,
            role=role,
            uri=uri,
        )

        linkedoslcresources_list_post_request_data_item_attributes.additional_properties = d
        return linkedoslcresources_list_post_request_data_item_attributes
