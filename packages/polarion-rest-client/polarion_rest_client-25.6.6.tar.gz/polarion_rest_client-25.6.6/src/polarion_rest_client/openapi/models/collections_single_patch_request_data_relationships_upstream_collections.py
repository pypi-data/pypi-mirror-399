...
T = TypeVar(
    "T", bound="CollectionsSinglePatchRequestDataRelationshipsUpstreamCollections"
)
...
class CollectionsSinglePatchRequestDataRelationshipsUpstreamCollections:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_patch_request_data_relationships_upstream_collections = cls(
            data=data,
        )

        collections_single_patch_request_data_relationships_upstream_collections.additional_properties = d
        return collections_single_patch_request_data_relationships_upstream_collections
