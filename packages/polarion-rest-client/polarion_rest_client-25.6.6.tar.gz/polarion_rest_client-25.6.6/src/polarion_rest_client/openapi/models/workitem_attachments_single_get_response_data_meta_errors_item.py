...
T = TypeVar("T", bound="WorkitemAttachmentsSingleGetResponseDataMetaErrorsItem")
...
class WorkitemAttachmentsSingleGetResponseDataMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                WorkitemAttachmentsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                    _source
                )
            )
        ...
        workitem_attachments_single_get_response_data_meta_errors_item.additional_properties = d
