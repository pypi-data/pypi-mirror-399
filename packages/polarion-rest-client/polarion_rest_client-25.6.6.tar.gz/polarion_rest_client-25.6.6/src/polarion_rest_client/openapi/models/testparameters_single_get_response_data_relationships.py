...
class TestparametersSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_definition, Unset):
            ...
            definition = (
                TestparametersSingleGetResponseDataRelationshipsDefinition.from_dict(
                    _definition
                )
            )

        testparameters_single_get_response_data_relationships = cls(
            definition=definition,
        )

        testparameters_single_get_response_data_relationships.additional_properties = d
        return testparameters_single_get_response_data_relationships
