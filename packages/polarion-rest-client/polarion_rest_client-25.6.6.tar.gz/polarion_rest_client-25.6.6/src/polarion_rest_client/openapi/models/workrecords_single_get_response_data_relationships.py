...
class WorkrecordsSingleGetResponseDataRelationships:
    ...
    user: Union[Unset, "WorkrecordsSingleGetResponseDataRelationshipsUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project, Unset):
            ...
            project = WorkrecordsSingleGetResponseDataRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_user, Unset):
            ...
            user = WorkrecordsSingleGetResponseDataRelationshipsUser.from_dict(_user)

        workrecords_single_get_response_data_relationships = cls(
            project=project,
            user=user,
        )

        workrecords_single_get_response_data_relationships.additional_properties = d
        return workrecords_single_get_response_data_relationships
