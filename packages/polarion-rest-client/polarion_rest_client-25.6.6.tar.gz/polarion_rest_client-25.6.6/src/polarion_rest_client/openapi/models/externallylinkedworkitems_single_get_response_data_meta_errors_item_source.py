...
T = TypeVar(
    "T", bound="ExternallylinkedworkitemsSingleGetResponseDataMetaErrorsItemSource"
)
...
class ExternallylinkedworkitemsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        externallylinkedworkitems_single_get_response_data_meta_errors_item_source = (
            cls(
                pointer=pointer,
                parameter=parameter,
                resource=resource,
        ...
        externallylinkedworkitems_single_get_response_data_meta_errors_item_source.additional_properties = d
        return (
            externallylinkedworkitems_single_get_response_data_meta_errors_item_source
        )
