...
T = TypeVar("T", bound="WorkitemsListPatchRequestDataItemRelationshipsVotesDataItem")
...
class WorkitemsListPatchRequestDataItemRelationshipsVotesDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_patch_request_data_item_relationships_votes_data_item = cls(
            type_=type_,
            id=id,
        )

        workitems_list_patch_request_data_item_relationships_votes_data_item.additional_properties = d
        return workitems_list_patch_request_data_item_relationships_votes_data_item
