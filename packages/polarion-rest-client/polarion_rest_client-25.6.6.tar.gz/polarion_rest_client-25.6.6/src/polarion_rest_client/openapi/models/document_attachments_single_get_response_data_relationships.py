...
class DocumentAttachmentsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                DocumentAttachmentsSingleGetResponseDataRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                DocumentAttachmentsSingleGetResponseDataRelationshipsProject.from_dict(
                    _project
                )
            )
        ...
        document_attachments_single_get_response_data_relationships.additional_properties = d
