...
class FeatureselectionsSingleGetResponseData:
    ...
    attributes: Union[Unset, "FeatureselectionsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = FeatureselectionsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = FeatureselectionsSingleGetResponseDataLinks.from_dict(_links)

        featureselections_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        featureselections_single_get_response_data.additional_properties = d
        return featureselections_single_get_response_data
