...
class FeatureselectionsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_work_item, Unset):
            ...
            work_item = (
                FeatureselectionsListGetResponseDataItemRelationshipsWorkItem.from_dict(
                    _work_item
                )
            )

        featureselections_list_get_response_data_item_relationships = cls(
            work_item=work_item,
        )

        featureselections_list_get_response_data_item_relationships.additional_properties = d
        return featureselections_list_get_response_data_item_relationships
