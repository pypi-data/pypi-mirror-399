...
class TestrecordsListPostRequestDataItemRelationshipsDefect:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_list_post_request_data_item_relationships_defect = cls(
            data=data,
        )

        testrecords_list_post_request_data_item_relationships_defect.additional_properties = d
        return testrecords_list_post_request_data_item_relationships_defect
