...
class LinkedworkitemsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_work_item, Unset):
            ...
            work_item = (
                LinkedworkitemsListGetResponseDataItemRelationshipsWorkItem.from_dict(
                    _work_item
                )
            )
        ...
        linkedworkitems_list_get_response_data_item_relationships.additional_properties = d
