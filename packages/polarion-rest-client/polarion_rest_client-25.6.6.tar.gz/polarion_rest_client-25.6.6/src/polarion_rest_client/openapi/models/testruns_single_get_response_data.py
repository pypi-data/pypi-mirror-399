...
class TestrunsSingleGetResponseData:
    ...
    relationships: Union[Unset, "TestrunsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrunsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
        ...
        testruns_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testruns_single_get_response_data.additional_properties = d
        return testruns_single_get_response_data
