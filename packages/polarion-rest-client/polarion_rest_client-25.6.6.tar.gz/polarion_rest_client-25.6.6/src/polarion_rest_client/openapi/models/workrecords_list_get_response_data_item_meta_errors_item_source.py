...
class WorkrecordsListGetResponseDataItemMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workrecords_list_get_response_data_item_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        workrecords_list_get_response_data_item_meta_errors_item_source.additional_properties = d
        return workrecords_list_get_response_data_item_meta_errors_item_source
