...
T = TypeVar("T", bound="WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItem")
...
class WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItem:
    ...
    type_: Union[
        Unset, WorkitemsSingleGetResponseDataRelationshipsAttachmentsDataItemType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_attachments_data_item.additional_properties = d
