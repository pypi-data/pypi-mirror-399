...
if TYPE_CHECKING:
    from ..models.testruns_single_get_response_data import TestrunsSingleGetResponseData
...
class TestrunsSingleGetResponse:
    ...
    included: Union[Unset, list["TestrunsSingleGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        testruns_single_get_response.additional_properties = d
        return testruns_single_get_response
