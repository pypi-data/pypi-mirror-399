...
class WorkitemApprovalsListGetResponseDataItemMeta:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for errors_item_data in _errors or []:
            errors_item = (
                WorkitemApprovalsListGetResponseDataItemMetaErrorsItem.from_dict(
                    errors_item_data
                )
            )
        ...
        workitem_approvals_list_get_response_data_item_meta = cls(
            errors=errors,
        )

        workitem_approvals_list_get_response_data_item_meta.additional_properties = d
        return workitem_approvals_list_get_response_data_item_meta
