...
class FeatureselectionsListGetResponse:
    ...
    data: Union[Unset, list["FeatureselectionsListGetResponseDataItem"]] = UNSET
    included: Union[Unset, list["FeatureselectionsListGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for included_item_data in _included or []:
            included_item = FeatureselectionsListGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        featureselections_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        featureselections_list_get_response.additional_properties = d
        return featureselections_list_get_response
