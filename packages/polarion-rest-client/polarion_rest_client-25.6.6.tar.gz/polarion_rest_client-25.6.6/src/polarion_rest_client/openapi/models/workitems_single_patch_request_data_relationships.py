...
class WorkitemsSinglePatchRequestDataRelationships:
    ...
    votes: Union[Unset, "WorkitemsSinglePatchRequestDataRelationshipsVotes"] = UNSET
    watches: Union[Unset, "WorkitemsSinglePatchRequestDataRelationshipsWatches"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_assignee, Unset):
            ...
            assignee = WorkitemsSinglePatchRequestDataRelationshipsAssignee.from_dict(
                _assignee
            )
        ...
        if isinstance(_categories, Unset):
            ...
            categories = (
                WorkitemsSinglePatchRequestDataRelationshipsCategories.from_dict(
                    _categories
                )
            )
        ...
        if isinstance(_linked_revisions, Unset):
            ...
            linked_revisions = (
                WorkitemsSinglePatchRequestDataRelationshipsLinkedRevisions.from_dict(
                    _linked_revisions
                )
            )
        ...
        if isinstance(_votes, Unset):
            ...
            votes = WorkitemsSinglePatchRequestDataRelationshipsVotes.from_dict(_votes)
        ...
        if isinstance(_watches, Unset):
            ...
            watches = WorkitemsSinglePatchRequestDataRelationshipsWatches.from_dict(
                _watches
            )
        ...
        workitems_single_patch_request_data_relationships.additional_properties = d
