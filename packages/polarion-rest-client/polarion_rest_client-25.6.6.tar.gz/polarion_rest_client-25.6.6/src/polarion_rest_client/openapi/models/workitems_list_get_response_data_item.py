...
class WorkitemsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "WorkitemsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[Unset, "WorkitemsListGetResponseDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkitemsListGetResponseDataItemRelationships.from_dict(
                _relationships
            )
