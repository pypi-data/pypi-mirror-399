...
class TestrunAttachmentsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_list_get_response_data_item_attributes = cls(
            file_name=file_name,
            id=id,
            length=length,
            title=title,
        ...
        testrun_attachments_list_get_response_data_item_attributes.additional_properties = d
        return testrun_attachments_list_get_response_data_item_attributes
