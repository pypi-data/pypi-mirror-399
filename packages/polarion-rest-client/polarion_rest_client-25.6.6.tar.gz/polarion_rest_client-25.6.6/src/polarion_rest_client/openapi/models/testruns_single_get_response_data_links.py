...
class TestrunsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_get_response_data_links = cls(
            self_=self_,
            portal=portal,
        )

        testruns_single_get_response_data_links.additional_properties = d
        return testruns_single_get_response_data_links
