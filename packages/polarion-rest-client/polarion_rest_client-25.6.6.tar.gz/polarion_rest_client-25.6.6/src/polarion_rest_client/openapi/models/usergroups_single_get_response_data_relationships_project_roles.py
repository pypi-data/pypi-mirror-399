...
T = TypeVar("T", bound="UsergroupsSingleGetResponseDataRelationshipsProjectRoles")
...
class UsergroupsSingleGetResponseDataRelationshipsProjectRoles:
    ...
    data: Union[
        Unset, list["UsergroupsSingleGetResponseDataRelationshipsProjectRolesDataItem"]
    ] = UNSET
    meta: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = (
                UsergroupsSingleGetResponseDataRelationshipsProjectRolesMeta.from_dict(
                    _meta
                )
            )
        ...
        usergroups_single_get_response_data_relationships_project_roles.additional_properties = d
