...
class ProjecttemplatesListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parameters, Unset):
            ...
            parameters = (
                ProjecttemplatesListGetResponseDataItemAttributesParameters.from_dict(
                    _parameters
                )
            )

        projecttemplates_list_get_response_data_item_attributes = cls(
        ...
        projecttemplates_list_get_response_data_item_attributes.additional_properties = d
        return projecttemplates_list_get_response_data_item_attributes
