...
class TestparametersListGetResponseDataItem:
    ...
    attributes: Union[Unset, "TestparametersListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestparametersListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TestparametersListGetResponseDataItemLinks.from_dict(_links)

        testparameters_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testparameters_list_get_response_data_item.additional_properties = d
        return testparameters_list_get_response_data_item
