...
class TestrecordsSingleGetResponse:
    ...
    included: Union[Unset, list["TestrecordsSingleGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        testrecords_single_get_response.additional_properties = d
        return testrecords_single_get_response
