...
class CollectionsListGetResponseDataItemRelationships:
    ...
    downstream_collections: Union[
        Unset, "CollectionsListGetResponseDataItemRelationshipsDownstreamCollections"
    ] = UNSET
    project: Union[Unset, "CollectionsListGetResponseDataItemRelationshipsProject"] = (
        UNSET
    )
    ...
    upstream_collections: Union[
        Unset, "CollectionsListGetResponseDataItemRelationshipsUpstreamCollections"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_documents, Unset):
            ...
            documents = (
                CollectionsListGetResponseDataItemRelationshipsDocuments.from_dict(
                    _documents
                )
            )
        ...
        if isinstance(_reused_from, Unset):
            ...
            reused_from = (
                CollectionsListGetResponseDataItemRelationshipsReusedFrom.from_dict(
                    _reused_from
                )
            )
        ...
        if isinstance(_rich_pages, Unset):
            ...
            rich_pages = (
                CollectionsListGetResponseDataItemRelationshipsRichPages.from_dict(
                    _rich_pages
                )
            )
        ...
        collections_list_get_response_data_item_relationships = cls(
            author=author,
            documents=documents,
        ...
        collections_list_get_response_data_item_relationships.additional_properties = d
        return collections_list_get_response_data_item_relationships
