...
class PlansListPostRequestDataItemRelationships:
    ...
    parent: Union[Unset, "PlansListPostRequestDataItemRelationshipsParent"] = UNSET
    project_span: Union[
        Unset, "PlansListPostRequestDataItemRelationshipsProjectSpan"
    ] = UNSET
    template: Union[Unset, "PlansListPostRequestDataItemRelationshipsTemplate"] = UNSET
    work_items: Union[Unset, "PlansListPostRequestDataItemRelationshipsWorkItems"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_parent, Unset):
            ...
            parent = PlansListPostRequestDataItemRelationshipsParent.from_dict(_parent)
        ...
        if isinstance(_template, Unset):
            ...
            template = PlansListPostRequestDataItemRelationshipsTemplate.from_dict(
                _template
            )
        ...
        if isinstance(_work_items, Unset):
            ...
            work_items = PlansListPostRequestDataItemRelationshipsWorkItems.from_dict(
                _work_items
            )

        plans_list_post_request_data_item_relationships = cls(
            parent=parent,
        ...
        plans_list_post_request_data_item_relationships.additional_properties = d
        return plans_list_post_request_data_item_relationships
