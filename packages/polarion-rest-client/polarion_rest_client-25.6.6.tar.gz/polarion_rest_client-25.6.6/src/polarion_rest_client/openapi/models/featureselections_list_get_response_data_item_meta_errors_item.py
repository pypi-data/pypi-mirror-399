...
T = TypeVar("T", bound="FeatureselectionsListGetResponseDataItemMetaErrorsItem")
...
class FeatureselectionsListGetResponseDataItemMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                FeatureselectionsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                    _source
                )
            )

        featureselections_list_get_response_data_item_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        featureselections_list_get_response_data_item_meta_errors_item.additional_properties = d
        return featureselections_list_get_response_data_item_meta_errors_item
