...
from ..models.jobs_single_post_response_data_type import JobsSinglePostResponseDataType
...
class JobsSinglePostResponseData:
    ...
    relationships: Union[Unset, "JobsSinglePostResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = JobsSinglePostResponseDataAttributes.from_dict(_attributes)
        ...
        jobs_single_post_response_data = cls(
            type_=type_,
            id=id,
        ...
        jobs_single_post_response_data.additional_properties = d
        return jobs_single_post_response_data
