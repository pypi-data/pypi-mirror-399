...
class ExternallylinkedworkitemsSingleGetResponse:
    ...
    data: Union[Unset, "ExternallylinkedworkitemsSingleGetResponseData"] = UNSET
    included: Union[
        Unset, list["ExternallylinkedworkitemsSingleGetResponseIncludedItem"]
    ] = UNSET
    links: Union[Unset, "ExternallylinkedworkitemsSingleGetResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = ExternallylinkedworkitemsSingleGetResponseData.from_dict(_data)

        included = []
        _included = d.pop("included", UNSET)
        for included_item_data in _included or []:
            included_item = (
                ExternallylinkedworkitemsSingleGetResponseIncludedItem.from_dict(
                    included_item_data
                )
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = ExternallylinkedworkitemsSingleGetResponseLinks.from_dict(_links)

        externallylinkedworkitems_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        externallylinkedworkitems_single_get_response.additional_properties = d
        return externallylinkedworkitems_single_get_response
