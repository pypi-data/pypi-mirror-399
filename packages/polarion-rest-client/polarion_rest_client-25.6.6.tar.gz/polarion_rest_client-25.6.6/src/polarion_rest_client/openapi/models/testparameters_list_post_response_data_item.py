...
class TestparametersListPostResponseDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = TestparametersListPostResponseDataItemLinks.from_dict(_links)

        testparameters_list_post_response_data_item = cls(
            type_=type_,
            id=id,
            links=links,
        )

        testparameters_list_post_response_data_item.additional_properties = d
        return testparameters_list_post_response_data_item
