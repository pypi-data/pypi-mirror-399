...
class PlansSinglePatchRequestDataRelationshipsWorkItems:
    ...
    data: Union[
        Unset, list["PlansSinglePatchRequestDataRelationshipsWorkItemsDataItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                PlansSinglePatchRequestDataRelationshipsWorkItemsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        plans_single_patch_request_data_relationships_work_items = cls(
            data=data,
        )

        plans_single_patch_request_data_relationships_work_items.additional_properties = d
        return plans_single_patch_request_data_relationships_work_items
