...
class TeststepResultsListGetResponse:
    ...
    included: Union[Unset, list["TeststepResultsListGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TeststepResultsListGetResponseDataItem.from_dict(data_item_data)
        ...
        for included_item_data in _included or []:
            included_item = TeststepResultsListGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        teststep_results_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        teststep_results_list_get_response.additional_properties = d
        return teststep_results_list_get_response
