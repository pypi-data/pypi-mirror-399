...
class TestrecordAttachmentsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_single_get_response_data_links = cls(
            self_=self_,
            content=content,
        )

        testrecord_attachments_single_get_response_data_links.additional_properties = d
        return testrecord_attachments_single_get_response_data_links
