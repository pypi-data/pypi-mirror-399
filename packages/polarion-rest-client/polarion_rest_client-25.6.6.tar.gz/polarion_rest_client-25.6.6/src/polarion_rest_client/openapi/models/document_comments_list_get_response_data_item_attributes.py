...
class DocumentCommentsListGetResponseDataItemAttributes:
    ...
    text: Union[Unset, "DocumentCommentsListGetResponseDataItemAttributesText"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_comments_list_get_response_data_item_attributes.additional_properties = d
