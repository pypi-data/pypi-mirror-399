...
class WorkitemsListPostRequestDataItemRelationships:
    ...
    author: Union[Unset, "WorkitemsListPostRequestDataItemRelationshipsAuthor"] = UNSET
    categories: Union[
    ...
    module: Union[Unset, "WorkitemsListPostRequestDataItemRelationshipsModule"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = WorkitemsListPostRequestDataItemRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_categories, Unset):
            ...
            categories = (
                WorkitemsListPostRequestDataItemRelationshipsCategories.from_dict(
                    _categories
                )
            )
        ...
        if isinstance(_linked_revisions, Unset):
            ...
            linked_revisions = (
                WorkitemsListPostRequestDataItemRelationshipsLinkedRevisions.from_dict(
                    _linked_revisions
                )
            )
        ...
        if isinstance(_module, Unset):
            ...
            module = WorkitemsListPostRequestDataItemRelationshipsModule.from_dict(
                _module
            )
        ...
        workitems_list_post_request_data_item_relationships.additional_properties = d
