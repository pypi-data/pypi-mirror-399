...
T = TypeVar("T", bound="LinkedworkitemsListGetResponseDataItemMetaErrorsItemSource")
...
class LinkedworkitemsListGetResponseDataItemMetaErrorsItemSource:
    ...
    resource: Union[
        Unset, "LinkedworkitemsListGetResponseDataItemMetaErrorsItemSourceResource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linkedworkitems_list_get_response_data_item_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        linkedworkitems_list_get_response_data_item_meta_errors_item_source.additional_properties = d
        return linkedworkitems_list_get_response_data_item_meta_errors_item_source
