...
T = TypeVar("T", bound="WorkitemsSinglePatchRequestDataRelationshipsCategoriesDataItem")
...
class WorkitemsSinglePatchRequestDataRelationshipsCategoriesDataItem:
    ...
    type_: Union[
        Unset, WorkitemsSinglePatchRequestDataRelationshipsCategoriesDataItemType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_patch_request_data_relationships_categories_data_item.additional_properties = d
