...
class RevisionsSingleGetResponseData:
    ...
    attributes: Union[Unset, "RevisionsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "RevisionsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = RevisionsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = RevisionsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
        ...
        revisions_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        revisions_single_get_response_data.additional_properties = d
        return revisions_single_get_response_data
