...
T = TypeVar("T", bound="TeststepresultAttachmentsListGetResponseDataItemRelationships")
...
class TeststepresultAttachmentsListGetResponseDataItemRelationships:
    ...
    author: Union[
        Unset, "TeststepresultAttachmentsListGetResponseDataItemRelationshipsAuthor"
    ] = UNSET
    project: Union[
        Unset, "TeststepresultAttachmentsListGetResponseDataItemRelationshipsProject"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststepresult_attachments_list_get_response_data_item_relationships = cls(
            author=author,
            project=project,
        )

        teststepresult_attachments_list_get_response_data_item_relationships.additional_properties = d
        return teststepresult_attachments_list_get_response_data_item_relationships
