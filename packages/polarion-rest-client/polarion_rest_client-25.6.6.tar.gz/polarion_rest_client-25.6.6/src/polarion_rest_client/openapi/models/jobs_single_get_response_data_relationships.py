...
class JobsSingleGetResponseDataRelationships:
    ...
    document: Union[Unset, "JobsSingleGetResponseDataRelationshipsDocument"] = UNSET
    documents: Union[Unset, "JobsSingleGetResponseDataRelationshipsDocuments"] = UNSET
    project: Union[Unset, "JobsSingleGetResponseDataRelationshipsProject"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document, Unset):
            ...
            document = JobsSingleGetResponseDataRelationshipsDocument.from_dict(
                _document
            )
        ...
        if isinstance(_documents, Unset):
            ...
            documents = JobsSingleGetResponseDataRelationshipsDocuments.from_dict(
                _documents
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = JobsSingleGetResponseDataRelationshipsProject.from_dict(_project)

        jobs_single_get_response_data_relationships = cls(
            document=document,
            documents=documents,
            project=project,
        )

        jobs_single_get_response_data_relationships.additional_properties = d
        return jobs_single_get_response_data_relationships
