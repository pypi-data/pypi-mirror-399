...
class TestrunsListPostRequestDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document, Unset):
            ...
            document = TestrunsListPostRequestDataItemRelationshipsDocument.from_dict(
                _document
            )
        ...
        if isinstance(_project_span, Unset):
            ...
            project_span = (
                TestrunsListPostRequestDataItemRelationshipsProjectSpan.from_dict(
                    _project_span
                )
            )
        ...
        if isinstance(_summary_defect, Unset):
            ...
            summary_defect = (
                TestrunsListPostRequestDataItemRelationshipsSummaryDefect.from_dict(
                    _summary_defect
                )
            )
        ...
        if isinstance(_template, Unset):
            ...
            template = TestrunsListPostRequestDataItemRelationshipsTemplate.from_dict(
                _template
            )

        testruns_list_post_request_data_item_relationships = cls(
            document=document,
        ...
        testruns_list_post_request_data_item_relationships.additional_properties = d
        return testruns_list_post_request_data_item_relationships
