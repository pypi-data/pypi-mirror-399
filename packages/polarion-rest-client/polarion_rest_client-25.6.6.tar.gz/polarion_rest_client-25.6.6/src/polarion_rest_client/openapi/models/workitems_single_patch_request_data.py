...
class WorkitemsSinglePatchRequestData:
    ...
    attributes: Union[Unset, "WorkitemsSinglePatchRequestDataAttributes"] = UNSET
    relationships: Union[Unset, "WorkitemsSinglePatchRequestDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkitemsSinglePatchRequestDataRelationships.from_dict(
                _relationships
            )
