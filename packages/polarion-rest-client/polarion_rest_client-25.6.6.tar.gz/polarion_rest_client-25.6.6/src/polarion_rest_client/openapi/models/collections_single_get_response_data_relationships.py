...
class CollectionsSingleGetResponseDataRelationships:
    ...
    author: Union[Unset, "CollectionsSingleGetResponseDataRelationshipsAuthor"] = UNSET
    documents: Union[
        Unset, "CollectionsSingleGetResponseDataRelationshipsDocuments"
    ] = UNSET
    downstream_collections: Union[
        Unset, "CollectionsSingleGetResponseDataRelationshipsDownstreamCollections"
    ] = UNSET
    project: Union[Unset, "CollectionsSingleGetResponseDataRelationshipsProject"] = (
        UNSET
    )
    ...
    upstream_collections: Union[
        Unset, "CollectionsSingleGetResponseDataRelationshipsUpstreamCollections"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = CollectionsSingleGetResponseDataRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_documents, Unset):
            ...
            documents = (
                CollectionsSingleGetResponseDataRelationshipsDocuments.from_dict(
                    _documents
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = CollectionsSingleGetResponseDataRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_reused_from, Unset):
            ...
            reused_from = (
                CollectionsSingleGetResponseDataRelationshipsReusedFrom.from_dict(
                    _reused_from
                )
            )
        ...
        if isinstance(_rich_pages, Unset):
            ...
            rich_pages = (
                CollectionsSingleGetResponseDataRelationshipsRichPages.from_dict(
                    _rich_pages
                )
            )
        ...
        collections_single_get_response_data_relationships = cls(
            author=author,
            documents=documents,
        ...
        collections_single_get_response_data_relationships.additional_properties = d
        return collections_single_get_response_data_relationships
