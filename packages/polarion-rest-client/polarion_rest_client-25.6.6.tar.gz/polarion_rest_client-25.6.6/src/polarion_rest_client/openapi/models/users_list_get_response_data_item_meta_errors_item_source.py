...
class UsersListGetResponseDataItemMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        resource: Union[Unset, UsersListGetResponseDataItemMetaErrorsItemSourceResource]
        if isinstance(_resource, Unset):
            resource = UNSET
        else:
            resource = (
                UsersListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                    _resource
                )
            )
        ...
        users_list_get_response_data_item_meta_errors_item_source.additional_properties = d
