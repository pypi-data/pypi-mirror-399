...
T = TypeVar("T", bound="ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItem")
...
class ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItem:
    ...
    source: Union[
        Unset, "ExternallylinkedworkitemsListGetResponseDataItemMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        externallylinkedworkitems_list_get_response_data_item_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        externallylinkedworkitems_list_get_response_data_item_meta_errors_item.additional_properties = d
        return externallylinkedworkitems_list_get_response_data_item_meta_errors_item
