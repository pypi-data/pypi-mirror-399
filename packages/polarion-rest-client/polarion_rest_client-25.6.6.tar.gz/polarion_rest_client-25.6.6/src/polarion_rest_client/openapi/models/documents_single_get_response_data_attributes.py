...
class DocumentsSingleGetResponseDataAttributes:
    ...
    rendering_layouts: Union[
        Unset, list["DocumentsSingleGetResponseDataAttributesRenderingLayoutsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                DocumentsSingleGetResponseDataAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        if isinstance(_outline_numbering, Unset):
            ...
            outline_numbering = (
                DocumentsSingleGetResponseDataAttributesOutlineNumbering.from_dict(
                    _outline_numbering
                )
            )
        ...
        for rendering_layouts_item_data in _rendering_layouts or []:
            rendering_layouts_item = (
                DocumentsSingleGetResponseDataAttributesRenderingLayoutsItem.from_dict(
