...
class WorkitemApprovalsListGetResponseDataItem:
    ...
    links: Union[Unset, "WorkitemApprovalsListGetResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkitemApprovalsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = (
                WorkitemApprovalsListGetResponseDataItemRelationships.from_dict(
                    _relationships
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = WorkitemApprovalsListGetResponseDataItemMeta.from_dict(_meta)
        ...
        if isinstance(_links, Unset):
            ...
            links = WorkitemApprovalsListGetResponseDataItemLinks.from_dict(_links)

        workitem_approvals_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        workitem_approvals_list_get_response_data_item.additional_properties = d
        return workitem_approvals_list_get_response_data_item
