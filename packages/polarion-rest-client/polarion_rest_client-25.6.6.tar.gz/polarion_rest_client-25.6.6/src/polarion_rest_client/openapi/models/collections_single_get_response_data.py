...
class CollectionsSingleGetResponseData:
    ...
    attributes: Union[Unset, "CollectionsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "CollectionsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = CollectionsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
        ...
        collections_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        collections_single_get_response_data.additional_properties = d
        return collections_single_get_response_data
