...
T = TypeVar(
    "T", bound="TestparameterDefinitionsListGetResponseDataItemMetaErrorsItemSource"
)
...
class TestparameterDefinitionsListGetResponseDataItemMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testparameter_definitions_list_get_response_data_item_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        testparameter_definitions_list_get_response_data_item_meta_errors_item_source.additional_properties = d
        return testparameter_definitions_list_get_response_data_item_meta_errors_item_source
