...
class CollectionsListGetResponseDataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_get_response_data_item_links = cls(
            self_=self_,
            portal=portal,
        )

        collections_list_get_response_data_item_links.additional_properties = d
        return collections_list_get_response_data_item_links
