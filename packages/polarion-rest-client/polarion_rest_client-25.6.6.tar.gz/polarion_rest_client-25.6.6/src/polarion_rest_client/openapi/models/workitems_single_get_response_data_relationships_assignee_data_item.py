...
T = TypeVar("T", bound="WorkitemsSingleGetResponseDataRelationshipsAssigneeDataItem")
...
class WorkitemsSingleGetResponseDataRelationshipsAssigneeDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_assignee_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        )

        workitems_single_get_response_data_relationships_assignee_data_item.additional_properties = d
        return workitems_single_get_response_data_relationships_assignee_data_item
