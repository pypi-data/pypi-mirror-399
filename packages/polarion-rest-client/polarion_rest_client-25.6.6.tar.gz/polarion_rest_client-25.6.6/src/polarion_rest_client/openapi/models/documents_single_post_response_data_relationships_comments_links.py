...
T = TypeVar("T", bound="DocumentsSinglePostResponseDataRelationshipsCommentsLinks")
...
class DocumentsSinglePostResponseDataRelationshipsCommentsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_post_response_data_relationships_comments_links = cls(
            related=related,
        )

        documents_single_post_response_data_relationships_comments_links.additional_properties = d
        return documents_single_post_response_data_relationships_comments_links
