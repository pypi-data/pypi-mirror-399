...
class WorkitemsListGetResponseDataItemRelationshipsVotes:
    ...
    data: Union[
        Unset, list["WorkitemsListGetResponseDataItemRelationshipsVotesDataItem"]
    ] = UNSET
    meta: Union[Unset, "WorkitemsListGetResponseDataItemRelationshipsVotesMeta"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                WorkitemsListGetResponseDataItemRelationshipsVotesDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        workitems_list_get_response_data_item_relationships_votes = cls(
            data=data,
            meta=meta,
        )

        workitems_list_get_response_data_item_relationships_votes.additional_properties = d
        return workitems_list_get_response_data_item_relationships_votes
