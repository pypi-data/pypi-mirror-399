...
class TestrecordsSingleGetResponseDataRelationships:
    ...
    defect: Union[Unset, "TestrecordsSingleGetResponseDataRelationshipsDefect"] = UNSET
    executed_by: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_defect, Unset):
            ...
            defect = TestrecordsSingleGetResponseDataRelationshipsDefect.from_dict(
                _defect
            )
        ...
        if isinstance(_executed_by, Unset):
            ...
            executed_by = (
                TestrecordsSingleGetResponseDataRelationshipsExecutedBy.from_dict(
                    _executed_by
                )
            )
        ...
        testrecords_single_get_response_data_relationships = cls(
            defect=defect,
            executed_by=executed_by,
            test_case=test_case,
        )

        testrecords_single_get_response_data_relationships.additional_properties = d
        return testrecords_single_get_response_data_relationships
