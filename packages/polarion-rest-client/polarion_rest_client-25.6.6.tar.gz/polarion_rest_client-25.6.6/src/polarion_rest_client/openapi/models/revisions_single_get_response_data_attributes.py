...
class RevisionsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        revisions_single_get_response_data_attributes = cls(
            created=created,
            id=id,
        ...
        revisions_single_get_response_data_attributes.additional_properties = d
        return revisions_single_get_response_data_attributes
