...
class BranchDocumentsRequestBody:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        for document_configurations_item_data in self.document_configurations:
            document_configurations_item = document_configurations_item_data.to_dict()
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        branch_documents_request_body = cls(
            document_configurations=document_configurations,
        )

        branch_documents_request_body.additional_properties = d
        return branch_documents_request_body
