...
class WorkitemsListGetResponseDataItemMetaErrorsItem:
    ...
    source: Union[Unset, "WorkitemsListGetResponseDataItemMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = WorkitemsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        workitems_list_get_response_data_item_meta_errors_item.additional_properties = d
