...
class PlansListPostResponseDataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        plans_list_post_response_data_item_links = cls(
            self_=self_,
            portal=portal,
        )

        plans_list_post_response_data_item_links.additional_properties = d
        return plans_list_post_response_data_item_links
