...
class ProjectsListGetResponseDataItemMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = (
                ProjectsListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                    _resource
                )
            )
        ...
        projects_list_get_response_data_item_meta_errors_item_source.additional_properties = d
