...
class WorkitemsListGetResponseDataItemRelationships:
    ...
    author: Union[Unset, "WorkitemsListGetResponseDataItemRelationshipsAuthor"] = UNSET
    backlinked_work_items: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsBacklinkedWorkItems"
    ] = UNSET
    categories: Union[
    ...
    externally_linked_work_items: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsExternallyLinkedWorkItems"
    ] = UNSET
    linked_oslc_resources: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsLinkedOslcResources"
    ] = UNSET
    ...
    module: Union[Unset, "WorkitemsListGetResponseDataItemRelationshipsModule"] = UNSET
    planned_in: Union[
    ...
    votes: Union[Unset, "WorkitemsListGetResponseDataItemRelationshipsVotes"] = UNSET
    watches: Union[Unset, "WorkitemsListGetResponseDataItemRelationshipsWatches"] = (
        UNSET
    )
    work_records: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_approvals, Unset):
            ...
            approvals = (
                WorkitemsListGetResponseDataItemRelationshipsApprovals.from_dict(
                    _approvals
                )
            )
        ...
        if isinstance(_attachments, Unset):
            ...
            attachments = (
                WorkitemsListGetResponseDataItemRelationshipsAttachments.from_dict(
                    _attachments
                )
            )
        ...
        if isinstance(_author, Unset):
            ...
            author = WorkitemsListGetResponseDataItemRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_categories, Unset):
            ...
            categories = (
                WorkitemsListGetResponseDataItemRelationshipsCategories.from_dict(
                    _categories
                )
            )
        ...
        if isinstance(_linked_revisions, Unset):
            ...
            linked_revisions = (
                WorkitemsListGetResponseDataItemRelationshipsLinkedRevisions.from_dict(
                    _linked_revisions
                )
            )
        ...
        if isinstance(_linked_work_items, Unset):
            ...
            linked_work_items = (
                WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItems.from_dict(
                    _linked_work_items
                )
            )
        ...
        if isinstance(_module, Unset):
            ...
            module = WorkitemsListGetResponseDataItemRelationshipsModule.from_dict(
                _module
            )
        ...
        if isinstance(_planned_in, Unset):
            ...
            planned_in = (
                WorkitemsListGetResponseDataItemRelationshipsPlannedIn.from_dict(
                    _planned_in
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = WorkitemsListGetResponseDataItemRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_test_steps, Unset):
            ...
            test_steps = (
                WorkitemsListGetResponseDataItemRelationshipsTestSteps.from_dict(
                    _test_steps
                )
            )
        ...
        if isinstance(_votes, Unset):
            ...
            votes = WorkitemsListGetResponseDataItemRelationshipsVotes.from_dict(_votes)
        ...
        if isinstance(_watches, Unset):
            ...
            watches = WorkitemsListGetResponseDataItemRelationshipsWatches.from_dict(
                _watches
            )
        ...
        if isinstance(_work_records, Unset):
            ...
            work_records = (
                WorkitemsListGetResponseDataItemRelationshipsWorkRecords.from_dict(
                    _work_records
                )
            )
        ...
        workitems_list_get_response_data_item_relationships.additional_properties = d
