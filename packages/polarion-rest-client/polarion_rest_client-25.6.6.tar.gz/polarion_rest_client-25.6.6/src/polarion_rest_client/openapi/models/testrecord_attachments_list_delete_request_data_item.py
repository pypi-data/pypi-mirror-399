...
class TestrecordAttachmentsListDeleteRequestDataItem:
    ...
    type_: Union[Unset, TestrecordAttachmentsListDeleteRequestDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_list_delete_request_data_item = cls(
            type_=type_,
            id=id,
        )

        testrecord_attachments_list_delete_request_data_item.additional_properties = d
        return testrecord_attachments_list_delete_request_data_item
