...
class FeatureselectionsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        featureselections_list_get_response_data_item_attributes = cls(
            selection_type=selection_type,
        )

        featureselections_list_get_response_data_item_attributes.additional_properties = d
        return featureselections_list_get_response_data_item_attributes
