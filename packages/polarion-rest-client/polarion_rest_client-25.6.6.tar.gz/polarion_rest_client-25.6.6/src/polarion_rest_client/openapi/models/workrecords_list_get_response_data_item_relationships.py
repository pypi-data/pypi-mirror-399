...
class WorkrecordsListGetResponseDataItemRelationships:
    ...
    user: Union[Unset, "WorkrecordsListGetResponseDataItemRelationshipsUser"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_user, Unset):
            ...
            user = WorkrecordsListGetResponseDataItemRelationshipsUser.from_dict(_user)

        workrecords_list_get_response_data_item_relationships = cls(
            project=project,
            user=user,
        )

        workrecords_list_get_response_data_item_relationships.additional_properties = d
        return workrecords_list_get_response_data_item_relationships
