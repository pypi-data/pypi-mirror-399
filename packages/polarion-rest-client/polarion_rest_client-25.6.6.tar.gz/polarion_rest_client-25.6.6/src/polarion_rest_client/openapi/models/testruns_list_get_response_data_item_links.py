...
class TestrunsListGetResponseDataItemLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_list_get_response_data_item_links = cls(
            self_=self_,
            portal=portal,
        )

        testruns_list_get_response_data_item_links.additional_properties = d
        return testruns_list_get_response_data_item_links
