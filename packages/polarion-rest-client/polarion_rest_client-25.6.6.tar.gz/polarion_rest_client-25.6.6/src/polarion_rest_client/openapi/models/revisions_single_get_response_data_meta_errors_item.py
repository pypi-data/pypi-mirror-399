...
class RevisionsSingleGetResponseDataMetaErrorsItem:
    ...
    source: Union[Unset, "RevisionsSingleGetResponseDataMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = RevisionsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                _source
            )

        revisions_single_get_response_data_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        revisions_single_get_response_data_meta_errors_item.additional_properties = d
        return revisions_single_get_response_data_meta_errors_item
