...
T = TypeVar("T", bound="DocumentsSingleGetResponseDataRelationshipsCommentsLinks")
...
class DocumentsSingleGetResponseDataRelationshipsCommentsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_get_response_data_relationships_comments_links.additional_properties = d
