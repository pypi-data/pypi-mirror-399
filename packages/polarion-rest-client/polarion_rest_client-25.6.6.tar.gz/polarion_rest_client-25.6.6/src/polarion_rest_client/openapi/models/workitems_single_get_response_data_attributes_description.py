...
class WorkitemsSingleGetResponseDataAttributesDescription:
    ...
    type_: Union[Unset, WorkitemsSingleGetResponseDataAttributesDescriptionType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsSingleGetResponseDataAttributesDescriptionType(_type_)
        ...
        workitems_single_get_response_data_attributes_description.additional_properties = d
