...
class CollectionsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                CollectionsListGetResponseDataItemAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        collections_list_get_response_data_item_attributes = cls(
            closed_on=closed_on,
            created=created,
        ...
        collections_list_get_response_data_item_attributes.additional_properties = d
        return collections_list_get_response_data_item_attributes
