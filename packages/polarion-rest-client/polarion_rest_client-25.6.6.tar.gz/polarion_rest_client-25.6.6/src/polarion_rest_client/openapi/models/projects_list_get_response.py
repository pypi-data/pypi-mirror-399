...
if TYPE_CHECKING:
    ...
    from ..models.projects_list_get_response_links import ProjectsListGetResponseLinks
    from ..models.projects_list_get_response_meta import ProjectsListGetResponseMeta
...
class ProjectsListGetResponse:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = ProjectsListGetResponseDataItem.from_dict(data_item_data)
