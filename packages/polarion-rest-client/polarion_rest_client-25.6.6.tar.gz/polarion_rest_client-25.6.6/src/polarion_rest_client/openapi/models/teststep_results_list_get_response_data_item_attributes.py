...
class TeststepResultsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststep_results_list_get_response_data_item_attributes = cls(
            comment=comment,
            result=result,
        )

        teststep_results_list_get_response_data_item_attributes.additional_properties = d
        return teststep_results_list_get_response_data_item_attributes
