...
T = TypeVar(
    "T", bound="DocumentPartsListPostRequestDataItemRelationshipsPreviousPartData"
)
...
class DocumentPartsListPostRequestDataItemRelationshipsPreviousPartData:
    ...
    type_: Union[
        Unset, DocumentPartsListPostRequestDataItemRelationshipsPreviousPartDataType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_parts_list_post_request_data_item_relationships_previous_part_data = (
            cls(
                type_=type_,
                id=id,
            )
        ...
        document_parts_list_post_request_data_item_relationships_previous_part_data.additional_properties = d
        return (
            document_parts_list_post_request_data_item_relationships_previous_part_data
        )
