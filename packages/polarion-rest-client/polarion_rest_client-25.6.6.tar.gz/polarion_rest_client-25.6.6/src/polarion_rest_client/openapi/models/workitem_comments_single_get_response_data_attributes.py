...
class WorkitemCommentsSingleGetResponseDataAttributes:
    ...
    text: Union[Unset, "WorkitemCommentsSingleGetResponseDataAttributesText"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_text, Unset):
            ...
            text = WorkitemCommentsSingleGetResponseDataAttributesText.from_dict(_text)
        ...
        workitem_comments_single_get_response_data_attributes.additional_properties = d
