...
class TestrecordsListPatchRequestDataItem:
    ...
    attributes: Union[Unset, "TestrecordsListPatchRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "TestrecordsListPatchRequestDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrecordsListPatchRequestDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrecordsListPatchRequestDataItemRelationships.from_dict(
                _relationships
            )

        testrecords_list_patch_request_data_item = cls(
            type_=type_,
            id=id,
        ...
        testrecords_list_patch_request_data_item.additional_properties = d
        return testrecords_list_patch_request_data_item
