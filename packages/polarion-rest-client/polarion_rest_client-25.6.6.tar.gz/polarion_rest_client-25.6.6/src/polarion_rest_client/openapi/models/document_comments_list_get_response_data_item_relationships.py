...
class DocumentCommentsListGetResponseDataItemRelationships:
    ...
    child_comments: Union[
        Unset, "DocumentCommentsListGetResponseDataItemRelationshipsChildComments"
    ] = UNSET
    parent_comment: Union[
        Unset, "DocumentCommentsListGetResponseDataItemRelationshipsParentComment"
    ] = UNSET
    project: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                DocumentCommentsListGetResponseDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                DocumentCommentsListGetResponseDataItemRelationshipsProject.from_dict(
                    _project
                )
            )
        ...
        document_comments_list_get_response_data_item_relationships.additional_properties = d
