...
class TeststepresultAttachmentsListGetResponseDataItem:
    ...
    type_: Union[Unset, TeststepresultAttachmentsListGetResponseDataItemType] = UNSET
    ...
    meta: Union[Unset, "TeststepresultAttachmentsListGetResponseDataItemMeta"] = UNSET
    links: Union[Unset, "TeststepresultAttachmentsListGetResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepresultAttachmentsListGetResponseDataItemType(_type_)
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                TeststepresultAttachmentsListGetResponseDataItemAttributes.from_dict(
                    _attributes
                )
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = (
                TeststepresultAttachmentsListGetResponseDataItemRelationships.from_dict(
                    _relationships
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = TeststepresultAttachmentsListGetResponseDataItemMeta.from_dict(_meta)
        ...
        teststepresult_attachments_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        teststepresult_attachments_list_get_response_data_item.additional_properties = d
        return teststepresult_attachments_list_get_response_data_item
