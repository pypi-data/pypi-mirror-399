...
class ProjecttemplatesListGetResponseDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = ProjecttemplatesListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = ProjecttemplatesListGetResponseDataItemLinks.from_dict(_links)

        projecttemplates_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        projecttemplates_list_get_response_data_item.additional_properties = d
        return projecttemplates_list_get_response_data_item
