...
class TestrunsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "TestrunsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[Unset, "TestrunsListGetResponseDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrunsListGetResponseDataItemRelationships.from_dict(
                _relationships
            )
        ...
        testruns_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testruns_list_get_response_data_item.additional_properties = d
        return testruns_list_get_response_data_item
