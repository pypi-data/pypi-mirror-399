...
T = TypeVar(
    "T", bound="TeststepresultAttachmentsListGetResponseDataItemRelationshipsAuthor"
)
...
class TeststepresultAttachmentsListGetResponseDataItemRelationshipsAuthor:
    ...
    data: Union[
        Unset, "TeststepresultAttachmentsListGetResponseDataItemRelationshipsAuthorData"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststepresult_attachments_list_get_response_data_item_relationships_author = (
            cls(
                data=data,
            )
        )

        teststepresult_attachments_list_get_response_data_item_relationships_author.additional_properties = d
        return (
            teststepresult_attachments_list_get_response_data_item_relationships_author
        )
