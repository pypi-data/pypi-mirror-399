...
class UsergroupsSingleGetResponseData:
    ...
    attributes: Union[Unset, "UsergroupsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "UsergroupsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = UsergroupsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
