...
class CollectionsSinglePatchRequestData:
    ...
    attributes: Union[Unset, "CollectionsSinglePatchRequestDataAttributes"] = UNSET
    relationships: Union[Unset, "CollectionsSinglePatchRequestDataRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = CollectionsSinglePatchRequestDataRelationships.from_dict(
                _relationships
            )

        collections_single_patch_request_data = cls(
            type_=type_,
            id=id,
        ...
        collections_single_patch_request_data.additional_properties = d
        return collections_single_patch_request_data
