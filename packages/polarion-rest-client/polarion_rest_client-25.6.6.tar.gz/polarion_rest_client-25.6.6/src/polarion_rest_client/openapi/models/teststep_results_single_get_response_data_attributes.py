...
class TeststepResultsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststep_results_single_get_response_data_attributes = cls(
            comment=comment,
            result=result,
        )

        teststep_results_single_get_response_data_attributes.additional_properties = d
        return teststep_results_single_get_response_data_attributes
