...
T = TypeVar(
    "T", bound="WorkitemCommentsSingleGetResponseDataRelationshipsChildCommentsDataItem"
)
...
class WorkitemCommentsSingleGetResponseDataRelationshipsChildCommentsDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_single_get_response_data_relationships_child_comments_data_item.additional_properties = d
