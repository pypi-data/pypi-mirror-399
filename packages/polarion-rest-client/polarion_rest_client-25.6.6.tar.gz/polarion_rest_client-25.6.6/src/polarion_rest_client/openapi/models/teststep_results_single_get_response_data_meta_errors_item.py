...
class TeststepResultsSingleGetResponseDataMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststep_results_single_get_response_data_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        teststep_results_single_get_response_data_meta_errors_item.additional_properties = d
        return teststep_results_single_get_response_data_meta_errors_item
