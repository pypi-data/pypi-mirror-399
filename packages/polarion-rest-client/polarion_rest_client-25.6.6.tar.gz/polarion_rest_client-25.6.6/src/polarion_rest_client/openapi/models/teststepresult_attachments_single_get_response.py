...
class TeststepresultAttachmentsSingleGetResponse:
    ...
    data: Union[Unset, "TeststepresultAttachmentsSingleGetResponseData"] = UNSET
    included: Union[
        Unset, list["TeststepresultAttachmentsSingleGetResponseIncludedItem"]
    ] = UNSET
    links: Union[Unset, "TeststepresultAttachmentsSingleGetResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = TeststepresultAttachmentsSingleGetResponseData.from_dict(_data)

        included = []
        _included = d.pop("included", UNSET)
        for included_item_data in _included or []:
            included_item = (
                TeststepresultAttachmentsSingleGetResponseIncludedItem.from_dict(
                    included_item_data
                )
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TeststepresultAttachmentsSingleGetResponseLinks.from_dict(_links)

        teststepresult_attachments_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        teststepresult_attachments_single_get_response.additional_properties = d
        return teststepresult_attachments_single_get_response
