...
class TestrunAttachmentsSinglePatchRequestData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunAttachmentsSinglePatchRequestDataAttributes.from_dict(
                _attributes
            )

        testrun_attachments_single_patch_request_data = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        testrun_attachments_single_patch_request_data.additional_properties = d
        return testrun_attachments_single_patch_request_data
