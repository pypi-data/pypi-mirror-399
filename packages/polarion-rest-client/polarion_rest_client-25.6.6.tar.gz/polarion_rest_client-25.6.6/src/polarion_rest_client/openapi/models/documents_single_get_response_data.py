...
class DocumentsSingleGetResponseData:
    ...
    attributes: Union[Unset, "DocumentsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "DocumentsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = DocumentsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = DocumentsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
