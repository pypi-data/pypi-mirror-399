...
class WorkitemApprovalsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_approvals_single_get_response_data_relationships = cls(
            user=user,
        )

        workitem_approvals_single_get_response_data_relationships.additional_properties = d
        return workitem_approvals_single_get_response_data_relationships
