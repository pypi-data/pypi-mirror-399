...
class FeatureselectionsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_work_item, Unset):
            ...
            work_item = (
                FeatureselectionsSingleGetResponseDataRelationshipsWorkItem.from_dict(
                    _work_item
                )
            )

        featureselections_single_get_response_data_relationships = cls(
            work_item=work_item,
        )

        featureselections_single_get_response_data_relationships.additional_properties = d
        return featureselections_single_get_response_data_relationships
