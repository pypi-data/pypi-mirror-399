...
class TestrunsListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                TestrunsListPostRequestDataItemAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        testruns_list_post_request_data_item_attributes = cls(
        ...
        testruns_list_post_request_data_item_attributes.additional_properties = d
        return testruns_list_post_request_data_item_attributes
