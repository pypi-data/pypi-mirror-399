...
T = TypeVar("T", bound="WorkitemsListGetResponseDataItemRelationshipsWorkRecords")
...
class WorkitemsListGetResponseDataItemRelationshipsWorkRecords:
    ...
    data: Union[
        Unset, list["WorkitemsListGetResponseDataItemRelationshipsWorkRecordsDataItem"]
    ] = UNSET
    meta: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = (
                WorkitemsListGetResponseDataItemRelationshipsWorkRecordsMeta.from_dict(
                    _meta
                )
            )

        workitems_list_get_response_data_item_relationships_work_records = cls(
            data=data,
            meta=meta,
        )

        workitems_list_get_response_data_item_relationships_work_records.additional_properties = d
        return workitems_list_get_response_data_item_relationships_work_records
