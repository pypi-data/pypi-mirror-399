...
class TestrunsSingleGetResponseDataRelationships:
    ...
    document: Union[Unset, "TestrunsSingleGetResponseDataRelationshipsDocument"] = UNSET
    project: Union[Unset, "TestrunsSingleGetResponseDataRelationshipsProject"] = UNSET
    project_span: Union[
    ...
    template: Union[Unset, "TestrunsSingleGetResponseDataRelationshipsTemplate"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = TestrunsSingleGetResponseDataRelationshipsAuthor.from_dict(_author)
        ...
        if isinstance(_document, Unset):
            ...
            document = TestrunsSingleGetResponseDataRelationshipsDocument.from_dict(
                _document
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = TestrunsSingleGetResponseDataRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_project_span, Unset):
            ...
            project_span = (
                TestrunsSingleGetResponseDataRelationshipsProjectSpan.from_dict(
                    _project_span
                )
            )
        ...
        if isinstance(_summary_defect, Unset):
            ...
            summary_defect = (
                TestrunsSingleGetResponseDataRelationshipsSummaryDefect.from_dict(
                    _summary_defect
                )
            )
        ...
        if isinstance(_template, Unset):
            ...
            template = TestrunsSingleGetResponseDataRelationshipsTemplate.from_dict(
                _template
            )

        testruns_single_get_response_data_relationships = cls(
            author=author,
            document=document,
            project=project,
        ...
        testruns_single_get_response_data_relationships.additional_properties = d
        return testruns_single_get_response_data_relationships
