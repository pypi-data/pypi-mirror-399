...
class PlansSingleGetResponseDataAttributesHomePageContent:
    ...
    type_: Union[Unset, PlansSingleGetResponseDataAttributesHomePageContentType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansSingleGetResponseDataAttributesHomePageContentType(_type_)

        value = d.pop("value", UNSET)

        plans_single_get_response_data_attributes_home_page_content = cls(
            type_=type_,
            value=value,
        )

        plans_single_get_response_data_attributes_home_page_content.additional_properties = d
        return plans_single_get_response_data_attributes_home_page_content
