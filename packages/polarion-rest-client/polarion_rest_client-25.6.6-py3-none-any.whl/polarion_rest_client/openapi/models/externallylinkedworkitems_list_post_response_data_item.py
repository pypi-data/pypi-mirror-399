...
class ExternallylinkedworkitemsListPostResponseDataItem:
    ...
    type_: Union[Unset, ExternallylinkedworkitemsListPostResponseDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ExternallylinkedworkitemsListPostResponseDataItemType(_type_)
        ...
        externallylinkedworkitems_list_post_response_data_item = cls(
            type_=type_,
            id=id,
            links=links,
        )

        externallylinkedworkitems_list_post_response_data_item.additional_properties = d
        return externallylinkedworkitems_list_post_response_data_item
