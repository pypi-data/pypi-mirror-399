...
class GlobalrolesSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = (
                GlobalrolesSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                    _resource
                )
            )
        ...
        globalroles_single_get_response_data_meta_errors_item_source.additional_properties = d
