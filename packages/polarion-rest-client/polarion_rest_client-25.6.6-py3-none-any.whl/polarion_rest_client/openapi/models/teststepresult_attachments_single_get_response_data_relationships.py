...
T = TypeVar("T", bound="TeststepresultAttachmentsSingleGetResponseDataRelationships")
...
class TeststepresultAttachmentsSingleGetResponseDataRelationships:
    ...
    author: Union[
        Unset, "TeststepresultAttachmentsSingleGetResponseDataRelationshipsAuthor"
    ] = UNSET
    project: Union[
        Unset, "TeststepresultAttachmentsSingleGetResponseDataRelationshipsProject"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststepresult_attachments_single_get_response_data_relationships = cls(
            author=author,
            project=project,
        )

        teststepresult_attachments_single_get_response_data_relationships.additional_properties = d
        return teststepresult_attachments_single_get_response_data_relationships
