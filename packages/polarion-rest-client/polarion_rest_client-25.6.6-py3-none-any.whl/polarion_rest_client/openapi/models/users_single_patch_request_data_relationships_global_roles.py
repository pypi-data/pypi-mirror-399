...
class UsersSinglePatchRequestDataRelationshipsGlobalRoles:
    ...
    data: Union[
        Unset, list["UsersSinglePatchRequestDataRelationshipsGlobalRolesDataItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                UsersSinglePatchRequestDataRelationshipsGlobalRolesDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        users_single_patch_request_data_relationships_global_roles.additional_properties = d
