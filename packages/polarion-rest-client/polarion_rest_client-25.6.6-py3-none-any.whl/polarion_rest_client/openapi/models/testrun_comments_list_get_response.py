...
class TestrunCommentsListGetResponse:
    ...
    included: Union[Unset, list["TestrunCommentsListGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TestrunCommentsListGetResponseDataItem.from_dict(data_item_data)
        ...
        for included_item_data in _included or []:
            included_item = TestrunCommentsListGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        testrun_comments_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        testrun_comments_list_get_response.additional_properties = d
        return testrun_comments_list_get_response
