...
class WorkrecordsListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workrecords_list_post_request_data_item_attributes = cls(
            comment=comment,
            date=date,
        ...
        workrecords_list_post_request_data_item_attributes.additional_properties = d
        return workrecords_list_post_request_data_item_attributes
