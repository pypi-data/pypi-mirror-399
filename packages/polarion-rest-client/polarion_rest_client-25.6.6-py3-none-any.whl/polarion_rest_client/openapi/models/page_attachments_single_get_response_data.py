...
class PageAttachmentsSingleGetResponseData:
    ...
    attributes: Union[Unset, "PageAttachmentsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "PageAttachmentsSingleGetResponseDataRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = PageAttachmentsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = PageAttachmentsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
