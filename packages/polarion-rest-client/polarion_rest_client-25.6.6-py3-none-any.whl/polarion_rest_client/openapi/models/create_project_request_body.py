...
class CreateProjectRequestBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        def _parse_params(
            ...
            try:
                if not isinstance(data, dict):
                    raise TypeError()
                params_type_0 = CreateProjectRequestBodyParamsType0.from_dict(data)

                return params_type_0
            except:  # noqa: E722
                pass
            return cast(Union["CreateProjectRequestBodyParamsType0", None, Unset], data)

        params = _parse_params(d.pop("params", UNSET))

        create_project_request_body = cls(
        ...
        create_project_request_body.additional_properties = d
        return create_project_request_body
