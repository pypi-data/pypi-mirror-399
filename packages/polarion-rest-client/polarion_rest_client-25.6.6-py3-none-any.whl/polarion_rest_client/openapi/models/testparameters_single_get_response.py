...
class TestparametersSingleGetResponse:
    ...
    included: Union[Unset, list["TestparametersSingleGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for included_item_data in _included or []:
            included_item = TestparametersSingleGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        testparameters_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        testparameters_single_get_response.additional_properties = d
        return testparameters_single_get_response
