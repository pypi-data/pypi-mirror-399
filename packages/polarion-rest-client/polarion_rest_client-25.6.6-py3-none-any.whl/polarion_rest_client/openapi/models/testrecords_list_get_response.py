...
class TestrecordsListGetResponse:
    ...
    included: Union[Unset, list["TestrecordsListGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TestrecordsListGetResponseDataItem.from_dict(data_item_data)
        ...
        testrecords_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        testrecords_list_get_response.additional_properties = d
        return testrecords_list_get_response
