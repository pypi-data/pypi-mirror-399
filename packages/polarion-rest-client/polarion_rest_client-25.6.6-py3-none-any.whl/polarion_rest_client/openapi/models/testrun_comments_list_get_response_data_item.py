...
class TestrunCommentsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "TestrunCommentsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunCommentsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TestrunCommentsListGetResponseDataItemLinks.from_dict(_links)

        testrun_comments_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testrun_comments_list_get_response_data_item.additional_properties = d
        return testrun_comments_list_get_response_data_item
