...
class DocumentsSinglePostResponseData:
    ...
    attributes: Union[Unset, "DocumentsSinglePostResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "DocumentsSinglePostResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = DocumentsSinglePostResponseDataRelationships.from_dict(
                _relationships
            )
