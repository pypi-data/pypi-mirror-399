...
class TestrecordsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "TestrecordsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "TestrecordsListPostRequestDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrecordsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrecordsListPostRequestDataItemRelationships.from_dict(
                _relationships
            )

        testrecords_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        testrecords_list_post_request_data_item.additional_properties = d
        return testrecords_list_post_request_data_item
