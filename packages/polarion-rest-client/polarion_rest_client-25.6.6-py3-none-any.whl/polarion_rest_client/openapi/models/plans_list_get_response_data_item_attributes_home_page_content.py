...
class PlansListGetResponseDataItemAttributesHomePageContent:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PlansListGetResponseDataItemAttributesHomePageContentType(_type_)

        value = d.pop("value", UNSET)

        plans_list_get_response_data_item_attributes_home_page_content = cls(
            type_=type_,
            value=value,
        )

        plans_list_get_response_data_item_attributes_home_page_content.additional_properties = d
        return plans_list_get_response_data_item_attributes_home_page_content
