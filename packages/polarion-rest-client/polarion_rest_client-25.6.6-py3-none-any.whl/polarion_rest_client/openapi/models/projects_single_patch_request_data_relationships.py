...
class ProjectsSinglePatchRequestDataRelationships:
    ...
    lead: Union[Unset, "ProjectsSinglePatchRequestDataRelationshipsLead"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_lead, Unset):
            ...
            lead = ProjectsSinglePatchRequestDataRelationshipsLead.from_dict(_lead)

        projects_single_patch_request_data_relationships = cls(
            lead=lead,
        )

        projects_single_patch_request_data_relationships.additional_properties = d
        return projects_single_patch_request_data_relationships
