...
class PlansListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_calculation_type, Unset):
            ...
            calculation_type = PlansListGetResponseDataItemAttributesCalculationType(
                _calculation_type
            )
        ...
        if isinstance(_description, Unset):
            ...
            description = PlansListGetResponseDataItemAttributesDescription.from_dict(
                _description
            )
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                PlansListGetResponseDataItemAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        plans_list_get_response_data_item_attributes = cls(
        ...
        plans_list_get_response_data_item_attributes.additional_properties = d
        return plans_list_get_response_data_item_attributes
