...
class PlansSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_calculation_type, Unset):
            ...
            calculation_type = PlansSinglePatchRequestDataAttributesCalculationType(
                _calculation_type
            )
        ...
        if isinstance(_description, Unset):
            ...
            description = PlansSinglePatchRequestDataAttributesDescription.from_dict(
                _description
            )
        ...
        plans_single_patch_request_data_attributes = cls(
        ...
        plans_single_patch_request_data_attributes.additional_properties = d
        return plans_single_patch_request_data_attributes
