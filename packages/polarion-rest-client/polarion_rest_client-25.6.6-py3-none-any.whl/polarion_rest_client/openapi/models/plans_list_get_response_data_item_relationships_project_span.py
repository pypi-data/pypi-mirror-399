...
class PlansListGetResponseDataItemRelationshipsProjectSpan:
    ...
    data: Union[
        Unset, list["PlansListGetResponseDataItemRelationshipsProjectSpanDataItem"]
    ] = UNSET
    meta: Union[Unset, "PlansListGetResponseDataItemRelationshipsProjectSpanMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                PlansListGetResponseDataItemRelationshipsProjectSpanDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        plans_list_get_response_data_item_relationships_project_span = cls(
            data=data,
            meta=meta,
        )

        plans_list_get_response_data_item_relationships_project_span.additional_properties = d
        return plans_list_get_response_data_item_relationships_project_span
