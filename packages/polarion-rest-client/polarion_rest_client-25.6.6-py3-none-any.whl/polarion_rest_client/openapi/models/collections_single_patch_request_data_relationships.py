...
class CollectionsSinglePatchRequestDataRelationships:
    ...
    upstream_collections: Union[
        Unset, "CollectionsSinglePatchRequestDataRelationshipsUpstreamCollections"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_documents, Unset):
            ...
            documents = (
                CollectionsSinglePatchRequestDataRelationshipsDocuments.from_dict(
                    _documents
                )
            )
        ...
        if isinstance(_rich_pages, Unset):
            ...
            rich_pages = (
                CollectionsSinglePatchRequestDataRelationshipsRichPages.from_dict(
                    _rich_pages
                )
            )
        ...
        collections_single_patch_request_data_relationships = cls(
            documents=documents,
            rich_pages=rich_pages,
            upstream_collections=upstream_collections,
        )

        collections_single_patch_request_data_relationships.additional_properties = d
        return collections_single_patch_request_data_relationships
