...
class TeststepResultsSinglePatchRequestData:
    ...
    attributes: Union[Unset, "TeststepResultsSinglePatchRequestDataAttributes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TeststepResultsSinglePatchRequestDataAttributes.from_dict(
                _attributes
            )

        teststep_results_single_patch_request_data = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        teststep_results_single_patch_request_data.additional_properties = d
        return teststep_results_single_patch_request_data
