...
class DocumentPartsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_next_part, Unset):
            ...
            next_part = (
                DocumentPartsListGetResponseDataItemRelationshipsNextPart.from_dict(
                    _next_part
                )
            )
        ...
        if isinstance(_previous_part, Unset):
            ...
            previous_part = (
                DocumentPartsListGetResponseDataItemRelationshipsPreviousPart.from_dict(
                    _previous_part
                )
            )
        ...
        if isinstance(_work_item, Unset):
            ...
            work_item = (
                DocumentPartsListGetResponseDataItemRelationshipsWorkItem.from_dict(
                    _work_item
                )
            )
        ...
        document_parts_list_get_response_data_item_relationships.additional_properties = d
