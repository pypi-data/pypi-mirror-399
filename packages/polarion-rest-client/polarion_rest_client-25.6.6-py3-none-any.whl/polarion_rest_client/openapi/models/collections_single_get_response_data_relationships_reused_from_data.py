...
T = TypeVar("T", bound="CollectionsSingleGetResponseDataRelationshipsReusedFromData")
...
class CollectionsSingleGetResponseDataRelationshipsReusedFromData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_get_response_data_relationships_reused_from_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        )

        collections_single_get_response_data_relationships_reused_from_data.additional_properties = d
        return collections_single_get_response_data_relationships_reused_from_data
