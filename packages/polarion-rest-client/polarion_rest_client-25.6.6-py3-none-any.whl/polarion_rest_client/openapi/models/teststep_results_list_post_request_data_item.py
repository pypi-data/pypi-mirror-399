...
class TeststepResultsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "TeststepResultsListPostRequestDataItemAttributes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TeststepResultsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )

        teststep_results_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
        )

        teststep_results_list_post_request_data_item.additional_properties = d
        return teststep_results_list_post_request_data_item
