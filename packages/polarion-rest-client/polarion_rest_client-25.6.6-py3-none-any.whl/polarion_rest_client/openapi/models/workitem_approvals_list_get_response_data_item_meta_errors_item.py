...
T = TypeVar("T", bound="WorkitemApprovalsListGetResponseDataItemMetaErrorsItem")
...
class WorkitemApprovalsListGetResponseDataItemMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                WorkitemApprovalsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                    _source
                )
            )

        workitem_approvals_list_get_response_data_item_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        workitem_approvals_list_get_response_data_item_meta_errors_item.additional_properties = d
        return workitem_approvals_list_get_response_data_item_meta_errors_item
