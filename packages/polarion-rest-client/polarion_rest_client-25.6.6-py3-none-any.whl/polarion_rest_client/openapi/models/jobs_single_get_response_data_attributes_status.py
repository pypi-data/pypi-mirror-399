...
class JobsSingleGetResponseDataAttributesStatus:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_single_get_response_data_attributes_status = cls(
            type_=type_,
            message=message,
        )

        jobs_single_get_response_data_attributes_status.additional_properties = d
        return jobs_single_get_response_data_attributes_status
