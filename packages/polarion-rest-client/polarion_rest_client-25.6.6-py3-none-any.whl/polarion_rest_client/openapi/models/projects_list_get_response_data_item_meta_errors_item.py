...
class ProjectsListGetResponseDataItemMetaErrorsItem:
    ...
    source: Union[Unset, "ProjectsListGetResponseDataItemMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = ProjectsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        projects_list_get_response_data_item_meta_errors_item.additional_properties = d
