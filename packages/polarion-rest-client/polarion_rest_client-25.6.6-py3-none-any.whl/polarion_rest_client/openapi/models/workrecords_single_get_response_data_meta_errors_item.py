...
class WorkrecordsSingleGetResponseDataMetaErrorsItem:
    ...
    source: Union[Unset, "WorkrecordsSingleGetResponseDataMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = WorkrecordsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                _source
            )

        workrecords_single_get_response_data_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        workrecords_single_get_response_data_meta_errors_item.additional_properties = d
        return workrecords_single_get_response_data_meta_errors_item
