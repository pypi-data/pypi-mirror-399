...
T = TypeVar("T", bound="WorkitemsListPostRequestDataItemRelationshipsModuleData")
...
class WorkitemsListPostRequestDataItemRelationshipsModuleData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListPostRequestDataItemRelationshipsModuleDataType(_type_)
        ...
        workitems_list_post_request_data_item_relationships_module_data.additional_properties = d
