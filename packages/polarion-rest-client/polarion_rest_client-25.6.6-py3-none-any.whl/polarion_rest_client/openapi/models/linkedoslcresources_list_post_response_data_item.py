...
class LinkedoslcresourcesListPostResponseDataItem:
    ...
    type_: Union[Unset, LinkedoslcresourcesListPostResponseDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = LinkedoslcresourcesListPostResponseDataItemLinks.from_dict(_links)

        linkedoslcresources_list_post_response_data_item = cls(
            type_=type_,
            id=id,
            links=links,
        )

        linkedoslcresources_list_post_response_data_item.additional_properties = d
        return linkedoslcresources_list_post_response_data_item
