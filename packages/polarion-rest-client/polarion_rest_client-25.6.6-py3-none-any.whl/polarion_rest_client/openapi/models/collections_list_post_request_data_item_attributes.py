...
class CollectionsListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                CollectionsListPostRequestDataItemAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        collections_list_post_request_data_item_attributes = cls(
            description=description,
            id=id,
            name=name,
        )

        collections_list_post_request_data_item_attributes.additional_properties = d
        return collections_list_post_request_data_item_attributes
