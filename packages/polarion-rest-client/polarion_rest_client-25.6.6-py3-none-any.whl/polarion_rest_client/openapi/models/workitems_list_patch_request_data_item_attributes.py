...
class WorkitemsListPatchRequestDataItemAttributes:
    ...
    hyperlinks: Union[
        Unset, list["WorkitemsListPatchRequestDataItemAttributesHyperlinksItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                WorkitemsListPatchRequestDataItemAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        for hyperlinks_item_data in _hyperlinks or []:
            hyperlinks_item = (
                WorkitemsListPatchRequestDataItemAttributesHyperlinksItem.from_dict(
        ...
        workitems_list_patch_request_data_item_attributes = cls(
        ...
        workitems_list_patch_request_data_item_attributes.additional_properties = d
        return workitems_list_patch_request_data_item_attributes
