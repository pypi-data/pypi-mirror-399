...
class WorkflowActionsActionResponseBodyLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workflow_actions_action_response_body_links = cls(
            first=first,
            prev=prev,
            next_=next_,
            last=last,
        ...
        workflow_actions_action_response_body_links.additional_properties = d
        return workflow_actions_action_response_body_links
