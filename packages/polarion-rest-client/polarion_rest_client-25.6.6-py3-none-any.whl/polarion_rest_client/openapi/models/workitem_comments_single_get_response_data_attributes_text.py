...
class WorkitemCommentsSingleGetResponseDataAttributesText:
    ...
    type_: Union[Unset, WorkitemCommentsSingleGetResponseDataAttributesTextType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemCommentsSingleGetResponseDataAttributesTextType(_type_)
        ...
        workitem_comments_single_get_response_data_attributes_text.additional_properties = d
