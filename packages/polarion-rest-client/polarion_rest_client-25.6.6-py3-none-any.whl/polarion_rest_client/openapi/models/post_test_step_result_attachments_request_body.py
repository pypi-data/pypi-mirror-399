...
class PostTestStepResultAttachmentsRequestBody:
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        files: Union[Unset, list[FileTypes]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = TeststepresultAttachmentsListPostRequest.from_dict(_resource)
        ...
        post_test_step_result_attachments_request_body = cls(
            resource=resource,
            files=files,
        )

        post_test_step_result_attachments_request_body.additional_properties = d
        return post_test_step_result_attachments_request_body
