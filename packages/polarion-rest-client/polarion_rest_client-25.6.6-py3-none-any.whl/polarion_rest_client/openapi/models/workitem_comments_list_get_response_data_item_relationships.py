...
class WorkitemCommentsListGetResponseDataItemRelationships:
    ...
    child_comments: Union[
        Unset, "WorkitemCommentsListGetResponseDataItemRelationshipsChildComments"
    ] = UNSET
    parent_comment: Union[
        Unset, "WorkitemCommentsListGetResponseDataItemRelationshipsParentComment"
    ] = UNSET
    project: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                WorkitemCommentsListGetResponseDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                WorkitemCommentsListGetResponseDataItemRelationshipsProject.from_dict(
                    _project
                )
            )
        ...
        workitem_comments_list_get_response_data_item_relationships.additional_properties = d
