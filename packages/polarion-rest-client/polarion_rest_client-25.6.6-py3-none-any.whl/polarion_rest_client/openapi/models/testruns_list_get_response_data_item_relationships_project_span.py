...
T = TypeVar("T", bound="TestrunsListGetResponseDataItemRelationshipsProjectSpan")
...
class TestrunsListGetResponseDataItemRelationshipsProjectSpan:
    ...
    data: Union[
        Unset, list["TestrunsListGetResponseDataItemRelationshipsProjectSpanDataItem"]
    ] = UNSET
    meta: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = (
                TestrunsListGetResponseDataItemRelationshipsProjectSpanMeta.from_dict(
                    _meta
                )
            )

        testruns_list_get_response_data_item_relationships_project_span = cls(
            data=data,
            meta=meta,
        )

        testruns_list_get_response_data_item_relationships_project_span.additional_properties = d
        return testruns_list_get_response_data_item_relationships_project_span
