...
class TestrecordAttachmentsSinglePatchRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_single_patch_request = cls(
            data=data,
        )

        testrecord_attachments_single_patch_request.additional_properties = d
        return testrecord_attachments_single_patch_request
