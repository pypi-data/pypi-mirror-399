...
T = TypeVar("T", bound="ExternallylinkedworkitemsSingleGetResponseDataAttributes")
...
class ExternallylinkedworkitemsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        externallylinkedworkitems_single_get_response_data_attributes = cls(
            role=role,
            work_item_uri=work_item_uri,
        )

        externallylinkedworkitems_single_get_response_data_attributes.additional_properties = d
        return externallylinkedworkitems_single_get_response_data_attributes
