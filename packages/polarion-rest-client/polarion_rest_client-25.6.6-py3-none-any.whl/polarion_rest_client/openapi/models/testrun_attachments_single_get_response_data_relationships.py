...
class TestrunAttachmentsSingleGetResponseDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                TestrunAttachmentsSingleGetResponseDataRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                TestrunAttachmentsSingleGetResponseDataRelationshipsProject.from_dict(
                    _project
                )
            )

        testrun_attachments_single_get_response_data_relationships = cls(
            author=author,
            project=project,
        )

        testrun_attachments_single_get_response_data_relationships.additional_properties = d
        return testrun_attachments_single_get_response_data_relationships
