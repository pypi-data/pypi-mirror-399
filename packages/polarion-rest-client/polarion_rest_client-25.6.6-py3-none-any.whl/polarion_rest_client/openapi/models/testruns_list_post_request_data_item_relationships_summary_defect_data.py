...
T = TypeVar("T", bound="TestrunsListPostRequestDataItemRelationshipsSummaryDefectData")
...
class TestrunsListPostRequestDataItemRelationshipsSummaryDefectData:
    ...
    type_: Union[
        Unset, TestrunsListPostRequestDataItemRelationshipsSummaryDefectDataType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_list_post_request_data_item_relationships_summary_defect_data = cls(
            type_=type_,
            id=id,
        )

        testruns_list_post_request_data_item_relationships_summary_defect_data.additional_properties = d
        return testruns_list_post_request_data_item_relationships_summary_defect_data
