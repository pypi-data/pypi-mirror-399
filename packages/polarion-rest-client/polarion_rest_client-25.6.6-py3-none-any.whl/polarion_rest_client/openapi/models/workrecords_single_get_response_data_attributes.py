...
class WorkrecordsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workrecords_single_get_response_data_attributes = cls(
            comment=comment,
            date=date,
            id=id,
        ...
        workrecords_single_get_response_data_attributes.additional_properties = d
        return workrecords_single_get_response_data_attributes
