...
T = TypeVar(
    "T", bound="CollectionsSingleGetResponseDataRelationshipsUpstreamCollections"
)
...
class CollectionsSingleGetResponseDataRelationshipsUpstreamCollections:
    ...
    meta: Union[
        Unset, "CollectionsSingleGetResponseDataRelationshipsUpstreamCollectionsMeta"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_single_get_response_data_relationships_upstream_collections = cls(
            data=data,
            meta=meta,
        )

        collections_single_get_response_data_relationships_upstream_collections.additional_properties = d
        return collections_single_get_response_data_relationships_upstream_collections
