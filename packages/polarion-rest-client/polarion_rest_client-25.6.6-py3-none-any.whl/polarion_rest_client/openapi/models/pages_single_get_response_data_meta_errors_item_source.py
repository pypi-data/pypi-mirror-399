...
class PagesSingleGetResponseDataMetaErrorsItemSource:
    ...
    resource: Union[Unset, "PagesSingleGetResponseDataMetaErrorsItemSourceResource"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        pages_single_get_response_data_meta_errors_item_source.additional_properties = d
