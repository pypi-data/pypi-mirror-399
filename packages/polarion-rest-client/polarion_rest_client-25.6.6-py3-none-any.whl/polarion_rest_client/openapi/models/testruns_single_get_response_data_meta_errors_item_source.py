...
class TestrunsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = (
                TestrunsSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                    _resource
                )
            )

        testruns_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        testruns_single_get_response_data_meta_errors_item_source.additional_properties = d
        return testruns_single_get_response_data_meta_errors_item_source
