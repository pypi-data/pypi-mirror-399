...
class TeststepResultsListPatchRequestDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TeststepResultsListPatchRequestDataItemAttributes.from_dict(
                _attributes
            )

        teststep_results_list_patch_request_data_item = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        teststep_results_list_patch_request_data_item.additional_properties = d
        return teststep_results_list_patch_request_data_item
