...
class WorkitemApprovalsListPatchRequestDataItemAttributes:
    ...
    status: Union[Unset, WorkitemApprovalsListPatchRequestDataItemAttributesStatus] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = WorkitemApprovalsListPatchRequestDataItemAttributesStatus(_status)

        workitem_approvals_list_patch_request_data_item_attributes = cls(
            status=status,
        )

        workitem_approvals_list_patch_request_data_item_attributes.additional_properties = d
        return workitem_approvals_list_patch_request_data_item_attributes
