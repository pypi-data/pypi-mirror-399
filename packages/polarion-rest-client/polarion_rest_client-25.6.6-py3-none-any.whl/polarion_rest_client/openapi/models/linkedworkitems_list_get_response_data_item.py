...
class LinkedworkitemsListGetResponseDataItem:
    ...
    attributes: Union[Unset, "LinkedworkitemsListGetResponseDataItemAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = LinkedworkitemsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = LinkedworkitemsListGetResponseDataItemLinks.from_dict(_links)
