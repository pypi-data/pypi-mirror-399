...
class PagesSingleGetResponseDataRelationshipsProjectData:
    ...
    type_: Union[Unset, PagesSingleGetResponseDataRelationshipsProjectDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = PagesSingleGetResponseDataRelationshipsProjectDataType(_type_)
        ...
        pages_single_get_response_data_relationships_project_data.additional_properties = d
