...
class TestrecordAttachmentsListGetResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_list_get_response_links = cls(
            self_=self_,
            first=first,
            prev=prev,
            next_=next_,
        ...
        testrecord_attachments_list_get_response_links.additional_properties = d
        return testrecord_attachments_list_get_response_links
