...
class UsersListPostRequestDataItemRelationshipsProjectRoles:
    ...
    data: Union[
        Unset, list["UsersListPostRequestDataItemRelationshipsProjectRolesDataItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                UsersListPostRequestDataItemRelationshipsProjectRolesDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        users_list_post_request_data_item_relationships_project_roles.additional_properties = d
