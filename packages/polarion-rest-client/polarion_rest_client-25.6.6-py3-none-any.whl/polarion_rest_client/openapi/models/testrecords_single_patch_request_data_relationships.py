...
class TestrecordsSinglePatchRequestDataRelationships:
    ...
    defect: Union[Unset, "TestrecordsSinglePatchRequestDataRelationshipsDefect"] = UNSET
    executed_by: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_defect, Unset):
            ...
            defect = TestrecordsSinglePatchRequestDataRelationshipsDefect.from_dict(
                _defect
            )
        ...
        if isinstance(_executed_by, Unset):
            ...
            executed_by = (
                TestrecordsSinglePatchRequestDataRelationshipsExecutedBy.from_dict(
                    _executed_by
                )
            )

        testrecords_single_patch_request_data_relationships = cls(
            defect=defect,
            executed_by=executed_by,
        )

        testrecords_single_patch_request_data_relationships.additional_properties = d
        return testrecords_single_patch_request_data_relationships
