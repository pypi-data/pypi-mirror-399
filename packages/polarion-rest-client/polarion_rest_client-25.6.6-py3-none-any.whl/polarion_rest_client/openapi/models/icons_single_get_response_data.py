...
from ..models.icons_single_get_response_data_type import IconsSingleGetResponseDataType
...
class IconsSingleGetResponseData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = IconsSingleGetResponseDataAttributes.from_dict(_attributes)
