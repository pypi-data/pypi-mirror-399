...
class LinkedworkitemsSingleGetResponseData:
    ...
    attributes: Union[Unset, "LinkedworkitemsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "LinkedworkitemsSingleGetResponseDataRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = LinkedworkitemsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = LinkedworkitemsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
