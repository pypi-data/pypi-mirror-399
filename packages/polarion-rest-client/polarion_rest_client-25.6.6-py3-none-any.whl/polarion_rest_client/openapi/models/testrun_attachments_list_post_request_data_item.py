...
class TestrunAttachmentsListPostRequestDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunAttachmentsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )

        testrun_attachments_list_post_request_data_item = cls(
            type_=type_,
            lid=lid,
            attributes=attributes,
        )

        testrun_attachments_list_post_request_data_item.additional_properties = d
        return testrun_attachments_list_post_request_data_item
