...
class TeststepResultsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststep_results_single_patch_request_data_attributes = cls(
            comment=comment,
            result=result,
        )

        teststep_results_single_patch_request_data_attributes.additional_properties = d
        return teststep_results_single_patch_request_data_attributes
