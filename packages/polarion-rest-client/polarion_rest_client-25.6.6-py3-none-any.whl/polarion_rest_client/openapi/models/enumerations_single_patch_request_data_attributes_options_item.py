...
T = TypeVar("T", bound="EnumerationsSinglePatchRequestDataAttributesOptionsItem")
...
class EnumerationsSinglePatchRequestDataAttributesOptionsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        enumerations_single_patch_request_data_attributes_options_item.additional_properties = d
