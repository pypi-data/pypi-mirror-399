...
class LinkedworkitemsListPostRequestDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_work_item, Unset):
            ...
            work_item = (
                LinkedworkitemsListPostRequestDataItemRelationshipsWorkItem.from_dict(
                    _work_item
                )
            )
        ...
        linkedworkitems_list_post_request_data_item_relationships.additional_properties = d
