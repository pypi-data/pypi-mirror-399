...
class TeststepsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_list_get_response_data_item_attributes = cls(
            index=index,
            keys=keys,
            values=values,
        )

        teststeps_list_get_response_data_item_attributes.additional_properties = d
        return teststeps_list_get_response_data_item_attributes
