...
T = TypeVar("T", bound="ExternallylinkedworkitemsListGetResponseDataItemAttributes")
...
class ExternallylinkedworkitemsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        externallylinkedworkitems_list_get_response_data_item_attributes = cls(
            role=role,
            work_item_uri=work_item_uri,
        )

        externallylinkedworkitems_list_get_response_data_item_attributes.additional_properties = d
        return externallylinkedworkitems_list_get_response_data_item_attributes
