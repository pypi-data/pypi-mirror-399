...
class CollectionsListPostRequestDataItemRelationships:
    ...
    upstream_collections: Union[
        Unset, "CollectionsListPostRequestDataItemRelationshipsUpstreamCollections"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_documents, Unset):
            ...
            documents = (
                CollectionsListPostRequestDataItemRelationshipsDocuments.from_dict(
                    _documents
                )
            )
        ...
        if isinstance(_rich_pages, Unset):
            ...
            rich_pages = (
                CollectionsListPostRequestDataItemRelationshipsRichPages.from_dict(
                    _rich_pages
                )
            )
        ...
        collections_list_post_request_data_item_relationships = cls(
            documents=documents,
            rich_pages=rich_pages,
            upstream_collections=upstream_collections,
        )

        collections_list_post_request_data_item_relationships.additional_properties = d
        return collections_list_post_request_data_item_relationships
