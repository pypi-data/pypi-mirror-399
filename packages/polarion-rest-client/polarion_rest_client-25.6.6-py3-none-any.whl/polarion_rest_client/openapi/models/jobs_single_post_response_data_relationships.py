...
class JobsSinglePostResponseDataRelationships:
    ...
    document: Union[Unset, "JobsSinglePostResponseDataRelationshipsDocument"] = UNSET
    documents: Union[Unset, "JobsSinglePostResponseDataRelationshipsDocuments"] = UNSET
    project: Union[Unset, "JobsSinglePostResponseDataRelationshipsProject"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document, Unset):
            ...
            document = JobsSinglePostResponseDataRelationshipsDocument.from_dict(
                _document
            )
        ...
        if isinstance(_documents, Unset):
            ...
            documents = JobsSinglePostResponseDataRelationshipsDocuments.from_dict(
                _documents
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = JobsSinglePostResponseDataRelationshipsProject.from_dict(_project)

        jobs_single_post_response_data_relationships = cls(
            document=document,
            documents=documents,
            project=project,
        )

        jobs_single_post_response_data_relationships.additional_properties = d
        return jobs_single_post_response_data_relationships
