...
class ProjectsSingleGetResponseData:
    ...
    relationships: Union[Unset, "ProjectsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = ProjectsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = ProjectsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
