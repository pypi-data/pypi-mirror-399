...
class TeststepsListGetResponseDataItemMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = (
                TeststepsListGetResponseDataItemMetaErrorsItemSourceResource.from_dict(
                    _resource
                )
            )

        teststeps_list_get_response_data_item_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        teststeps_list_get_response_data_item_meta_errors_item_source.additional_properties = d
        return teststeps_list_get_response_data_item_meta_errors_item_source
