...
class TestrecordsListPostResponseDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_list_post_response_data_item = cls(
            type_=type_,
            id=id,
            links=links,
        )

        testrecords_list_post_response_data_item.additional_properties = d
        return testrecords_list_post_response_data_item
