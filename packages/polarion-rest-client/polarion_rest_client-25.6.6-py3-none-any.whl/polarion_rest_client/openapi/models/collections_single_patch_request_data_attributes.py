...
class CollectionsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                CollectionsSinglePatchRequestDataAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        collections_single_patch_request_data_attributes = cls(
            description=description,
            name=name,
        )

        collections_single_patch_request_data_attributes.additional_properties = d
        return collections_single_patch_request_data_attributes
