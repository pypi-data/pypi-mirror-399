...
class DocumentPartsListPostRequestDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_next_part, Unset):
            ...
            next_part = (
                DocumentPartsListPostRequestDataItemRelationshipsNextPart.from_dict(
                    _next_part
                )
            )
        ...
        if isinstance(_previous_part, Unset):
            ...
            previous_part = (
                DocumentPartsListPostRequestDataItemRelationshipsPreviousPart.from_dict(
                    _previous_part
                )
            )
        ...
        if isinstance(_work_item, Unset):
            ...
            work_item = (
                DocumentPartsListPostRequestDataItemRelationshipsWorkItem.from_dict(
                    _work_item
                )
            )
        ...
        document_parts_list_post_request_data_item_relationships.additional_properties = d
