...
class DocumentsSinglePatchRequestDataAttributes:
    ...
    rendering_layouts: Union[
        Unset, list["DocumentsSinglePatchRequestDataAttributesRenderingLayoutsItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                DocumentsSinglePatchRequestDataAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        if isinstance(_outline_numbering, Unset):
            ...
            outline_numbering = (
                DocumentsSinglePatchRequestDataAttributesOutlineNumbering.from_dict(
                    _outline_numbering
                )
            )
        ...
        for rendering_layouts_item_data in _rendering_layouts or []:
            rendering_layouts_item = (
                DocumentsSinglePatchRequestDataAttributesRenderingLayoutsItem.from_dict(
        ...
        documents_single_patch_request_data_attributes.additional_properties = d
