...
T = TypeVar("T", bound="WorkitemsSingleGetResponseDataRelationshipsLinkedRevisions")
...
class WorkitemsSingleGetResponseDataRelationshipsLinkedRevisions:
    ...
    data: Union[
        Unset,
        list["WorkitemsSingleGetResponseDataRelationshipsLinkedRevisionsDataItem"],
    ] = UNSET
    meta: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_linked_revisions = cls(
            data=data,
            meta=meta,
        )

        workitems_single_get_response_data_relationships_linked_revisions.additional_properties = d
        return workitems_single_get_response_data_relationships_linked_revisions
