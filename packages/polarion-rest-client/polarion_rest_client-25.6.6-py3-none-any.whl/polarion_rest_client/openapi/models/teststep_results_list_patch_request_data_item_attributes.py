...
class TeststepResultsListPatchRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = (
                TeststepResultsListPatchRequestDataItemAttributesComment.from_dict(
                    _comment
                )
            )
        ...
        teststep_results_list_patch_request_data_item_attributes = cls(
            comment=comment,
            result=result,
        )

        teststep_results_list_patch_request_data_item_attributes.additional_properties = d
        return teststep_results_list_patch_request_data_item_attributes
