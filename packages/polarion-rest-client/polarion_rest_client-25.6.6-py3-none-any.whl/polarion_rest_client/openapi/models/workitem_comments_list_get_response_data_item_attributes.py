...
class WorkitemCommentsListGetResponseDataItemAttributes:
    ...
    text: Union[Unset, "WorkitemCommentsListGetResponseDataItemAttributesText"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_list_get_response_data_item_attributes.additional_properties = d
