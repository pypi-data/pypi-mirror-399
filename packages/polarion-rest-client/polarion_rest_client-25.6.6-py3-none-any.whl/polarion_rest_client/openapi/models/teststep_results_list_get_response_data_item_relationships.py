...
class TeststepResultsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_test_step, Unset):
            ...
            test_step = (
                TeststepResultsListGetResponseDataItemRelationshipsTestStep.from_dict(
                    _test_step
                )
            )

        teststep_results_list_get_response_data_item_relationships = cls(
            test_step=test_step,
        )

        teststep_results_list_get_response_data_item_relationships.additional_properties = d
        return teststep_results_list_get_response_data_item_relationships
