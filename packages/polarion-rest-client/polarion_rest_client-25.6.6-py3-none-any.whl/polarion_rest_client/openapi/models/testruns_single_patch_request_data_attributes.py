...
class TestrunsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                TestrunsSinglePatchRequestDataAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        testruns_single_patch_request_data_attributes = cls(
        ...
        testruns_single_patch_request_data_attributes.additional_properties = d
        return testruns_single_patch_request_data_attributes
