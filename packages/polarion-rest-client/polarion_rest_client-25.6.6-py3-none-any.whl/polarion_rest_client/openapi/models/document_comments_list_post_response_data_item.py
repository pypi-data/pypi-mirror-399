...
class DocumentCommentsListPostResponseDataItem:
    ...
    links: Union[Unset, "DocumentCommentsListPostResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = DocumentCommentsListPostResponseDataItemLinks.from_dict(_links)
        ...
        document_comments_list_post_response_data_item.additional_properties = d
