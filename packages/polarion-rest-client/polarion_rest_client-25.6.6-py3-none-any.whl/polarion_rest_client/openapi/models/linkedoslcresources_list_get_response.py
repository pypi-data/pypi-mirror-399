...
class LinkedoslcresourcesListGetResponse:
    ...
    data: Union[Unset, list["LinkedoslcresourcesListGetResponseDataItem"]] = UNSET
    included: Union[Unset, list["LinkedoslcresourcesListGetResponseIncludedItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for included_item_data in _included or []:
            included_item = LinkedoslcresourcesListGetResponseIncludedItem.from_dict(
                included_item_data
            )

            included.append(included_item)

        linkedoslcresources_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
        )

        linkedoslcresources_list_get_response.additional_properties = d
        return linkedoslcresources_list_get_response
