...
class TeststepsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_single_get_response_data_attributes = cls(
            index=index,
            keys=keys,
            values=values,
        )

        teststeps_single_get_response_data_attributes.additional_properties = d
        return teststeps_single_get_response_data_attributes
