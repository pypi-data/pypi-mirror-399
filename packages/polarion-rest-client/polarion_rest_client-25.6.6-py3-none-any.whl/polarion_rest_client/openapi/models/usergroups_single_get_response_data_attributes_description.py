...
class UsergroupsSingleGetResponseDataAttributesDescription:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = UsergroupsSingleGetResponseDataAttributesDescriptionType(_type_)
        ...
        usergroups_single_get_response_data_attributes_description.additional_properties = d
