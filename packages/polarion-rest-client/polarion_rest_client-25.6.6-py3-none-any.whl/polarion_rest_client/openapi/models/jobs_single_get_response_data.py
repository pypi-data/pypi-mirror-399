...
from ..models.jobs_single_get_response_data_type import JobsSingleGetResponseDataType
...
class JobsSingleGetResponseData:
    ...
    relationships: Union[Unset, "JobsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = JobsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        jobs_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        jobs_single_get_response_data.additional_properties = d
        return jobs_single_get_response_data
