...
class TeststepsSingleGetResponse:
    ...
    included: Union[Unset, list["TeststepsSingleGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        teststeps_single_get_response.additional_properties = d
        return teststeps_single_get_response
