...
class UsersSingleGetResponseDataRelationshipsGlobalRoles:
    ...
    data: Union[
        Unset, list["UsersSingleGetResponseDataRelationshipsGlobalRolesDataItem"]
    ] = UNSET
    meta: Union[Unset, "UsersSingleGetResponseDataRelationshipsGlobalRolesMeta"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                UsersSingleGetResponseDataRelationshipsGlobalRolesDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        users_single_get_response_data_relationships_global_roles.additional_properties = d
