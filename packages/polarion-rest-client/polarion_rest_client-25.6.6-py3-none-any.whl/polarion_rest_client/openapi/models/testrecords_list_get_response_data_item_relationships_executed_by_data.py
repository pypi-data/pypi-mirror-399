...
T = TypeVar("T", bound="TestrecordsListGetResponseDataItemRelationshipsExecutedByData")
...
class TestrecordsListGetResponseDataItemRelationshipsExecutedByData:
    ...
    type_: Union[
        Unset, TestrecordsListGetResponseDataItemRelationshipsExecutedByDataType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_list_get_response_data_item_relationships_executed_by_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        )

        testrecords_list_get_response_data_item_relationships_executed_by_data.additional_properties = d
        return testrecords_list_get_response_data_item_relationships_executed_by_data
