...
class TeststepsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_single_patch_request_data_attributes = cls(
            keys=keys,
            values=values,
        )

        teststeps_single_patch_request_data_attributes.additional_properties = d
        return teststeps_single_patch_request_data_attributes
