...
class TestrunsListPatchRequestDataItem:
    ...
    attributes: Union[Unset, "TestrunsListPatchRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "TestrunsListPatchRequestDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrunsListPatchRequestDataItemRelationships.from_dict(
                _relationships
            )

        testruns_list_patch_request_data_item = cls(
            type_=type_,
            id=id,
        ...
        testruns_list_patch_request_data_item.additional_properties = d
        return testruns_list_patch_request_data_item
