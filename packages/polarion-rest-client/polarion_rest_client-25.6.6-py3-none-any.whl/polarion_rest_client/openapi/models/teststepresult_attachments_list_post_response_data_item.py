...
class TeststepresultAttachmentsListPostResponseDataItem:
    ...
    type_: Union[Unset, TeststepresultAttachmentsListPostResponseDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepresultAttachmentsListPostResponseDataItemType(_type_)
        ...
        teststepresult_attachments_list_post_response_data_item = cls(
            type_=type_,
            id=id,
            links=links,
        )

        teststepresult_attachments_list_post_response_data_item.additional_properties = d
        return teststepresult_attachments_list_post_response_data_item
