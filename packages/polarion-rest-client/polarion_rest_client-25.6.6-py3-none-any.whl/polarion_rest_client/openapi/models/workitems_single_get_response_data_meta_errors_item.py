...
class WorkitemsSingleGetResponseDataMetaErrorsItem:
    ...
    source: Union[Unset, "WorkitemsSingleGetResponseDataMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = WorkitemsSingleGetResponseDataMetaErrorsItemSource.from_dict(
                _source
            )
        ...
        workitems_single_get_response_data_meta_errors_item.additional_properties = d
