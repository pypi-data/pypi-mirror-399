...
class TestparametersListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testparameters_list_post_request_data_item_attributes = cls(
            name=name,
            value=value,
        )

        testparameters_list_post_request_data_item_attributes.additional_properties = d
        return testparameters_list_post_request_data_item_attributes
