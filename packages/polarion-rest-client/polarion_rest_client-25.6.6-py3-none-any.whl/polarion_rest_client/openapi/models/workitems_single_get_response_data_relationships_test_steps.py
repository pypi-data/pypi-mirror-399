...
class WorkitemsSingleGetResponseDataRelationshipsTestSteps:
    ...
    data: Union[
        Unset, list["WorkitemsSingleGetResponseDataRelationshipsTestStepsDataItem"]
    ] = UNSET
    meta: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsTestStepsMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                WorkitemsSingleGetResponseDataRelationshipsTestStepsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        workitems_single_get_response_data_relationships_test_steps = cls(
            data=data,
            meta=meta,
        )

        workitems_single_get_response_data_relationships_test_steps.additional_properties = d
        return workitems_single_get_response_data_relationships_test_steps
