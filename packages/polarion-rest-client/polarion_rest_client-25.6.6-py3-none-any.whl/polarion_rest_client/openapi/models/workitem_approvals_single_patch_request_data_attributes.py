...
class WorkitemApprovalsSinglePatchRequestDataAttributes:
    ...
    status: Union[Unset, WorkitemApprovalsSinglePatchRequestDataAttributesStatus] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_status, Unset):
            ...
            status = WorkitemApprovalsSinglePatchRequestDataAttributesStatus(_status)

        workitem_approvals_single_patch_request_data_attributes = cls(
            status=status,
        )

        workitem_approvals_single_patch_request_data_attributes.additional_properties = d
        return workitem_approvals_single_patch_request_data_attributes
