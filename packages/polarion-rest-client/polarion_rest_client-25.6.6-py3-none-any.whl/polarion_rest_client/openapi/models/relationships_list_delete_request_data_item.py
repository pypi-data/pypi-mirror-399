...
class RelationshipsListDeleteRequestDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        relationships_list_delete_request_data_item = cls(
            type_=type_,
            id=id,
        )

        relationships_list_delete_request_data_item.additional_properties = d
        return relationships_list_delete_request_data_item
