...
class TeststepresultAttachmentsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststepresult_attachments_single_get_response_data_links = cls(
            self_=self_,
            content=content,
        )

        teststepresult_attachments_single_get_response_data_links.additional_properties = d
        return teststepresult_attachments_single_get_response_data_links
