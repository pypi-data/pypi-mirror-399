...
class WorkitemCommentsListPostRequestDataItemAttributes:
    ...
    text: Union[Unset, "WorkitemCommentsListPostRequestDataItemAttributesText"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_comments_list_post_request_data_item_attributes.additional_properties = d
