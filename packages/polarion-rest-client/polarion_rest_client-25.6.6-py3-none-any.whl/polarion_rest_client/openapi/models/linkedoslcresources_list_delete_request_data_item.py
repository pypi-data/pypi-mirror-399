...
class LinkedoslcresourcesListDeleteRequestDataItem:
    ...
    type_: Union[Unset, LinkedoslcresourcesListDeleteRequestDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        linkedoslcresources_list_delete_request_data_item = cls(
            type_=type_,
            id=id,
        )

        linkedoslcresources_list_delete_request_data_item.additional_properties = d
        return linkedoslcresources_list_delete_request_data_item
