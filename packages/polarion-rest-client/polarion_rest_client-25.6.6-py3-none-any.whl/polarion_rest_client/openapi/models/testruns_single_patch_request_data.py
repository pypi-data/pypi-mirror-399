...
class TestrunsSinglePatchRequestData:
    ...
    attributes: Union[Unset, "TestrunsSinglePatchRequestDataAttributes"] = UNSET
    relationships: Union[Unset, "TestrunsSinglePatchRequestDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunsSinglePatchRequestDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestrunsSinglePatchRequestDataRelationships.from_dict(
                _relationships
            )

        testruns_single_patch_request_data = cls(
            type_=type_,
            id=id,
        ...
        testruns_single_patch_request_data.additional_properties = d
        return testruns_single_patch_request_data
