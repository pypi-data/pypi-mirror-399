...
class WorkrecordsListPostRequest:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = WorkrecordsListPostRequestDataItem.from_dict(data_item_data)

            data.append(data_item)

        workrecords_list_post_request = cls(
            data=data,
        )

        workrecords_list_post_request.additional_properties = d
        return workrecords_list_post_request
