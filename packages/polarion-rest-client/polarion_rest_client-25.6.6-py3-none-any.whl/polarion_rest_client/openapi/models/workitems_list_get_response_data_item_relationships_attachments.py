...
T = TypeVar("T", bound="WorkitemsListGetResponseDataItemRelationshipsAttachments")
...
class WorkitemsListGetResponseDataItemRelationshipsAttachments:
    ...
    data: Union[
        Unset, list["WorkitemsListGetResponseDataItemRelationshipsAttachmentsDataItem"]
    ] = UNSET
    meta: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = (
                WorkitemsListGetResponseDataItemRelationshipsAttachmentsMeta.from_dict(
                    _meta
                )
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = (
                WorkitemsListGetResponseDataItemRelationshipsAttachmentsLinks.from_dict(
                    _links
                )
            )
        ...
        workitems_list_get_response_data_item_relationships_attachments.additional_properties = d
