...
class CollectionsListDeleteRequestDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_delete_request_data_item = cls(
            type_=type_,
            id=id,
        )

        collections_list_delete_request_data_item.additional_properties = d
        return collections_list_delete_request_data_item
