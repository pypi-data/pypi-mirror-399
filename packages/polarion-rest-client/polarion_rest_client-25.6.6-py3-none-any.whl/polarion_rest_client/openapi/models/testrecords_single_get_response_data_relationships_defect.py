...
class TestrecordsSingleGetResponseDataRelationshipsDefect:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecords_single_get_response_data_relationships_defect = cls(
            data=data,
        )

        testrecords_single_get_response_data_relationships_defect.additional_properties = d
        return testrecords_single_get_response_data_relationships_defect
