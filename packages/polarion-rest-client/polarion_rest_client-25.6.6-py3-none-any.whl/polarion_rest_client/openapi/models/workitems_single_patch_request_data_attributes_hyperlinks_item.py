...
T = TypeVar("T", bound="WorkitemsSinglePatchRequestDataAttributesHyperlinksItem")
...
class WorkitemsSinglePatchRequestDataAttributesHyperlinksItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_patch_request_data_attributes_hyperlinks_item.additional_properties = d
