...
class TestparametersSingleGetResponseData:
    ...
    attributes: Union[Unset, "TestparametersSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "TestparametersSingleGetResponseDataRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestparametersSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TestparametersSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
        ...
        testparameters_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testparameters_single_get_response_data.additional_properties = d
        return testparameters_single_get_response_data
