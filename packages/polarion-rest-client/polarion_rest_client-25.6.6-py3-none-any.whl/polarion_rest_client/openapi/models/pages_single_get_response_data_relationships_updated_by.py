...
class PagesSingleGetResponseDataRelationshipsUpdatedBy:
    ...
    data: Union[Unset, "PagesSingleGetResponseDataRelationshipsUpdatedByData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = PagesSingleGetResponseDataRelationshipsUpdatedByData.from_dict(_data)

        pages_single_get_response_data_relationships_updated_by = cls(
            data=data,
        )

        pages_single_get_response_data_relationships_updated_by.additional_properties = d
