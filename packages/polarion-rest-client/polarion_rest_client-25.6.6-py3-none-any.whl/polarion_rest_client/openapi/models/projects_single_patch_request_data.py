...
class ProjectsSinglePatchRequestData:
    ...
    attributes: Union[Unset, "ProjectsSinglePatchRequestDataAttributes"] = UNSET
    relationships: Union[Unset, "ProjectsSinglePatchRequestDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = ProjectsSinglePatchRequestDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = ProjectsSinglePatchRequestDataRelationships.from_dict(
                _relationships
            )

        projects_single_patch_request_data = cls(
            type_=type_,
            id=id,
        ...
        projects_single_patch_request_data.additional_properties = d
        return projects_single_patch_request_data
