...
class FeatureselectionsListGetResponseDataItem:
    ...
    links: Union[Unset, "FeatureselectionsListGetResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = FeatureselectionsListGetResponseDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = (
                FeatureselectionsListGetResponseDataItemRelationships.from_dict(
                    _relationships
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = FeatureselectionsListGetResponseDataItemMeta.from_dict(_meta)
        ...
        if isinstance(_links, Unset):
            ...
            links = FeatureselectionsListGetResponseDataItemLinks.from_dict(_links)

        featureselections_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        featureselections_list_get_response_data_item.additional_properties = d
        return featureselections_list_get_response_data_item
