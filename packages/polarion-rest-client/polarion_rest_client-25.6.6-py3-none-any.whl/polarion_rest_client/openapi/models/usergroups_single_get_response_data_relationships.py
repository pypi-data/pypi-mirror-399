...
class UsergroupsSingleGetResponseDataRelationships:
    ...
    users: Union[Unset, "UsergroupsSingleGetResponseDataRelationshipsUsers"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_global_roles, Unset):
            ...
            global_roles = (
                UsergroupsSingleGetResponseDataRelationshipsGlobalRoles.from_dict(
                    _global_roles
                )
            )
        ...
        if isinstance(_project_roles, Unset):
            ...
            project_roles = (
                UsergroupsSingleGetResponseDataRelationshipsProjectRoles.from_dict(
                    _project_roles
                )
            )
        ...
        if isinstance(_users, Unset):
            ...
            users = UsergroupsSingleGetResponseDataRelationshipsUsers.from_dict(_users)
        ...
        usergroups_single_get_response_data_relationships.additional_properties = d
