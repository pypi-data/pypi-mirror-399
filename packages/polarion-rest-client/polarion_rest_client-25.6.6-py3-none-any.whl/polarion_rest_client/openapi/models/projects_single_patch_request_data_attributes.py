...
class ProjectsSinglePatchRequestDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = ProjectsSinglePatchRequestDataAttributesDescription.from_dict(
                _description
            )
        ...
        projects_single_patch_request_data_attributes = cls(
            active=active,
            color=color,
        ...
        projects_single_patch_request_data_attributes.additional_properties = d
        return projects_single_patch_request_data_attributes
