...
class DocumentsSinglePostResponseDataAttributes:
    ...
    rendering_layouts: Union[
        Unset, list["DocumentsSinglePostResponseDataAttributesRenderingLayoutsItem"]
    ] = UNSET
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.branched_with_initialized_fields, Unset):
            branched_with_initialized_fields = self.branched_with_initialized_fields
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                DocumentsSinglePostResponseDataAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        if isinstance(_outline_numbering, Unset):
            ...
            outline_numbering = (
                DocumentsSinglePostResponseDataAttributesOutlineNumbering.from_dict(
                    _outline_numbering
                )
            )
        ...
        for rendering_layouts_item_data in _rendering_layouts or []:
            rendering_layouts_item = (
                DocumentsSinglePostResponseDataAttributesRenderingLayoutsItem.from_dict(
        ...
        documents_single_post_response_data_attributes.additional_properties = d
