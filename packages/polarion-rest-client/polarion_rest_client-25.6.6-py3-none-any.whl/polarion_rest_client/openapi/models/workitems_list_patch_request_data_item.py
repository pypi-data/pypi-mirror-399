...
class WorkitemsListPatchRequestDataItem:
    ...
    attributes: Union[Unset, "WorkitemsListPatchRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "WorkitemsListPatchRequestDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkitemsListPatchRequestDataItemRelationships.from_dict(
                _relationships
            )

        workitems_list_patch_request_data_item = cls(
            type_=type_,
            id=id,
        ...
        workitems_list_patch_request_data_item.additional_properties = d
        return workitems_list_patch_request_data_item
