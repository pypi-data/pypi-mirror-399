...
class WorkitemsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "WorkitemsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "WorkitemsListPostRequestDataItemRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkitemsListPostRequestDataItemRelationships.from_dict(
                _relationships
            )
