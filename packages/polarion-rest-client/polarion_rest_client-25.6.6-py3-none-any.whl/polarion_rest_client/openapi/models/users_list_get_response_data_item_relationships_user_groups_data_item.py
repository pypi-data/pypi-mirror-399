...
T = TypeVar("T", bound="UsersListGetResponseDataItemRelationshipsUserGroupsDataItem")
...
class UsersListGetResponseDataItemRelationshipsUserGroupsDataItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        users_list_get_response_data_item_relationships_user_groups_data_item.additional_properties = d
