...
class RevisionsSingleGetResponseDataRelationshipsAuthorData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = RevisionsSingleGetResponseDataRelationshipsAuthorDataType(_type_)

        id = d.pop("id", UNSET)

        revision = d.pop("revision", UNSET)

        revisions_single_get_response_data_relationships_author_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        )

        revisions_single_get_response_data_relationships_author_data.additional_properties = d
        return revisions_single_get_response_data_relationships_author_data
