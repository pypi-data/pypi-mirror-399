...
class DocumentsSinglePostResponseDataRelationshipsUpdatedBy:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_post_response_data_relationships_updated_by = cls(
            data=data,
        )

        documents_single_post_response_data_relationships_updated_by.additional_properties = d
        return documents_single_post_response_data_relationships_updated_by
