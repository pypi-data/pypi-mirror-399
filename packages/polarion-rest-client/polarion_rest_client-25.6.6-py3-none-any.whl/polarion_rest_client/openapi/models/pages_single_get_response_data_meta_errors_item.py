...
class PagesSingleGetResponseDataMetaErrorsItem:
    ...
    source: Union[Unset, "PagesSingleGetResponseDataMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = PagesSingleGetResponseDataMetaErrorsItemSource.from_dict(_source)
        ...
        pages_single_get_response_data_meta_errors_item.additional_properties = d
