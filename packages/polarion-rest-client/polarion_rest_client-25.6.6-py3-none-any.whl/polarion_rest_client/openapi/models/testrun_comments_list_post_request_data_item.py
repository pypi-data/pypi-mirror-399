...
class TestrunCommentsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "TestrunCommentsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TestrunCommentsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )
        ...
        testrun_comments_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        testrun_comments_list_post_request_data_item.additional_properties = d
        return testrun_comments_list_post_request_data_item
