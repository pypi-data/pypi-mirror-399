...
T = TypeVar("T", bound="DocumentsSingleGetResponseDataRelationshipsAttachmentsLinks")
...
class DocumentsSingleGetResponseDataRelationshipsAttachmentsLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_get_response_data_relationships_attachments_links = cls(
            related=related,
        )

        documents_single_get_response_data_relationships_attachments_links.additional_properties = d
        return documents_single_get_response_data_relationships_attachments_links
