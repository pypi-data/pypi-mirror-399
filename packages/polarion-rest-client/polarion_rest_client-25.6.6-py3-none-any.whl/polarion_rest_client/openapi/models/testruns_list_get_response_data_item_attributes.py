...
class TestrunsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                TestrunsListGetResponseDataItemAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        testruns_list_get_response_data_item_attributes = cls(
            created=created,
        ...
        testruns_list_get_response_data_item_attributes.additional_properties = d
        return testruns_list_get_response_data_item_attributes
