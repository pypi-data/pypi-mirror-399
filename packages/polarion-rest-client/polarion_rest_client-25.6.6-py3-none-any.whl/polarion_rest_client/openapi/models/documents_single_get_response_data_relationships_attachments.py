...
T = TypeVar("T", bound="DocumentsSingleGetResponseDataRelationshipsAttachments")
...
class DocumentsSingleGetResponseDataRelationshipsAttachments:
    ...
    data: Union[
        Unset, list["DocumentsSingleGetResponseDataRelationshipsAttachmentsDataItem"]
    ] = UNSET
    meta: Union[Unset, "DocumentsSingleGetResponseDataRelationshipsAttachmentsMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = (
                DocumentsSingleGetResponseDataRelationshipsAttachmentsLinks.from_dict(
                    _links
                )
            )
        ...
        documents_single_get_response_data_relationships_attachments.additional_properties = d
