...
class TestrunsListPatchRequestDataItemAttributes:
    ...
    Attributes:
        ...
        select_test_cases_by (Union[Unset, TestrunsListPatchRequestDataItemAttributesSelectTestCasesBy]):  Example:
            manualSelection.
        status (Union[Unset, str]):  Example: notrun.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                TestrunsListPatchRequestDataItemAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        testruns_list_patch_request_data_item_attributes = cls(
        ...
        testruns_list_patch_request_data_item_attributes.additional_properties = d
        return testruns_list_patch_request_data_item_attributes
