...
class WorkitemApprovalsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitem_approvals_list_get_response_data_item_relationships = cls(
            user=user,
        )

        workitem_approvals_list_get_response_data_item_relationships.additional_properties = d
        return workitem_approvals_list_get_response_data_item_relationships
