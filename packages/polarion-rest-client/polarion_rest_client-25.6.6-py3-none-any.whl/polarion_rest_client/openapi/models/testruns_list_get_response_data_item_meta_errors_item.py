...
class TestrunsListGetResponseDataItemMetaErrorsItem:
    ...
    source: Union[Unset, "TestrunsListGetResponseDataItemMetaErrorsItemSource"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = TestrunsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                _source
            )

        testruns_list_get_response_data_item_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        testruns_list_get_response_data_item_meta_errors_item.additional_properties = d
        return testruns_list_get_response_data_item_meta_errors_item
