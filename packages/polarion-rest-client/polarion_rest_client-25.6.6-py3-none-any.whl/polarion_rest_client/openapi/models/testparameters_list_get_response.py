...
class TestparametersListGetResponse:
    ...
    included: Union[Unset, list["TestparametersListGetResponseIncludedItem"]] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TestparametersListGetResponseDataItem.from_dict(data_item_data)
        ...
        for included_item_data in _included or []:
            included_item = TestparametersListGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        testparameters_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        testparameters_list_get_response.additional_properties = d
        return testparameters_list_get_response
