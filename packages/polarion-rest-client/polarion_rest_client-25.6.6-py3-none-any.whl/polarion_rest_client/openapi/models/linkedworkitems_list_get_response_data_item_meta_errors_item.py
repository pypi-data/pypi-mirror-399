...
class LinkedworkitemsListGetResponseDataItemMetaErrorsItem:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_source, Unset):
            ...
            source = (
                LinkedworkitemsListGetResponseDataItemMetaErrorsItemSource.from_dict(
                    _source
                )
            )
        ...
        linkedworkitems_list_get_response_data_item_meta_errors_item.additional_properties = d
