...
class PlansSinglePatchRequestData:
    ...
    relationships: Union[Unset, "PlansSinglePatchRequestDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = PlansSinglePatchRequestDataAttributes.from_dict(_attributes)
        ...
        plans_single_patch_request_data = cls(
            type_=type_,
            id=id,
        ...
        plans_single_patch_request_data.additional_properties = d
        return plans_single_patch_request_data
