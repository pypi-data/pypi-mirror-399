...
T = TypeVar(
    "T", bound="WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItems"
)
...
class WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItems:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_externally_linked_work_items = cls(
            data=data,
            meta=meta,
        )

        workitems_single_get_response_data_relationships_externally_linked_work_items.additional_properties = d
        return workitems_single_get_response_data_relationships_externally_linked_work_items
