...
class TestrunCommentsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_comments_single_get_response_data_links = cls(
            self_=self_,
        )

        testrun_comments_single_get_response_data_links.additional_properties = d
        return testrun_comments_single_get_response_data_links
