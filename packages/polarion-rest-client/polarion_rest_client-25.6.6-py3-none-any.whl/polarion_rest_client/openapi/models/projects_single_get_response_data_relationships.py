...
class ProjectsSingleGetResponseDataRelationships:
    ...
    lead: Union[Unset, "ProjectsSingleGetResponseDataRelationshipsLead"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_lead, Unset):
            ...
            lead = ProjectsSingleGetResponseDataRelationshipsLead.from_dict(_lead)

        projects_single_get_response_data_relationships = cls(
            lead=lead,
        )

        projects_single_get_response_data_relationships.additional_properties = d
