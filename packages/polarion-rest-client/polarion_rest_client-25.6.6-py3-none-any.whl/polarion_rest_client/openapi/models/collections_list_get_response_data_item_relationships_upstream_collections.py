...
T = TypeVar(
    "T", bound="CollectionsListGetResponseDataItemRelationshipsUpstreamCollections"
)
...
class CollectionsListGetResponseDataItemRelationshipsUpstreamCollections:
    ...
    meta: Union[
        Unset, "CollectionsListGetResponseDataItemRelationshipsUpstreamCollectionsMeta"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_get_response_data_item_relationships_upstream_collections = (
            cls(
                data=data,
                meta=meta,
            )
        ...
        collections_list_get_response_data_item_relationships_upstream_collections.additional_properties = d
        return (
            collections_list_get_response_data_item_relationships_upstream_collections
        )
