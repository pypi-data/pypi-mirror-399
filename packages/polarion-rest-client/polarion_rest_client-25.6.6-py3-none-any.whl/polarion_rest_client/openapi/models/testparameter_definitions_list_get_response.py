...
class TestparameterDefinitionsListGetResponse:
    ...
    data: Union[Unset, list["TestparameterDefinitionsListGetResponseDataItem"]] = UNSET
    included: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = TestparameterDefinitionsListGetResponseDataItem.from_dict(
                data_item_data
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TestparameterDefinitionsListGetResponseLinks.from_dict(_links)

        testparameter_definitions_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        testparameter_definitions_list_get_response.additional_properties = d
        return testparameter_definitions_list_get_response
