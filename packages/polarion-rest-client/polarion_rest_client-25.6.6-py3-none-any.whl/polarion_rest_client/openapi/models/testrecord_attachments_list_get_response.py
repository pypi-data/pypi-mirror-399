...
class TestrecordAttachmentsListGetResponse:
    ...
    data: Union[Unset, list["TestrecordAttachmentsListGetResponseDataItem"]] = UNSET
    included: Union[Unset, list["TestrecordAttachmentsListGetResponseIncludedItem"]] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for included_item_data in _included or []:
            included_item = TestrecordAttachmentsListGetResponseIncludedItem.from_dict(
                included_item_data
            )
        ...
        testrecord_attachments_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        testrecord_attachments_list_get_response.additional_properties = d
        return testrecord_attachments_list_get_response
