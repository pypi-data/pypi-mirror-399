...
T = TypeVar(
    "T", bound="DocumentCommentsListPostRequestDataItemRelationshipsParentCommentData"
)
...
class DocumentCommentsListPostRequestDataItemRelationshipsParentCommentData:
    ...
    type_: Union[
        Unset, DocumentCommentsListPostRequestDataItemRelationshipsParentCommentDataType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_comments_list_post_request_data_item_relationships_parent_comment_data.additional_properties = d
