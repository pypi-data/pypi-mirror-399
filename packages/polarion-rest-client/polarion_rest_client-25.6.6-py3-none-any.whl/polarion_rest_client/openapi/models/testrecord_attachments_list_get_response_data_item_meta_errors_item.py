...
T = TypeVar("T", bound="TestrecordAttachmentsListGetResponseDataItemMetaErrorsItem")
...
class TestrecordAttachmentsListGetResponseDataItemMetaErrorsItem:
    ...
    source: Union[
        Unset, "TestrecordAttachmentsListGetResponseDataItemMetaErrorsItemSource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_list_get_response_data_item_meta_errors_item = cls(
            status=status,
            title=title,
            detail=detail,
            source=source,
        ...
        testrecord_attachments_list_get_response_data_item_meta_errors_item.additional_properties = d
        return testrecord_attachments_list_get_response_data_item_meta_errors_item
