...
T = TypeVar("T", bound="TestrunAttachmentsListGetResponseDataItemRelationships")
...
class TestrunAttachmentsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                TestrunAttachmentsListGetResponseDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                TestrunAttachmentsListGetResponseDataItemRelationshipsProject.from_dict(
                    _project
                )
            )

        testrun_attachments_list_get_response_data_item_relationships = cls(
            author=author,
            project=project,
        )

        testrun_attachments_list_get_response_data_item_relationships.additional_properties = d
        return testrun_attachments_list_get_response_data_item_relationships
