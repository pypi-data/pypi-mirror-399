...
class TestrunsSingleGetResponseDataAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_home_page_content, Unset):
            ...
            home_page_content = (
                TestrunsSingleGetResponseDataAttributesHomePageContent.from_dict(
                    _home_page_content
                )
            )
        ...
        testruns_single_get_response_data_attributes = cls(
            created=created,
        ...
        testruns_single_get_response_data_attributes.additional_properties = d
        return testruns_single_get_response_data_attributes
