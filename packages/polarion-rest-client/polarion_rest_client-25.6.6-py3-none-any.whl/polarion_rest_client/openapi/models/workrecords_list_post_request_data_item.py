...
class WorkrecordsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "WorkrecordsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "WorkrecordsListPostRequestDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkrecordsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkrecordsListPostRequestDataItemRelationships.from_dict(
                _relationships
            )

        workrecords_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        workrecords_list_post_request_data_item.additional_properties = d
        return workrecords_list_post_request_data_item
