...
class CollectionsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "CollectionsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "CollectionsListPostRequestDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = CollectionsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = CollectionsListPostRequestDataItemRelationships.from_dict(
                _relationships
            )

        collections_list_post_request_data_item = cls(
            type_=type_,
            attributes=attributes,
            relationships=relationships,
        )

        collections_list_post_request_data_item.additional_properties = d
        return collections_list_post_request_data_item
