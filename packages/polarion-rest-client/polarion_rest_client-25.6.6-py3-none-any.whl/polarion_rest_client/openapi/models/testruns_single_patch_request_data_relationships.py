...
class TestrunsSinglePatchRequestDataRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_document, Unset):
            ...
            document = TestrunsSinglePatchRequestDataRelationshipsDocument.from_dict(
                _document
            )
        ...
        if isinstance(_project_span, Unset):
            ...
            project_span = (
                TestrunsSinglePatchRequestDataRelationshipsProjectSpan.from_dict(
                    _project_span
                )
            )
        ...
        if isinstance(_summary_defect, Unset):
            ...
            summary_defect = (
                TestrunsSinglePatchRequestDataRelationshipsSummaryDefect.from_dict(
                    _summary_defect
                )
            )

        testruns_single_patch_request_data_relationships = cls(
            document=document,
            project_span=project_span,
            summary_defect=summary_defect,
        )

        testruns_single_patch_request_data_relationships.additional_properties = d
        return testruns_single_patch_request_data_relationships
