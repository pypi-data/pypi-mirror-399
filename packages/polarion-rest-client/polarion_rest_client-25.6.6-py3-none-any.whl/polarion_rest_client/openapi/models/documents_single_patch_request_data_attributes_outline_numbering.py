...
T = TypeVar("T", bound="DocumentsSinglePatchRequestDataAttributesOutlineNumbering")
...
class DocumentsSinglePatchRequestDataAttributesOutlineNumbering:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        documents_single_patch_request_data_attributes_outline_numbering.additional_properties = d
