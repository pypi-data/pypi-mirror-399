...
class WorkrecordsSingleGetResponseDataMetaErrorsItemSource:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_resource, Unset):
            ...
            resource = (
                WorkrecordsSingleGetResponseDataMetaErrorsItemSourceResource.from_dict(
                    _resource
                )
            )

        workrecords_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        workrecords_single_get_response_data_meta_errors_item_source.additional_properties = d
        return workrecords_single_get_response_data_meta_errors_item_source
