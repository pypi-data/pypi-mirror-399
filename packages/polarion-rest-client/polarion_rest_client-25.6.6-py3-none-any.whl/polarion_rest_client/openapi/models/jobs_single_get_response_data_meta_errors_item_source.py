...
class JobsSingleGetResponseDataMetaErrorsItemSource:
    ...
    resource: Union[Unset, "JobsSingleGetResponseDataMetaErrorsItemSourceResource"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        jobs_single_get_response_data_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        jobs_single_get_response_data_meta_errors_item_source.additional_properties = d
        return jobs_single_get_response_data_meta_errors_item_source
