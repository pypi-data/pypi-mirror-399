...
class TeststepresultAttachmentsListPostRequestDataItem:
    ...
    type_: Union[Unset, TeststepresultAttachmentsListPostRequestDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TeststepresultAttachmentsListPostRequestDataItemType(_type_)
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                TeststepresultAttachmentsListPostRequestDataItemAttributes.from_dict(
                    _attributes
                )
            )

        teststepresult_attachments_list_post_request_data_item = cls(
            type_=type_,
            lid=lid,
            attributes=attributes,
        )

        teststepresult_attachments_list_post_request_data_item.additional_properties = d
        return teststepresult_attachments_list_post_request_data_item
