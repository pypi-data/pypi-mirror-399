...
class TestrunsSingleGetResponseDataRelationshipsProjectSpan:
    ...
    data: Union[
        Unset, list["TestrunsSingleGetResponseDataRelationshipsProjectSpanDataItem"]
    ] = UNSET
    meta: Union[Unset, "TestrunsSingleGetResponseDataRelationshipsProjectSpanMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                TestrunsSingleGetResponseDataRelationshipsProjectSpanDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        testruns_single_get_response_data_relationships_project_span = cls(
            data=data,
            meta=meta,
        )

        testruns_single_get_response_data_relationships_project_span.additional_properties = d
        return testruns_single_get_response_data_relationships_project_span
