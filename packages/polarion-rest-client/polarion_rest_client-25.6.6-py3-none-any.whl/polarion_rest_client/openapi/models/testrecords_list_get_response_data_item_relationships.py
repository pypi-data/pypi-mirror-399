...
class TestrecordsListGetResponseDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_executed_by, Unset):
            ...
            executed_by = (
                TestrecordsListGetResponseDataItemRelationshipsExecutedBy.from_dict(
                    _executed_by
                )
            )
        ...
        if isinstance(_test_case, Unset):
            ...
            test_case = (
                TestrecordsListGetResponseDataItemRelationshipsTestCase.from_dict(
                    _test_case
                )
            )

        testrecords_list_get_response_data_item_relationships = cls(
            defect=defect,
            executed_by=executed_by,
            test_case=test_case,
        )

        testrecords_list_get_response_data_item_relationships.additional_properties = d
        return testrecords_list_get_response_data_item_relationships
