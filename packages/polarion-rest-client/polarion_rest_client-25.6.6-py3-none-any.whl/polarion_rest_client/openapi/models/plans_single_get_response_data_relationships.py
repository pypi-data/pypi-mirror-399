...
class PlansSingleGetResponseDataRelationships:
    ...
    author: Union[Unset, "PlansSingleGetResponseDataRelationshipsAuthor"] = UNSET
    parent: Union[Unset, "PlansSingleGetResponseDataRelationshipsParent"] = UNSET
    project: Union[Unset, "PlansSingleGetResponseDataRelationshipsProject"] = UNSET
    project_span: Union[Unset, "PlansSingleGetResponseDataRelationshipsProjectSpan"] = (
        UNSET
    )
    template: Union[Unset, "PlansSingleGetResponseDataRelationshipsTemplate"] = UNSET
    work_items: Union[Unset, "PlansSingleGetResponseDataRelationshipsWorkItems"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = PlansSingleGetResponseDataRelationshipsAuthor.from_dict(_author)
        ...
        if isinstance(_parent, Unset):
            ...
            parent = PlansSingleGetResponseDataRelationshipsParent.from_dict(_parent)
        ...
        if isinstance(_project, Unset):
            ...
            project = PlansSingleGetResponseDataRelationshipsProject.from_dict(_project)
        ...
        if isinstance(_project_span, Unset):
            ...
            project_span = PlansSingleGetResponseDataRelationshipsProjectSpan.from_dict(
                _project_span
            )
        ...
        if isinstance(_template, Unset):
            ...
            template = PlansSingleGetResponseDataRelationshipsTemplate.from_dict(
                _template
            )
        ...
        if isinstance(_work_items, Unset):
            ...
            work_items = PlansSingleGetResponseDataRelationshipsWorkItems.from_dict(
                _work_items
            )

        plans_single_get_response_data_relationships = cls(
            author=author,
            parent=parent,
            project=project,
        ...
        plans_single_get_response_data_relationships.additional_properties = d
        return plans_single_get_response_data_relationships
