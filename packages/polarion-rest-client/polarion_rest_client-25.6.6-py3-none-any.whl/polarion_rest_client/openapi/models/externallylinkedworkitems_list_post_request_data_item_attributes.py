...
T = TypeVar("T", bound="ExternallylinkedworkitemsListPostRequestDataItemAttributes")
...
class ExternallylinkedworkitemsListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        externallylinkedworkitems_list_post_request_data_item_attributes = cls(
            role=role,
            work_item_uri=work_item_uri,
        )

        externallylinkedworkitems_list_post_request_data_item_attributes.additional_properties = d
        return externallylinkedworkitems_list_post_request_data_item_attributes
