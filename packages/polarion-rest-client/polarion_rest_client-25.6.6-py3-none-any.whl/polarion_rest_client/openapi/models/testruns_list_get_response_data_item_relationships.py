...
class TestrunsListGetResponseDataItemRelationships:
    ...
    author: Union[Unset, "TestrunsListGetResponseDataItemRelationshipsAuthor"] = UNSET
    document: Union[Unset, "TestrunsListGetResponseDataItemRelationshipsDocument"] = (
        UNSET
    )
    project: Union[Unset, "TestrunsListGetResponseDataItemRelationshipsProject"] = UNSET
    project_span: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = TestrunsListGetResponseDataItemRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_document, Unset):
            ...
            document = TestrunsListGetResponseDataItemRelationshipsDocument.from_dict(
                _document
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = TestrunsListGetResponseDataItemRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_project_span, Unset):
            ...
            project_span = (
                TestrunsListGetResponseDataItemRelationshipsProjectSpan.from_dict(
                    _project_span
                )
            )
        ...
        if isinstance(_summary_defect, Unset):
            ...
            summary_defect = (
                TestrunsListGetResponseDataItemRelationshipsSummaryDefect.from_dict(
                    _summary_defect
                )
            )
        ...
        if isinstance(_template, Unset):
            ...
            template = TestrunsListGetResponseDataItemRelationshipsTemplate.from_dict(
                _template
            )

        testruns_list_get_response_data_item_relationships = cls(
            author=author,
            document=document,
            project=project,
        ...
        testruns_list_get_response_data_item_relationships.additional_properties = d
        return testruns_list_get_response_data_item_relationships
