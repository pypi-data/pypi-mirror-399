...
class TestrunAttachmentsSingleGetResponseDataLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_single_get_response_data_links = cls(
            self_=self_,
            content=content,
        )

        testrun_attachments_single_get_response_data_links.additional_properties = d
        return testrun_attachments_single_get_response_data_links
