...
class WorkitemCommentsListPostResponseDataItem:
    ...
    links: Union[Unset, "WorkitemCommentsListPostResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_links, Unset):
            ...
            links = WorkitemCommentsListPostResponseDataItemLinks.from_dict(_links)
        ...
        workitem_comments_list_post_response_data_item.additional_properties = d
