...
class ExternallylinkedworkitemsListGetResponseDataItem:
    ...
    type_: Union[Unset, ExternallylinkedworkitemsListGetResponseDataItemType] = UNSET
    id: Union[Unset, str] = UNSET
    revision: Union[Unset, str] = UNSET
    attributes: Union[
        Unset, "ExternallylinkedworkitemsListGetResponseDataItemAttributes"
    ] = UNSET
    meta: Union[Unset, "ExternallylinkedworkitemsListGetResponseDataItemMeta"] = UNSET
    links: Union[Unset, "ExternallylinkedworkitemsListGetResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ExternallylinkedworkitemsListGetResponseDataItemType(_type_)
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                ExternallylinkedworkitemsListGetResponseDataItemAttributes.from_dict(
                    _attributes
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = ExternallylinkedworkitemsListGetResponseDataItemMeta.from_dict(_meta)
        ...
        externallylinkedworkitems_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        externallylinkedworkitems_list_get_response_data_item.additional_properties = d
        return externallylinkedworkitems_list_get_response_data_item
