...
class TestparameterDefinitionsSingleGetResponse:
    ...
    links: Union[Unset, "TestparameterDefinitionsSingleGetResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_data, Unset):
            ...
            data = TestparameterDefinitionsSingleGetResponseData.from_dict(_data)

        included = []
        _included = d.pop("included", UNSET)
        for included_item_data in _included or []:
            included_item = (
                TestparameterDefinitionsSingleGetResponseIncludedItem.from_dict(
                    included_item_data
                )
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = TestparameterDefinitionsSingleGetResponseLinks.from_dict(_links)

        testparameter_definitions_single_get_response = cls(
            data=data,
            included=included,
            links=links,
        )

        testparameter_definitions_single_get_response.additional_properties = d
        return testparameter_definitions_single_get_response
