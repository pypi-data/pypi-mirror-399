...
class TestrecordsSinglePatchRequestDataAttributes:
    ...
    comment: Union[Unset, "TestrecordsSinglePatchRequestDataAttributesComment"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_comment, Unset):
            ...
            comment = TestrecordsSinglePatchRequestDataAttributesComment.from_dict(
                _comment
            )
        ...
        testrecords_single_patch_request_data_attributes = cls(
            comment=comment,
            duration=duration,
            executed=executed,
            result=result,
        ...
        testrecords_single_patch_request_data_attributes.additional_properties = d
        return testrecords_single_patch_request_data_attributes
