...
T = TypeVar("T", bound="TestrunsListPostRequestDataItemRelationshipsDocumentData")
...
class TestrunsListPostRequestDataItemRelationshipsDocumentData:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = TestrunsListPostRequestDataItemRelationshipsDocumentDataType(_type_)

        id = d.pop("id", UNSET)

        revision = d.pop("revision", UNSET)

        testruns_list_post_request_data_item_relationships_document_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        )

        testruns_list_post_request_data_item_relationships_document_data.additional_properties = d
        return testruns_list_post_request_data_item_relationships_document_data
