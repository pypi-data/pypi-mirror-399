...
class DocumentPartsListPostRequestDataItem:
    ...
    attributes: Union[Unset, "DocumentPartsListPostRequestDataItemAttributes"] = UNSET
    relationships: Union[Unset, "DocumentPartsListPostRequestDataItemRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = DocumentPartsListPostRequestDataItemAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = DocumentPartsListPostRequestDataItemRelationships.from_dict(
                _relationships
            )
