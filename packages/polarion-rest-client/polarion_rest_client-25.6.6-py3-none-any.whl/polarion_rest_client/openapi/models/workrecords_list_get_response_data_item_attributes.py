...
class WorkrecordsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workrecords_list_get_response_data_item_attributes = cls(
            comment=comment,
            date=date,
            id=id,
        ...
        workrecords_list_get_response_data_item_attributes.additional_properties = d
        return workrecords_list_get_response_data_item_attributes
