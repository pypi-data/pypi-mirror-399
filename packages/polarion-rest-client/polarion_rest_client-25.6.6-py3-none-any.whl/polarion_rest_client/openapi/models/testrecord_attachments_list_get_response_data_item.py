...
class TestrecordAttachmentsListGetResponseDataItem:
    ...
    type_: Union[Unset, TestrecordAttachmentsListGetResponseDataItemType] = UNSET
    ...
    meta: Union[Unset, "TestrecordAttachmentsListGetResponseDataItemMeta"] = UNSET
    links: Union[Unset, "TestrecordAttachmentsListGetResponseDataItemLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                TestrecordAttachmentsListGetResponseDataItemAttributes.from_dict(
                    _attributes
                )
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = (
                TestrecordAttachmentsListGetResponseDataItemRelationships.from_dict(
                    _relationships
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = TestrecordAttachmentsListGetResponseDataItemMeta.from_dict(_meta)
        ...
        if isinstance(_links, Unset):
            ...
            links = TestrecordAttachmentsListGetResponseDataItemLinks.from_dict(_links)

        testrecord_attachments_list_get_response_data_item = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        testrecord_attachments_list_get_response_data_item.additional_properties = d
        return testrecord_attachments_list_get_response_data_item
