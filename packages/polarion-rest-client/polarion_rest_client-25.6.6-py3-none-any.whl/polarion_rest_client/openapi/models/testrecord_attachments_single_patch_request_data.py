...
class TestrecordAttachmentsSinglePatchRequestData:
    ...
    type_: Union[Unset, TestrecordAttachmentsSinglePatchRequestDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                TestrecordAttachmentsSinglePatchRequestDataAttributes.from_dict(
                    _attributes
                )
            )

        testrecord_attachments_single_patch_request_data = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        testrecord_attachments_single_patch_request_data.additional_properties = d
        return testrecord_attachments_single_patch_request_data
