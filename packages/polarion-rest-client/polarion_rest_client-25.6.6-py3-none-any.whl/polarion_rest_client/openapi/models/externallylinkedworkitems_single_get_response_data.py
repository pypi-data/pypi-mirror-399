...
class ExternallylinkedworkitemsSingleGetResponseData:
    ...
    type_: Union[Unset, ExternallylinkedworkitemsSingleGetResponseDataType] = UNSET
    id: Union[Unset, str] = UNSET
    revision: Union[Unset, str] = UNSET
    attributes: Union[
        Unset, "ExternallylinkedworkitemsSingleGetResponseDataAttributes"
    ] = UNSET
    meta: Union[Unset, "ExternallylinkedworkitemsSingleGetResponseDataMeta"] = UNSET
    links: Union[Unset, "ExternallylinkedworkitemsSingleGetResponseDataLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = (
                ExternallylinkedworkitemsSingleGetResponseDataAttributes.from_dict(
                    _attributes
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = ExternallylinkedworkitemsSingleGetResponseDataMeta.from_dict(_meta)
        ...
        if isinstance(_links, Unset):
            ...
            links = ExternallylinkedworkitemsSingleGetResponseDataLinks.from_dict(
                _links
            )

        externallylinkedworkitems_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        externallylinkedworkitems_single_get_response_data.additional_properties = d
        return externallylinkedworkitems_single_get_response_data
