...
class ExternallylinkedworkitemsListGetResponse:
    ...
    data: Union[Unset, list["ExternallylinkedworkitemsListGetResponseDataItem"]] = UNSET
    included: Union[
        Unset, list["ExternallylinkedworkitemsListGetResponseIncludedItem"]
    ] = UNSET
    links: Union[Unset, "ExternallylinkedworkitemsListGetResponseLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = ExternallylinkedworkitemsListGetResponseMeta.from_dict(_meta)

        data = []
        _data = d.pop("data", UNSET)
        for data_item_data in _data or []:
            data_item = ExternallylinkedworkitemsListGetResponseDataItem.from_dict(
                data_item_data
            )
        ...
        if isinstance(_links, Unset):
            ...
            links = ExternallylinkedworkitemsListGetResponseLinks.from_dict(_links)

        externallylinkedworkitems_list_get_response = cls(
            meta=meta,
            data=data,
            included=included,
            links=links,
        ...
        externallylinkedworkitems_list_get_response.additional_properties = d
        return externallylinkedworkitems_list_get_response
