...
class ExternallylinkedworkitemsListDeleteRequestDataItem:
    ...
    type_: Union[Unset, ExternallylinkedworkitemsListDeleteRequestDataItemType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = ExternallylinkedworkitemsListDeleteRequestDataItemType(_type_)

        id = d.pop("id", UNSET)

        externallylinkedworkitems_list_delete_request_data_item = cls(
            type_=type_,
            id=id,
        )

        externallylinkedworkitems_list_delete_request_data_item.additional_properties = d
        return externallylinkedworkitems_list_delete_request_data_item
