...
class WorkitemsListGetResponseDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_description, Unset):
            ...
            description = (
                WorkitemsListGetResponseDataItemAttributesDescription.from_dict(
                    _description
                )
            )
        ...
        for hyperlinks_item_data in _hyperlinks or []:
            hyperlinks_item = (
                WorkitemsListGetResponseDataItemAttributesHyperlinksItem.from_dict(
        ...
        workitems_list_get_response_data_item_attributes.additional_properties = d
