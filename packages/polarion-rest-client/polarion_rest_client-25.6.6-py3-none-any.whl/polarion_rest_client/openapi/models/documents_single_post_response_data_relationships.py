...
class DocumentsSinglePostResponseDataRelationships:
    ...
    author: Union[Unset, "DocumentsSinglePostResponseDataRelationshipsAuthor"] = UNSET
    branched_from: Union[
    ...
    project: Union[Unset, "DocumentsSinglePostResponseDataRelationshipsProject"] = UNSET
    updated_by: Union[
        Unset, "DocumentsSinglePostResponseDataRelationshipsUpdatedBy"
    ] = UNSET
    variant: Union[Unset, "DocumentsSinglePostResponseDataRelationshipsVariant"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attachments, Unset):
            ...
            attachments = (
                DocumentsSinglePostResponseDataRelationshipsAttachments.from_dict(
                    _attachments
                )
            )
        ...
        if isinstance(_author, Unset):
            ...
            author = DocumentsSinglePostResponseDataRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_branched_from, Unset):
            ...
            branched_from = (
                DocumentsSinglePostResponseDataRelationshipsBranchedFrom.from_dict(
                    _branched_from
                )
            )
        ...
        if isinstance(_comments, Unset):
            ...
            comments = DocumentsSinglePostResponseDataRelationshipsComments.from_dict(
                _comments
            )
        ...
        if isinstance(_derived_from, Unset):
            ...
            derived_from = (
                DocumentsSinglePostResponseDataRelationshipsDerivedFrom.from_dict(
                    _derived_from
                )
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = DocumentsSinglePostResponseDataRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_updated_by, Unset):
            ...
            updated_by = (
                DocumentsSinglePostResponseDataRelationshipsUpdatedBy.from_dict(
                    _updated_by
                )
            )
        ...
        if isinstance(_variant, Unset):
            ...
            variant = DocumentsSinglePostResponseDataRelationshipsVariant.from_dict(
                _variant
            )

        documents_single_post_response_data_relationships = cls(
        ...
        documents_single_post_response_data_relationships.additional_properties = d
        return documents_single_post_response_data_relationships
