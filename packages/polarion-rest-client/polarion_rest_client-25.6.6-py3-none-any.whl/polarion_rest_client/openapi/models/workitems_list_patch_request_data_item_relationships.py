...
class WorkitemsListPatchRequestDataItemRelationships:
    ...
    votes: Union[Unset, "WorkitemsListPatchRequestDataItemRelationshipsVotes"] = UNSET
    watches: Union[Unset, "WorkitemsListPatchRequestDataItemRelationshipsWatches"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_categories, Unset):
            ...
            categories = (
                WorkitemsListPatchRequestDataItemRelationshipsCategories.from_dict(
                    _categories
                )
            )
        ...
        if isinstance(_linked_revisions, Unset):
            ...
            linked_revisions = (
                WorkitemsListPatchRequestDataItemRelationshipsLinkedRevisions.from_dict(
                    _linked_revisions
                )
            )
        ...
        if isinstance(_votes, Unset):
            ...
            votes = WorkitemsListPatchRequestDataItemRelationshipsVotes.from_dict(
                _votes
            )
        ...
        workitems_list_patch_request_data_item_relationships = cls(
            assignee=assignee,
        ...
        workitems_list_patch_request_data_item_relationships.additional_properties = d
        return workitems_list_patch_request_data_item_relationships
