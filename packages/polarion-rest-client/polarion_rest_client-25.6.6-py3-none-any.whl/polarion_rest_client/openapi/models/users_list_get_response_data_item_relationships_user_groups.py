...
class UsersListGetResponseDataItemRelationshipsUserGroups:
    ...
    data: Union[
        Unset, list["UsersListGetResponseDataItemRelationshipsUserGroupsDataItem"]
    ] = UNSET
    meta: Union[Unset, "UsersListGetResponseDataItemRelationshipsUserGroupsMeta"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        for data_item_data in _data or []:
            data_item = (
                UsersListGetResponseDataItemRelationshipsUserGroupsDataItem.from_dict(
                    data_item_data
                )
            )
        ...
        users_list_get_response_data_item_relationships_user_groups.additional_properties = d
