...
class PatchTestRunAttachmentsRequestBody:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        d = dict(src_dict)
        resource = TestrunAttachmentsSinglePatchRequest.from_dict(d.pop("resource"))
        ...
        patch_test_run_attachments_request_body = cls(
            resource=resource,
            content=content,
        )

        patch_test_run_attachments_request_body.additional_properties = d
        return patch_test_run_attachments_request_body
