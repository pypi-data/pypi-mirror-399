...
class DocumentCommentsListPostRequestDataItemRelationships:
    ...
    parent_comment: Union[
        Unset, "DocumentCommentsListPostRequestDataItemRelationshipsParentComment"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_author, Unset):
            ...
            author = (
                DocumentCommentsListPostRequestDataItemRelationshipsAuthor.from_dict(
                    _author
                )
            )
        ...
        document_comments_list_post_request_data_item_relationships.additional_properties = d
