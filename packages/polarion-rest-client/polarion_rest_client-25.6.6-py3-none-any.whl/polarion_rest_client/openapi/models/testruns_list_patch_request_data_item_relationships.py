...
class TestrunsListPatchRequestDataItemRelationships:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project_span, Unset):
            ...
            project_span = (
                TestrunsListPatchRequestDataItemRelationshipsProjectSpan.from_dict(
                    _project_span
                )
            )
        ...
        if isinstance(_summary_defect, Unset):
            ...
            summary_defect = (
                TestrunsListPatchRequestDataItemRelationshipsSummaryDefect.from_dict(
                    _summary_defect
                )
            )

        testruns_list_patch_request_data_item_relationships = cls(
            document=document,
            project_span=project_span,
            summary_defect=summary_defect,
        )

        testruns_list_patch_request_data_item_relationships.additional_properties = d
        return testruns_list_patch_request_data_item_relationships
