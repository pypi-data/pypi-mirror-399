...
T = TypeVar("T", bound="TestrunsSinglePatchRequestDataRelationshipsProjectSpan")
...
class TestrunsSinglePatchRequestDataRelationshipsProjectSpan:
    ...
    data: Union[
        Unset, list["TestrunsSinglePatchRequestDataRelationshipsProjectSpanDataItem"]
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testruns_single_patch_request_data_relationships_project_span = cls(
            data=data,
        )

        testruns_single_patch_request_data_relationships_project_span.additional_properties = d
        return testruns_single_patch_request_data_relationships_project_span
