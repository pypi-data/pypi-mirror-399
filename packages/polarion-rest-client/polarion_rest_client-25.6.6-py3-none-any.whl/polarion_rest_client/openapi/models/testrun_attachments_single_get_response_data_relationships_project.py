...
class TestrunAttachmentsSingleGetResponseDataRelationshipsProject:
    ...
    data: Union[
        Unset, "TestrunAttachmentsSingleGetResponseDataRelationshipsProjectData"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrun_attachments_single_get_response_data_relationships_project = cls(
            data=data,
        )

        testrun_attachments_single_get_response_data_relationships_project.additional_properties = d
        return testrun_attachments_single_get_response_data_relationships_project
