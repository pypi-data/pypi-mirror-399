...
class WorkitemAttachmentsSingleGetResponseData:
    ...
    links: Union[Unset, "WorkitemAttachmentsSingleGetResponseDataLinks"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkitemAttachmentsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = (
                WorkitemAttachmentsSingleGetResponseDataRelationships.from_dict(
                    _relationships
                )
            )
        ...
        if isinstance(_meta, Unset):
            ...
            meta = WorkitemAttachmentsSingleGetResponseDataMeta.from_dict(_meta)
        ...
        if isinstance(_links, Unset):
            ...
            links = WorkitemAttachmentsSingleGetResponseDataLinks.from_dict(_links)
