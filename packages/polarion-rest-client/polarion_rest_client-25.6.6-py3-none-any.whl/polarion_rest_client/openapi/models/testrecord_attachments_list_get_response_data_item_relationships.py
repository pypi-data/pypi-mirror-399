...
T = TypeVar("T", bound="TestrecordAttachmentsListGetResponseDataItemRelationships")
...
class TestrecordAttachmentsListGetResponseDataItemRelationships:
    ...
    author: Union[
        Unset, "TestrecordAttachmentsListGetResponseDataItemRelationshipsAuthor"
    ] = UNSET
    project: Union[
        Unset, "TestrecordAttachmentsListGetResponseDataItemRelationshipsProject"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        testrecord_attachments_list_get_response_data_item_relationships = cls(
            author=author,
            project=project,
        )

        testrecord_attachments_list_get_response_data_item_relationships.additional_properties = d
        return testrecord_attachments_list_get_response_data_item_relationships
