...
class WorkitemsSingleGetResponseData:
    ...
    attributes: Union[Unset, "WorkitemsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "WorkitemsSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = WorkitemsSingleGetResponseDataAttributes.from_dict(_attributes)
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = WorkitemsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
