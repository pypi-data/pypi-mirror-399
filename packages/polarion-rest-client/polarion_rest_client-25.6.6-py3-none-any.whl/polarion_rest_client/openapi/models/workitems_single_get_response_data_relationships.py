...
class WorkitemsSingleGetResponseDataRelationships:
    ...
    author: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsAuthor"] = UNSET
    ...
    externally_linked_work_items: Union[
        Unset, "WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItems"
    ] = UNSET
    ...
    module: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsModule"] = UNSET
    planned_in: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsPlannedIn"] = (
        UNSET
    )
    project: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsProject"] = UNSET
    test_steps: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsTestSteps"] = (
        UNSET
    )
    votes: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsVotes"] = UNSET
    watches: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsWatches"] = UNSET
    work_records: Union[
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        if not isinstance(self.externally_linked_work_items, Unset):
            externally_linked_work_items = self.externally_linked_work_items.to_dict()
        ...
        if externally_linked_work_items is not UNSET:
            field_dict["externallyLinkedWorkItems"] = externally_linked_work_items
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_approvals, Unset):
            ...
            approvals = WorkitemsSingleGetResponseDataRelationshipsApprovals.from_dict(
                _approvals
            )
        ...
        if isinstance(_assignee, Unset):
            ...
            assignee = WorkitemsSingleGetResponseDataRelationshipsAssignee.from_dict(
                _assignee
            )
        ...
        if isinstance(_attachments, Unset):
            ...
            attachments = (
                WorkitemsSingleGetResponseDataRelationshipsAttachments.from_dict(
                    _attachments
                )
            )
        ...
        if isinstance(_author, Unset):
            ...
            author = WorkitemsSingleGetResponseDataRelationshipsAuthor.from_dict(
                _author
            )
        ...
        if isinstance(_categories, Unset):
            ...
            categories = (
                WorkitemsSingleGetResponseDataRelationshipsCategories.from_dict(
                    _categories
                )
            )
        ...
        if isinstance(_comments, Unset):
            ...
            comments = WorkitemsSingleGetResponseDataRelationshipsComments.from_dict(
                _comments
            )

        _externally_linked_work_items = d.pop("externallyLinkedWorkItems", UNSET)
        externally_linked_work_items: Union[
            Unset, WorkitemsSingleGetResponseDataRelationshipsExternallyLinkedWorkItems
        ]
        ...
        if isinstance(_linked_revisions, Unset):
            ...
            linked_revisions = (
                WorkitemsSingleGetResponseDataRelationshipsLinkedRevisions.from_dict(
                    _linked_revisions
                )
            )
        ...
        if isinstance(_linked_work_items, Unset):
            ...
            linked_work_items = (
                WorkitemsSingleGetResponseDataRelationshipsLinkedWorkItems.from_dict(
                    _linked_work_items
                )
            )
        ...
        if isinstance(_module, Unset):
            ...
            module = WorkitemsSingleGetResponseDataRelationshipsModule.from_dict(
                _module
            )
        ...
        if isinstance(_planned_in, Unset):
            ...
            planned_in = WorkitemsSingleGetResponseDataRelationshipsPlannedIn.from_dict(
                _planned_in
            )
        ...
        if isinstance(_project, Unset):
            ...
            project = WorkitemsSingleGetResponseDataRelationshipsProject.from_dict(
                _project
            )
        ...
        if isinstance(_test_steps, Unset):
            ...
            test_steps = WorkitemsSingleGetResponseDataRelationshipsTestSteps.from_dict(
                _test_steps
            )
        ...
        if isinstance(_votes, Unset):
            ...
            votes = WorkitemsSingleGetResponseDataRelationshipsVotes.from_dict(_votes)
        ...
        if isinstance(_watches, Unset):
            ...
            watches = WorkitemsSingleGetResponseDataRelationshipsWatches.from_dict(
                _watches
            )
        ...
        if isinstance(_work_records, Unset):
            ...
            work_records = (
                WorkitemsSingleGetResponseDataRelationshipsWorkRecords.from_dict(
                    _work_records
                )
            )
        ...
        workitems_single_get_response_data_relationships.additional_properties = d
