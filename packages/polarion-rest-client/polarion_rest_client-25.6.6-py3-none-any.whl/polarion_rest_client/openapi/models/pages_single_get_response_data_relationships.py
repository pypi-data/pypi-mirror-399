...
class PagesSingleGetResponseDataRelationships:
    ...
    author: Union[Unset, "PagesSingleGetResponseDataRelationshipsAuthor"] = UNSET
    project: Union[Unset, "PagesSingleGetResponseDataRelationshipsProject"] = UNSET
    updated_by: Union[Unset, "PagesSingleGetResponseDataRelationshipsUpdatedBy"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attachments, Unset):
            ...
            attachments = PagesSingleGetResponseDataRelationshipsAttachments.from_dict(
                _attachments
            )
        ...
        if isinstance(_author, Unset):
            ...
            author = PagesSingleGetResponseDataRelationshipsAuthor.from_dict(_author)
        ...
        if isinstance(_project, Unset):
            ...
            project = PagesSingleGetResponseDataRelationshipsProject.from_dict(_project)
        ...
        if isinstance(_updated_by, Unset):
            ...
            updated_by = PagesSingleGetResponseDataRelationshipsUpdatedBy.from_dict(
                _updated_by
            )
