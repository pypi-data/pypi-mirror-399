...
T = TypeVar(
    "T", bound="CollectionsListPostRequestDataItemRelationshipsRichPagesDataItem"
)
...
class CollectionsListPostRequestDataItemRelationshipsRichPagesDataItem:
    ...
    type_: Union[
        Unset, CollectionsListPostRequestDataItemRelationshipsRichPagesDataItemType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        collections_list_post_request_data_item_relationships_rich_pages_data_item = (
            cls(
                type_=type_,
                id=id,
            )
        ...
        collections_list_post_request_data_item_relationships_rich_pages_data_item.additional_properties = d
        return (
            collections_list_post_request_data_item_relationships_rich_pages_data_item
        )
