...
class TestrunCommentsListPostRequestDataItemAttributes:
    ...
    text: Union[Unset, "TestrunCommentsListPostRequestDataItemAttributesText"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_text, Unset):
            ...
            text = TestrunCommentsListPostRequestDataItemAttributesText.from_dict(_text)

        title = d.pop("title", UNSET)

        testrun_comments_list_post_request_data_item_attributes = cls(
            resolved=resolved,
            text=text,
            title=title,
        )

        testrun_comments_list_post_request_data_item_attributes.additional_properties = d
        return testrun_comments_list_post_request_data_item_attributes
