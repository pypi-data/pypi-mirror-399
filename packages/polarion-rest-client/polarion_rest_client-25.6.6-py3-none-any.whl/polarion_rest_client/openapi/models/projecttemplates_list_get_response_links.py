...
class ProjecttemplatesListGetResponseLinks:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        projecttemplates_list_get_response_links = cls(
            self_=self_,
            first=first,
            prev=prev,
            next_=next_,
        ...
        projecttemplates_list_get_response_links.additional_properties = d
        return projecttemplates_list_get_response_links
