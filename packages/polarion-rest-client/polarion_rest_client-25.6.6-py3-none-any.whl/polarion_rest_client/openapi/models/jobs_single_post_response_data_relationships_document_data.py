...
class JobsSinglePostResponseDataRelationshipsDocumentData:
    ...
    type_: Union[Unset, JobsSinglePostResponseDataRelationshipsDocumentDataType] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = JobsSinglePostResponseDataRelationshipsDocumentDataType(_type_)

        id = d.pop("id", UNSET)

        jobs_single_post_response_data_relationships_document_data = cls(
            type_=type_,
            id=id,
        )

        jobs_single_post_response_data_relationships_document_data.additional_properties = d
        return jobs_single_post_response_data_relationships_document_data
