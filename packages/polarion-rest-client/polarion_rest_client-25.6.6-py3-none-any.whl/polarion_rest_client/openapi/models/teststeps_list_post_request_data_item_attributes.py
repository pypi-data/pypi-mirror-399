...
class TeststepsListPostRequestDataItemAttributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_list_post_request_data_item_attributes = cls(
            keys=keys,
            values=values,
        )

        teststeps_list_post_request_data_item_attributes.additional_properties = d
        return teststeps_list_post_request_data_item_attributes
