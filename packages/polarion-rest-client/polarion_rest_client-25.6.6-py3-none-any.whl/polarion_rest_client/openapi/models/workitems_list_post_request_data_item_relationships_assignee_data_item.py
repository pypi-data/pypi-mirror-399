...
T = TypeVar("T", bound="WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItem")
...
class WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItem:
    ...
    type_: Union[
        Unset, WorkitemsListPostRequestDataItemRelationshipsAssigneeDataItemType
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_post_request_data_item_relationships_assignee_data_item.additional_properties = d
