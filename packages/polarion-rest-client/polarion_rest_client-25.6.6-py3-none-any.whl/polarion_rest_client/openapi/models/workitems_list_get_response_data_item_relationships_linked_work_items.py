...
T = TypeVar("T", bound="WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItems")
...
class WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItems:
    ...
    data: Union[
        Unset,
        list["WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsDataItem"],
    ] = UNSET
    meta: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsMeta"
    ] = UNSET
    links: Union[
        Unset, "WorkitemsListGetResponseDataItemRelationshipsLinkedWorkItemsLinks"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_list_get_response_data_item_relationships_linked_work_items.additional_properties = d
