...
class WorkitemsListGetResponseDataItemAttributesDescription:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_type_, Unset):
            ...
            type_ = WorkitemsListGetResponseDataItemAttributesDescriptionType(_type_)
        ...
        workitems_list_get_response_data_item_attributes_description.additional_properties = d
