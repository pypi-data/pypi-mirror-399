...
class TeststepResultsSingleGetResponseData:
    ...
    attributes: Union[Unset, "TeststepResultsSingleGetResponseDataAttributes"] = UNSET
    relationships: Union[Unset, "TeststepResultsSingleGetResponseDataRelationships"] = (
        UNSET
    )
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = TeststepResultsSingleGetResponseDataAttributes.from_dict(
                _attributes
            )
        ...
        if isinstance(_relationships, Unset):
            ...
            relationships = TeststepResultsSingleGetResponseDataRelationships.from_dict(
                _relationships
            )
        ...
        teststep_results_single_get_response_data = cls(
            type_=type_,
            id=id,
            revision=revision,
        ...
        teststep_results_single_get_response_data.additional_properties = d
        return teststep_results_single_get_response_data
