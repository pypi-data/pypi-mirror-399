...
class DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSource:
    ...
    resource: Union[
        Unset, "DocumentAttachmentsSingleGetResponseDataMetaErrorsItemSourceResource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        document_attachments_single_get_response_data_meta_errors_item_source.additional_properties = d
