...
class WorkitemsSingleGetResponseDataRelationshipsProject:
    ...
    data: Union[Unset, "WorkitemsSingleGetResponseDataRelationshipsProjectData"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        workitems_single_get_response_data_relationships_project.additional_properties = d
