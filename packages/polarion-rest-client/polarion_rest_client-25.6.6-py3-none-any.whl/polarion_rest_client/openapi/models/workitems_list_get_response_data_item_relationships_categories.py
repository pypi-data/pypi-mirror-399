...
T = TypeVar("T", bound="WorkitemsListGetResponseDataItemRelationshipsCategories")
...
class WorkitemsListGetResponseDataItemRelationshipsCategories:
    ...
    data: Union[
        Unset, list["WorkitemsListGetResponseDataItemRelationshipsCategoriesDataItem"]
    ] = UNSET
    meta: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_meta, Unset):
            ...
            meta = (
                WorkitemsListGetResponseDataItemRelationshipsCategoriesMeta.from_dict(
                    _meta
                )
            )
        ...
        workitems_list_get_response_data_item_relationships_categories.additional_properties = d
