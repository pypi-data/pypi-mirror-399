...
class TeststepResultsListGetResponseDataItemMetaErrorsItemSource:
    ...
    resource: Union[
        Unset, "TeststepResultsListGetResponseDataItemMetaErrorsItemSourceResource"
    ] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststep_results_list_get_response_data_item_meta_errors_item_source = cls(
            pointer=pointer,
            parameter=parameter,
            resource=resource,
        )

        teststep_results_list_get_response_data_item_meta_errors_item_source.additional_properties = d
        return teststep_results_list_get_response_data_item_meta_errors_item_source
