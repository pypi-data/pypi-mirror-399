...
class TeststepsListPatchRequestDataItem:
    ...
    attributes: Union[Unset, "TeststepsListPatchRequestDataItemAttributes"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        teststeps_list_patch_request_data_item = cls(
            type_=type_,
            id=id,
            attributes=attributes,
        )

        teststeps_list_patch_request_data_item.additional_properties = d
        return teststeps_list_patch_request_data_item
