...
class WorkitemCommentsSingleGetResponseDataRelationships:
    ...
    child_comments: Union[
        Unset, "WorkitemCommentsSingleGetResponseDataRelationshipsChildComments"
    ] = UNSET
    parent_comment: Union[
        Unset, "WorkitemCommentsSingleGetResponseDataRelationshipsParentComment"
    ] = UNSET
    project: Union[
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_project, Unset):
            ...
            project = (
                WorkitemCommentsSingleGetResponseDataRelationshipsProject.from_dict(
                    _project
                )
            )
        ...
        workitem_comments_single_get_response_data_relationships.additional_properties = d
