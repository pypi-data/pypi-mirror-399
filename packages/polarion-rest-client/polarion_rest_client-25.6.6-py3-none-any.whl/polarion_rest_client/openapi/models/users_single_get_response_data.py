...
from ..models.users_single_get_response_data_type import UsersSingleGetResponseDataType
...
class UsersSingleGetResponseData:
    ...
    relationships: Union[Unset, "UsersSingleGetResponseDataRelationships"] = UNSET
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        if isinstance(_attributes, Unset):
            ...
            attributes = UsersSingleGetResponseDataAttributes.from_dict(_attributes)
