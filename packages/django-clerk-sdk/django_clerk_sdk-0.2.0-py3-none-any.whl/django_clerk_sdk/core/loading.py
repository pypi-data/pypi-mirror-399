...
from django_clerk_sdk.utils.deprecation import RemovedInNextVersionWarning
...
def get_model(app_label, model_name):
    ...
    """
    moved_model = MOVED_MODELS.get(app_label, None)
    if moved_model:
        if model_name.lower() in moved_model[1]:
            original_app_label = app_label
            app_label = moved_model[0]
            warnings.warn(
