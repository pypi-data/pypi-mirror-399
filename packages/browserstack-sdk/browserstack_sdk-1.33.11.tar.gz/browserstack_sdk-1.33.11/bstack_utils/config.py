...
conf = {
    bstack1l1l_opy_ (u"࠭ࡡࡱࡲࡢࡥࡺࡺ࡯࡮ࡣࡷࡩࠬ៳"): False,
    bstack1l1l_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࠨ៴"): True,
    bstack1l1l_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧ៵"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11l1ll11111_opy_ = conf
    @classmethod
    def bstack1l1ll1l111_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11l1ll1111l_opy_=None):
        return self._11l1ll11111_opy_.get(property_name, bstack11l1ll1111l_opy_)
    def bstack1lll1111l_opy_(self, property_name, bstack11l1l1lllll_opy_):
        self._11l1ll11111_opy_[property_name] = bstack11l1l1lllll_opy_
    def bstack1ll11ll11l_opy_(self, val):
        self._11l1ll11111_opy_[bstack1l1l_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨ៶")] = bool(val)
    def bstack1llllll1l1l_opy_(self):
        return self._11l1ll11111_opy_.get(bstack1l1l_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩ៷"), False)