...
conf = {
    bstack11111l_opy_ (u"࠭ࡡࡱࡲࡢࡥࡺࡺ࡯࡮ࡣࡷࡩࠬ៬"): False,
    bstack11111l_opy_ (u"ࠧࡣࡵࡷࡥࡨࡱ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࠨ៭"): True,
    bstack11111l_opy_ (u"ࠨࡵ࡮࡭ࡵࡥࡳࡦࡵࡶ࡭ࡴࡴ࡟ࡴࡶࡤࡸࡺࡹࠧ៮"): False
}
class Config(object):
    instance = None
    def __init__(self):
        self._11l1ll1111l_opy_ = conf
    @classmethod
    def bstack1llll1lll_opy_(cls):
        if cls.instance:
            return cls.instance
        return Config()
    def get_property(self, property_name, bstack11l1ll111ll_opy_=None):
        return self._11l1ll1111l_opy_.get(property_name, bstack11l1ll111ll_opy_)
    def bstack1ll1lll11_opy_(self, property_name, bstack11l1ll111l1_opy_):
        self._11l1ll1111l_opy_[property_name] = bstack11l1ll111l1_opy_
    def bstack1l11111111_opy_(self, val):
        self._11l1ll1111l_opy_[bstack11111l_opy_ (u"ࠩࡶ࡯࡮ࡶ࡟ࡴࡧࡶࡷ࡮ࡵ࡮ࡠࡵࡷࡥࡹࡻࡳࠨ៯")] = bool(val)
    def bstack111111l111_opy_(self):
        return self._11l1ll1111l_opy_.get(bstack11111l_opy_ (u"ࠪࡷࡰ࡯ࡰࡠࡵࡨࡷࡸ࡯࡯࡯ࡡࡶࡸࡦࡺࡵࡴࠩ៰"), False)