...
Ascender framework. It includes a command-line copilot TUI, MCP server provider
...
Include your chosen license here (e.g. MIT). If you don't want to add one yet,
consider adding an explicit `UNLICENSED` or `MIT` file so consumers know how
...
- Add a tiny `setup`/packaging guide or `Makefile` for common dev tasks.
