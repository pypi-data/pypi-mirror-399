...
IMPORT_MIGRATIONS = [
    ...
    (r"from arifos_core\.fag import", "from arifos_core.governance.fag import"),
    (r"from arifos_core\.kernel import", "from arifos_core.system.kernel import"),
    (r"from arifos_core\.merkle import", "from arifos_core.governance.merkle import"),
    (r"from arifos_core\.ledger_hashing import", "from arifos_core.governance.ledger_hashing import"),
    ...
    (r"from arifos_core\.governed_llm import", "from arifos_core.wrappers.governed_session import"),
    ...
    (r"from arifos_core\.vault_retrieval import", "from arifos_core.governance.vault_retrieval import"),
    (r"from arifos_core\.zkpc_runtime import", "from arifos_core.governance.zkpc_runtime import"),
]
