...
**Version:** v44.0.0 | **Status:** AUTHORITATIVE | **Last Updated:** 2025-12-25

---

## ⚖️ AUTHORITY STATEMENT

**spec/v44/ is the SOLE RUNTIME AUTHORITY for all Track B (tunable) thresholds.**

Runtime loaders MUST use spec/v44/ files (or explicit env override) with fail-closed behavior.

Legacy specs (v35Omega, v38Omega, v42) are retained for history only. They MUST NOT be loaded by default.

---

## 📁 Canonical Spec Files (v44.0)
...
- **v44.0:** **TEARFRAME physics + consolidated single authority** ← YOU ARE HERE
...
B) spec/v44/constitutional_floors.json               ← Authoritative default
...
{
  "version": "v44.0",
  "_loaded_from": "spec/v44/constitutional_floors.json",
  // ... rest of spec
}
```
...
- **Spec:** `spec/v44/session_physics.json` (NEW)

### W@W Federation:
- **Loader:** `arifos_core/waw/federation.py:_load_waw_spec()`
- **Spec:** `spec/v44/waw_prompt_floors.json`
...
| **Track B (Spec)** | Thresholds | `spec/v44/` | Tunable (operator override) |
