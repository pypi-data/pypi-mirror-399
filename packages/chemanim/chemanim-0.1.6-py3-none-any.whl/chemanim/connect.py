...
def fetch_pdb_file(pdb_id: str, output_dir: str = None, force: bool = False) -> str:
    """
    Download a PDB file from RCSB PDB.
    
    Args:
        pdb_id: 4-letter PDB ID (e.g., '2HHB' for Hemoglobin)
    ...
    # Return existing file if not forcing re-download
