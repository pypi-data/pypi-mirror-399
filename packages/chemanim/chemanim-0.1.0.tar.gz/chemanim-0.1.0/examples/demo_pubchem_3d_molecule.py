...
class PubChem3DScene(ThreeDScene):
    def construct(self):
        self.set_camera_orientation(phi=60 * DEGREES, theta=-45 * DEGREES, zoom=2.4)

        mol = ChemObject3D.from_pubchem(
            "caffeine",  # change identifier as needed (name or CID)
            prefer_3d=True,
            coord_scale=1.0,
...
# Run:
# D:/Law/Chemanim/env311/Scripts/python.exe -m manim -pql examples/demo_pubchem_3d_molecule.py PubChem3DScene
