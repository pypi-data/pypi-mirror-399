...
class PatchedUserRequest(BaseModel):
    ...
    company: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=255)]] = None
    __properties: ClassVar[List[str]] = ["username", "first_name", "last_name", "email", "password", "country", "company"]
