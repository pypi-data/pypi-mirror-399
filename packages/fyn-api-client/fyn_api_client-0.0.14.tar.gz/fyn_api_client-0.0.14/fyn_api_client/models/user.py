...
class User(BaseModel):
    ...
    country: Annotated[str, Field(strict=True, max_length=255)]
    company: Annotated[str, Field(strict=True, max_length=255)]
    __properties: ClassVar[List[str]] = ["username", "first_name", "last_name", "email", "country", "company"]
