...
class Assessments:
    ...
    async def create_atomic_assessment(
        ...
        1. POST /v2/assessments/project_from_template - Create assessment with tests+scenarios
        2. POST /v1/assessments/{id}/update_defaults - Assign test points
        ...
        Returns:
            Dict with assessment_id, name, scenario_count, asset_ids, version
        ...
        try:
            # Step 1: Create v2 assessment with tests and scenarios in one call
            scenarios_payload = [{"id": sid, "order": i} for i, sid in enumerate(scenario_ids, 1)]
            ...
            # Step 2: Assign test points (assets) - API accepts list
