...
1. Check if the bug has already been reported in [Issues](https://github.com/yourusername/saasready/issues)
...
1. Check existing [Issues](https://github.com/yourusername/saasready/issues) and [Discussions](https://github.com/yourusername/saasready/discussions)
