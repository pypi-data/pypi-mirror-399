...
ERROR_RID_NOT_ASCEND_K_DATA = 'ERROR_RID_NOT_ASCEND_K_DATA:Wrong K data,target_index:{!r},target_time:{!r},wrong_time={!r},time_exist={!r},time_loc={!r}'
...
ARGCHECKER_INVALID_PARAM_QUARTER_ERROR = '函数 {}: 无效 {} 参数, 期望参数格式类似 2022q1, 得到参数值 {}'
