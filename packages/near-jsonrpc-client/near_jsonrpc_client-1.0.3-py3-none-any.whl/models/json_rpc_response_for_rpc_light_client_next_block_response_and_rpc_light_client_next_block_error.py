from models.error_wrapper_for_rpc_light_client_next_block_error import ErrorWrapperForRpcLightClientNextBlockError
from models.rpc_light_client_next_block_response import RpcLightClientNextBlockResponse
