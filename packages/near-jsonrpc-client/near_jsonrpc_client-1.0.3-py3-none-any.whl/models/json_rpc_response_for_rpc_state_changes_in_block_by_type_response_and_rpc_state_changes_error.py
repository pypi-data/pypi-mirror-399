from models.error_wrapper_for_rpc_state_changes_error import ErrorWrapperForRpcStateChangesError
from models.rpc_state_changes_in_block_by_type_response import RpcStateChangesInBlockByTypeResponse
