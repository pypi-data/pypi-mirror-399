...
from .asset import Asset, AssetData, AssetPublishRepo
...
class AssetManager:
    ...
    def create_asset(
        ...
        **asset_repos: str,
        ...
        # asset_repos = asset_repos or asset_data.package.publish.repos
        # default_repo = default_repo or asset_data.get("publish", {}).get("publish_to")
        ...
        asset_path = asset_folder / name
        rich.print("Creating Asset", asset_path)
        rich.print(asset_data)

        asset_path.mkdir(exist_ok=True)

        src = asset_path / "src" / name
        src.mkdir(parents=True, exist_ok=True)

        asset_toml = asset_path / "src" / name / "asset.toml"
...
def main() -> None:
    ...
    """
        ...
        readme_content = f"# TGZR Asset: {name}\n"
    ...
    def _edit_asset_data(
        ...
        init_file = asset_path / "src" / asset_name / "__init__.py"
        asset = Asset(init_file)
