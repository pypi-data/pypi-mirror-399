"""
Basic usage example for Servicenow MCP Server.
...
Prerequisites:
- Install the package: pip install servicenow-mcp
...
async def example_usage():
    """
    Example usage of Servicenow MCP Server.
...
if __name__ == "__main__":
    ...
    print("\n" + "="*60)
    print(f"  Servicenow MCP Server - Basic Usage Example")
    print("="*60 + "\n")
    ...
    try:
        ...
        print("2. All dependencies are installed: pip install servicenow-mcp")
