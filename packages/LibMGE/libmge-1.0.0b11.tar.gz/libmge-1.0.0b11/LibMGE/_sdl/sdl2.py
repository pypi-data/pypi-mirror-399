...
def SDL_LockSurface(surface): return SDLFunc("SDL_LockSurface", [_P(SDL_Surface)], c_int)
...
def SDL_CreateSoftwareRenderer(surf: SDL_Surface) -> SDL_Renderer: return SDLFunc("SDL_CreateSoftwareRenderer", [_P(SDL_Surface)], _P(SDL_Renderer))(surf)
...
def SDL_SetRenderTarget(render: SDL_Renderer, texture: SDL_Texture | None) -> int: return SDLFunc("SDL_SetRenderTarget", [_P(SDL_Renderer), _P(SDL_Texture)], c_int)(render, texture)
def SDL_GetRenderTarget(render: SDL_Renderer) -> SDL_Texture: return SDLFunc("SDL_GetRenderTarget", [_P(SDL_Renderer)], _P(SDL_Texture))(render)
