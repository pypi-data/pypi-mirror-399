...
class Table:
    ...
    def get_records(self, access_token: str, filter: FilterField,
    ...
    def get_records_by_id(self, access_token: str, record_ids: list[str],
        ...
        """
            ...
            :param with_shared_url: 是否包含共享链接，默认为False
        """
        url = f"https://open.feishu.cn/open-apis/bitable/v1/apps/{self.bitable.app_token}/tables/{self.id}/records/batch_get"
        headers = {
            **COMMON_HEADER,
            "Authorization": f"Bearer {access_token}"
        }
