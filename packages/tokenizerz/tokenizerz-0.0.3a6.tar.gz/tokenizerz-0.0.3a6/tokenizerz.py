...
class Tokenizer:
    def __init__(self, repo_name="Qwen", model_name="Qwen2.5-Coder-0.5B", local_dir='models', verbose=False):
        ...
        try:
            with open(f'{local_dir}/{model_name}/tokenizer_config.json', 'r') as f:
