...
def main():
    ...
    parser.add_argument(
        "--model",
        default=get_resource_path("model_save/model_weight.pth"),
        help="Model weight file"
    )
    parser.add_argument(
        "--kmeans",
        default=get_resource_path("model_save/kmeans.pickle"),
        help="KMeans model"
    )
    parser.add_argument(
        "--tree",
        default=get_resource_path("model_save/tbt.pickle"),
        help="Taxonomic tree"
    )
    parser.add_argument(
        "--index",
        default=get_resource_path("model_save/index.pickle"),
