...
#define __PYX_HAVE__cykit__common
#define __PYX_HAVE_API__cykit__common
/* Early includes */
#include <stdint.h>
#include <string.h>
#include <stdio.h>
...
/* Module declarations from "cykit.common" */
/* #### Code section: typeinfo ### */
/* #### Code section: before_global_var ### */
#define __Pyx_MODULE_NAME "cykit.common"
extern int __pyx_module_is_main_cykit__common;
int __pyx_module_is_main_cykit__common = 0;

/* Implementation of "cykit.common" */
...
#define __pyx_kp_b_int_uint32_t_is_power_of_two __pyx_string_tab[9]
...
static CYTHON_INLINE int __pyx_f_5cykit_6common_is_power_of_two(uint32_t __pyx_v_n) {
  int __pyx_r;
  int __pyx_t_1;
  int __pyx_t_2;
...
*/
  ...
  __pyx_t_2 = ((__pyx_v_n & (__pyx_v_n - 1)) == 0);
  __pyx_t_1 = __pyx_t_2;
...
static int __Pyx_modinit_function_export_code(__pyx_mstatetype *__pyx_mstate) {
  ...
  /*--- Function export code ---*/
  {
    ...
    const char * __pyx_export_signature = __Pyx_PyBytes_AsString(__pyx_mstate_global->__pyx_kp_b_int_uint32_t_is_power_of_two);
    #if !CYTHON_ASSUME_SAFE_MACROS
    if (unlikely(!__pyx_export_signature)) __PYX_ERR(0, 3, __pyx_L1_error)
    #endif
    const char * __pyx_export_name = __pyx_export_signature + 15;
    void (*const __pyx_export_pointers[])(void) = {(void (*)(void))&__pyx_f_5cykit_6common_is_power_of_two, (void (*)(void)) NULL};
...
__Pyx_RefNannySetupContext("PyInit_common", 0);
  ...
  if (__pyx_module_is_main_cykit__common) {
  ...
  }
  {
    ...
    if (!PyDict_GetItemString(modules, "cykit.common")) {
      if (unlikely((PyDict_SetItemString(modules, "cykit.common", __pyx_m) < 0))) __PYX_ERR(0, 3, __pyx_L1_error)
    }
  }
  /*--- Builtin init code ---*/
...
*/
  ...
  if (__pyx_m) {
    if (__pyx_mstate->__pyx_d && stringtab_initialized) {
      __Pyx_AddTraceback("init cykit.common", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    #if !CYTHON_USE_MODULE_STATE
    Py_CLEAR(__pyx_m);
    #else
    ...
    PyErr_SetString(PyExc_ImportError, "init cykit.common");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
...
static int __Pyx_InitConstants(__pyx_mstatetype *__pyx_mstate) {
  CYTHON_UNUSED_VAR(__pyx_mstate);
  {
    const struct { const unsigned int length: 5; } index[] = {{1},{18},{8},{10},{8},{12},{12},{10},{8},{30}};
    #if (CYTHON_COMPRESS_STRINGS) != 0 /* compression: zlib (97 bytes) */
const char* const cstring = "x\332%\210\313\r\2000\014C\031\205#\\a\000F\261B\033\244\210\376hS\001\333S\300\207\347g/\306I`H\200f2\274\222\331\001Om\267\370h\253\343\327\002\371\257\323}\301P\222\327\217J\356\377\013\253\345\215\252S@\2714J\320~\250\215\363\004\035;)H\361\344\214\270A\317\370\000\247\253-\337";
...
const char* const bytes = "?cline_in_traceback__main____module____name____pyx_capi____qualname__setdefault__test__int (uint32_t)\000is_power_of_two";
    PyObject *data = NULL;
