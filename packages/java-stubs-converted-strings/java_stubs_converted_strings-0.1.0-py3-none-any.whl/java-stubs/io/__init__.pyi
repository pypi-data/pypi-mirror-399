...
class Console(Flushable):
    ...
    @typing.overload
    def format(self, locale: java.util.Locale, string: str, *object: typing.Any) -> 'Console': ...
    def isTerminal(self) -> bool: ...
    @typing.overload
    def printf(self, string: str, *object: typing.Any) -> 'Console': ...
    @typing.overload
    def printf(self, locale: java.util.Locale, string: str, *object: typing.Any) -> 'Console': ...
    @typing.overload
    def readLine(self) -> str: ...
    @typing.overload
    def readLine(self, string: str, *object: typing.Any) -> str: ...
    @typing.overload
    def readLine(self, locale: java.util.Locale, string: str, *object: typing.Any) -> str: ...
    @typing.overload
    ...
    @typing.overload
    def readPassword(self, locale: java.util.Locale, string: str, *object: typing.Any) -> typing.MutableSequence[str]: ...
...
class Reader(java.lang.Readable, Closeable):
    ...
    def readAllLines(self) -> java.util.List[str]: ...
    def ready(self) -> bool: ...
    def reset(self) -> None: ...
    def skip(self, long: int) -> int: ...
