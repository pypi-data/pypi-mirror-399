...
class PEMDecoder:
    ...
    @typing.overload
    def decode(self, string: str) -> DEREncodable: ...
    @typing.overload
    def decode(self, string: str, class_: typing.Type[_decode_3__S]) -> _decode_3__S: ...
    @staticmethod
    def of() -> 'PEMDecoder': ...
...
class PEMEncoder:
    ...
    def encodeToString(self, dEREncodable: DEREncodable) -> str: ...
    @staticmethod
    def of() -> 'PEMEncoder': ...
...
class PEMRecord(java.lang.Record, DEREncodable):
    ...
    @typing.overload
    def __init__(self, type: str, content: str, leadingData: typing.Union[typing.List[int], jpype.JArray, bytes]): ...
